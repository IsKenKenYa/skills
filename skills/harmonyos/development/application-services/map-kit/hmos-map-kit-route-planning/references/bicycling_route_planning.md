...
提供两点之间的骑行路径规划能力，返回详细的路线信息、距离、耗时等。

- **版本**: 1.0
- **服务标识**: `getCyclingRoutes`
- **官方文档**: <https://developer.huawei.com/consumer/cn/doc/harmonyos-references/map-navi-api>

### 接口定义

**函数**: `navi.getCyclingRoutes(params: RouteParams): Promise<RouteResult>`
...
详情见 ../assets/cyclingRouteDemo.ets
