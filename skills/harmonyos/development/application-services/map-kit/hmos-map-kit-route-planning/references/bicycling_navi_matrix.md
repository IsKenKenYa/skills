...
提供多点之间骑行路径批量计算功能，适用于外卖配送、快递派送等高并发场景。

- **版本**: 1.0
- **服务标识**: `getCyclingMatrix`
- **官方文档**: <https://developer.huawei.com/consumer/cn/doc/harmonyos-references/map-navi-api>

### 接口定义

**函数**: `navi.getCyclingMatrix(params: MatrixParams): Promise<MatrixResult>`
...
详情见 ../assets/cyclingMatrixDemo.ets
