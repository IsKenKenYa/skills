...
| ageGroup | [AgeGroup](#section397519409416) | 否 | 是 | 年龄段信息。说明：仅当未成年人模式开启时才返回此字段。当登录中国境内（香港特别行政区、澳门特别行政区、中国台湾除外）儿童账号（14周岁及以下）开启未成年人模式，则可能返回年龄段信息为[0,3)、[3,8)、[8,12)或[12,16)。如用户登录4周岁儿童账号，则返回年龄段信息为[3,8)。如用户登录9周岁儿童账号，则返回年龄段信息为[8,12)。当登录中国境内（香港特别行政区、澳门特别行政区、中国台湾除外）非儿童账号开启未成年人模式，则可能返回年龄段信息为[0,3)、[3,8)、[8,12)、[12,16)或[16,18)。如用户创建13岁临时使用者，则返回年龄段信息为[12,16)。如用户创建17岁临时使用者，则返回年龄段信息为[16,18)。 |
#### AgeGroup
...
| **名称** | **值** | **说明** |
| --- | --- | --- |
| MINORS_MODE_NOT_ENABLED | [1009900002](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Account Kit（华为账号服务）/account-api-error-code.md) | 未成年人模式未开启。 |
| USER_CANCELED | [1009900003](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Account Kit（华为账号服务）/account-api-error-code.md) | 用户取消操作。 |
| MINORS_MODE_ALREADY_ON | [1009900005](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Account Kit（华为账号服务）/account-api-error-code.md) | 未成年人模式已经开启。 |
| MINORS_MODE_ALREADY_OFF | [1009900006](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Account Kit（华为账号服务）/account-api-error-code.md) | 未成年人模式已经关闭。 |
| UNSUPPORTED_ACCOUNT | [1009900007](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Account Kit（华为账号服务）/account-api-error-code.md) | 不支持的账号。 |
| SERVICE_NOT_AVAILABLE | [1009900011](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Account Kit（华为账号服务）/account-api-error-code.md) | 服务不可用。 |
#### supportMinorsMode
...
| 类型 | 说明 |
| --- | --- |
| [MinorsProtectionInfo](#section3551104714566) | 返回[MinorsProtectionInfo](#section3551104714566)对象。用于获取未成年人模式开启状态、年龄段信息。 |
**错误码：**
以下错误码的详细介绍请参见 [ArkTS错误码](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Account Kit（华为账号服务）/account-api-error-code.md) 。
| 错误码ID | 错误信息 |
| --- | --- |
...
| 类型 | 说明 |
| --- | --- |
| Promise<[MinorsProtectionInfo](#section3551104714566)> | Promise对象，返回[MinorsProtectionInfo](#section3551104714566)对象。用于获取未成年人模式开启状态、年龄段信息。 |
**错误码：**
以下错误码的详细介绍请参见 [ArkTS错误码](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Account Kit（华为账号服务）/account-api-error-code.md) 。
| 错误码ID | 错误信息 |
| --- | --- |
...
| [1001502009](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Account Kit（华为账号服务）/account-api-error-code.md) | Internal error. |
| [1009900002](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Account Kit（华为账号服务）/account-api-error-code.md) | The minors mode is not enabled. |
**示例：**
```typescript
import { minorsProtection } from '@kit.AccountKit';
import { hilog } from '@kit.PerformanceAnalysisKit';
...
| [401](D:/code/APIDevice/output/md_output/harmonyos-references/API参考概述/errorcode-universal.md) | Parameter error. Possible causes: 1. Mandatory parameters are left unspecified; 2. Incorrect parameter types. |
| [1001502009](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Account Kit（华为账号服务）/account-api-error-code.md) | Internal error. |
| [1009900003](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Account Kit（华为账号服务）/account-api-error-code.md) | The user canceled the operation. |
| [1009900005](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Account Kit（华为账号服务）/account-api-error-code.md) | The minors mode is already on. |
| [1009900007](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Account Kit（华为账号服务）/account-api-error-code.md) | Unsupported HUAWEI ID. |
| [1009900011](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Account Kit（华为账号服务）/account-api-error-code.md) | Service not available. |
**示例：**
```typescript
import { minorsProtection } from '@kit.AccountKit';
import { hilog } from '@kit.PerformanceAnalysisKit';
...
| [1001502009](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Account Kit（华为账号服务）/account-api-error-code.md) | Internal error. |
| [1009900003](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Account Kit（华为账号服务）/account-api-error-code.md) | The user canceled the operation. |
| [1009900006](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Account Kit（华为账号服务）/account-api-error-code.md) | The minors mode is already off. |
| [1009900011](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Account Kit（华为账号服务）/account-api-error-code.md) | Service not available. |
**示例：**
```typescript
import { minorsProtection } from '@kit.AccountKit';
