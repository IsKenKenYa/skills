...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e9/v3/cCl5HIEbQGmdzu_fSXxQRg/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260701T105121Z&HW-CC-Expire=86400&HW-CC-Sign=14F2EE62E14A4DD467B42FD2A55F11AE06C2BF56BB1D5AEB9D7ABF9E15117C6B)
1.
儿童账号一键登录场景：
...
6.
仅支持企业开发者使用一键登录，个人开发者请使用 [华为账号登录](D:/code/APIDevice/output/md_output/harmonyos-guides/应用服务/Account Kit（华为账号服务）/登录/华为账号登录（获取UnionID_OpenID）/使用“华为账号登录”按钮登录/account-unionid-login-button.md) 或 [静默登录](D:/code/APIDevice/output/md_output/harmonyos-guides/应用服务/Account Kit（华为账号服务）/登录/静默登录/account-silent-login.md) 实现登录。
#### 用户体验设计
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c5/v3/MIo7xOBRTha6OxkWVu5sxw/zh-cn_image_0000002628701536.png?HW-CC-KV=V1&HW-CC-Date=20260701T105121Z&HW-CC-Expire=86400&HW-CC-Sign=9DEDF1C2CC8F38311B6749F49A44BDB49C9F810CA0F4EE7E88921D0823A3D10D)
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/27/v3/8ZifkxlETg6cXxr9Kjerhw/zh-cn_image_0000002659100765.png?HW-CC-KV=V1&HW-CC-Date=20260701T105121Z&HW-CC-Expire=86400&HW-CC-Sign=99D9CC79AB9630A69A02AD1FCC20E83EB033923F4671C3227EC100C006E585C4)
#### 登录页面UX设计规范
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/cb/v3/FCqB-Xw6S0Oy3N6M8FNvsw/zh-cn_image_0000002628861416.png?HW-CC-KV=V1&HW-CC-Date=20260701T105121Z&HW-CC-Expire=86400&HW-CC-Sign=398C8EC3E397F53375B76CD5AFB1EA7A73B9E31E4BB3C504D8E6F798CCC190D2)
一键登录按钮的用户体验和UX设计需符合 [【华为账号一键登录】按钮](https://developer.huawei.com/consumer/cn/doc/design-guides/id-0000001880001344#section41792374210) 规范，用户体验设计图2中的华为标志按钮可参考 [华为账号登录视觉规范](https://developer.huawei.com/consumer/cn/doc/design-guides/id-0000001880001344#section61791745172816) 中的样式三。不符合规范的UX设计可能会对应用上架和用户体验带来影响。一键登录按钮的样式设计具体可以参考 [华为账号登录按钮类型](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Account Kit（华为账号服务）/ArkTS组件/account-api-component-manager.md) 。
#### 用户场景设计
用户使用华为账号一键登录能力，注册/登录应用时，可能存在多种场景，应用可参照以下流程，根据自身业务场景进行设计。
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d/v3/1YGkxIq1Q26FrwNgyCKeDA/zh-cn_image_0000002659220729.png?HW-CC-KV=V1&HW-CC-Date=20260701T105121Z&HW-CC-Expire=86400&HW-CC-Sign=A32FA699132B0751CB2610CA09737B85BBD9FCD09ED901B5873BF6E8C8E295FB)
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e4/v3/7bx0NWtzR1acVw5NzoTnow/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260701T105121Z&HW-CC-Expire=86400&HW-CC-Sign=BE7662147F72F68A8F714CFF67092A8A3BC2BCC6FA9D215059A4645A7F6A93D5)
**将UnionID/OpenID和手机号同时与应用账号建立关联，可以为用户带来更多便利的功能。如：实现[静默登录](D:/code/APIDevice/output/md_output/harmonyos-guides/应用服务/Account Kit（华为账号服务）/登录/静默登录/account-silent-login.md)、[获取华为账号用户信息](D:/code/APIDevice/output/md_output/harmonyos-guides/应用服务/Account Kit（华为账号服务）/获取华为账号用户信息/概述/account-get-user-info-overview.md)、[获取华为账号风险等级](D:/code/APIDevice/output/md_output/harmonyos-guides/应用服务/Account Kit（华为账号服务）/获取华为账号用户信息/获取风险等级/通过华为账号一键登录获取用户风险等级/account-get-risklevel-byquicklogin.md)等。实现免用户操作登录，获得安全快捷的应用登录体验。**
#### 业务流程
#### 用户首次登录应用
若应用未接入过华为账号登录，不存在使用华为账号登录过的应用账号，请参照以下流程接入华为账号一键登录。
**图1** 华为账号一键登录（用户首次登录应用）流程图
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/12/v3/9CFgfucGRnC9kuE1sQOc-g/zh-cn_image_0000002628701538.png?HW-CC-KV=V1&HW-CC-Date=20260701T105121Z&HW-CC-Expire=86400&HW-CC-Sign=FA74A947509A4E7BB4CBA330C436629081BC8AC4750A7FE21A906A40668A5A17)
流程说明：
1.
预取号阶段（序号1-4）：
1.
[AuthorizationWithHuaweiIDRequest](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Account Kit（华为账号服务）/ArkTS API/account-api-authentication.md)
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ca/v3/19MLzA5ISdKj5g_0Z1Qf8A/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260701T105121Z&HW-CC-Expire=86400&HW-CC-Sign=2BA6C8276115BFC0E066B7335D6CBC485734AD53EBBFCA0372B45C98382BA866)
获取匿名手机号时建议设置超时处理，推荐设置5秒以保证用户体验。
2. 若华为账号未登录，调用[AuthorizationWithHuaweiIDRequest](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Account Kit（华为账号服务）/ArkTS API/account-api-authentication.md)授权请求会返回[1001502001 用户未登录华为账号](D:/code/APIDevice/output/md_output/harmonyos-references/errorcode-account-kit.md)错误码，此时应用需要展示其他登录方式进行应用登录。
2.
展示一键登录页面阶段（序号5）：
1. 获取到的匿名手机号需要展示在页面上并设置好隐私协议，设置登录按钮类型为LoginType.QUICK_LOGIN，展示包含[LoginWithHuaweiIDButton](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Account Kit（华为账号服务）/ArkTS组件/account-api-huawei-id-button.md)组件的一键登录页面。应用可结合实际登录风控场景，通过组件参数传入风险等级标识以[获取华为账号风险等级](D:/code/APIDevice/output/md_output/harmonyos-guides/应用服务/Account Kit（华为账号服务）/获取华为账号用户信息/获取风险等级/通过华为账号一键登录获取用户风险等级/account-get-risklevel-byquicklogin.md)，从而对恶意账号进行风控，提升应用的安全等级。
3.
点击一键登录关联用户账号阶段（序号6-16）：
1. 用户同意协议后，点击华为账号一键登录按钮，应用可以通过[HuaweiIDCredential](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Account Kit（华为账号服务）/ArkTS组件/account-api-component-manager.md)获取到Authorization Code等数据。
2. 将获取的Authorization Code数据传给应用服务端，应用服务端通过Authorization Code调用[/oauth2/v6/quickLogin/getPhoneNumber接口](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Account Kit（华为账号服务）/REST API/获取用户信息/account-api-get-user-info-quicklogin-by-code.md)获取用户完整手机号和UnionID、OpenID。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/83/v3/lFXaVKYUQPG7rcOUbl40NQ/zh-cn_image_0000002659100767.png?HW-CC-KV=V1&HW-CC-Date=20260701T105121Z&HW-CC-Expire=86400&HW-CC-Sign=AD42BF5AB9762D2AFF47326798FB16C62480B163F4BE9C05A78CB9B22AA95359)
流程说明：
1.
应用调用 [AuthorizationWithHuaweiIDRequest](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Account Kit（华为账号服务）/ArkTS API/account-api-authentication.md) 授权请求获取 [AuthorizationWithHuaweiIDResponse](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Account Kit（华为账号服务）/ArkTS API/account-api-authentication.md) 响应结果中的Authorization Code。
2.
应用服务端通过Authorization Code调用 [/oauth2/v6/quickLogin/getPhoneNumber接口](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Account Kit（华为账号服务）/REST API/获取用户信息/account-api-get-user-info-quicklogin-by-code.md) 获取用户相关信息。通过Authorization Code凭证获取用户信息可以有效避免黑客通过数据遍历、身份伪造、重放攻击等手段导致的安全风险。
3.
...
| 接口名 | 描述 |
| --- | --- |
| [createAuthorizationWithHuaweiIDRequest](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Account Kit（华为账号服务）/ArkTS API/account-api-authentication.md)():[AuthorizationWithHuaweiIDRequest](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Account Kit（华为账号服务）/ArkTS API/account-api-authentication.md) | 获取授权接口，通过[AuthorizationWithHuaweiIDRequest](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Account Kit（华为账号服务）/ArkTS API/account-api-authentication.md)传入一键登录的scope：quickLoginAnonymousPhone，即可在授权结果中获取到用户的匿名手机号和Authorization Code。 |
...
| [LoginWithHuaweiIDButton](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Account Kit（华为账号服务）/ArkTS组件/account-api-huawei-id-button.md) | 华为账号Button登录组件。该组件仅纯文本样式支持华为账号一键登录功能。开发者可以通过调整按钮的大小、圆角等参数以适配HarmonyOS应用登录界面。如果仍然不能满足开发者的诉求，可以使用[Style](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Account Kit（华为账号服务）/ArkTS组件/account-api-component-manager.md)的BUTTON_CUSTOM值定义按钮的文字颜色和背景色。 |
| [onClickLoginWithHuaweiIDButton](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Account Kit（华为账号服务）/ArkTS组件/account-api-component-manager.md)(callback: AsyncCallback<[HuaweiIDCredential](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Account Kit（华为账号服务）/ArkTS组件/account-api-component-manager.md)>):[LoginWithHuaweiIDButtonController](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Account Kit（华为账号服务）/ArkTS组件/account-api-component-manager.md) | 注册华为账号一键登录按钮的结果回调。 |
| [setAgreementStatus](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Account Kit（华为账号服务）/ArkTS组件/account-api-component-manager.md)(agreementStatus:[AgreementStatus](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Account Kit（华为账号服务）/ArkTS组件/account-api-component-manager.md)):[LoginWithHuaweiIDButtonController](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Account Kit（华为账号服务）/ArkTS组件/account-api-component-manager.md) | 设置协议状态方法。用户未同意协议前设置协议状态为NOT_ACCEPTED，用户同意协议后设置协议状态为ACCEPTED，才可以完成华为账号登录。 |
| [onClickEvent](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Account Kit（华为账号服务）/ArkTS组件/account-api-component-manager.md)(callback: AsyncCallback<[ClickEvent](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Account Kit（华为账号服务）/ArkTS组件/account-api-component-manager.md)>):[LoginWithHuaweiIDButtonController](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Account Kit（华为账号服务）/ArkTS组件/account-api-component-manager.md) | 注册华为账号一键登录按钮的点击事件回调。 |
| [continueLogin](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Account Kit（华为账号服务）/ArkTS组件/account-api-component-manager.md)(callback: AsyncCallback<void>):[LoginWithHuaweiIDButtonController](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Account Kit（华为账号服务）/ArkTS组件/account-api-component-manager.md) | 用户点击协议弹框的同意并登录按钮结果回调。 |
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/39/v3/m_9wazdqRNqPrLvP-JD2hQ/caution_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260701T105121Z&HW-CC-Expire=86400&HW-CC-Sign=6D5A2522AE5F25C560B3D3EA6F5AB05CC10F0138687C3701A3B5315648C50DC7)
上述接口需在页面或自定义组件生命周期内调用。
#### 开发前提
1.
在进行代码开发前，请先确认已完成 [开发准备](D:/code/APIDevice/output/md_output/harmonyos-guides/应用服务/Account Kit（华为账号服务）/开发准备/申请账号权限/account-config-permissions.md) 工作。
...
若未申请“华为账号一键登录”权限，将报错 [1001502014 应用未申请scopes或permissions权限](D:/code/APIDevice/output/md_output/harmonyos-guides/应用服务/Account Kit（华为账号服务）/Account Kit常见问题/1001502014 应用未申请scopes或permissions权限的可能原因和解决方法/account-faq-2.md) 。
2.
若应用开启了 [代码混淆](D:/code/APIDevice/output/md_output/harmonyos-guides/应用框架/ArkTS（方舟编程语言）/ArkTS编译工具链/ArkGuard源码混淆工具/ArkGuard混淆开启指南/source-obfuscation-guide.md) ，应用工程代码中获取到的quickLoginAnonymousPhone（匿名手机号）属性需要配置混淆白名单防止编译release包时被混淆，否则无法获取到匿名手机号。在调用获取匿名手机号方法工程模块的混淆文件obfuscation-rules.txt中添加：
```typescript
...
```
#### 客户端开发
开发者可参考下述内容自行开发，也可使用Account Kit为常见的三方开发框架（Flutter、H5、React-Native、uni-app）提供的SampleCode示例工程，用于接入华为账号一键登录能力，具体可参考 [三方开发框架接入华为账号一键登录](D:/code/APIDevice/output/md_output/harmonyos-guides/应用服务/Account Kit（华为账号服务）/Account Kit常见问题/三方开发框架接入华为账号一键登录/account-faq-18.md) 进行开发。
#### 用户首次登录应用
1.
导入模块。
导入Account Kit的 [authentication](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Account Kit（华为账号服务）/ArkTS API/account-api-authentication.md) 模块及相关公共模块。
```typescript
...
2.
获取匿名手机号。
调用 [authentication](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Account Kit（华为账号服务）/ArkTS API/account-api-authentication.md) 模块的 [AuthorizationWithHuaweiIDRequest](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Account Kit（华为账号服务）/ArkTS API/account-api-authentication.md) 请求获取华为账号用户的匿名手机号。匿名手机号用于登录页面展示。
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ae/v3/7agvMuGHQFWUrkIdBI8NOw/caution_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260701T105121Z&HW-CC-Expire=86400&HW-CC-Sign=7051CBA5F46931DA0436FB637D9F483F73C5D5FA60C0FBFAFD4EDDFDDFA04DF6)
...
| 1001502014 | 应用未申请scopes或permissions权限 | 请参考[1001502014 应用未申请scopes或permissions权限的可能原因和解决方法](D:/code/APIDevice/output/md_output/harmonyos-guides/应用服务/Account Kit（华为账号服务）/Account Kit常见问题/1001502014 应用未申请scopes或permissions权限的可能原因和解决方法/account-faq-2.md)解决该报错 |
| 1001500001 | 应用指纹证书校验失败 | 请参考[1001500001 应用指纹证书校验失败的可能原因和解决办法](D:/code/APIDevice/output/md_output/harmonyos-guides/应用服务/Account Kit（华为账号服务）/Account Kit常见问题/1001500001 应用指纹证书校验失败的可能原因和解决办法/account-faq-1.md)解决该报错 |
| 1001500002 | 重复请求 | 重复请求，应用无需处理 |
| 1001500003 | 不支持该scopes或permissions | 1、华为账号用户注册地可能为中国境外、香港特别行政区、澳门特别行政区或中国台湾，应用展示其他登录方式2、5.1.1(19)起支持TV设备，26.0.0起支持Car设备，其他版本应用可以通过[华为账号登录](D:/code/APIDevice/output/md_output/harmonyos-guides/应用服务/Account Kit（华为账号服务）/登录/华为账号登录（获取UnionID_OpenID）/使用“华为账号登录”按钮登录/account-unionid-login-button.md)进行登录 |
| 12300001 | 系统服务异常 | 应用展示其他登录方式 |
2）获取到的匿名手机号为空，说明华为账号没有绑定手机号、权限未申请或未生效，上述异常场景应用需要展示其他登录方式。
3）若开发者开启了 [代码混淆](D:/code/APIDevice/output/md_output/harmonyos-guides/应用框架/ArkTS（方舟编程语言）/ArkTS编译工具链/ArkGuard源码混淆工具/ArkGuard混淆开启指南/source-obfuscation-guide.md) ，需将quickLoginAnonymousPhone（匿名手机号）属性加入混淆白名单，防止其被混淆。
```
...
将获取到的匿名手机号设置给下面QuickLoginButtonComponent组件示例代码中的 **quickLoginAnonymousPhone** 变量，调用 [LoginWithHuaweiIDButton](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Account Kit（华为账号服务）/ArkTS组件/account-api-huawei-id-button.md) 组件，实现应用自己的登录页面，并展示华为账号一键登录按钮和华为账号用户认证协议（Account Kit提供跳转链接，应用需实现协议跳转，参见 [约束与限制](#约束与限制) 第2点），用户同意协议并点击一键登录按钮后，可获取到Authorization Code，将该值传给应用服务端用于获取用户信息（完整手机号、UnionID、OpenID）。通过code凭证获取用户信息可以有效避免因数据遍历、身份伪造、重放攻击导致的安全风险。
```typescript
...
```
#### 用户非首次登录应用（可选）
用户非首次登录应用流程请参考 [首次登录应用开发流程](#用户首次登录应用-1) 中的导入模块及获取匿名手机号，获取 [AuthorizationWithHuaweiIDResponse](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Account Kit（华为账号服务）/ArkTS API/account-api-authentication.md) 响应结果中的Authorization Code。可能存在的异常场景及处理方法，可参考表1 获取匿名手机号错误码处理。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/9f/v3/6HbIFqyzTSyeMM8XiOF0bA/zh-cn_image_0000002628861418.png?HW-CC-KV=V1&HW-CC-Date=20260701T105121Z&HW-CC-Expire=86400&HW-CC-Sign=4766F9F4C7941CB5CE81A009A110A95C1384CF8C517090650D04806F00D8E392)
若代码片段插入失败，可查询 [快速插入场景化代码片段](D:/code/APIDevice/output/md_output/harmonyos-guides/编写与调试应用/代码编辑/快速插入场景化代码片段/ide-kit-assistant.md) 的说明排查原因。
4.
...
-
存在如下异常场景：
1）返回 [1001502001 用户未登录华为账号](D:/code/APIDevice/output/md_output/harmonyos-references/errorcode-account-kit.md) 错误码，说明华为账号未登录。
2）返回 [1001500003 不支持该scopes或permissions](D:/code/APIDevice/output/md_output/harmonyos-references/errorcode-account-kit.md) 错误码，说明华为账号用户注册地为中国境外、香港特别行政区、澳门特别行政区或中国台湾。
3）获取到的匿名手机号为空，说明华为账号没有绑定手机号、权限未申请或未生效。
上述异常场景应用需要展示其他登录方式。
5.
根据上述代码实现应用的登录页面，并展示华为账号一键登录按钮和华为账号用户认证协议（Account Kit提供跳转链接，应用需实现协议跳转，参见 [约束与限制](#约束与限制) 第2点），用户同意协议并点击一键登录按钮后，可获取到Authorization Code，将该值传给应用服务端用于获取用户信息（完整手机号、UnionID、OpenID）。
#### 服务端开发
1.
应用服务端使用Client ID、Client Secret、Authorization Code调用 [/oauth2/v6/quickLogin/getPhoneNumber接口](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Account Kit（华为账号服务）/REST API/获取用户信息/account-api-get-user-info-quicklogin-by-code.md) 获取完整手机号和华为账号用户标识UnionID。
2.
应用通过获取到的完整手机号或UnionID查询该用户是否已关联应用系统数据库。如已关联，则绑定获取的UnionID与手机号到已有用户上（如已绑定，则可忽略），完成用户登录；如未关联，则创建新用户并绑定手机号与UnionID到该用户上。
#### 客户端与服务端交互开发
#### 应用客户端到应用服务端的开发
业务流程：
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d8/v3/nEuuOBAsRlesDbF-Gq0F2A/zh-cn_image_0000002659220731.png?HW-CC-KV=V1&HW-CC-Date=20260701T105121Z&HW-CC-Expire=86400&HW-CC-Sign=B5B1BC92029F9E078DD94A244A545D3D4F1865BE5DE60C45CBB39A794E2EC9E3)
- 准备：
1.
请先完成应用客户端一键登录的相关开发，相关开发指导参考 [客户端开发](#客户端开发) ；
2.
参考 [使用fetch发送网络请求](D:/code/APIDevice/output/md_output/harmonyos-guides/系统/网络/Remote Communication Kit（远场通信服务）/使用HTTP协议进行网络通信/发起HTTP请求，获取响应/发送网络请求（ArkTS）/remote-communication-netsend-arkts.md) 完成客户端到服务端的接口请求，开发步骤如下；
1.
在应用客户端调用应用服务端提供的接口，将Authorization Code传输给应用的服务端；
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/17/v3/jZLWwKtsRueSvun3DfVd-Q/caution_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260701T105121Z&HW-CC-Expire=86400&HW-CC-Sign=9E1FC48770D300D5314E9C9D0D80A339DBC967F40DB6FF447AE6F4F2E4BBB706)
...
```
3.
应用服务端获取到Authorization Code之后，对接华为账号服务器，参考 [服务端开发](#服务端开发) ，调用 [/oauth2/v6/quickLogin/getPhoneNumber接口](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Account Kit（华为账号服务）/REST API/获取用户信息/account-api-get-user-info-quicklogin-by-code.md) 获取完整手机号、UnionID、OpenID；
4.
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/5a/v3/u4MnbMYISiiKHVX0E6ds6w/zh-cn_image_0000002628701540.png?HW-CC-KV=V1&HW-CC-Date=20260701T105121Z&HW-CC-Expire=86400&HW-CC-Sign=157461EFE83450B1A4271E1EF6039DE36352CC901F41B68D294E76258F0D1D42)
2.
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/96/v3/9keWr_npRNadIKP9W9xa3A/zh-cn_image_0000002659100769.png?HW-CC-KV=V1&HW-CC-Date=20260701T105121Z&HW-CC-Expire=86400&HW-CC-Sign=8B304783B3E45E3845192BFD2306E2E6E03E262D5B85B3EF24221A4FFD4B0B6A)
#### 开发后验证
...
| 4 | 登录页面内容用户体验原则 | 建议 | （1）若未提供其他登录方式，不应显示“其他登录方式”的入口；（2）若使用华为账号一键登录，页面匿名手机号须展示从华为账号侧获取的匿名手机号，不应展示其他来源的手机号；（3）用户协议中，必须包含[《华为账号用户认证协议》](https://privacy.consumer.huawei.com/legal/id/authentication-terms.htm?code=CN&language=zh-CN)，且协议必须可点击、可加载，加载后支持回退页面，且回到点击前的页面。 |
