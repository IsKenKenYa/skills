...
LoginWithHuaweiIDButton需要配合 [loginComponentManager](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Account Kit（华为账号服务）/ArkTS组件/account-api-component-manager.md) 一起使用，用于实现华为账号登录功能。LoginWithHuaweiIDButton组件文本内容默认支持多语言。
**起始版本：** 4.1.0(11)
#### 导入模块
```typescript
...
| 名称 | 类型 | 必填 | 装饰器类型 | 说明 |
| --- | --- | --- | --- | --- |
| params | [LoginWithHuaweiIDButtonParams](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Account Kit（华为账号服务）/ArkTS组件/account-api-component-manager.md) | 是 | - | LoginWithHuaweiIDButton组件参数。 |
| controller | [LoginWithHuaweiIDButtonController](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Account Kit（华为账号服务）/ArkTS组件/account-api-component-manager.md) | 是 | - | LoginWithHuaweiIDButton组件控制器用来接收组件的点击事件。 |
#### build
build(): void
