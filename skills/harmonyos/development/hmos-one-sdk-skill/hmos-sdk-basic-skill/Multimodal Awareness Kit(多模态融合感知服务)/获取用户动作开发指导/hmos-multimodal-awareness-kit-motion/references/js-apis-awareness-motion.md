...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c4/v3/22lFTJCYQX6iG-sJxdhFtQ/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260401T093436Z&HW-CC-Expire=86400&HW-CC-Sign=0F03806D2FB6B079433539113F4C86FA7AC46B6D8B9E63946180808F0CBE14E1)
...
**错误码** ：
以下错误码的详细介绍请参见 [动作感知错误码](D:/code/APIDevice/output/md_output/harmonyos-references/系统/硬件/Multimodal Awareness Kit（多模态融合感知服务）/错误码/errorcode-motion.md) 和 [通用错误码](D:/code/APIDevice/output/md_output/harmonyos-references/API参考概述/errorcode-universal.md) 。
| 错误码ID | 错误信息 |
| --- | --- |
