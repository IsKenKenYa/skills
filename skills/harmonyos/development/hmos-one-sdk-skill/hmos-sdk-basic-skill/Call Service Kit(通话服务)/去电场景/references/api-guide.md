...
#### 业务流程
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/83/v3/_-Ml-F3QTnWZwHb5QkQQCg/zh-cn_image_0000002628861508.jpg?HW-CC-KV=V1&HW-CC-Date=20260701T105147Z&HW-CC-Expire=86400&HW-CC-Sign=5AB663C3157778DD076CBBF14E92B99AD3450FBBB5EB9DFEFD52676B1B6B6798)
#### 接口说明
去电场景的接口，由 [voipCall](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Call Service Kit（通话服务）/ArkTS API/call-voipcall.md) 提供。更多接口信息详见 [接口文档](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Call Service Kit（通话服务）/ArkTS API/call-voipcall.md) 。
| 接口名 | 描述 |
| --- | --- |
...
```
3.
应用内部建立通话连接之后，需要向Call Service Kit上报去电，并携带通话信息，详见 [VoipCallAttribute](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Call Service Kit（通话服务）/ArkTS API/call-voipcall.md) 。
系统会在屏幕左上角，展示通话胶囊。
以语音去电为例，示例代码如下：
```typescript
// 构建上报去电的参数
...
```
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/20/v3/-G_AN1AtTlSi_CnV_DFlnw/caution_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260701T105147Z&HW-CC-Expire=86400&HW-CC-Sign=2FBC0D34F114039184F0DA3D6A42972AA904D6FEFFE399A3F14F3CE74631E485)
上报去电时，通话状态必须是VOIP_CALL_STATE_DIALING，否则Call Service Kit会认为参数不合法而返回 [1007200001错误码](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Call Service Kit（通话服务）/ArkTS API/call-error-code.md) 。
4.
如果对端接听，应用需要向Call Service Kit上报通话状态 [VOIP_CALL_STATE_ACTIVE](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Call Service Kit（通话服务）/ArkTS API/call-voipcall.md) 。系统会更新通话胶囊，开始展示通话计时。
示例代码如下：
```typescript
// ...应用服务器收到对端接听的消息
...
开发方法与来电场景相同，详见 [来电场景：静音与解除静音](D:/code/APIDevice/output/md_output/harmonyos-guides/应用服务/Call Service Kit（通话服务）/来电场景/incoming-calls.md) 。
6.
去电场景，用户也可以拉起通知中心面板，在实况窗通知上点击挂断。
开发方式与来电场景相同，详见 [来电场景：用户点击挂断](D:/code/APIDevice/output/md_output/harmonyos-guides/应用服务/Call Service Kit（通话服务）/来电场景/incoming-calls.md) 。
7.
