...
---
# 位置服务错误码
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/0a/v3/fIk3k2OIS0-4yqQ8IH-NfA/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260401T093825Z&HW-CC-Expire=86400&HW-CC-Sign=B08E208A1BDF8A538EDCD940BD7956DFFF3EB906CE45E6F64025A864BD04FD16)
...
**可能原因**
定位请求参数 [LocationRequest](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Location Kit（位置服务）/ArkTS API/js-apis-geolocationmanager.md) 、 [CurrentLocationRequest](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Location Kit（位置服务）/ArkTS API/js-apis-geolocationmanager.md) 中的精度要求(maxAccuracy)值设定过小。
**处理步骤**
请将定位请求参数 [LocationRequest](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Location Kit（位置服务）/ArkTS API/js-apis-geolocationmanager.md) 、 [CurrentLocationRequest](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Location Kit（位置服务）/ArkTS API/js-apis-geolocationmanager.md) 中的精度要求(maxAccuracy)适当放宽，可参考如下场景建议：
-
当 [scenario](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Location Kit（位置服务）/ArkTS API/js-apis-geolocationmanager.md) 为NAVIGATION/TRAJECTORY_TRACKING/CAR_HAILING，或者 [priority](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Location Kit（位置服务）/ArkTS API/js-apis-geolocationmanager.md) 为ACCURACY时，建议设置maxAccuracy为大于10的值。
-
当 [scenario](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Location Kit（位置服务）/ArkTS API/js-apis-geolocationmanager.md) 为DAILY_LIFE_SERVICE/NO_POWER，或者 [priority](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Location Kit（位置服务）/ArkTS API/js-apis-geolocationmanager.md) 为LOW_POWER/FIRST_FIX时，建议设置maxAccuracy为大于100的值。
#### 3. 获取缓存位置失败
**错误信息**
...
系统无缓存位置情况下，尝试获取缓存位置。
**处理步骤**
系统未提前将位置信息进行缓存的情况下，需使用 [getCurrentLocation](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Location Kit（位置服务）/ArkTS API/js-apis-geolocationmanager.md) 接口获取实时位置信息。
#### 4. 其他原因导致定位失败
**错误信息**
