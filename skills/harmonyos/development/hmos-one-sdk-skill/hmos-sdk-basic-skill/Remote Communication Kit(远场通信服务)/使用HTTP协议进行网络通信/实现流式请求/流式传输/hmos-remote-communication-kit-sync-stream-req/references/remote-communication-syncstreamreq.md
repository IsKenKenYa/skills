...
#### 约束与限制
流式传输能力支持Phone、2in1、Tablet、Wearable设备。并且从5.1.1(19)开始，新增支持TV设备；从6.1.0(23)开始，新增支持Car设备。
#### 基于缓冲区的流式传输
#### 使用示例
1.
导入模块。
...
| 接口名 | 描述 |
| --- | --- |
| uploadFromStream(url:[URLOrString](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Remote Communication Kit（远场通信服务）/ArkTS API/remote-communication-rcp.md), uploadFrom:[UploadFromStream](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Remote Communication Kit（远场通信服务）/ArkTS API/remote-communication-rcp.md)): Promise<[Response](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Remote Communication Kit（远场通信服务）/ArkTS API/remote-communication-rcp.md)> | 从流中上传。 |
| downloadToStream(url:[URLOrString](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Remote Communication Kit（远场通信服务）/ArkTS API/remote-communication-rcp.md), downloadTo:[DownloadToStream](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Remote Communication Kit（远场通信服务）/ArkTS API/remote-communication-rcp.md)): Promise<[Response](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Remote Communication Kit（远场通信服务）/ArkTS API/remote-communication-rcp.md)> | 下载到流中。 |
#### 使用示例
1.
导入模块。
```typescript
