...
---
# ArkTS API错误码
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/49/v3/UIG82mGfQZ24wlC4fGFMPA/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260401T093324Z&HW-CC-Expire=86400&HW-CC-Sign=42BC6D309D3D42CC132BEC0BD795920F81997CD7098B632768344B198B5743C4)
...
下载数据量超过最大值。
**处理步骤**
当请求数据量超大时推荐使用 [OnDataReceive](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Remote Communication Kit（远场通信服务）/ArkTS API/remote-communication-rcp.md) 。
#### 1007900025 上传失败
**错误信息**
...
提供了格式不正确的选项。
**可能原因**
可能是因为 [StaticDnsRule](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Remote Communication Kit（远场通信服务）/ArkTS API/remote-communication-rcp.md) 或者 [DynamicDnsRule](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Remote Communication Kit（远场通信服务）/ArkTS API/remote-communication-rcp.md) 传入的IP地址格式不正确。
**处理步骤**
确认 [StaticDnsRule](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Remote Communication Kit（远场通信服务）/ArkTS API/remote-communication-rcp.md) 或者 [DynamicDnsRule](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Remote Communication Kit（远场通信服务）/ArkTS API/remote-communication-rcp.md) 传入参数格式是否正确可用。
...
**错误描述**
通过使用 [PathPreference](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Remote Communication Kit（远场通信服务）/ArkTS API/remote-communication-rcp.md) 的'cellular'模式拉起蜂窝数据连接时，因为条件不满足而导致激活蜂窝超时。
**可能原因**
...
Timeout was reached.
**错误描述**
URPC请求超出开发者配置的 [UrpcConnectConfiguration](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Remote Communication Kit（远场通信服务）/ArkTS API/remote-communication-urpcapi.md) 时长。
**可能原因**
...
Stub提前触发销毁了。
**处理步骤**
排查 [UrpcStub](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Remote Communication Kit（远场通信服务）/ArkTS API/remote-communication-urpcapi.md) 类的声明和使用是否正确。
