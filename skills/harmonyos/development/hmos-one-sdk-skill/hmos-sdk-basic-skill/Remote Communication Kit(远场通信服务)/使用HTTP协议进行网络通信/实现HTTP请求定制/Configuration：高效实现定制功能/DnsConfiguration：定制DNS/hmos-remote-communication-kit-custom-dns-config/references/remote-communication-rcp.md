...
创建HTTP会话。这是启动HTTP交互的主要方法。开发者可以使用此API与 [SessionConfiguration](#section18613443123412) 一起创建会话。
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/7e/v3/YcODg7NlSCub_t9FqurQbQ/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260401T093323Z&HW-CC-Expire=86400&HW-CC-Sign=9D9BB594747A3405FFC86B0A6EB41D15AEC8536271F1A55F727A80C67F69BF4E)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| sessionConfiguration | [SessionConfiguration](#section18613443123412) | 否 | 会话配置，应用于会话请求的设置。 |
**返回值：**
| 类型 | 说明 |
| --- | --- |
| [Session](#section1671892662116) | 代表一个会话，用于发送HTTP请求并管理其配置、取消和关闭的生命周期。 |
**错误码：**
错误码的详细介绍请参见 [ArkTS API错误码](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Remote Communication Kit（远场通信服务）/ArkTS API/remote-communication-error-code.md) 。
| 错误码ID | 错误信息 |
| --- | --- |
| 401 | Parameter error. |
...
| configuration | [SessionConfiguration](#section18613443123412)| undefined | 是 | 否 | 表示会话的配置设置。 |
#### fetch
fetch(request: Request): Promise<Response>
发送一个HTTP请求，并返回来自服务器的HTTP响应。使用Promise异步回调。
**需要权限** ：ohos.permission.INTERNET（如果使用 [PathPreference](#section828055885811) 的'cellular'模式，则额外需要ohos.permission.GET_NETWORK_INFO）
**系统能力** ：SystemCapability.Collaboration.RemoteCommunication
**起始版本：** 4.1.0(11)
**参数：**
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| request | [Request](#section10768169134510) | 是 | 要发送的请求。 |
**返回值：**
| 类型 | 说明 |
| --- | --- |
| Promise<[Response](#section156381815599)> | Promise对象，返回来自服务器的响应对象。 |
**错误码：** 错误码的详细介绍请参见 [ArkTS API错误码](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Remote Communication Kit（远场通信服务）/ArkTS API/remote-communication-error-code.md) 。
**示例：**
```typescript
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| request | [Request](#section10768169134510) | 是 | 待发送的请求。 |
**返回值：**
| 类型 | 说明 |
| --- | --- |
| Promise<[ResponseSendable](#section92642282211)> | Promise对象，返回来自服务器的响应对象，该响应对象支持Sendable。 |
**错误码：** 错误码的详细介绍请参见 [ArkTS API错误码](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Remote Communication Kit（远场通信服务）/ArkTS API/remote-communication-error-code.md) 。
**示例：**
```typescript
import { rcp } from '@kit.RemoteCommunicationKit';
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| url | [URLOrString](#section320653742718) | 是 | HTTP GET请求资源的URL。 |
| destination | [ResponseBodyDestination](#section9250173916506) | 否 | HTTP响应的目标位置或目的地。**起始版本**：5.0.0(12) |
**返回值：**
| 类型 | 说明 |
| --- | --- |
| Promise<[Response](#section156381815599)> | Promise对象，返回来自服务器的响应对象。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| url | [URLOrString](#section320653742718) | 是 | HTTP POST请求资源的URL。 |
| content | [RequestContent](#section18971142565016) | 否 | 请求的正文内容。默认为undefined。 |
| destination | [ResponseBodyDestination](#section9250173916506) | 否 | HTTP响应的目标位置或目的地。**起始版本**：5.0.0(12) |
**返回值：**
| 类型 | 说明 |
| --- | --- |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| url | [URLOrString](#section320653742718) | 是 | HTTP PUT请求资源的URL。 |
| content | [RequestContent](#section18971142565016) | 否 | 请求正文发送的内容。默认为undefined。 |
| destination | [ResponseBodyDestination](#section9250173916506) | 否 | HTTP响应的目标位置或目的地。**起始版本**：5.0.0(12) |
**返回值：**
| 类型 | 说明 |
| --- | --- |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| url | [URLOrString](#section320653742718) | 是 | HTTP DOWNLOADTOFILE请求资源的URL。 |
| downloadTo | [DownloadToFile](#section298118136197) | 是 | HTTP中用于将服务器上下载的文件保存到本地文件系统中的指定位置。 |
**返回值：**
| 类型 | 说明 |
| --- | --- |
| Promise<[Response](#section156381815599)> | Promise对象，返回来自服务器的响应对象。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| url | [URLOrString](#section320653742718) | 是 | HTTP UPLOADFROMFILE请求资源的URL。 |
| uploadFrom | [UploadFromFile](#section1753162618375) | 是 | HTTP中从本地计算机上传文件到服务器的请求。 |
**返回值：**
| 类型 | 说明 |
| --- | --- |
| Promise<[Response](#section156381815599)> | Promise对象，返回来自服务器的响应对象。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| url | [URLOrString](#section320653742718) | 是 | HTTP DOWNLOADTOSTREAM请求资源的URL。 |
| downloadTo | [DownloadToStream](#section1790033215431) | 是 | HTTP中将请求文件从服务器下载到客户端，并将其写入到一个数据流中。 |
**返回值：**
| 类型 | 说明 |
| --- | --- |
| Promise<[Response](#section156381815599)> | Promise对象，返回来自服务器的响应对象。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| url | [URLOrString](#section320653742718) | 是 | HTTP UPLOADFROMSTREAM请求资源的URL。 |
| uploadFrom | [UploadFromStream](#section187981940151318) | 是 | HTTP中从一个输入流中上传数据到服务器的请求。 |
**返回值：**
| 类型 | 说明 |
| --- | --- |
| Promise<[Response](#section156381815599)> | Promise对象，返回来自服务器的响应对象。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| url | [URLOrString](#section320653742718) | 是 | HTTP HEAD请求资源的URL。 |
**返回值：**
| 类型 | 说明 |
| --- | --- |
| Promise<[Response](#section156381815599)> | Promise对象，返回来自服务器的响应对象。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| url | [URLOrString](#section320653742718) | 是 | HTTP DELETE请求资源的URL。 |
**返回值：**
| 类型 | 说明 |
| --- | --- |
| Promise<[Response](#section156381815599)> | Promise对象，返回来自服务器的响应对象。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| requestToCancel | [Request](#section10768169134510)|[Request](#section10768169134510)[] | 否 | 要取消的请求或请求数组。在不指定[Request](#section10768169134510)情况下，默认取消所有请求。 |
**错误码：**
错误码的详细介绍请参见 [ArkTS API错误码](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Remote Communication Kit（远场通信服务）/ArkTS API/remote-communication-error-code.md) 。
| 错误码ID | 错误信息 |
| --- | --- |
...
远场通信框架会预置两种处理器，一种会调用拦截器的 [intercept](#section527252111410) 函数，一种会调用系统的fetchInternal使用系统能力发起请求，使用promise异步回调。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| context | [RequestContext](#section08792411316) | 是 | 请求上下文。 |
**返回值：**
| 类型 | 说明 |
| --- | --- |
| Promise<[Response](#section156381815599)> | Promise对象，返回来自服务器的响应对象。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| request | [Request](#section10768169134510) | 否 | 否 | HTTP请求 |
| session | [Session](#section1671892662116) | 否 | 否 | 持有此拦截器的会话 |
#### Interceptor
拦截器。
**系统能力** ：SystemCapability.Collaboration.RemoteCommunication
**起始版本：** 5.0.0(12)
...
| --- | --- | --- | --- |
| context | [RequestContext](#section08792411316) | 是 | 请求上下文。 |
| next | [RequestHandler](#section83672138232) | 是 | 下一个请求处理器。 |
**返回值：**
| 类型 | 说明 |
| --- | --- |
| Promise<[Response](#section156381815599)> | 直接返回一个 Promise对象 ，或者返回下一个拦截器的值。 |
**示例：**
```typescript
import { rcp } from '@kit.RemoteCommunicationKit';
import { BusinessError } from '@kit.BasicServicesKit';
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| interceptors | [Interceptor](#section1385412349596)[] | 否 | 是 | 请求/响应拦截器。**起始版本：**5.0.0(12) |
| requestConfiguration | [Configuration](#section1898141153617) | 否 | 是 | 指定与会话关联的HTTP请求的配置。包括transfer、proxy、DNS、connection和security configurations。 |
| baseAddress | [URLOrString](#section320653742718) | 否 | 是 | 设置会话中URL的基地址。这允许开发者为会话中的多个请求定义一个通用的基本URL。如果请求URL不是绝对URL，则把基地址预制在请求URL的前面。例如，"https://example.com?name=value"，https://example.com为基地址，"?name=value"为请求URL。 |
| headers | [RequestHeaders](#section16586132194914) | 否 | 是 | 为Session发出的HTTP请求定义headers（可自定义）。开发者可以根据他们的需求定制的特定headers。 |
| cookies | [RequestCookies](#section127791738567) | 否 | 是 | 提供在与会话关联的HTTP请求中包含自定义cookie的方法。适用于需要将某些cookie附加到每个请求的场景。需要手动设置cookie，携带cookie为用户行为。 |
| sessionListener | [SessionListener](#section1872726111319) | 否 | 是 | 允许开发者将侦听器附加到会话，接收会话取消或关闭等事件的通知，更好地处理应用程序中与会话相关的事件。 |
| connectionConfiguration | [ConnectionConfiguration](#section4802256134519) | 否 | 是 | 连接配置。用于指定此会话中允许的并发TCP连接总数以及单个主机所允许的最大并发TCP 连接数。**起始版本：**5.0.0(12) |
| cacheControl | [CacheControl](#section191412521521) | 否 | 是 | 缓存控制配置。用于主动控制会话中缓存验证策略，影响服务器或中间代理如何响应请求。**起始版本**：6.0.0(20) |
**示例：**
```typescript
import { rcp } from '@kit.RemoteCommunicationKit';
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| transfer | [TransferConfiguration](#section59321354193610) | 否 | 是 | 配置与HTTP请求期间的数据传输相关的各个方面，例如自动重定向和超时设置。 |
| tracing | [TracingConfiguration](#section557714186379) | 否 | 是 | 使开发者能够在HTTP请求期间捕获详细的跟踪信息，有助于调试和性能分析。 |
| proxy | [ProxyConfiguration](#section731665213712) | 否 | 是 | 配置会话的代理设置，允许开发者定义'system'、'no-proxy'或WebProxy配置。 |
| dns | [DnsConfiguration](#section9677185417382) | 否 | 是 | 指定与DNS相关的配置，包括自定义DNS规则和通过HTTPS使用DNS的选项。 |
| security | [SecurityConfiguration](#section1597118916425) | 否 | 是 | 包括用于处理安全相关方面的设置，如证书和服务器身份验证。 |
| processing | [ProcessingConfiguration](#section163971034123120) | 否 | 是 | 响应处理配置。**起始版本：**5.0.0(12) |
| cache | [ResponseCache](#section1124718239340) | 否 | 是 | 指定与HTTP缓存相关的配置。**起始版本：**6.0.0(20) |
**示例：**
```typescript
import { rcp } from '@kit.RemoteCommunicationKit';
...
| userTimeoutMs | number | 否 | 是 | 该参数设置一个超时时间。若传输的数据在超时时间内未收到服务器的确认报文，TCP连接将被断开。单位：ms。取值范围：1~3600000。默认值：和[Timeout](#section253517541009).transferMs保持一致。 |
...
| timeout | [Timeout](#section253517541009) | 否 | 是 | 配置HTTP请求的超时值，允许开发者定义连接和传输数据所允许的最长时间。如果未设置，则使用默认时间。 |
| assumesHTTP3Capable | boolean | 否 | 是 | 指定连接是否具有HTTP/3功能，true代表连接具有HTTP/3功能，false代表没有，默认为false。 |
| pathPreference | [PathPreference](#section828055885811) | 否 | 是 | HTTP请求路径首选项，此处配置的为建议路径，在实际使用过程中，系统会决定使用哪个路径。可以是'自动'或'蜂窝'路径。默认为'自动'路径。 |
| serviceType | [ServiceType](#section4811141807) | 否 | 是 | 服务类型。默认为undefined。 |
| maxAutoRedirects | number | 否 | 是 | 请求要遵循的最大重定向次数，如果 autoRedirect 属性为 true，则需要对其设置。默认值为50，最大值为2147483647。**起始版本**：5.0.0(12) |
| pausePolicy | [PausePolicy](#section195053616613) | 否 | 是 | 请求暂停策略。**起始版本**：5.0.0(12) |
| tcp | [TcpConfiguration](#section1376921132812) | 否 | 是 | TCP连接的相关配置。**起始版本**：6.0.0(20) |
**示例：**
```typescript
import { rcp } from '@kit.RemoteCommunicationKit';
const transferConfig: rcp.TransferConfiguration = {
...
| infoToCollect | [InfoToCollect](#section12292010397) | 否 | 是 | 配置要收集的特定类型的信息事件。默认无事件需要收集。 |
| collectTimeInfo | boolean | 否 | 是 | 指示在跟踪过程中是否应收集与时间相关的信息，true代表收集，false代表不收集，默认值为false。 |
| httpEventsHandler | [HttpEventsHandler](#section87603011401) | 否 | 是 | 为HTTP请求/响应过程中的特定操作定义响应处理程序的回调。默认值为undefined。 |
**示例：**
```typescript
import { rcp } from '@kit.RemoteCommunicationKit';
...
```
#### ProxyConfiguration
type ProxyConfiguration = 'system' | 'no-proxy' | [WebProxy](#section750717273598)
...
| [WebProxy](#section750717273598) | HTTP代理配置。WebProxy：表示提供自定义代理设置。 |
**示例：**
```typescript
import { rcp } from '@kit.RemoteCommunicationKit';
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| dnsRules | [DnsServers](#section520311317520)|[StaticDnsRules](#section8646352103418)|[DynamicDnsRule](#section8160554134811) | 否 | 是 | 配置DNS规则，默认值为undefined。DnsServers：表示优先使用指定的DNS服务器解析主机名。StaticDnsRules：静态DNS规则，表示如果hostname匹配，则优先使用指定的地址。DynamicDnsRule：动态DNS规则，表示优先使用函数中返回的地址。注意：针对同一域名配置多个静态或者动态DNS规则后，默认情况下，仅有最后一个IP地址生效。如果希望多个IP地址同时生效，在6.0.0(20)版本后，支持同一域名配置多个静态或者动态DNS规则，此时将happyEyeballOnDnsRule设置为true可以让多个IP地址同时生效。 |
| dnsOverHttps | [DnsOverHttpsConfiguration](#section13705867403) | 否 | 是 | DNS over HTTPS配置。默认值为undefined。如果设置，则优先使用DNS服务器解析的地址。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| url | [URLOrString](#section320653742718) | 否 | 否 | DOH端点的URL或字符串表示形式。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| remoteValidation | 'system' | 'skip' |[CertificateAuthority](#section1191716433375)|[ValidationCallback](#section209691249748) | 否 | 是 | 证书颁发机构（CA），用于验证远程服务器的身份。默认值为'system'。如果未设置此字段，系统CA将被用于验证远程服务器的标识。'system'：表示使用系统CA配置。'skip'：跳过验证。CertificateAuthority：证书颁发机构（CA）验证。ValidationCallback：自定义证书校验。说明：从5.0.0(12)版本开始，新增支持ValidationCallback类型。 |
| certificate | [ClientCertificate](#section134001711153819) | 否 | 是 | 发送到远程服务器的客户端证书，用于远程服务器使用其验证委托人的身份证明。默认值为undefined，表示服务器不需要验证客户端。 |
| tlsOptions | 'system' |[CipherSuite](#section184507292518)[] |[TlsV13Option](#section2816178141816)|[TlsV12Option](#section177701532908)|[TlsV11Option](#section147673411215)|[TlsV10Option](#section1638114214316) | 否 | 是 | TLS版本选择器，用于选择TLS的版本，默认为'system'。'system'：表示使用系统的TLS版本。[CipherSuite](#section184507292518)[]：用来声明加密套件的类型的数组。[TlsV13Option](#section2816178141816)：表示使用TLS1.3版本。[TlsV12Option](#section177701532908)：表示使用TLS1.2版本。[TlsV11Option](#section147673411215)：表示使用TLS1.1版本。[TlsV10Option](#section1638114214316)：表示使用TLS1.0版本。**起始版本：**5.0.0(12) |
| tlsRange | [TlsVersionRangeOptions](#section1023912106245) | 否 | 是 | TLS版本范围配置器，用于设置客户端可使用TLS版本的范围，默认不配置。**起始版本：**6.0.0(20) |
| serverAuthentication | [ServerAuthentication](#section523243163818) | 否 | 是 | 安全连接期间的服务器身份验证配置。默认不认证。 |
| certificatePinning | [CertificatePinning](#section930513513227)|[CertificatePinning](#section930513513227)[] | 否 | 是 | 证书锁定配置。**起始版本：**5.0.0(12) |
**示例：**
```typescript
import { rcp } from '@kit.RemoteCommunicationKit';
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| credential | [Credential](#section721442771710) | 否 | 否 | 服务器的凭证。默认值为undefined。 |
| authenticationType | [AuthenticationType](#section5757123313210) | 否 | 是 | 服务器的认证类型。如果没有设置，需与服务器协商。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| min | [TlsVersion](#section9929122918293) | 否 | 是 | TLS可用最小版本，默认不设置，由系统选择。 |
| max | [TlsVersion](#section9929122918293) | 否 | 是 | TLS可用最大版本，默认不设置，由系统选择。 |
| cipherSuite | [CipherSuite](#section184507292518)[] | 否 | 是 | TLS可用版本范围内的加密套件列表，默认不设置，由系统选择。 |
**错误码：**
错误码的详细介绍请参见 [ArkTS API错误码](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Remote Communication Kit（远场通信服务）/ArkTS API/remote-communication-error-code.md) 。
| 错误码ID | 错误信息 |
| --- | --- |
...
| url | [URL](#section66401230152412) | 否 | 否 | HTTP请求的URL。 |
| method | [HttpMethod](#section20787153164810) | 否 | 否 | 要使用的HTTP方法。默认值为'GET'。 |
| headers | [RequestHeaders](#section16586132194914) | 否 | 是 | HTTP请求头。默认值为undefined。 |
| content | [RequestContent](#section18971142565016) | 否 | 是 | HTTP请求内容。默认值为undefined。 |
| cookies | [RequestCookies](#section127791738567) | 否 | 是 | HTTP请求的Cookie。将设置转换为HTTP Cookies标头。默认值为undefined。 |
| transferRange | [TransferRange](#section838945575618)|[TransferRange](#section838945575618)[] | 否 | 是 | HTTP传输范围。转换为HTTP Range头。带有range头的HTTP请求要求服务器只返回HTTP响应的一部分。默认值为undefined。 |
| configuration | [Configuration](#section1898141153617) | 否 | 是 | HTTP请求配置。用于覆盖默认或会话范围的设置。默认值为undefined。 |
| destination | [ResponseBodyDestination](#section9250173916506) | 否 | 是 | HTTP响应体放置位置。**起始版本**：5.0.0(12) |
| cacheControl | [CacheControl](#section191412521521) | 否 | 是 | HTTP请求缓存控制配置。若配置，则[SessionConfiguration](#section18613443123412)中的配置的缓存控制不生效。默认值为undefined。**起始版本**：6.0.0(20) |
#### constructor
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| url | [URLOrString](#section320653742718) | 是 | 请求的地址类型，在构造函数中，参数可以是 URLOrString，但 URL 只是 URL，字符串需要转换为URL。 |
| method | [HttpMethod](#section20787153164810) | 否 | HTTP 请求方法。默认是GET。 |
| headers | [RequestHeaders](#section16586132194914) | 否 | HTTP请求头。 |
| content | [RequestContent](#section18971142565016) | 否 | HTTP 请求正文。 |
| cookies | [RequestCookies](#section127791738567) | 否 | HTTP 请求 cookie。该设置将转换为 HTTP Cookies header。 |
| transferRange | [TransferRange](#section838945575618)|[TransferRange](#section838945575618)[] | 否 | HTTP 传输范围。该设置将转换为 HTTP Range header。 |
| configuration | [Configuration](#section1898141153617) | 否 | HTTP 请求配置。见[Configuration](#section1898141153617)。 |
**示例：**
```typescript
import { rcp } from '@kit.RemoteCommunicationKit';
...
#### URL
type URL = url.URL
请求的地址类型，链接到@ [ohos.url](D:/code/APIDevice/output/md_output/harmonyos-references/应用框架/ArkTS（方舟编程语言）/ArkTS API/js-apis-url.md) 中的URL。
**系统能力** ：SystemCapability.Collaboration.RemoteCommunication
**起始版本：** 4.1.0(11)
| 类型 | 说明 |
| --- | --- |
...
提供 x509 证书类型，链接到@ [ohos.security.cert](D:/code/APIDevice/output/md_output/harmonyos-references/系统/安全/Device Certificate Kit（设备证书服务）/ArkTS API/js-apis-cert.md) 中的X509Cert。
取值范围请见下表。
**系统能力** ：SystemCapability.Collaboration.RemoteCommunication
**起始版本：** 5.0.0(12)
| 类型 | 说明 |
...
#### File
type File = fs.File
文件系统中的文件，链接到@ [ohos.file.fs](D:/code/APIDevice/output/md_output/harmonyos-references/应用框架/Core File Kit（文件基础服务）/ArkTS API/js-apis-file-fs.md) 中的File。
**系统能力** ：SystemCapability.Collaboration.RemoteCommunication
**起始版本：** 5.0.0(12)
| 类型 | 说明 |
| --- | --- |
...
可以随机访问的文件，链接到@ [ohos.file.fs](D:/code/APIDevice/output/md_output/harmonyos-references/应用框架/Core File Kit（文件基础服务）/ArkTS API/js-apis-file-fs.md) 中的RandomAccessFile。
**系统能力** ：SystemCapability.Collaboration.RemoteCommunication
**起始版本：** 5.0.0(12)
| 类型 | 说明 |
| --- | --- |
...
提供数据流的形式，链接到@ [ohos.file.fs](D:/code/APIDevice/output/md_output/harmonyos-references/应用框架/Core File Kit（文件基础服务）/ArkTS API/js-apis-file-fs.md) 中的Stream。
**系统能力** ：SystemCapability.Collaboration.RemoteCommunication
**起始版本：** 5.0.0(12)
| 类型 | 说明 |
| --- | --- |
...
#### LocalFile
type LocalFile = [FileDescriptor](#section21886214126) | [File](#section627313541711) | [RandomAccessFile](#section5384161714342)
具有文件特性的对象，允许用户使用不同类型的文件描述符或文件对象进行操作。
**系统能力** ：SystemCapability.Collaboration.RemoteCommunication
**起始版本：** 5.0.0(12)
| 类型 | 说明 |
| --- | --- |
| [FileDescriptor](#section21886214126) | 表示文件的描述符。文件描述符是一个整数，用于标识一个打开的文件。 |
| [File](#section627313541711) | 文件系统中的文件，用于获取文件的描述符、路径和名称，以及对文件的锁定和解锁操作。 |
| [RandomAccessFile](#section5384161714342) | 提供随机访问文件的操作功能。用于处理随机访问文件的一种类型。提供了文件描述符、文件指针的读取，以及文件指针的设置和文件的写入操作。 |
#### WriteFile
提供向文件写入数据的函数。
**系统能力** ：SystemCapability.Collaboration.RemoteCommunication
**起始版本：** 5.0.0(12)
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| path | [Path](#section173755717538) | 否 | 否 | 如果请求目标（[Request.destination](#section10768169134510)）是下载到文件时，path表示文件保存的路径。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| path | [Path](#section173755717538) | 否 | 否 | 指定的数据下载路径。 |
| skipRequest | boolean | 否 | 是 | 是否跳过请求，true代表跳过，false代表不跳过，默认值为false。 |
#### TargetFileCallback
type TargetFileCallback = (request: [Request](#section10768169134510) , suggestedPath: [Path](#section173755717538) ) => [TargetFile](#section1522633761218) | Promise< [TargetFile](#section1522633761218) >
[TargetFile](#section1522633761218) 回调函数，返回一个 [TargetFile](#section1522633761218) 对象，使用Promise异步回调。
**系统能力** ：SystemCapability.Collaboration.RemoteCommunication
**起始版本：** 5.0.0(12)
**参数：**
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| request | [Request](#section10768169134510) | 是 | 表示入参的类型为一个HTTP请求。 |
| suggestedPath | [Path](#section173755717538) | 是 | 表示入参的类型为[Path](#section173755717538)，请求中指定的路径。 |
**返回值：**
| 类型 | 说明 |
| --- | --- |
| [TargetFile](#section1522633761218)| Promise<[TargetFile](#section1522633761218)> | 直接返回[TargetFile](#section1522633761218)，或者使用Promise异步回调，表示下载数据的存放位置，或是默认文件夹。 |
...
| 参数名 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| fileOrPath | [Path](#section173755717538)|[LocalFile](#section19493339161418)|[ReadFile](#section4363132325017) | 是 | 否 | 表示需要上传的文件或者上传文件的路径，参考[应用文件](D:/code/APIDevice/output/md_output/harmonyos-guides/应用框架/Core File Kit（文件基础服务）/应用文件/app-file.md)。 |
#### constructor
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| fileOrPath | [Path](#section173755717538)|[LocalFile](#section19493339161418)|[ReadFile](#section4363132325017) | 是 | 表示需要上传的文件或者上传文件的路径，参考[应用文件](D:/code/APIDevice/output/md_output/harmonyos-guides/应用框架/Core File Kit（文件基础服务）/应用文件/app-file.md)。 |
#### UploadFromStream
...
| 参数名 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| stream | [Stream](#section17454218451)|[ReadStream](#section14397920517)|[SyncReadStream](#section121694408513) | 是 | 否 | 表示需要上传的流。 |
#### constructor
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| stream | [Stream](#section17454218451)|[ReadStream](#section14397920517)|[SyncReadStream](#section121694408513) | 是 | 表示需要上传的流。 |
#### DownloadToFile
...
将文件下载到文件夹或文件中。如果下载到文件夹，文件名将与服务器中的文件名相同。取值范围为以下表中类型的并集。其中，kind 用于指定想要下载到文件或目录，file 指的是具体要下载到的目标文件或目录（参考 [应用文件](D:/code/APIDevice/output/md_output/harmonyos-guides/应用框架/Core File Kit（文件基础服务）/应用文件/app-file.md) ）。
取值范围为以下表中类型的并集。
**系统能力** ：SystemCapability.Collaboration.RemoteCommunication
**起始版本：** 5.0.0(12)
| 类型 | 说明 |
| --- | --- |
| { kind: 'file'; file:[TargetFileCallback](#section205374351176); } | 表示键kind的键值为'file'，键file的键值为[TargetFileCallback](#section205374351176)。 |
| { kind: 'file'; file:[Path](#section173755717538); keepLocal?: boolean; } | 表示键kind的值为'file'，键file的值为[Path](#section173755717538)对象，其中keepLocal为可选参数值，当本地文件名和下载的文件名相同时，不会重复下载。 |
| { kind: 'file'; file:[LocalFile](#section19493339161418)|[WriteFile](#section1372525722415); } | 表示键kind的值为'file'，键file的值为[LocalFile](#section19493339161418)或[WriteFile](#section1372525722415)对象。 |
| { kind: 'folder'; path:[Path](#section173755717538); keepLocal?: boolean; } | 键kind的值为'folder'，键path的值为[Path](#section173755717538)对象，其中keepLocal为可选参数值，当本地文件夹名和下载的文件夹名相同时，不会重复下载。 |
#### DownloadToStream
...
| 类型 | 说明 |
| --- | --- |
| { kind: 'stream'; stream:[Stream](#section17454218451)|[WriteStream](#section113874918253)|[SyncWriteStream](#section27539206460)} | 表示键kind值为'stream'，键stream的值为[Stream](#section17454218451)或[WriteStream](#section113874918253)或[SyncWriteStream](#section27539206460)的对象。 |
#### PausePolicy
请求的暂停策略。
**系统能力** ：SystemCapability.Collaboration.RemoteCommunication
**起始版本：** 5.0.0(12)
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| receiving | [ReceivingPausePolicy](#section0636945286) | 否 | 是 | 设置暂停响应体接收的策略。 |
| sending | [SendingPausePolicy](#section6701585215) | 否 | 是 | 设置暂停请求体发送的策略。 |
...
| 类型 | 说明 |
| --- | --- |
| [ReceivingPauseByCache](#section73638218812) | 策略的缓存大小。 |
| [ReceivingPauseByTimeout](#section46402018173) | 策略的超时时间。 |
#### NetworkOutputQueue
const NetworkOutputQueue: NetworkOutputQueueConstructor
通过 new NetworkInputQueue()来创建一个 [INetworkOutputQueue](#section13239201618464) 。
**系统能力** ：SystemCapability.Collaboration.RemoteCommunication
**起始版本：** 5.0.0(12)
#### NetworkOutputQueueConstructor
NetworkOutputQueueConstructor是一个 [INetworkOutputQueue](#section13239201618464) 的构造函数。
**系统能力** ：SystemCapability.Collaboration.RemoteCommunication
**起始版本：** 5.0.0(12)
#### new
new (): INetworkOutputQueue
创建一个 [INetworkOutputQueue](#section13239201618464) 。
**系统能力** ：SystemCapability.Collaboration.RemoteCommunication
**起始版本：** 5.0.0(12)
**返回值：**
| 类型 | 说明 |
| --- | --- |
| [INetworkOutputQueue](#section13239201618464) | 返回一个同步读队列对象。 |
#### new
...
| pausePolicyOverride | [ReceivingPausePolicy](#section0636945286) | 是 | 请求的接收暂停策略。 |
**返回值：**
| 类型 | 说明 |
| --- | --- |
| [INetworkOutputQueue](#section13239201618464) | 返回一个同步读队列对象。 |
#### INetworkOutputQueue
INetworkOutputQueue是用读响应体的同步读队列。通过new [NetworkOutputQueue](#section165642074433) ()来构造。
**系统能力** ：SystemCapability.Collaboration.RemoteCommunication
**起始版本：** 5.0.0(12)
#### read
...
| [IncomingDataCallback](#section1421528202712) | 表示值的类型为[IncomingDataCallback](#section1421528202712)类型数据。将响应体写到回调函数中。 |
| [DownloadToFile](#section298118136197) | 表示值的类型为[DownloadToFile](#section298118136197)类型数据。将响应体写到文件中。 |
| [DownloadToStream](#section1790033215431) | 表示值的类型为[DownloadToStream](#section1790033215431)类型对象。将响应体写到自定义的流中。 |
| [INetworkOutputQueue](#section13239201618464) | 表示值的类型为[INetworkOutputQueue](#section13239201618464)类型对象。把响应体写到队列。 |
#### URLOrString
type URLOrString = [URL](#section66401230152412) | string
URLOrString类型是表示URL对象或表示URL的字符串的并集类型。可以作为HTTP/HTTPS地址的入参。
**系统能力** ：SystemCapability.Collaboration.RemoteCommunication
**起始版本：** 4.1.0(11)
| 类型 | 说明 |
| --- | --- |
| [URL](#section66401230152412) | URL对象，可以作为HTTP/HTTPS地址的入参。 |
...
| 类型 | 说明 |
| --- | --- |
| [IpAndPort](#section842181319618)[] | 表示值的类型为[IpAndPort](#section842181319618)数组，数组成员为地址和端口键值对。 |
#### IpAndPort
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| ip | [IpAddress](#section1489910532316) | 否 | 否 | 要关联的IP地址。IPv4或IPv6地址。 |
...
| 类型 | 说明 |
| --- | --- |
| { [k: string]: string | string[] | undefined;'authorization'?: string;'accept'?:[ContentType](#section535112587019)|[ContentType](#section535112587019)[];'accept-charset'?: string | string[];'accept-encoding'?:[ContentCoding](#section2719142017119)|[ContentCoding](#section2719142017119)[];'accept-language'?: string | string[];'cache-control'?: string | string[];'cookie'?: string | string[];'range'?: string | string[];'upgrade'?: string | string[];'user-agent'?: string;'content-type'?:[ContentType](#section535112587019); } | 若键取值为[k: string]: string | string[] | undefined，表示值类型为一个包含一个或多个键值对的对象，其键的类型为字符，可取任意值，其值的类型为字符、字符数组或undefined。若键取值为'authorization'，值的类型为字符，可取任意值。若键取值为'accept'，值的类型为[ContentType](#section535112587019)或[ContentType](#section535112587019)数组，可取任意值。若键取值为'accept-charset'，值的类型为字符或字符数组，可取任意值。若键取值为'accept-encoding'，值的类型为[ContentCoding](#section2719142017119)或[ContentCoding](#section2719142017119)数组，可取任意值。若键取值为'accept-language'，值的类型为字符或字符数组，可取任意值。若键取值为'cache-control'，值的类型为字符或字符数组，可取任意值。若键取值为'cookie'，值的类型为字符或字符数组，可取任意值。若键取值为'range'，值的类型为字符或字符数组，可取任意值。若键取值为'upgrade'，值的类型为字符或字符数组，可取任意值。若键取值为'user-agent'，值的类型为字符，可取任意值。若键取值为'content-type'，值的类型为[ContentType](#section535112587019)，可取任意值。当此项不存在或为空字符串时，系统将根据[RequestContent](#section18971142565016)配置默认的内容类型。若不希望使用默认内容类型，可以传入单个空格。 |
#### SendingPausePolicy
暂停发送流程的策略。
**系统能力** ：SystemCapability.Collaboration.RemoteCommunication
**起始版本：** 5.0.0(12)
...
通过 new NetworkInputQueue()来创建一个 [INetworkInputQueue](#section882732713562) 。
**系统能力** ：SystemCapability.Collaboration.RemoteCommunication
**起始版本：** 5.0.0(12)
#### NetworkInputQueueConstructor
NetworkInputQueueConstructor是一个 [INetworkInputQueue](#section882732713562) 的构造函数。
**系统能力** ：SystemCapability.Collaboration.RemoteCommunication
**起始版本：** 5.0.0(12)
#### new
new (): INetworkInputQueue
创建一个 [INetworkInputQueue](#section882732713562) 。
**系统能力** ：SystemCapability.Collaboration.RemoteCommunication
**起始版本：** 5.0.0(12)
**返回值：**
| 类型 | 说明 |
| --- | --- |
| [INetworkInputQueue](#section882732713562) | 返回一个同步写队列对象。 |
#### new
...
| --- | --- | --- | --- |
| maxSize | number | 是 | 队列大小，表示可写入的最大字节数。 |
| pausePolicyOverride | [SendingPausePolicy](#section6701585215) | 是 | 请求的发送暂停策略。 |
**返回值：**
| 类型 | 说明 |
| --- | --- |
| [INetworkInputQueue](#section882732713562) | 返回一个同步写队列对象。 |
#### INetworkInputQueue
INetworkInputQueue是用于写请求体的同步写队列。通过new [NetworkInputQueue](#section127952271692) ()来构造。
**系统能力** ：SystemCapability.Collaboration.RemoteCommunication
**起始版本：** 5.0.0(12)
#### write
...
| 类型 | 说明 |
| --- | --- |
| [RawDataContent](#section12323181618910) | ArkTs的基本类型的数据。 |
| [Form](#section1188301010515) | HTTP简单的表格数据。 |
| [MultipartForm](#section1420174317517) | HTTP多部分表格数据。 |
| [GetDataCallback](#section78781933114) | 获取任意数据的回调方法的类型，其入参为数据最大字节数。 |
| [UploadFromStream](#section187981940151318) | UploadFromStream表示以流的形式进行上传操作。**起始版本**：5.0.0(12) |
| [UploadFromFile](#section1753162618375) | UploadFromFile表示一种文件上传的方式，允许客户端将本地计算机上的文件上传到服务器。**起始版本**：5.0.0(12) |
| [INetworkInputQueue](#section882732713562) | INetworkInputQueue是用于写请求体的同步写队列。**起始版本**：5.0.0(12) |
#### Form
HTTP简单的表格数据。
**系统能力** ：SystemCapability.Collaboration.RemoteCommunication
**起始版本：** 4.1.0(11)
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| fields | [FormFields](#section16427123712526) | 否 | 否 | HTTP简单表单数据字段，类型为表单字段类型。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| fields | [FormFields](#section16427123712526) | 是 | HTTP简单表单数据字段，类型为表单字段类型。 |
**示例：**
```typescript
import { rcp } from '@kit.RemoteCommunicationKit';
let headers: rcp.RequestHeaders = {
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| fields | [MultipartFormFields](#section103661472920) | 否 | 否 | 表示多部分表单数据，其中值为多表单字段类型。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| fields | [MultipartFormFields](#section103661472920) | 是 | 表示多部分表单数据，其中值为多表单字段类型。 |
**示例：**
```typescript
import { rcp } from '@kit.RemoteCommunicationKit';
let headers: rcp.RequestHeaders = {
...
| 类型 | 说明 |
| --- | --- |
| { [k: string]:[MultipartFormFieldValue](#section7241730104213)|[MultipartFormFieldValue](#section7241730104213)[] } | 表示值的类型为一个或者多个多部分表单数据字段值，值的类型为[MultipartFormFieldValue](#section7241730104213)或[MultipartFormFieldValue](#section7241730104213)的数组，可取任意值。 |
...
| 类型 | 说明 |
| --- | --- |
| [FormFieldValue](#section620319167532) | 表示值的类型为[FormFieldValue](#section620319167532)，HTTP简单表单数据字段值。 |
| [FormFieldFileValue](#section1497311813556) | 表示值的类型为[FormFieldFileValue](#section1497311813556)，文件表单数据接口。 |
#### FormFields
...
| 类型 | 说明 |
| --- | --- |
| { [k: string]:[FormFieldValue](#section620319167532)|[FormFieldValue](#section620319167532)[] } | 表示值的类型为简单表单字段或对应数组。 |
**示例：**
```typescript
import { rcp } from '@kit.RemoteCommunicationKit';
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| contentType | [ContentType](#section535112587019) | 否 | 是 | HTTP多部分表单数据内容类型。默认值为undefined。 |
| remoteFileName | string | 否 | 是 | 保存到远程服务器的文件名。默认值为undefined。 |
| contentOrPath | [Path](#section173755717538)|[FileContent](#section1126712263547)|[GetDataCallback](#section78781933114) | 否 | 否 | 要发送到远程服务器的内容或文件路径。具体允许的类型见链接。 |
**示例**
```typescript
import { rcp } from '@kit.RemoteCommunicationKit';
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| request | [Request](#section10768169134510) | 是 | 否 | 此HTTP响应对应的HTTP请求。系统按照HTTP协议将请求内容封装为HTTP报文并发送。**说明：**请求内容中遵循HTTP协议的有效内容才能被封装为HTTP报文。 |
| statusCode | number | 是 | 否 | HTTP请求的结果代码。如果回调函数成功执行，将返回ResponseCode中定义的结果代码。否则，将在AsyncCallback中的error字段中返回错误代码。 |
| headers | [ResponseHeaders](#section253714181004) | 是 | 否 | 响应头。 |
| effectiveUrl | [URL](#section66401230152412) | 是 | 是 | 重定向后请求的有效URL。默认值为undefined。 |
| body | ArrayBuffer | 是 | 是 | 响应内容根据响应头中的Content-type返回。响应内容必须与服务器返回的数据类型相同。默认最大下载字节数是50M。如果超过50M，为了防止内存溢出，请通过[OnDataReceive](#section9264115918536)来流式接收数据。 |
| downloadedTo | [DownloadedTo](#section1166941712103) | 是 | 是 | 内容下载的路径。在使用下载至文件对象和文件标识符两种方式时，默认情况下，并未设置回调信息。**起始版本**：5.0.0(12) |
| debugInfo | [DebugInfo](#section175663117434)[] | 是 | 是 | 与响应相关联的调试信息。默认值为undefined。 |
| timeInfo | [TimeInfo](#section183911041803) | 是 | 是 | HTTP请求各阶段的定时信息。默认值为undefined。 |
| cookies | [ResponseCookie](#section295119276014)[] | 是 | 是 | 响应中的Cookie数组。 |
| httpVersion | [HttpVersion](#section14719175117590) | 是 | 是 | HTTP的版本。**起始版本**：5.0.0(12) |
| reasonPhrase | string | 是 | 是 | HTTP响应状态行的reasonPhrase，提供与数字状态代码相关的文本描述。**起始版本**：5.0.0(12) |
| cacheInfo | [CacheInfo](#section19758103145620) | 是 | 是 | 缓存信息，包含缓存已存在时长、原始HTTP请求ID信息。当HTTP响应从缓存中获取时，该属性有值，否则为undefined。**起始版本**：6.0.0(20) |
**示例：**
```typescript
import { rcp } from '@kit.RemoteCommunicationKit';
...
#### toJSON
toJSON(): object | null
返回默认的JSON反序列化结果，如需要定制JSON反序列化方式，请参考 [JSON解析与生成](D:/code/APIDevice/output/md_output/harmonyos-references/应用框架/ArkTS（方舟编程语言）/ArkTS API/js-apis-json.md) 。
**系统能力** ：SystemCapability.Collaboration.RemoteCommunication
**起始版本：** 4.1.0(11)
**返回值：**
| 类型 | 说明 |
...
| downloadedTo | [DownloadedTo](#section1166941712103) | 是 | 是 | 内容下载的路径，在使用下载至文件对象和文件标识符两种方式时，默认情况下，不设置回调信息。 |
| debugInfo | [DebugInfo](#section175663117434)[] | 是 | 是 | 与响应相关联的调试信息，默认值为undefined。 |
| timeInfo | [TimeInfo](#section183911041803) | 是 | 是 | HTTP请求各阶段的定时信息，默认值为undefined。 |
| cookies | [ResponseCookie](#section295119276014)[] | 是 | 是 | 响应中的Cookie数组。 |
| httpVersion | [HttpVersion](#section14719175117590) | 是 | 是 | HTTP的版本。 |
| reasonPhrase | string | 是 | 是 | 提供HTTP请求结果代码的文本描述。 |
| cacheInfo | [CacheInfo](#section19758103145620) | 是 | 是 | 缓存信息，包含缓存已存在时长、原始HTTP请求ID信息。当HTTP响应从缓存中获取时，该属性有值，否则为undefined。 |
#### ResponseHeaders
...
| cookieAttributes | [CookieAttributes](#section162175111013) | 否 | 是 | 响应cookie中的所有属性。 |
#### DebugInfo
请求/响应处理调试信息的接口。
**系统能力** ：SystemCapability.Collaboration.RemoteCommunication
**起始版本：** 4.1.0(11)
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| type | [DebugEvent](#section1295195318118) | 否 | 否 | 调试信息的类型。具体类型值见类型链接。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/9a/v3/DrCO3jGKRYWjx96RIAAAkA/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260401T093323Z&HW-CC-Expire=86400&HW-CC-Sign=E5884D553EEC87F87A669B3E3DEC1FAFE99E9A14D88F3E1DDEAB079A1EF45360)
...
| x509Certs | [X509Cert](#section136572026194112)[] | 否 | 否 | X509证书对象。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| context | [ValidationContext](#section7263163111816) | 是 | 表示值的类型为context，是证书上下文。 |
**返回值：**
| 取值范围 | 说明 |
| --- | --- |
...
| 类型 | 说明 |
| --- | --- |
| [TlsV13CipherSuite](#section593594720197) | 表示值的类型为[TlsV13CipherSuite](#section593594720197)。 |
#### TlsV13CipherSuite
...
| 类型 | 说明 |
| --- | --- |
| [TlsV12CipherSuite](#section79896219610) | 表示值的类型为[TlsV12CipherSuite](#section79896219610)。 |
| [TlsV13SpecificCipherSuite](#section3129163617819) | 表示值的类型为[TlsV13SpecificCipherSuite](#section3129163617819)。 |
#### TlsV12CipherSuite
...
| 类型 | 说明 |
| --- | --- |
| [TlsV11CipherSuite](#section3358251787) | 表示值的类型为[TlsV11CipherSuite](#section3358251787)。 |
| [TlsV12SpecificCipherSuite](#section14955113664814) | 表示值的类型为[TlsV12SpecificCipherSuite](#section14955113664814)。 |
#### TlsV11CipherSuite
...
| 类型 | 说明 |
| --- | --- |
| [TlsV10CipherSuite](#section1451210179125) | 表示值的类型为[TlsV10CipherSuite](#section1451210179125)。 |
#### TlsV10CipherSuite
...
| 类型 | 说明 |
| --- | --- |
| [TlsV10SpecificCipherSuite](#section18083613205) | 表示值的类型为[TlsV10SpecificCipherSuite](#section18083613205)。 |
#### TlsV13Option
...
| cipherSuite | [TlsV13CipherSuite](#section593594720197)[] | 否 | 是 | TLS1.3版本对应的加密套件。 |
#### TlsV12Option
...
| cipherSuite | [TlsV12CipherSuite](#section79896219610)[] | 否 | 是 | TLS1.2版本对应的加密套件。 |
#### TlsV11Option
...
| cipherSuite | [TlsV11CipherSuite](#section3358251787)[] | 否 | 是 | TLS1.1版本对应的加密套件。 |
#### TlsV10Option
...
| cipherSuite | [TlsV10CipherSuite](#section1451210179125)[] | 否 | 是 | TLS1.0版本对应的加密套件。 |
#### ContentCoding
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| response | [Response](#section156381815599) | 是 | 框架传入的响应，即需要进行校验的响应。 |
**返回值：**
| 类型 | 说明 |
| --- | --- |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| validateResponse | 'default' |[ResponseValidationCallback](#section1619313413298) | 否 | 是 | 默认不处理。或者使用[ResponseValidationCallback](#section1619313413298)对响应进行校验。 |
#### GetDataCallback
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| url | [URLOrString](#section320653742718) | 是 | 表示URL对象或表示URL的字符串的并集类型。表示入参的类型为[URLOrString](#section320653742718)，返回值为boolean的方法。为true，代表主机使用代理，false则代表未使用。 |
| 类型 | 说明 |
| --- | --- |
...
| ipAddresses | [IpAddress](#section1489910532316)[] | 否 | 否 | 要与指定的主机名和端口关联的IP地址阵列。 |
#### StaticDnsRules
...
| 类型 | 说明 |
| --- | --- |
| [StaticDnsRule](#section47911616155511)[] | 表示值的类型为[StaticDnsRule](#section47911616155511)数组。 |
#### DynamicDnsRule
...
| 类型 | 说明 |
| --- | --- |
| [IpAddress](#section1489910532316)[] | 一个IP地址数组。 |
#### WebProxy
WebProxy接口使开发者能够在 [ProxyConfiguration](#section731665213712) 中配置自定义代理时定义自定义代理设置。它允许指定代理URL、排除和其他安全配置。
**系统能力** ：SystemCapability.Collaboration.RemoteCommunication
**起始版本：** 4.1.0(11)
#### 属性
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| url | [URLOrString](#section320653742718) | 否 | 否 | 自定义代理的URL。 |
...
| exclusions | [URLOrString](#section320653742718)|[URLOrString](#section320653742718)[] |[DynamicExclusionRule](#section1037054954) | 否 | 是 | 要从代理中排除的URL （例如："[http://exclude.example.com](http://exclude.example.com/)"或["[http://exclude1.com](http://exclude1.com/)", "[http://exclude2.com](http://exclude2.com/)"]）。默认值为undefined。 |
| security | [SecurityConfiguration](#section1597118916425) | 否 | 是 | 设置代理安全配置。默认值为undefined。 |
#### InfoToCollect
InfoToCollect接口可以帮助开发者收集信息事件。收集到的信息事件会在 [Response](#section156381815599) 的debugInfo字段中返回。
**系统能力** ：SystemCapability.Collaboration.RemoteCommunication
**起始版本：** 4.1.0(11)
#### 属性
| 名称 | 类型 | 只读 | 可选 | 说明 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ab/v3/w3pNW1hdSM2CQlhd7amz5w/caution_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260401T093323Z&HW-CC-Expire=86400&HW-CC-Sign=AB94D85707E46BFE8C6CDCACA793591B345E91B6C6C0600BEAB80224C86617E6)
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| onDataReceive | [OnDataReceive](#section9264115918536) | 否 | 是 | 当接收到HTTP响应正文的一部分时调用的回调。默认为undefined。当开发者需要请求超过50M字节的数据时，使用此回调接受数据。使用后，返回的[Response](#section156381815599)对象的body字段将不再含有数据。 |
| onUploadProgress | [OnUploadProgress](#section1596171465719) | 否 | 是 | 用于在响应期间处理上传进度的回调。默认为undefined。 |
| onDownloadProgress | [OnDownloadProgress](#section832314187551) | 否 | 是 | 用于在响应期间处理下载进度的的回调。默认为undefined。 |
| onHeaderReceive | [OnHeaderReceive](#section13232139165012) | 否 | 是 | 用于在响应期间处理接收到的headers的回调。默认为undefined。 |
| onDataEnd | [OnDataEnd](#section1356075625115) | 否 | 是 | 数据传输完成时触发的回调。默认为undefined。 |
| onCanceled | [OnCanceled](#section844405416446) | 否 | 是 | 取消请求/响应时触发的回调。默认为undefined。 |
| onTimeInfo | [OnTimeInfo](#section254219518422) | 否 | 是 | HTTP请求失败/成功时触发的回调。默认为undefined。**起始版本：**5.0.3(15) |
| onStatusCodeReceive | [OnStatusCodeReceive](#section829213325618) | 否 | 是 | 用于在响应期间处理接收到的状态码的回调。默认为undefined。**起始版本：**6.0.0(20) |
#### Timeout
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| onCanceled | [OnCanceled](#section844405416446) | 否 | 是 | 会话取消事件的回调。会话取消时调用。默认为undefined。 |
| onClosed | [OnClosed](#section334964220501) | 否 | 是 | 会话关闭事件回调。会话关闭时调用。默认为undefined。 |
#### Credential
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| request | [Request](#section10768169134510) | 否 | 触发回调的HTTP请求。**起始版本**：6.0.0(20) |
#### OnClosed
type OnClosed = () => void
此类型表示会话关闭时的回调。
**系统能力** ：SystemCapability.Collaboration.RemoteCommunication
...
此类型表示接收到HTTP body时的回调。当开发者需要请求超过50M字节的数据时，使用此回调接受数据。使用后，返回的 [Response](#section156381815599) 对象的body字段将不再含有数据。
**系统能力** ：SystemCapability.Collaboration.RemoteCommunication
**起始版本：** 4.1.0(11)
**参数：**
| 参数名 | 类型 | 必填 | 说明 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| headers | [ResponseHeaders](#section253714181004) | 是 | 参数为HTTP响应头，返回为空。 |
| request | [Request](#section10768169134510) | 否 | 触发回调的HTTP请求。**起始版本**：6.0.0(20) |
#### OnDataEnd
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| timeInfo | [TimeInfo](#section183911041803) | 是 | HTTP各个阶段耗时。 |
| request | [Request](#section10768169134510) | 否 | 触发回调的HTTP请求。**起始版本**：6.0.0(20) |
**示例：**
```typescript
import { rcp } from '@kit.RemoteCommunicationKit';
...
| request | [Request](#section10768169134510) | 否 | 触发回调的HTTP请求。 |
#### CacheControl
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| expirationPolicy | [TimeLimitedExpirationPolicy](#section1915682752214) | 否 | 是 | 为HTTP请求所创建的缓存配置过期策略。如果设置该属性，则会覆盖HTTP响应过期策略。 |
...
| maxAge | [TimeInterval](#section202412166407) | 否 | 是 | 该属性指定缓存资源的有效时长，在此期间客户端可直接使用缓存而无需请求服务器。 |
| maxStale | [TimeInterval](#section202412166407) | 否 | 是 | 该属性允许客户端接受已过期但未超过指定时间的缓存资源，提升数据可用性。 |
| minFresh | [TimeInterval](#section202412166407) | 否 | 是 | 该属性要求服务器返回的响应在指定时间内保持新鲜，确保资源短期内不过期。 |
...
| age | [TimeInterval](#section202412166407) | 否 | 否 | 缓存已存在时长。 |
#### ExpirationPolicy
...
| 类型 | 说明 |
| --- | --- |
| [NeverExpirationPolicy](#section9834444133020) | 永不过期类型过期策略。 |
| [TimeLimitedExpirationPolicy](#section1915682752214) | 时间限制类型过期策略。 |
...
| 类型 | 说明 |
| --- | --- |
| [AbsoluteTimeExpirationPolicy](#section1756102119351) | 绝对时间过期策略。到达指定时间，该缓存记录过期。 |
| [RelativeTimeExpirationPolicy](#section1655411614379) | 相对时间过期策略。经过指定的时间间隔后，该缓存记录过期。 |
| [SlidingTimeExpirationPolicy](#section18501111511392) | 滑动时间过期策略。指定的时间间隔期间，若无任何访问，该缓存记录过期；若有访问，则重置过期时间。 |
...
| time | [TimeInterval](#section202412166407) | 否 | 否 | 指定时间间隔。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| units | [TimeIntervalUnits](#section32011352124313) | 否 | 否 | 时间间隔单位。 |
...
| headers | [ResponseHeaders](#section253714181004) | 否 | 否 | HTTP响应头信息。 |
| body | ArrayBuffer | 否 | 是 | HTTP响应内容。 |
| effectiveUrl | string | 否 | 是 | 重定向后请求的有效URL。默认值为undefined。 |
| httpVersion | [HttpVersion](#section14719175117590) | 否 | 是 | HTTP的版本。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| url | [URLOrString](#section320653742718) | 否 | 否 | 请求URL。 |
| method | [HttpMethod](#section20787153164810) | 否 | 否 | HTTP方法。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| expirationPolicy | [ExpirationPolicy](#section962212143274) | 否 | 否 | 缓存过期策略。 |
| response | [CachedResponse](#section49322045124710) | 否 | 否 | 存储的缓存响应。 |
| key | [ResponseCacheKey](#section12431163985515) | 否 | 否 | 缓存响应对应的缓存键。 |
#### CacheConfiguration
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| persistent | [PersistentStorageConfiguration](#section187463325215) | 否 | 否 | 指定持久化缓存配置。 |
| inMemory | [InMemoryCacheConfiguration](#section101531755759) | 否 | 是 | 指定内存缓存配置。 |
...
| defaultExpirationPolicy | [TimeLimitedExpirationPolicy](#section1915682752214) | 否 | 是 | 默认缓存过期策略。如果设置，它将应用于每个新增的响应记录；如果未设置，将默认设置为1小时的[SlidingTimeExpirationPolicy](#section18501111511392)。[set](#section1187111165016)方法配置的缓存过期策略会覆盖本接口默认缓存过期策略。 |
...
| 类型 | 说明 |
| --- | --- |
| [FileSystemStorageConfiguration](#section1765861216411) | 基于文件系统的缓存存储配置。 |
...
| pathToFolder | string | 否 | 否 | 指定存储缓存的文件路径。可以参考[应用文件](D:/code/APIDevice/output/md_output/harmonyos-guides/应用框架/Core File Kit（文件基础服务）/应用文件/app-file.md)。 |
...
| maxSize | number | 否 | 是 | 指定内存缓存所占用内存上限。若设置，则[CacheConfiguration](#section139991413145915)中配置的maxSize对内存缓存存储不生效。单位：MB。默认值：10。 |
#### CacheState
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| configuration | [CacheConfiguration](#section139991413145915) | 是 | 缓存配置。 |
**错误码：**
错误码的详细介绍请参见 [ArkTS API错误码](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Remote Communication Kit（远场通信服务）/ArkTS API/remote-communication-error-code.md) 。
**示例：**
```typescript
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| key | [ResponseCacheKey](#section12431163985515) | 是 | 缓存键。 |
| response | [CachedResponse](#section49322045124710) | 是 | 需要添加或替换的HTTP缓存响应内容。 |
| expirationPolicy | [ExpirationPolicy](#section962212143274) | 否 | 缓存过期策略。若传入该参数，则会覆盖[CacheConfiguration](#section139991413145915)中的默认缓存过期策略，即defaultExpirationPolicy。 |
**返回值：**
| 类型 | 说明 |
| --- | --- |
| Promise<void> | Promise对象，无返回结果。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<[ResponseCacheRecord](#section13850182925713)> | Promise对象，返回HTTP响应缓存记录。 |
**错误码：**
错误码的详细介绍请参见 [ArkTS API错误码](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Remote Communication Kit（远场通信服务）/ArkTS API/remote-communication-error-code.md) 。
| 错误码ID | 错误信息 |
| --- | --- |
...
| 类型 | 说明 |
| --- | --- |
| Promise<[CacheState](#section29031836872)> | Promise对象，返回缓存状态信息。 |
**错误码：**
错误码的详细介绍请参见 [ArkTS API错误码](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Remote Communication Kit（远场通信服务）/ArkTS API/remote-communication-error-code.md) 。
| 错误码ID | 错误信息 |
| --- | --- |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| url | [URLOrString](#section320653742718) | 是 | URL，用于与缓存键中的URL进行匹配。 |
| matchKind | [URLMatchKind](#section13928831917) | 是 | URL匹配类型。 |
| method | [HttpMethod](#section20787153164810) | 否 | HTTP请求方法。 |
**返回值：**
| 类型 | 说明 |
| --- | --- |
| Promise<boolean> | Promise对象，返回true表示删除成功；返回false表示删除失败。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| request | [Request](#section10768169134510) | 是 | 要创建响应的HTTP请求。 |
| cachedResponse | [CachedResponse](#section49322045124710) | 是 | 缓存中存储的HTTP响应缓存。 |
| currentTime | Date | 是 | 当前时间。 |
**返回值：**
| 类型 | 说明 |
| --- | --- |
| [Response](#section156381815599) | HTTP响应。 |
**错误码：**
错误码的详细介绍请参见 [ArkTS API错误码](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Remote Communication Kit（远场通信服务）/ArkTS API/remote-communication-error-code.md) 。
**示例：**
```typescript
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| response | [Response](#section156381815599) | 是 | HTTP响应。 |
| timeStamp | Date | 否 | 缓存的响应时间戳。默认为当前系统时间。 |
**返回值：**
| 类型 | 说明 |
| --- | --- |
| [CachedResponse](#section49322045124710) | HTTP响应缓存。 |
**错误码：**
错误码的详细介绍请参见 [ArkTS API错误码](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Remote Communication Kit（远场通信服务）/ArkTS API/remote-communication-error-code.md) 。
**示例：**
```typescript
