...
#### 约束与限制
关闭会话能力支持Phone、2in1、Tablet、Wearable设备。并且从5.1.1(19)开始，新增支持TV设备；从6.1.0(23)开始，新增支持Car设备。
#### 接口说明
...
| 接口名 | 描述 |
| --- | --- |
| uint32_t HMS_Rcp_CloseSession([Rcp_Session](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Remote Communication Kit（远场通信服务）/C API/模块/remote-communication-overview.md)**session); | 关闭会话。 |
#### 使用示例
1.
CPP侧导入模块。
```cpp
