...
```
#### MapPolyline
折线，继承 [BaseOverlay](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-baseoverlay.md) 。在调用map. [MapComponentController](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-mapcomponentcontroller.md) 类的 [addPolyline](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-mapcomponentcontroller.md) 方法时会返回该类型的实例。
...
| 类型 | 说明 |
| --- | --- |
| [mapCommon.CapStyle](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map-common.md) | 折线的末尾端点样式。 |
**示例：**
```typescript
...
| 类型 | 说明 |
| --- | --- |
| [mapCommon.JointType](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map-common.md) | 折线除起始和结束顶点之外的所有顶点的节点类型属性。 |
**示例：**
```typescript
...
| 类型 | 说明 |
| --- | --- |
| Array<[mapCommon.PatternItem](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map-common.md)> | 折线的样式属性。 |
**示例：**
```typescript
...
| 类型 | 说明 |
| --- | --- |
| Array<[mapCommon.LatLng](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map-common.md)> | 折线的顶点坐标属性。 |
**示例：**
```typescript
...
| 类型 | 说明 |
| --- | --- |
| [mapCommon.CapStyle](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map-common.md) | 折线的起始端点样式。 |
**示例：**
```typescript
...
| 类型 | 说明 |
| --- | --- |
| boolean | 折线的可点击性。true：可点击false：不可点击 |
**示例：**
```typescript
...
| 类型 | 说明 |
| --- | --- |
| boolean | 折线的大地线属性。true：大地线false：非大地线 |
**示例：**
```typescript
...
| 类型 | 说明 |
| --- | --- |
| boolean | 折线的渐变属性。true：渐变false：不渐变 |
**示例：**
```typescript
...
| 参数名 | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| clickable | boolean | 是 | 设置折线是否可以点击，默认值为false。true：可以false：不可以 |
**示例：**
```typescript
...
| 参数名 | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| endCap | [mapCommon.CapStyle](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map-common.md) | 是 | 折线的末尾端点样式。 |
**示例：**
```typescript
...
| 参数名 | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| geodesic | boolean | 是 | 将折线的每个线段绘制为大地线，默认值为false。true：每段绘制为大地线false：不是大地线 |
**示例：**
```typescript
...
| 参数名 | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| gradient | boolean | 是 | 设置渐变属性是否启用，默认值为false。true：渐变false：不渐变 |
**示例：**
```typescript
...
| 参数名 | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| jointType | [mapCommon.JointType](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map-common.md) | 是 | 节点类型。 |
**示例：**
```typescript
...
| 参数名 | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| patterns | Array<[mapCommon.PatternItem](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map-common.md)> | 是 | [PatternItem](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map-common.md)对象的集合。 |
**示例：**
```typescript
...
| 参数名 | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| points | Array<[mapCommon.LatLng](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map-common.md)> | 是 | 折线顶点的集合。默认情况下，折线不闭合；要形成闭合的折线，起点和终点必须相同。 |
**示例：**
```typescript
...
| 参数名 | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| startCap | [mapCommon.CapStyle](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map-common.md) | 是 | 折线的起始端点样式。 |
**示例：**
```typescript
...
| 参数名 | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| customTexture | [ResourceStr](D:/code/APIDevice/output/md_output/harmonyos-references/应用框架/ArkUI（方舟UI框架）/ArkTS组件/公共定义/ts-types.md)|[image.PixelMap](D:/code/APIDevice/output/md_output/harmonyos-references/媒体/Image Kit（图片处理服务）/ArkTS API/@ohos.multimedia.image (图片处理)/arkts-apis-image-pixelmap.md) | 是 | 折线纹理。建议纹理使用没有背景色（透明色）的图片。 |
**返回值：**
| 类型 | 说明 |
| --- | --- |
...
| --- | --- | --- | --- |
| customTexture | [ResourceStr](D:/code/APIDevice/output/md_output/harmonyos-references/应用框架/ArkUI（方舟UI框架）/ArkTS组件/公共定义/ts-types.md)|[image.PixelMap](D:/code/APIDevice/output/md_output/harmonyos-references/媒体/Image Kit（图片处理服务）/ArkTS API/@ohos.multimedia.image (图片处理)/arkts-apis-image-pixelmap.md) | 是 | 折线纹理。建议纹理使用没有背景色（透明色）的图片。 |
| isTextureMappingUsed | boolean | 是 | 是否使用贴图模式进行纹理绘制，默认为false。如果设置为false，建议纹理没有背景色（使用透明色）。true：使用贴图模式false：不使用贴图模式 |
**返回值：**
| 类型 | 说明 |
| --- | --- |
| Promise<void> | Promise对象。无返回结果的Promise对象。 |
