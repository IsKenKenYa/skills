...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b3/v3/onLFI6f9SBCDoZtYdfi7wA/zh-cn_image_0000002628701840.gif?HW-CC-KV=V1&HW-CC-Date=20260701T105234Z&HW-CC-Expire=86400&HW-CC-Sign=A23549BB757FDCB256ACC5F180B42A51A2047CFECCEE96DC7472C249A783EC0D)
#### 接口说明
绘制动态轨迹功能主要由 [TraceOverlayParams](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map-common.md) 、 [addTraceOverlay](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-mapcomponentcontroller.md) 、 [Marker](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-marker.md) 和 [TraceOverlay](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-traceoverlay.md) 提供，更多接口及使用方法请参见 [接口文档](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-traceoverlay.md) 。
| 接口名 | 描述 |
| --- | --- |
| [TraceOverlayParams](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map-common.md) | 动态轨迹参数。 |
| [addTraceOverlay](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-mapcomponentcontroller.md)(params:[mapCommon.TraceOverlayParams](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map-common.md), markers?: Array<[Marker](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-marker.md)>): Promise<[TraceOverlay](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-traceoverlay.md)> | 绘制动态轨迹。 |
| [Marker](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-marker.md) | 动态轨迹的一组标记。 |
| [TraceOverlay](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-traceoverlay.md) | 动态轨迹，支持暂停和删除等功能。 |
#### 开发步骤
1.
导入相关模块。
```typescript
