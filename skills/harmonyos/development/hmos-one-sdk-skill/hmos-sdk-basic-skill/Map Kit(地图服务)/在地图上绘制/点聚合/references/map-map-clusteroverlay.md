...
建议使用 [ClusterOverlay.on(type: 'click')](#section8306133712135) 。
**模型约束：** 此接口仅可在Stage模型下使用。
**元服务API：** 从版本5.0.0(12)开始，该接口支持在元服务中使用。
**系统能力：** SystemCapability.Map.Core
**起始版本：** 5.0.0(12)
...
| callback | Callback<Array<[mapCommon.ClusterItem](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map-common.md)>> | 是 | 回调函数，返回Array<[mapCommon.ClusterItem](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map-common.md)>。 |
**示例：**
```typescript
...
建议使用 [ClusterOverlay.off(type: 'click')](#section13314133751318) 。
**模型约束：** 此接口仅可在Stage模型下使用。
**元服务API：** 从版本5.0.0(12)开始，该接口支持在元服务中使用。
**系统能力：** SystemCapability.Map.Core
**起始版本：** 5.0.0(12)
...
| callback | Callback<Array<[mapCommon.ClusterItem](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map-common.md)>> | 是 | 回调函数，返回Array<[mapCommon.ClusterItem](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map-common.md)>，监听聚合图层的聚合点点击事件。 |
**示例：**
```typescript
...
| --- | --- | --- | --- |
| type | string | 是 | 'click'：监听聚合图层的聚合点点击事件。 |
| callback | Callback<Array<[mapCommon.ClusterItem](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map-common.md)>> | 否 | 回调函数，返回Array<[mapCommon.ClusterItem](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map-common.md)>，取消监听聚合图层的聚合点点击事件。callback为空：取消所有callback回调。callback非空：取消指定的callback回调。 |
**示例：**
```typescript
let callback1 = (clusterItem: Array<mapCommon.ClusterItem>) => {
...
| callback | Callback<[MarkerClusterInfo](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-markerclusterinfo.md)> | 是 | 回调函数，返回Callback<[MarkerClusterInfo](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-markerclusterinfo.md)>，监听聚合图层的标记点击事件。MarkerClusterInfo包括：marker：聚合图层的标记。clusterItems：聚合节点数组。 |
**示例：**
```typescript
...
| --- | --- | --- | --- |
| type | string | 是 | 'markerClusterClick'：聚合图层的标记点击监听事件。 |
| callback | Callback<[MarkerClusterInfo](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-markerclusterinfo.md)> | 否 | 回调函数，返回Callback<[MarkerClusterInfo](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-markerclusterinfo.md)>，取消监听聚合图层的标记点击事件。callback为空：取消所有callback回调。callback非空：取消指定的callback回调。MarkerClusterInfo包括：marker：聚合图层的标记。clusterItems：聚合节点数组。 |
**示例：**
```typescript
let callback1 = (markerClusterInfo: map.MarkerClusterInfo) => {
  console.info("markerClusterClick", `callback1 markerClusterInfo`);
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| item | mapCommon.[ClusterItem](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map-common.md) | 是 | 待聚合节点。 |
**返回值：**
| 类型 | 说明 |
| --- | --- |
