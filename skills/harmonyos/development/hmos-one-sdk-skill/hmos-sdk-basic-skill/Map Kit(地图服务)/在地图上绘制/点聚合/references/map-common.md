...
| **名称** | **类型** | 只读 | 可选 | **说明** |
| --- | --- | --- | --- | --- |
| mapType | [MapType](#zh-cn_topic_0000001245084266_section18522846142615) | 否 | 是 | 地图类型，默认值为[MapType](#zh-cn_topic_0000001245084266_section18522846142615).STANDARD，异常值按默认值处理。**元服务API：**从版本4.1.0(11)开始，该接口支持在元服务中使用。 |
| position | [CameraPosition](#section105031244194712) | 否 | 否 | 地图相机位置。**元服务API：**从版本4.1.0(11)开始，该接口支持在元服务中使用。 |
| bounds | [LatLngBounds](#section96341159111320) | 否 | 是 | 地图展示边界，异常值根据无边界处理。**元服务API：**从版本4.1.0(11)开始，该接口支持在元服务中使用。说明：西南角纬度不能大于东北角纬度。 |
...
| rotateGesturesEnabled | boolean | 否 | 是 | 是否支持旋转手势，默认值为true，异常值按默认值处理。true：支持false：不支持**元服务API：**从版本4.1.0(11)开始，该接口支持在元服务中使用。 |
| scrollGesturesEnabled | boolean | 否 | 是 | 是否支持滑动手势，默认值为true，异常值按默认值处理。true：支持false：不支持**元服务API：**从版本4.1.0(11)开始，该接口支持在元服务中使用。 |
| zoomGesturesEnabled | boolean | 否 | 是 | 是否支持缩放手势，默认值为true，异常值按默认值处理。true：支持false：不支持**元服务API：**从版本4.1.0(11)开始，该接口支持在元服务中使用。 |
| tiltGesturesEnabled | boolean | 否 | 是 | 是否支持倾斜手势，默认值为true，异常值按默认值处理。true：支持false：不支持**元服务API：**从版本4.1.0(11)开始，该接口支持在元服务中使用。 |
| zoomControlsEnabled | boolean | 否 | 是 | 是否展示缩放控件，默认值为true，异常值按默认值处理。true：展示false：不展示**元服务API：**从版本4.1.0(11)开始，该接口支持在元服务中使用。 |
| myLocationControlsEnabled | boolean | 否 | 是 | 是否展示我的位置按钮，默认值为false，异常值按默认值处理。true：展示false：不展示**元服务API：**从版本4.1.0(11)开始，该接口支持在元服务中使用。 |
| compassControlsEnabled | boolean | 否 | 是 | 是否展示指南针控件，默认值为true，异常值按默认值处理。true：展示false：不展示**元服务API：**从版本4.1.0(11)开始，该接口支持在元服务中使用。 |
| scaleControlsEnabled | boolean | 否 | 是 | 是否展示比例尺，默认值为false，异常值按默认值处理。true：展示false：不展示**元服务API：**从版本4.1.0(11)开始，该接口支持在元服务中使用。 |
| padding | [Padding](#section144591344648) | 否 | 是 | 设置地图和边界的距离，默认值为{ left: 0 , top: 0 , right: 0 , bottom: 0 }。**元服务API：**从版本4.1.0(11)开始，该接口支持在元服务中使用。 |
| styleId | string | 否 | 是 | 自定义样式ID。ID不生效时，使用系统样式。使用方式详见[显示自定义地图](D:/code/APIDevice/output/md_output/harmonyos-guides/应用服务/Map Kit（地图服务）/创建地图/显示自定义地图/map-style.md)章节。**起始版本：**5.0.0(12)**元服务API：**从版本5.0.0(12)开始，该接口支持在元服务中使用。 |
| dayNightMode | [DayNightMode](#section634916281725) | 否 | 是 | 日间夜间模式，默认值为[DayNightMode](#section634916281725).DAY（日间模式）。**起始版本：**5.0.0(12)**元服务API：**从版本5.0.0(12)开始，该接口支持在元服务中使用。 |
| alwaysShowScaleEnabled | boolean | 否 | 是 | 是否一直显示比例尺，只有比例尺启用时该参数才生效。启用比例尺可以由地图初始化时scaleControlsEnabled属性设置为true或者通过[setScaleControlsEnabled](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-mapcomponentcontroller.md)方法设置为true。true：始终显示false：关闭始终显示默认是false。**起始版本：**5.0.0(12)**元服务API：**从版本5.0.0(12)开始，该接口支持在元服务中使用。 |
| logoScale | number | 否 | 是 | Logo缩放比例，取值范围是[0.8, 1]，默认值是1。**起始版本：**5.0.3(15)**元服务API：**从版本5.0.3(15)开始，该接口支持在元服务中使用。 |
| sphereEnabled | boolean | 否 | 是 | 是否开启3D地球效果，默认值为false。true：开启3D地球效果false：关闭3D地球效果**起始版本：**5.0.3(15)**元服务API：**从版本5.0.3(15)开始，该接口支持在元服务中使用。 |
| indoorMapEnabled | boolean | 否 | 是 | 是否启用室内图，默认值为false。true：开启室内图false：关闭室内图**起始版本：**5.1.1(19)**元服务API：**从版本5.1.1(19)开始，该接口支持在元服务中使用。 |
| scaleUnit | [ScaleUnit](#section2230143218276) | 否 | 是 | 地图比例尺单位，默认值为[ScaleUnit](#section2230143218276).METRIC_UNIT（公制单位）。**起始版本：**5.1.1(19)**元服务API：**从版本5.1.1(19)开始，该接口支持在元服务中使用。 |
| language | string | 否 | 是 | 地图语言。语种取值请参见[地图组件支持语言](D:/code/APIDevice/output/md_output/harmonyos-guides/应用服务/Map Kit（地图服务）/附录/支持的语言/map-language.md)列表。默认使用当前系统语言。**起始版本：**6.0.0(20)**元服务API：**从版本6.0.0(20)开始，该接口支持在元服务中使用。 |
**示例：**
```typescript
// 地图初始化参数
...
| 名称 | **类型** | 只读 | 可选 | **说明** |
| --- | --- | --- | --- | --- |
| target | [LatLng](#section20691173773810) | 否 | 否 | 地图中心位置的经纬度坐标。 |
...
| 名称 | **类型** | 只读 | 可选 | **说明** |
| --- | --- | --- | --- | --- |
| northeast | [LatLng](#section20691173773810) | 否 | 否 | 东北角经纬度。 |
| southwest | [LatLng](#section20691173773810) | 否 | 否 | 西南角经纬度。 |
**示例：**
```typescript
...
| 名称 | **类型** | 只读 | 可选 | **说明** |
| --- | --- | --- | --- | --- |
| type | [PatternItemType](#section128001052193017) | 否 | 否 | 边框样式类型。 |
...
| icon | string |[image.PixelMap](D:/code/APIDevice/output/md_output/harmonyos-references/媒体/Image Kit（图片处理服务）/ArkTS API/@ohos.multimedia.image (图片处理)/arkts-apis-image-pixelmap.md)|[Resource](D:/code/APIDevice/output/md_output/harmonyos-references/应用框架/ArkUI（方舟UI框架）/ArkTS组件/公共定义/ts-types.md) | 否 | 是 | 定位图标。图片格式支持jpg、jpeg、png、gif、webp、svg。string类型入参支持两种格式：资源相对路径格式：图标存放在resources/rawfile，icon参数传入rawfile文件夹下的相对路径。toDataURL格式（如data:image/png;base64,<图片的Base64字节编码值>）。说明：从5.0.0(12)版本开始，icon属性支持[image.PixelMap](D:/code/APIDevice/output/md_output/harmonyos-references/媒体/Image Kit（图片处理服务）/ArkTS API/@ohos.multimedia.image (图片处理)/arkts-apis-image-pixelmap.md)和[Resource](D:/code/APIDevice/output/md_output/harmonyos-references/应用框架/ArkUI（方舟UI框架）/ArkTS组件/公共定义/ts-types.md)类型。**元服务API：**从版本4.1.0(11)开始，该接口支持在元服务中使用。 |
| radiusFillColor | number | 否 | 是 | 定位图标填充色，默认值为0x8F7570FF（紫色），颜色值为ARGB格式。**元服务API：**从版本4.1.0(11)开始，该接口支持在元服务中使用。 |
| displayType | [MyLocationDisplayType](#section78428244375) | 否 | 是 | 定位图标的展示样式，默认值为[MyLocationDisplayType](#section78428244375).DEFAULT。**起始版本：**5.0.0(12)**元服务API：**从版本5.0.0(12)开始，该接口支持在元服务中使用。 |
**示例：**
```typescript
...
| position | [LatLng](#section20691173773810) | 否 | 否 | POI的经纬度位置。 |
**示例：**
```typescript
...
```
#### BaseOverlayOptions
定义覆盖物基本属性。 [MarkerOptions](#section559041743210) 、 [MapCircleOptions](#section5282124803117) 、 [MapPolygonOptions](#section1615694815308) 、 [MapPolylineOptions](#section113246334153) 、 [MapArcParams](#section943619551002) 、 [ImageOverlayParams](#section12537418218) 、 [BasePriorityOverlayParams](#section20126194774515) 等继承该基础类。
**模型约束：** 此接口仅可在Stage模型下使用。
**元服务API：** 从版本4.1.0(11)开始，该接口支持在元服务中使用。
**系统能力：** SystemCapability.Map.Core
**起始版本：** 4.1.0(11)
| 名称 | **类型** | 只读 | 可选 | **说明** |
| --- | --- | --- | --- | --- |
| visible | boolean | 否 | 是 | 是否可见，默认值为true，异常值按默认值处理。true：可见false：不可见 |
| zIndex | number | 否 | 是 | 覆盖物的叠加顺序，具有较大z指数的覆盖物会绘制在具有较小z指数的覆盖物上，具有相同z指数的叠加顺序为元素添加的先后顺序。覆盖物初始化时如果未设置zIndex参数，默认值为0。异常值按默认值处理。说明：[BasePriorityOverlayParams](#section20126194774515)的zIndex向下取整数。 |
#### MarkerOptions
描述Marker属性，继承 [BaseOverlayOptions](#section7400647135116) 。
**模型约束：** 此接口仅可在Stage模型下使用。
**系统能力：** SystemCapability.Map.Core
**起始版本：** 4.1.0(11)
| **名称** | **类型** | 只读 | 可选 | **说明** |
| --- | --- | --- | --- | --- |
| position | [LatLng](#section20691173773810) | 否 | 否 | 标记的位置坐标。**元服务API：**从版本4.1.0(11)开始，该接口支持在元服务中使用。 |
...
| icon | string |[image.PixelMap](D:/code/APIDevice/output/md_output/harmonyos-references/媒体/Image Kit（图片处理服务）/ArkTS API/@ohos.multimedia.image (图片处理)/arkts-apis-image-pixelmap.md)|[Resource](D:/code/APIDevice/output/md_output/harmonyos-references/应用框架/ArkUI（方舟UI框架）/ArkTS组件/公共定义/ts-types.md) | 否 | 是 | 图标，不传时显示默认图标。图片格式支持jpg、jpeg、png、gif、webp、svg。string类型入参支持两种格式：资源相对路径格式：图标存放在resources/rawfile，icon参数传入rawfile文件夹下的相对路径。toDataURL格式（如data:image/png;base64,<图片的Base64字节编码值>）。**元服务API：**从版本4.1.0(11)开始，该接口支持在元服务中使用。说明：从5.0.0(12)版本开始，icon属性支持[image.PixelMap](D:/code/APIDevice/output/md_output/harmonyos-references/媒体/Image Kit（图片处理服务）/ArkTS API/@ohos.multimedia.image (图片处理)/arkts-apis-image-pixelmap.md)和[Resource](D:/code/APIDevice/output/md_output/harmonyos-references/应用框架/ArkUI（方舟UI框架）/ArkTS组件/公共定义/ts-types.md)类型。 |
...
| clickable | boolean | 否 | 是 | 标记是否可以点击，默认值为false，异常值按默认值处理。true：可点击false：不可点击**元服务API：**从版本4.1.0(11)开始，该接口支持在元服务中使用。 |
| draggable | boolean | 否 | 是 | 是否可以通过长按来拖拽，默认值为false，异常值按默认值处理。true：可拖拽false：不可拖拽**元服务API：**从版本4.1.0(11)开始，该接口支持在元服务中使用。 |
| flat | boolean | 否 | 是 | 是否平贴地图，默认值为false，异常值按默认值处理。true：可平贴false：不可平贴**元服务API：**从版本4.1.0(11)开始，该接口支持在元服务中使用。 |
...
| collisionRule | [CollisionRule](#section230211714264) | 否 | 是 | 标记与地图POI之间的冲突处理规则，默认值为[CollisionRule](#section230211714264).NONE。异常值按照默认值处理。说明：从5.0.3(15)版本开始，collisionRule属性支持CollisionRule.NONE和CollisionRule.ALL类型。**起始版本：**5.0.3(15)**元服务API：**从版本5.0.3(15)开始，该接口支持在元服务中使用。 |
| annotations | [Text](#section132819018245)[] | 否 | 是 | 标记的注释，最小长度为1，最大长度为3。**起始版本：**5.0.3(15)**元服务API：**从版本5.0.3(15)开始，该接口支持在元服务中使用。 |
| showIcon | boolean | 否 | 是 | 是否显示标记的图标，默认值为true。根据显示的图标对异常值进行处理。true：显示标记的图标false：不显示标记的图标**起始版本：**5.0.3(15)**元服务API：**从版本5.0.3(15)开始，该接口支持在元服务中使用。 |
| annotationPosition | [TextPosition](#section939311423718) | 否 | 是 | 注释相对于图标的位置，默认值为[TextPosition](#section939311423718).DEFAULT。**起始版本：**5.0.3(15)**元服务API：**从版本5.0.3(15)开始，该接口支持在元服务中使用。 |
| iconBuilder | [CustomBuilder](D:/code/APIDevice/output/md_output/harmonyos-references/应用框架/ArkUI（方舟UI框架）/ArkTS组件/公共定义/ts-types.md) | 否 | 是 | 用于生成标记图标的自定义组件。自定义组件的优先级高于图标属性。**起始版本：**6.0.0(20)**元服务API：**从版本6.0.0(20)开始，该接口支持在元服务中使用 |
...
```
#### MapCircleOptions
描述MapCircle属性，继承 [BaseOverlayOptions](#section7400647135116) 。
**模型约束：** 此接口仅可在Stage模型下使用。
**元服务API：** 从版本4.1.0(11)开始，该接口支持在元服务中使用。
**系统能力：** SystemCapability.Map.Core
**起始版本：** 4.1.0(11)
| **名称** | **类型** | 只读 | 可选 | **说明** |
| --- | --- | --- | --- | --- |
| center | [LatLng](#section20691173773810) | 否 | 否 | 圆的圆心，不能为空。圆的中心点纬度在[-85.051119, 85.051119]范围内才能画出圆。若圆中心点纬度为-85.051119或85.051119时，能画出半径为1米的圆。异常值不处理。 |
| radius | number | 否 | 否 | 圆的半径，单位：米，默认值为0，异常值按默认值处理。 |
| clickable | boolean | 否 | 是 | 圆的可点击性，默认值为false，异常值按默认值处理。true：可点击false：不可点击 |
...
| patterns | Array<[PatternItem](#section917314511192)> | 否 | 是 | 圆的边框样式，默认值为空数组，异常值按默认值处理。 |
...
```
#### MapPolygonOptions
描述MapPolygon属性，继承 [BaseOverlayOptions](#section7400647135116) 。
**模型约束：** 此接口仅可在Stage模型下使用。
**元服务API：** 从版本4.1.0(11)开始，该接口支持在元服务中使用。
**系统能力：** SystemCapability.Map.Core
**起始版本：** 4.1.0(11)
| **名称** | **类型** | 只读 | 可选 | **说明** |
| --- | --- | --- | --- | --- |
| points | Array<[LatLng](#section20691173773810)> | 否 | 否 | 多边形的一组顶点，纬度取值范围：[-85.2, 85.2]，异常值不处理。 |
| holes | Array<Array<[LatLng](#section20691173773810)>> | 否 | 是 | 多边形的一组空心洞，默认值为空数组，异常值按默认值处理。说明：当空心洞的坐标贴合多边形边缘时，会导致渲染出现异常，渲染多余的空心区域。 |
| clickable | boolean | 否 | 是 | 多边形的可点击性，默认值为false，异常值按默认值处理。true：可点击false：不可点击 |
| fillColor | number | 否 | 是 | 多边形的填充颜色，默认值为0x00000000（透明），颜色值为ARGB格式，异常值按默认值处理。 |
| geodesic | boolean | 否 | 是 | 多边形的线段是否为大地曲线，默认值为false，异常值按默认值处理。true：大地曲线false：非大地曲线 |
| strokeColor | number | 否 | 是 | 多边形的边框颜色，默认值为0xff000000（黑色），颜色值为ARGB格式，异常值按默认值处理。 |
| jointType | [JointType](#section73559613164) | 否 | 是 | 多边形线条的拐角样式，默认值为[JointType](#section73559613164).DEFAULT，异常值按默认值处理。 |
| patterns | Array<[PatternItem](#section917314511192)> | 否 | 是 | 多边形的边框样式，默认值为空数组，异常值按默认值处理。 |
...
```
#### MapPolylineOptions
描述MapPolyline属性，继承 [BaseOverlayOptions](#section7400647135116) 。
**模型约束：** 此接口仅可在Stage模型下使用。
**系统能力：** SystemCapability.Map.Core
**起始版本：** 4.1.0(11)
| **名称** | **类型** | 只读 | 可选 | **说明** |
| --- | --- | --- | --- | --- |
| points | Array<[LatLng](#section20691173773810)> | 否 | 否 | 折线的一组顶点，异常值不处理。**元服务API：**从版本4.1.0(11)开始，该接口支持在元服务中使用。 |
| clickable | boolean | 否 | 是 | 折线的可点击性，默认值为false，异常值按默认值处理。true：可点击false：不可点击**元服务API：**从版本4.1.0(11)开始，该接口支持在元服务中使用。 |
...
| startCap | [CapStyle](#section173028494409) | 否 | 是 | 折线的起始顶点的样式，默认值为[CapStyle](#section173028494409).BUTT，异常值按默认值处理。**元服务API：**从版本4.1.0(11)开始，该接口支持在元服务中使用。 |
| endCap | [CapStyle](#section173028494409) | 否 | 是 | 折线的结束顶点的样式，默认值为[CapStyle](#section173028494409).BUTT，异常值按默认值处理。**元服务API：**从版本4.1.0(11)开始，该接口支持在元服务中使用。 |
| geodesic | boolean | 否 | 是 | 折线的线段是否为大地曲线，默认值为false，异常值按默认值处理。true：大地曲线false：非大地曲线**元服务API：**从版本4.1.0(11)开始，该接口支持在元服务中使用。 |
| jointType | [JointType](#section73559613164) | 否 | 是 | 折线的线条拐角样式，默认值为[JointType](#section73559613164).DEFAULT，异常值按默认值处理。**元服务API：**从版本4.1.0(11)开始，该接口支持在元服务中使用。 |
| patterns | Array<[PatternItem](#section917314511192)> | 否 | 是 | 折线的样式，默认值为空数组，异常值按默认值处理。**元服务API：**从版本4.1.0(11)开始，该接口支持在元服务中使用。 |
| width | number | 否 | 是 | 折线的宽度，单位：px，默认值为10，取值范围：[0, 512]，大于512按512处理。**元服务API：**从版本4.1.0(11)开始，该接口支持在元服务中使用。 |
| gradient | boolean | 否 | 是 | 折线的渐变属性，默认值为false，异常值按默认值处理。true：可渐变false：不可渐变**元服务API：**从版本4.1.0(11)开始，该接口支持在元服务中使用。 |
| customTexture | [ResourceStr](D:/code/APIDevice/output/md_output/harmonyos-references/应用框架/ArkUI（方舟UI框架）/ArkTS组件/公共定义/ts-types.md)|[image.PixelMap](D:/code/APIDevice/output/md_output/harmonyos-references/媒体/Image Kit（图片处理服务）/ArkTS API/@ohos.multimedia.image (图片处理)/arkts-apis-image-pixelmap.md) | 否 | 是 | 折线纹理。建议纹理使用没有背景色（透明色）的图片。**起始版本：**5.0.0(12)**元服务API：**从版本5.0.0(12)开始，该接口支持在元服务中使用。 |
| isTextureMappingUsed | boolean | 否 | 是 | 是否使用贴图的方式处理纹理，默认值为false。true：使用贴图的方式处理纹理false：不使用贴图的方式处理纹理**起始版本：**5.0.3(15)**元服务API：**从版本5.0.3(15)开始，该接口支持在元服务中使用。 |
| customTextures | Array<[ResourceStr](D:/code/APIDevice/output/md_output/harmonyos-references/应用框架/ArkUI（方舟UI框架）/ArkTS组件/公共定义/ts-types.md)|[image.PixelMap](D:/code/APIDevice/output/md_output/harmonyos-references/媒体/Image Kit（图片处理服务）/ArkTS API/@ohos.multimedia.image (图片处理)/arkts-apis-image-pixelmap.md)> | 否 | 是 | 多个纹理图片。**起始版本：**5.0.3(15)**元服务API：**从版本5.0.3(15)开始，该接口支持在元服务中使用。说明：如果同时传入customTexture和customTextures，则呈现customTexture的效果。 |
...
描述气泡、点注释等覆盖物的基础信息，继承 [BaseOverlayOptions](#section7400647135116) 。
**模型约束：** 此接口仅可在Stage模型下使用。
**元服务API：** 从版本4.1.0(11)开始，该接口支持在元服务中使用。
**系统能力：** SystemCapability.Map.Core
**起始版本：** 4.1.0(11)
...
| forceVisible | boolean | 否 | 是 | POI的显示属性，默认值为false，异常值按默认值处理。true：碰撞后仍能显示false：碰撞后不可显示 |
...
描述点注释属性，继承 [BasePriorityOverlayParams](#section20126194774515) 。
**模型约束：** 此接口仅可在Stage模型下使用。
**系统能力：** SystemCapability.Map.Core
**起始版本：** 4.1.0(11)
| **名称** | **类型** | 只读 | 可选 | **说明** |
| --- | --- | --- | --- | --- |
| position | [LatLng](#section20691173773810) | 否 | 否 | 点注释图标锚点，异常值不处理。**元服务API：**从版本4.1.0(11)开始，该接口支持在元服务中使用。 |
| repeatable | boolean | 否 | 是 | 点注释名称与地图POI名称相同时，是否支持去重，默认值为false，异常值按默认值处理。true：支持去重false：不支持去重**元服务API：**从版本4.1.0(11)开始，该接口支持在元服务中使用。说明：碰撞规则为[CollisionRule](#section230211714264).NONE时，repeatable不支持设置。 |
| collisionRule | [CollisionRule](#section230211714264) | 否 | 是 | 点注释的碰撞规则，默认值为[CollisionRule](#section230211714264).NAME，异常值按默认值处理。**元服务API：**从版本4.1.0(11)开始，该接口支持在元服务中使用。说明：设置碰撞规则为[CollisionRule](#section230211714264).ALL，需要同时设置覆盖物碰撞优先级priority属性。 |
| titles | Array<[Text](#section132819018245)> | 否 | 否 | 点注释的标题，数组长度最小为1，最大为3。**元服务API：**从版本4.1.0(11)开始，该接口支持在元服务中使用。 |
| icon | string |[image.PixelMap](D:/code/APIDevice/output/md_output/harmonyos-references/媒体/Image Kit（图片处理服务）/ArkTS API/@ohos.multimedia.image (图片处理)/arkts-apis-image-pixelmap.md)|[Resource](D:/code/APIDevice/output/md_output/harmonyos-references/应用框架/ArkUI（方舟UI框架）/ArkTS组件/公共定义/ts-types.md) | 否 | 是 | 点注释的图标，不传时使用默认图标。图片格式支持jpg、jpeg、png、gif、webp、svg。string类型入参支持两种格式：1. 资源相对路径格式：图标存放在resources/rawfile，icon参数传入rawfile文件夹下的相对路径。2. toDataURL格式（如data:image/png;base64,<图片的Base64字节编码值>）。**元服务API：**从版本4.1.0(11)开始，该接口支持在元服务中使用。说明：从5.0.0(12)版本开始，icon属性支持[image.PixelMap](D:/code/APIDevice/output/md_output/harmonyos-references/媒体/Image Kit（图片处理服务）/ArkTS API/@ohos.multimedia.image (图片处理)/arkts-apis-image-pixelmap.md)和[Resource](D:/code/APIDevice/output/md_output/harmonyos-references/应用框架/ArkUI（方舟UI框架）/ArkTS组件/公共定义/ts-types.md)类型。 |
| showIcon | boolean | 否 | 是 | 点注释是否展示图标。默认值为true。true：展示false：不展示**元服务API：**从版本4.1.0(11)开始，该接口支持在元服务中使用。 |
| textPosition | [TextPosition](#section939311423718) | 否 | 是 | 设置点注释的文本位置。默认值为[TextPosition](#section939311423718).DEFAULT。**起始版本：**5.0.0(12)**元服务API：**从版本5.0.0(12)开始，该接口支持在元服务中使用。 |
**示例：**
```typescript
...
```
#### BubbleParams
描述气泡属性，继承 [BasePriorityOverlayParams](#section20126194774515) 。
**模型约束：** 此接口仅可在Stage模型下使用。
**元服务API：** 从版本4.1.0(11)开始，该接口支持在元服务中使用。
**系统能力：** SystemCapability.Map.Core
**起始版本：** 4.1.0(11)
| **名称** | **类型** | 只读 | 可选 | **说明** |
| --- | --- | --- | --- | --- |
| positions | Array<Array<[LatLng](#section20691173773810)>> | 否 | 否 | 气泡位置，系统基于多个位置段计算图标的适当位置，异常值不处理。 |
| icons | Array<string |[image.PixelMap](D:/code/APIDevice/output/md_output/harmonyos-references/媒体/Image Kit（图片处理服务）/ArkTS API/@ohos.multimedia.image (图片处理)/arkts-apis-image-pixelmap.md)|[Resource](D:/code/APIDevice/output/md_output/harmonyos-references/应用框架/ArkUI（方舟UI框架）/ArkTS组件/公共定义/ts-types.md)> | 否 | 否 | 气泡图标，异常值不处理。必须提供4个方向的图标，传入的图标宽高需要相同。图片格式支持jpg、jpeg、png、gif、webp、svg。string类型入参支持两种格式：资源相对路径格式：图标存放在resources/rawfile，icon参数传入rawfile文件夹下的相对路径。toDataURL格式（如data:image/png;base64,<图片的Base64字节编码值>）。说明：从5.0.0(12)版本开始，icon属性支持[image.PixelMap](D:/code/APIDevice/output/md_output/harmonyos-references/媒体/Image Kit（图片处理服务）/ArkTS API/@ohos.multimedia.image (图片处理)/arkts-apis-image-pixelmap.md)和[Resource](D:/code/APIDevice/output/md_output/harmonyos-references/应用框架/ArkUI（方舟UI框架）/ArkTS组件/公共定义/ts-types.md)类型。 |
**示例：**
```typescript
...
| fontStyle | [FontStyle](#section1117015922613) | 否 | 是 | 标题字体样式，默认值为[FontStyle](#section1117015922613).REGULAR，异常值按默认值处理。 |
**示例：**
```typescript
...
| **名称** | **类型** | 只读 | 可选 | **说明** |
| --- | --- | --- | --- | --- |
| farLeft | [LatLng](#section20691173773810) | 否 | 否 | 定义相机的左上角。 |
| farRight | [LatLng](#section20691173773810) | 否 | 否 | 定义相机的右上角。 |
| bounds | [LatLngBounds](#section96341159111320) | 否 | 否 | 定义的可视区域的最小边界框。 |
| nearLeft | [LatLng](#section20691173773810) | 否 | 否 | 定义相机的左下角。 |
| nearRight | [LatLng](#section20691173773810) | 否 | 否 | 定义相机的右下角。 |
**示例：**
```typescript
...
| styleContent | string | 否 | 是 | 离线样式内容，内容格式参见[样式参考](D:/code/APIDevice/output/md_output/harmonyos-guides/应用服务/Map Kit（地图服务）/创建地图/显示自定义地图/map-style.md)。 |
**示例：**
```typescript
...
| **名称** | **类型** | 只读 | 可选 | **说明** |
| --- | --- | --- | --- | --- |
| position | [LatLng](#section20691173773810) | 否 | 否 | 待聚合节点的坐标。 |
**示例：**
```typescript
...
| **名称** | **类型** | 只读 | 可选 | **说明** |
| --- | --- | --- | --- | --- |
| clusterItems | Array<[ClusterItem](#section9436522104316)> | 否 | 否 | 待聚合节点数组。 |
| distance | number | 否 | 否 | 聚合节点聚合的距离，单位：vp。 |
接口提供以下方法，支持聚合项自定义图标。
| 返回类型 | 方法 |
| --- | --- |
| Promise<[image.PixelMap](D:/code/APIDevice/output/md_output/harmonyos-references/媒体/Image Kit（图片处理服务）/ArkTS API/@ohos.multimedia.image (图片处理)/arkts-apis-image-pixelmap.md)> | [getCustomIcon](#section252017318496)?(clusterItems: Array<[ClusterItem](#section9436522104316)>)根据聚合项自定义图标，使用Promise异步回调。 |
**示例：**
```typescript
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| clusterItems | Array<[ClusterItem](#section9436522104316)> | 是 | 聚合节点数组。 |
**返回值：**
| 类型 | 说明 |
| --- | --- |
...
```
#### ImageOverlayParams
覆盖物参数。继承 [BaseOverlayOptions](#section7400647135116) 。
**模型约束：** 此接口仅可在Stage模型下使用。
**元服务API：** 从版本5.0.0(12)开始，该接口支持在元服务中使用。
**系统能力：** SystemCapability.Map.Core
**起始版本：** 5.0.0(12)
| **名称** | **类型** | 只读 | 可选 | **说明** |
| --- | --- | --- | --- | --- |
| bounds | [LatLngBounds](#section96341159111320) | 否 | 是 | 设置基于矩形区域的覆盖物的位置。position和bounds是可选的，但是两个参数需要必填其中一个参数，当两者都入参时，bounds具有更高的优先级。position入参时，width为必填参数。 |
| position | [LatLng](#section20691173773810) | 否 | 是 | 设置覆盖物的位置。position和bounds是可选的，但是两个参数需要必填其中一个，当两者都入参时，bounds具有更高的优先级。position入参时，width为必填参数。 |
...
| image | [ResourceStr](D:/code/APIDevice/output/md_output/harmonyos-references/应用框架/ArkUI（方舟UI框架）/ArkTS组件/公共定义/ts-types.md)|[image.PixelMap](D:/code/APIDevice/output/md_output/harmonyos-references/媒体/Image Kit（图片处理服务）/ArkTS API/@ohos.multimedia.image (图片处理)/arkts-apis-image-pixelmap.md) | 否 | 否 | 覆盖物的图像入参。图片格式支持jpg、jpeg、png、gif、webp、svg。说明：[ResourceStr](D:/code/APIDevice/output/md_output/harmonyos-references/应用框架/ArkUI（方舟UI框架）/ArkTS组件/公共定义/ts-types.md)为Resource和string两种格式，其中string类型入参支持两种格式：资源相对路径格式：图标存放在resources/rawfile，image参数传入rawfile文件夹下的相对路径。toDataURL格式（如data:image/png;base64,<图片的Base64字节编码值>）。 |
...
| **名称** | **类型** | 只读 | 可选 | **说明** |
| --- | --- | --- | --- | --- |
| points | Array<[LatLng](#section20691173773810)> | 否 | 否 | 建筑底面坐标集合。最少三个坐标点，而且坐标点按顺时针方向连接可以形成完整的平面。 |
...
| sideTexture | [BuildingTexture](#section16452081559) | 否 | 是 | 建筑的侧面纹理。 |
| floorTexture | [BuildingTexture](#section16452081559) | 否 | 是 | 所选楼层的纹理。 |
**示例：**
```typescript
...
| **名称** | **类型** | 只读 | 可选 | **说明** |
| --- | --- | --- | --- | --- |
| image | [ResourceStr](D:/code/APIDevice/output/md_output/harmonyos-references/应用框架/ArkUI（方舟UI框架）/ArkTS组件/公共定义/ts-types.md)|[image.PixelMap](D:/code/APIDevice/output/md_output/harmonyos-references/媒体/Image Kit（图片处理服务）/ArkTS API/@ohos.multimedia.image (图片处理)/arkts-apis-image-pixelmap.md) | 否 | 否 | 纹理图片。图片格式支持jpg、jpeg、png、gif、webp、svg。说明：[ResourceStr](D:/code/APIDevice/output/md_output/harmonyos-references/应用框架/ArkUI（方舟UI框架）/ArkTS组件/公共定义/ts-types.md)为Resource和string两种格式，其中string类型入参支持两种格式：资源相对路径格式：图标存放在resources/rawfile，image参数传入rawfile文件夹下的相对路径。toDataURL格式（如data:image/png;base64,<图片的Base64字节编码值>）。 |
...
| **名称** | **类型** | 只读 | 可选 | **说明** |
| --- | --- | --- | --- | --- |
| points | Array<[LatLng](#section20691173773810)> | 否 | 否 | 跟踪点。points个数上限为100000。 |
| width | number | 否 | 是 | 轨迹宽度，单位：px。默认值为10。取值范围：[0, 512]，大于512按512处理。 |
| color | number | 否 | 是 | 轨迹颜色，颜色值是ARGB格式。默认值为0xaaff0000。 |
| isMapMoving | boolean | 否 | 是 | 设置地图和轨迹是否一起移动。true：地图和轨迹一起移动false：仅轨迹移动默认值为false。 |
...
```
#### MapArcParams
弧线的参数。继承 [BaseOverlayOptions](#section7400647135116) 。
**模型约束：** 此接口仅可在Stage模型下使用。
**元服务API：** 从版本5.0.0(12)开始，该接口支持在元服务中使用。
**系统能力：** SystemCapability.Map.Core
**起始版本：** 5.0.0(12)
| **名称** | **类型** | 只读 | 可选 | **说明** |
| --- | --- | --- | --- | --- |
| startPoint | [LatLng](#section20691173773810) | 否 | 否 | 起始位置。 |
| centerPoint | [LatLng](#section20691173773810) | 否 | 否 | 中心位置。 |
| endPoint | [LatLng](#section20691173773810) | 否 | 否 | 结束位置。 |
...
| **名称** | **类型** | 只读 | 可选 | **说明** |
| --- | --- | --- | --- | --- |
| coordinateType | [CoordinateType](#section78948324526) | 否 | 否 | 坐标系类型。 |
| location | [LatLng](#section20691173773810) | 否 | 否 | 坐标。 |
**示例：**
```typescript
...
```
#### TileOverlayParams
瓦片图层的参数。继承 [BaseOverlayOptions](#section7400647135116) 。
**模型约束：** 此接口仅可在Stage模型下使用。
...
| tileProvider | [TileProvider](#section1574174915920) | 否 | 是 | 根据瓦片坐标获取瓦片。 |
| transparency | number | 否 | 是 | 瓦片图层的透明度。取值范围为[0, 1]，0表示不透明，1表示透明。默认值为0。 |
| fadeIn | boolean | 否 | 是 | 是否开启瓦片图层淡入。true：开启瓦片图层淡入。false：不开启瓦片图层淡入。默认值为true。 |
...
| --- | --- | --- | --- | --- |
| id | string | 否 | 否 | 热力图ID。 |
| data | [WeightedLatLng](#section14151459134817)[] | 否 | 否 | 热力图数据（建议数据量小于10000条）。 |
...
| radius | number | Record<number, number> | 否 | 是 | 热力图半径，可以配置不同层级的半径，key表示层级，value表示按半径，如果是number类型，所有层级使用同一个半径，默认值10，默认单位：[RadiusUnit](#section117031317134216).PIXEL_UNIT。 |
| radiusUnit | [RadiusUnit](#section117031317134216) | 否 | 是 | 半径单位。默认值：[RadiusUnit](#section117031317134216).PIXEL_UNIT。 |
...
| **名称** | **类型** | 只读 | 可选 | **说明** |
| --- | --- | --- | --- | --- |
| point | [LatLng](#section20691173773810) | 否 | 否 | 经纬度。 |
...
#### MvtOverlayParams
矢量图层的参数。继承 [BaseOverlayOptions](#section7400647135116) 。
**模型约束：** 此接口仅可在Stage模型下使用。
**系统能力：** SystemCapability.Map.Core.EnhancedOverlay
**起始版本：** 6.0.0(20)
| **名称** | **类型** | 只读 | 可选 | **说明** |
| --- | --- | --- | --- | --- |
| source | [MvtSource](#section877213310341) | 否 | 否 | 矢量图层的来源。**元服务API：**从版本6.0.0(20)开始，该接口支持在元服务中使用。 |
| layers | [MvtLayer](#section14599124818)[] | 否 | 否 | 样式数组，建议矢量图层少于2000层，确保矢量图层的流畅度。**元服务API：**从版本6.0.0(20)开始，该接口支持在元服务中使用。 |
...
| type | [MvtLayerType](#section11385518298) | 否 | 否 | 矢量图层类型。 |
| sourceLayer | string | 否 | 否 | 矢量图层数据中图层的名称。 |
| paint | [MvtPaint](#section1546292610511) | 否 | 是 | 用于配置几何体的渲染，如填充、描边等。 |
#### MvtPaint
用于配置几何体的渲染，如填充、描边等。
**模型约束：** 此接口仅可在Stage模型下使用。
**元服务API：** 从版本6.0.0(20)开始，该接口支持在元服务中使用。
...
| **名称** | **类型** | 只读 | 可选 | **说明** |
| --- | --- | --- | --- | --- |
| fillColor | number |[Expression](#section139149121817) | 否 | 是 | 填充颜色，默认值：0x000000，异常值按默认值处理。支持：十六进制RGB格式。从矢量图层数据的属性中读取。 |
| fillOpacity | number |[Expression](#section139149121817) | 否 | 是 | 填充不透明度，默认值：0，异常值按默认值处理。支持：介于0到1之间的数字。从矢量图层数据的属性中读取。 |
#### MvtLayerType
矢量图层类型。
**模型约束：** 此接口仅可在Stage模型下使用。
**元服务API：** 从版本6.0.0(20)开始，该接口支持在元服务中使用。
...
| **名称** | **类型** | 只读 | 可选 | **说明** |
| --- | --- | --- | --- | --- |
| operator | [Operator](#section1745405383014) | 否 | 否 | 操作符。 |
| args | string | string[] |[Expression](#section139149121817)[] | 否 | 否 | 参数。说明：string[]和[Expression](#section139149121817)[]类型为预留类型，将来使用。 |
#### Operator
操作符。
**模型约束：** 此接口仅可在Stage模型下使用。
**元服务API：** 从版本6.0.0(20)开始，该接口支持在元服务中使用。
...
流场图层的参数。继承 [BaseOverlayOptions](#section7400647135116) 。
**模型约束：** 此接口仅可在Stage模型下使用。
**元服务API：** 从版本6.0.0(20)开始，该接口支持在元服务中使用。
**系统能力：** SystemCapability.Map.Core.EnhancedOverlay
**起始版本：** 6.0.0(20)
| **名称** | **类型** | 只读 | 可选 | **说明** |
| --- | --- | --- | --- | --- |
| data | string | 否 | 否 | 流场图层的数据，数据格式参见[流场数据格式参考](D:/code/APIDevice/output/md_output/harmonyos-guides/应用服务/Map Kit（地图服务）/在地图上绘制/流场图层/map-flow-field.md)。 |
| style | [ParticleStyle](#section1666151282917) | 否 | 是 | 粒子样式。 |
#### ParticleStyle
粒子样式。
**模型约束：** 此接口仅可在Stage模型下使用。
**元服务API：** 从版本6.0.0(20)开始，该接口支持在元服务中使用。
...
| position | [LatLng](#section20691173773810) | 否 | 否 | 项目的经纬度坐标。 |
| title | string | 否 | 是 | 标题。 |
...
| items | [MassPointItem](#section17837254174411)[] | 否 | 否 | 海量点列表（建议数据量小于100000条）。 |
| icon | [ResourceStr](D:/code/APIDevice/output/md_output/harmonyos-references/应用框架/ArkUI（方舟UI框架）/ArkTS组件/公共定义/ts-types.md)|[image.PixelMap](D:/code/APIDevice/output/md_output/harmonyos-references/媒体/Image Kit（图片处理服务）/ArkTS API/@ohos.multimedia.image (图片处理)/arkts-apis-image-pixelmap.md) | 否 | 否 | 海量点的图标。 |
...
| 名称 | 值 | 说明 |
| --- | --- | --- |
| OVERLAY | 1 | 覆盖物，包括[MapCircle](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-mapcircle.md)、[MapPolygon](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-mappolygon.md)、[MapPolyline](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-mappolyline.md)、[MapArc](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-maparc.md)、[ImageOverlay](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-imageoverlay.md)、[TraceOverlay](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-traceoverlay.md)。 |
| POI | 2 | 底图[Poi](#section1155919456273)。 |
| CUSTOM_POI | 3 | 支持碰撞的覆盖物，包括[PointAnnotation](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-pointannotation.md)、[Bubble](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-bubble.md)。 |
| MARKER | 4 | 包括[Marker](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-marker.md)、[ClusterOverlay](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-clusteroverlay.md)。 |