...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/74/v3/sQ_sOpYgSnST8mCBO6JrmA/zh-cn_image_0000002659221031.gif?HW-CC-KV=V1&HW-CC-Date=20260701T105234Z&HW-CC-Expire=86400&HW-CC-Sign=F13D985323D5173B0CBF3883DE3693BBD44CB4156FC584B5249F3EEB6485EAC9)
#### 接口说明
添加3D建筑功能主要由 [BuildingOverlayParams](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map-common.md) 、 [addBuildingOverlay](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-mapcomponentcontroller.md) 和 [BuildingOverlay](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-buildingoverlay.md) 提供，更多接口及使用方法请参见 [接口文档](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-buildingoverlay.md) 。
| 接口名 | 描述 |
| --- | --- |
| [BuildingOverlayParams](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map-common.md) | 3D建筑参数。 |
| [addBuildingOverlay](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-mapcomponentcontroller.md)(params:[mapCommon.BuildingOverlayParams](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map-common.md)): Promise<[BuildingOverlay](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-buildingoverlay.md)> | 在地图上添加3D建筑。 |
| [BuildingOverlay](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-buildingoverlay.md) | 3D建筑，支持更新和查询相关属性。 |
#### 开发步骤
#### 添加3D建筑
1.
导入相关模块。
