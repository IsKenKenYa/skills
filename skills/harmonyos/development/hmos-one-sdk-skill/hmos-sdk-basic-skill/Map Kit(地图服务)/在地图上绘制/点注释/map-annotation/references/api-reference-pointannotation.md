...
```
#### PointAnnotation
点注释，继承 [BasePriorityOverlay](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-basepriorityoverlay.md) 。在调用map. [MapComponentController](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-mapcomponentcontroller.md) 类的 [addPointAnnotation](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-mapcomponentcontroller.md) 方法时会返回该类型的实例。
...
| 类型 | 说明 |
| --- | --- |
| [mapCommon.LatLng](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map-common.md) | 点注释的锚点坐标。 |
**示例：**
```typescript
...
| 类型 | 说明 |
| --- | --- |
| [mapCommon.Text](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map-common.md) | 获取点注释第一标题的属性。 |
**示例：**
```typescript
...
| 参数名 | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| text | [mapCommon.Text](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map-common.md) | 是 | 第一标题属性（除content）。说明：约束条件：fontSize、strokeWidth大于等于0。 |
**示例：**
```typescript
// 以pointAnnotation为例
...
| 参数名 | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| animation | [FontSizeAnimation](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-fontsizeanimation.md) | 是 | 点注释的标题动画。 |
**示例：**
```typescript
