...
```
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/45/v3/1MuGwarES6eMR-18SPE0LQ/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260401T093826Z&HW-CC-Expire=86400&HW-CC-Sign=859192DF6573BCDEF7CC671613A966267B198A1A15C5FA02B7A8881CB6A92C85)
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| update | [CameraUpdate](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-cameraupdate.md) | 是 | 相机状态将要发生的变化。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<[AnimateResult](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-animateresult.md)> | Promise对象，返回[AnimateResult](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-animateresult.md)。 |
**错误码：**
以下错误码的详细介绍请参见 [ArkTS API错误码](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map-errorcode.md) 。
| 错误码ID | 错误信息 |
| --- | --- |
...
在指定的持续时间内以动画的形式更新相机状态，并更新指定的marker。使用Promise异步回调。相机移动过程中不能被打断，否则 [AnimateResult](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-animateresult.md) 的参数isCanceled返回值为true。
**模型约束：** 此接口仅可在Stage模型下使用。
**元服务API：** 从版本5.0.0(12)开始，该接口支持在元服务中使用。
**系统能力：** SystemCapability.Map.Core
**起始版本：** 5.0.0(12)
...
| --- | --- | --- | --- |
| update | [CameraUpdate](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-cameraupdate.md) | 是 | 相机状态将要发生的变化。 |
| marker | [Marker](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-marker.md) | 是 | 标记。 |
...
| --- | --- | --- | --- |
| update | [CameraUpdate](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-cameraupdate.md) | 是 | 相机状态将要发生的变化。 |
| markers | Array<[Marker](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-marker.md)> | 是 | 一组标记。说明：一组标记的位置必须相同，否则会返回401错误码。 |
| duration | number | 是 | 动画的持续时间，单位：ms，默认值为250，取值范围：大于0，小于等于0按照默认值处理。 |
**返回值：**
| 类型 | 说明 |
| --- | --- |
...
| 类型 | 说明 |
| --- | --- |
| [mapCommon.CameraPosition](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map-common.md) | 相机的当前状态信息。 |
**示例：**
```typescript
...
指定一个 [mapCommon.LatLngBounds](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map-common.md) 来约束相机目标，使用户移动地图时，相机目标不会移出此边界。当设置新的边界时，新边界将覆盖之前设置的边界。
**模型约束：** 此接口仅可在Stage模型下使用。
**元服务API：** 从版本4.1.0(11)开始，该接口支持在元服务中使用。
**系统能力：** SystemCapability.Map.Core
**起始版本：** 4.1.0(11)
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| bounds | [mapCommon.LatLngBounds](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map-common.md) | 是 | 约束相机目标的边界。说明：西南角纬度大于东北角纬度时不生效。 |
**示例：**
```typescript
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| point | [mapCommon.MapPoint](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map-common.md) | 是 | 屏幕坐标点，异常值不处理。 |
**示例：**
```typescript
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| enabled | boolean | 是 | true：打开路况图层false：关闭路况图层默认值为false。 |
**示例：**
```typescript
...
| 类型 | 说明 |
| --- | --- |
| boolean | true：路况图层为开启状态false：路况图层为关闭状态 |
**示例：**
```typescript
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| enabled | boolean | 是 | true：打开3D建筑图层false：关闭3D建筑图层默认值为false。说明：打开3D建筑图层后将地图层级缩放至建筑物可视层，即可展现3D图层效果。 |
**示例：**
```typescript
...
| 类型 | 说明 |
| --- | --- |
| boolean | true：3D建筑图层为开启状态false：3D建筑图层为关闭状态 |
**示例：**
```typescript
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| myLocationEnabled | boolean | 是 | true：启用“我的位置”图层false：禁用“我的位置”图层默认值为false。 |
**示例：**
```typescript
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| location | [geoLocationManager.Location](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Location Kit（位置服务）/ArkTS API/js-apis-geolocationmanager.md) | 是 | 用户的位置。说明：location参数需使用WGS84坐标系。 |
**示例：**
```typescript
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| style | [mapCommon.MyLocationStyle](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map-common.md) | 是 | 用户的位置样式。说明：如果displayType使用FOLLOW_ROTATE需应用申请传感器权限：ohos.permission.ACCELEROMETER，具体可参考[声明权限](D:/code/APIDevice/output/md_output/harmonyos-guides/系统/安全/程序访问控制/应用权限管控/申请应用权限/声明权限/declare-permissions.md)。 |
**返回值：**
| 类型 | 说明 |
| --- | --- |
...
| 类型 | 说明 |
| --- | --- |
| boolean | “我的位置”图层的开启状态。true：启用false：禁用 |
**示例：**
```typescript
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| enabled | boolean | 是 | true：启用缩放手势false：禁用缩放手势默认值为true。 |
**示例：**
```typescript
...
| 类型 | 说明 |
| --- | --- |
| boolean | 缩放手势功能的启用状态。true：启用缩放手势false：禁用缩放手势 |
**示例：**
```typescript
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| enabled | boolean | 是 | true：启用滚动手势false：禁用滚动手势默认值为true。 |
**示例：**
```typescript
...
| 类型 | 说明 |
| --- | --- |
| boolean | 滚动手势的启用状态。true：启用滚动手势false：禁用滚动手势 |
**示例：**
```typescript
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| enabled | boolean | 是 | true：启用旋转手势false：禁用旋转手势默认值为true。 |
**示例：**
```typescript
...
| 类型 | 说明 |
| --- | --- |
| boolean | 旋转手势的启用状态。true：启用旋转手势false：禁用旋转手势 |
**示例：**
```typescript
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| enabled | boolean | 是 | true：启用倾斜手势false：禁用倾斜手势默认值为true。 |
**示例：**
```typescript
...
| 类型 | 说明 |
| --- | --- |
| boolean | 倾斜手势的启用状态。true：启用倾斜手势false：禁用倾斜手势 |
**示例：**
```typescript
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| enabled | boolean | 是 | true：启用缩放控制器false：禁用缩放控制器默认值为true。 |
**示例：**
```typescript
...
| 类型 | 说明 |
| --- | --- |
| boolean | 缩放控制器的启用状态。true：启用缩放控制器false：禁用缩放控制器 |
**示例：**
```typescript
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| enabled | boolean | 是 | true：启用“我的位置”按钮false：禁用“我的位置”按钮默认值为false。 |
**示例：**
```typescript
...
| 类型 | 说明 |
| --- | --- |
| boolean | “我的位置”按钮的启用状态。true：启用false：禁用 |
**示例：**
```typescript
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| enabled | boolean | 是 | true：启用比例尺false：禁用比例尺默认值为false。 |
**示例：**
```typescript
...
| 类型 | 说明 |
| --- | --- |
| boolean | 比例尺的启用状态。true：启用false：禁用 |
**示例：**
```typescript
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| enabled | boolean | 是 | true：启用指南针false：禁用指南针默认值为true。 |
**示例：**
```typescript
...
| 类型 | 说明 |
| --- | --- |
| boolean | 指南针的启用状态。true：启用false：禁用 |
**示例：**
```typescript
...
- 启用状态，地图将以传入的固定屏幕点进行缩放。通过[setPointToCenter](#section159768471777)方法设置屏幕中心点坐标。
...
| 类型 | 说明 |
| --- | --- |
| boolean | 以固定屏幕中心点进行缩放功能的开启状态。true：启用false：禁用 |
**示例：**
```typescript
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| alignment | [mapCommon.LogoAlignment](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map-common.md) | 是 | 地图Logo的对齐方式，默认值为[LogoAlignment](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map-common.md).BOTTOM_START。 |
**示例：**
```typescript
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/4a/v3/ckp-SIzcSs-_jDJvuiZBug/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260401T093826Z&HW-CC-Expire=86400&HW-CC-Sign=7AA8320C03BB877DA7A6EE0AF21F326A375F70F11EC2C4AFC70082F028C51CAF)
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| padding | [mapCommon.Padding](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map-common.md) | 是 | 地图边界与Logo之间的间距。 |
**示例：**
```typescript
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| options | [mapCommon.MarkerOptions](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map-common.md) | 是 | 标记的属性设置。 |
**返回值：**
| 类型 | 说明 |
| --- | --- |
| Promise<[Marker](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-marker.md)> | Promise对象，返回[Marker](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-marker.md)。 |
**错误码：**
以下错误码的详细介绍请参见 [ArkTS API错误码](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map-errorcode.md) 。
| 错误码ID | 错误信息 |
| --- | --- |
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| options | [mapCommon.MapCircleOptions](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map-common.md) | 是 | 圆的属性设置。 |
**返回值：**
| 类型 | 说明 |
| --- | --- |
| Promise<[MapCircle](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-mapcircle.md)> | Promise对象，返回[MapCircle](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-mapcircle.md)。 |
**错误码：**
以下错误码的详细介绍请参见 [ArkTS API错误码](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map-errorcode.md) 。
| 错误码ID | 错误信息 |
| --- | --- |
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| options | [mapCommon.MapPolylineOptions](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map-common.md) | 是 | 折线的属性设置。 |
**返回值：**
| 类型 | 说明 |
| --- | --- |
| Promise<[MapPolyline](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-mappolyline.md)> | Promise对象，返回[MapPolyline](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-mappolyline.md)。 |
**错误码：**
以下错误码的详细介绍请参见 [ArkTS API错误码](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map-errorcode.md) 。
| 错误码ID | 错误信息 |
| --- | --- |
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| options | [mapCommon.MapPolygonOptions](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map-common.md) | 是 | 多边形的属性设置。 |
**返回值：**
| 类型 | 说明 |
| --- | --- |
| Promise<[MapPolygon](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-mappolygon.md)> | Promise对象，返回[MapPolygon](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-mappolygon.md)。 |
**错误码：**
以下错误码的详细介绍请参见 [ArkTS API错误码](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map-errorcode.md) 。
| 错误码ID | 错误信息 |
| --- | --- |
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| params | [mapCommon.PointAnnotationParams](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map-common.md) | 是 | 点注释的属性设置。 |
**返回值：**
| 类型 | 说明 |
| --- | --- |
| Promise<[PointAnnotation](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-pointannotation.md)> | Promise对象，返回[PointAnnotation](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-pointannotation.md)。 |
**错误码：**
以下错误码的详细介绍请参见 [ArkTS API错误码](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map-errorcode.md) 。
| 错误码ID | 错误信息 |
| --- | --- |
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| params | [mapCommon.BubbleParams](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map-common.md) | 是 | 气泡的属性设置。 |
**返回值：**
| 类型 | 说明 |
| --- | --- |
| Promise<[Bubble](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-bubble.md)> | Promise对象，返回[Bubble](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-bubble.md)。 |
**错误码：**
以下错误码的详细介绍请参见 [ArkTS API错误码](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map-errorcode.md) 。
| 错误码ID | 错误信息 |
| --- | --- |
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| padding | [mapCommon.Padding](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map-common.md) | 否 | 地图和边界的距离，默认值为{ left: 0, right: 0, top: 0, bottom: 0 }。 |
**示例：**
```typescript
// 初始化参数，左边距0，底边距50
let padding: mapCommon.Padding = {
...
| 类型 | 说明 |
| --- | --- |
| [Projection](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-projection.md) | [Projection](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-projection.md)对象。 |
**示例：**
```typescript
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| customMapStyleOptions | [mapCommon.CustomMapStyleOptions](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map-common.md) | 是 | 自定义样式参数。 |
**返回值：**
| 类型 | 说明 |
| --- | --- |
| Promise<void> | Promise对象，无返回结果的Promise对象。 |
...
| 类型 | 说明 |
| --- | --- |
| [mapCommon.DayNightMode](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map-common.md) | 日间夜间模式。 |
**示例：**
```typescript
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| mode | [mapCommon.DayNightMode](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map-common.md) | 是 | 日间夜间模式。 |
**示例：**
```typescript
...
| **类型** | **说明** |
| --- | --- |
| [mapCommon.MapType](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map-common.md) | 查询地图的类型。 |
**示例：**
```typescript
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| mapType | [mapCommon.MapType](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map-common.md) | 是 | 地图类型。 |
**示例：**
```typescript
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| point | [mapCommon.MapPoint](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map-common.md) | 是 | 比例尺位置。说明：比例尺在穿戴设备上默认处于左右居中位置，接口传入的positionX值在穿戴设备上不显示效果。 |
**示例：**
```typescript
let point: mapCommon.MapPoint = {
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| point | [mapCommon.MapPoint](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map-common.md) | 是 | 设置指南针位置，即指南针左上角相对地图组件左上角的偏移量，单位：px。 |
**示例：**
```typescript
let point: mapCommon.MapPoint = {
  positionX: 10,
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| enabled | boolean | 是 | true：启用手势false：禁用手势默认值为true。 |
**示例：**
```typescript
...
设置是否始终显示比例尺。该功能需优先使用 [setScaleControlsEnabled](#section1845222318187) 方法开启比例尺控件方可使用。
**模型约束：** 此接口仅可在Stage模型下使用。
**元服务API：** 从版本5.0.0(12)开始，该接口支持在元服务中使用。
**系统能力：** SystemCapability.Map.Core
**起始版本：** 5.0.0(12)
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| enabled | boolean | 是 | true：始终显示false：关闭始终显示，比例尺显示2秒后关闭默认值为false。 |
**示例：**
```typescript
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| params | [mapCommon.ClusterOverlayParams](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map-common.md) | 是 | 聚合图层参数。 |
**返回值：**
| 类型 | 说明 |
| --- | --- |
| Promise<[ClusterOverlay](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-clusteroverlay.md)> | Promise对象，返回[ClusterOverlay](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-clusteroverlay.md)。 |
**错误码：**
以下错误码的详细介绍请参见 [ArkTS API错误码](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map-errorcode.md) 。
| 错误码ID | 错误信息 |
| --- | --- |
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| params | [mapCommon.ImageOverlayParams](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map-common.md) | 是 | 覆盖物参数。 |
**返回值：**
| 类型 | 说明 |
| --- | --- |
| Promise<[ImageOverlay](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-imageoverlay.md)> | Promise对象，返回[ImageOverlay](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-imageoverlay.md)。 |
**错误码：**
以下错误码的详细介绍请参见 [ArkTS API错误码](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map-errorcode.md) 。
| 错误码ID | 错误信息 |
| --- | --- |
...
| 类型 | 说明 |
| --- | --- |
| Promise<[image.PixelMap](D:/code/APIDevice/output/md_output/harmonyos-references/媒体/Image Kit（图片处理服务）/ArkTS API/@ohos.multimedia.image (图片处理)/arkts-apis-image-pixelmap.md)> | Promise对象，返回[image.PixelMap](D:/code/APIDevice/output/md_output/harmonyos-references/媒体/Image Kit（图片处理服务）/ArkTS API/@ohos.multimedia.image (图片处理)/arkts-apis-image-pixelmap.md)。 |
**示例：**
```typescript
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| params | [mapCommon.BuildingOverlayParams](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map-common.md) | 是 | 3D建筑相关属性。 |
**返回值：**
| 类型 | 说明 |
| --- | --- |
| Promise<[BuildingOverlay](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-buildingoverlay.md)> | Promise对象，返回[BuildingOverlay](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-buildingoverlay.md)。 |
**错误码：**
以下错误码的详细介绍请参见 [ArkTS API错误码](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map-errorcode.md) 。
| 错误码ID | 错误信息 |
| --- | --- |
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| params | [mapCommon.TraceOverlayParams](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map-common.md) | 是 | 动态轨迹参数。 |
| markers | Array<[Marker](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-marker.md)> | 否 | 动态轨迹的图片数组，异常值不处理。说明：一组标记的位置必须相同。 |
**返回值：**
| 类型 | 说明 |
| --- | --- |
| Promise<[TraceOverlay](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-traceoverlay.md)> | Promise对象，返回[TraceOverlay](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-traceoverlay.md)。 |
**错误码：**
以下错误码的详细介绍请参见 [ArkTS API错误码](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map-errorcode.md) 。
| 错误码ID | 错误信息 |
| --- | --- |
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| params | [mapCommon.MapArcParams](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map-common.md) | 是 | 弧线的相关属性。 |
**返回值：**
| 类型 | 说明 |
| --- | --- |
| MapArc | 返回[MapArc](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-maparc.md)。 |
**错误码：**
以下错误码的详细介绍请参见 [ArkTS API错误码](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map-errorcode.md) 。
| 错误码ID | 错误信息 |
| --- | --- |
...
| **类型** | **说明** |
| --- | --- |
| [MapEventManager](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-mapeventmanager.md) | 地图监听事件管理器。 |
**示例：**
```typescript
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| types | Array<[mapCommon.MapElementType](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map-common.md)> | 是 | 四类地图元素的显示顺序，默认顺序为[1, 2, 3, 4]。入参的长度必须是4，且必须是[mapCommon.MapElementType](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map-common.md)的4个取值，如果不满足，则返回错误码401。 |
**错误码：**
以下错误码的详细介绍请参见 [ArkTS API错误码](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map-errorcode.md) 。
| 错误码ID | 错误信息 |
| --- | --- |
...
| 类型 | 说明 |
| --- | --- |
| boolean | true：3D地球为开启状态false：3D地球为关闭状态 |
**示例：**
```typescript
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| enabled | boolean | 是 | 是否开启3D地球效果开关。取值范围：true：开启3D地球效果开关false：不开启3D地球效果开关默认不开启3D地球效果。 |
**示例：**
```typescript
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| enabled | boolean | 是 | 以动画形式切换2D或3D地球。取值范围：true：开启3D地球false：2D地球默认不开启3D地球效果。 |
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| params | [mapCommon.HeatmapParams](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map-common.md) | 是 | 添加热力图的参数。 |
**返回值：**
| 类型 | 说明 |
| --- | --- |
| Promise<[Heatmap](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-heatmap.md)> | Promise对象，返回[Heatmap](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-heatmap.md)，热力图覆盖物。 |
**错误码：**
以下错误码的详细介绍请参见 [ArkTS API错误码](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map-errorcode.md) 。
| 错误码ID | 错误信息 |
| --- | --- |
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| params | [mapCommon.MvtOverlayParams](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map-common.md) | 是 | 矢量图层的参数。说明：使用在线下载方式添加矢量图层时（即使用[mapCommon.MvtOverlayParams](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map-common.md)中[mapCommon.MvtSource](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map-common.md)参数的tileUrl方式），需要申请访问网络的权限：ohos.permission.INTERNET。 |
**返回值：**
| 类型 | 说明 |
| --- | --- |
| [MvtOverlay](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-mvtoverlay.md) | 矢量图层管理对象。 |
**错误码：**
以下错误码的详细介绍请参见 [ArkTS API错误码](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map-errorcode.md) 。
| 错误码ID | 错误信息 |
| --- | --- |
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| params | [mapCommon.FlowFieldOverlayParams](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map-common.md) | 是 | 流场图层的参数。 |
**返回值：**
| 类型 | 说明 |
| --- | --- |
| Promise<[FlowFieldOverlay](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-flowfieldoverlay.md)> | Promise对象，返回流场图层的管理对象。 |
**错误码：**
以下错误码的详细介绍请参见 [ArkTS API错误码](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map-errorcode.md) 。
| 错误码ID | 错误信息 |
| --- | --- |
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| params | [mapCommon.MassPointOverlayParams](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map-common.md) | 是 | 海量点图层的参数。 |
**返回值：**
| 类型 | 说明 |
| --- | --- |
| Promise<[MassPointOverlay](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-masspointoverlay.md)> | Promise对象，返回海量点的管理对象。 |
**错误码：**
以下错误码的详细介绍请参见 [ArkTS API错误码](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map-errorcode.md) 。
| 错误码ID | 错误信息 |
| --- | --- |
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| language | string | 是 | 地图语言。语种取值请参见[地图组件支持语言](D:/code/APIDevice/output/md_output/harmonyos-guides/应用服务/Map Kit（地图服务）/附录/支持的语言/map-language.md)列表。 |
**示例：**
```typescript
...
| 类型 | 说明 |
| --- | --- |
| string | 地图语言。语种取值请参见[地图组件支持语言](D:/code/APIDevice/output/md_output/harmonyos-guides/应用服务/Map Kit（地图服务）/附录/支持的语言/map-language.md)列表。 |
**示例：**
```typescript
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| isBelow | boolean | 是 | 我的位置图层是否位于覆盖物之下。true：我的位置图层位于覆盖物之下false：我的位置图层位于覆盖物之上说明：该接口对[Marker](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-marker.md)、[MapPolyline](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-mappolyline.md)、[MapPolygon](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-mappolygon.md)、[MapCircle](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-mapcircle.md)、[PointAnnotation](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-pointannotation.md)、[Bubble](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-bubble.md)、[ImageOverlay](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-imageoverlay.md)、[MapArc](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-maparc.md)、[TraceOverlay](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-traceoverlay.md)、底图[Poi](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map-common.md)生效。 |
**示例：**
```typescript
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| params | [mapCommon.TileOverlayParams](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map-common.md)|[mapCommon.TileOverlayOptions](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map-common.md) | 是 | 瓦片图层参数。说明：从6.0.0(20)版本开始，params属性支持[mapCommon.TileOverlayOptions](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map-common.md)类型。 |
**返回值：**
| 类型 | 说明 |
| --- | --- |
| [TileOverlay](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-tileoverlay.md) | 瓦片图层。 |
**错误码：**
以下错误码的详细介绍请参见 [ArkTS API错误码](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map-errorcode.md) 。
| 错误码ID | 错误信息 |
| --- | --- |
...
建议使用 [MapEventManager.on(type: 'cameraChange')](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-mapeventmanager.md) 。
**模型约束：** 此接口仅可在Stage模型下使用。
**元服务API：** 从版本4.1.0(11)开始，该接口支持在元服务中使用。
**系统能力：** SystemCapability.Map.Core
**起始版本：** 4.1.0(11)
...
| callback | Callback<[mapCommon.LatLng](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map-common.md)> | 是 | 回调函数，返回[mapCommon.LatLng](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map-common.md)，监听地图相机状态变化事件。该回调不会在动画过程中触发，而是在动画结束时触发。 |
**示例：**
```typescript
...
建议使用 [MapEventManager.off(type: 'cameraChange')](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-mapeventmanager.md) 。
**模型约束：** 此接口仅可在Stage模型下使用。
**元服务API：** 从版本4.1.0(11)开始，该接口支持在元服务中使用。
**系统能力：** SystemCapability.Map.Core
**起始版本：** 4.1.0(11)
...
建议使用 [MapEventManager.on(type: 'cameraIdle')](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-mapeventmanager.md) 。
**模型约束：** 此接口仅可在Stage模型下使用。
**元服务API：** 从版本4.1.0(11)开始，该接口支持在元服务中使用。
**系统能力：** SystemCapability.Map.Core
**起始版本：** 4.1.0(11)
...
建议使用 [MapEventManager.off(type: 'cameraIdle')](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-mapeventmanager.md) 。
**模型约束：** 此接口仅可在Stage模型下使用。
**元服务API：** 从版本4.1.0(11)开始，该接口支持在元服务中使用。
**系统能力：** SystemCapability.Map.Core
**起始版本：** 4.1.0(11)
...
建议使用 [MapEventManager.on(type: 'cameraMoveCancel')](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-mapeventmanager.md) 。
**模型约束：** 此接口仅可在Stage模型下使用。
**元服务API：** 从版本4.1.0(11)开始，该接口支持在元服务中使用。
**系统能力：** SystemCapability.Map.Core
**起始版本：** 4.1.0(11)
...
建议使用 [MapEventManager.off(type: 'cameraMoveCancel')](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-mapeventmanager.md) 。
**模型约束：** 此接口仅可在Stage模型下使用。
**元服务API：** 从版本4.1.0(11)开始，该接口支持在元服务中使用。
**系统能力：** SystemCapability.Map.Core
**起始版本：** 4.1.0(11)
...
建议使用 [MapEventManager.on(type: 'cameraMove')](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-mapeventmanager.md) 。
**模型约束：** 此接口仅可在Stage模型下使用。
**元服务API：** 从版本4.1.0(11)开始，该接口支持在元服务中使用。
**系统能力：** SystemCapability.Map.Core
**起始版本：** 4.1.0(11)
...
建议使用 [MapEventManager.off(type: 'cameraMove')](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-mapeventmanager.md) 。
**模型约束：** 此接口仅可在Stage模型下使用。
**元服务API：** 从版本4.1.0(11)开始，该接口支持在元服务中使用。
**系统能力：** SystemCapability.Map.Core
**起始版本：** 4.1.0(11)
...
建议使用 [MapEventManager.on(type: 'cameraMoveStart')](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-mapeventmanager.md) 。
**模型约束：** 此接口仅可在Stage模型下使用。
**元服务API：** 从版本4.1.0(11)开始，该接口支持在元服务中使用。
**系统能力：** SystemCapability.Map.Core
**起始版本：** 4.1.0(11)
...
| callback | Callback<number> | 是 | 回调函数，返回number。number表示相机改变的原因：1：地图上的用户手势2：用户交互产生的默认动画3：开发人员启动的动画 |
**示例：**
```typescript
...
建议使用 [MapEventManager.off(type: 'cameraMoveStart')](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-mapeventmanager.md) 。
**模型约束：** 此接口仅可在Stage模型下使用。
**元服务API：** 从版本4.1.0(11)开始，该接口支持在元服务中使用。
**系统能力：** SystemCapability.Map.Core
**起始版本：** 4.1.0(11)
...
建议使用 [MapEventManager.on(type: 'mapClick')](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-mapeventmanager.md) 。
**模型约束：** 此接口仅可在Stage模型下使用。
**元服务API：** 从版本4.1.0(11)开始，该接口支持在元服务中使用。
**系统能力：** SystemCapability.Map.Core
**起始版本：** 4.1.0(11)
...
| callback | Callback<[mapCommon.LatLng](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map-common.md)> | 是 | 回调函数，返回[mapCommon.LatLng](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map-common.md)。 |
**示例：**
```typescript
...
建议使用 [MapEventManager.off(type: 'mapClick')](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-mapeventmanager.md) 。
**模型约束：** 此接口仅可在Stage模型下使用。
**元服务API：** 从版本4.1.0(11)开始，该接口支持在元服务中使用。
**系统能力：** SystemCapability.Map.Core
**起始版本：** 4.1.0(11)
...
建议使用 [MapEventManager.on(type: 'mapLoad')](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-mapeventmanager.md) 。
**模型约束：** 此接口仅可在Stage模型下使用。
**元服务API：** 从版本4.1.0(11)开始，该接口支持在元服务中使用。
**系统能力：** SystemCapability.Map.Core
**起始版本：** 4.1.0(11)
...
建议使用 [MapEventManager.off(type: 'mapLoad')](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-mapeventmanager.md) 。
**模型约束：** 此接口仅可在Stage模型下使用。
**元服务API：** 从版本4.1.0(11)开始，该接口支持在元服务中使用。
**系统能力：** SystemCapability.Map.Core
**起始版本：** 4.1.0(11)
...
建议使用 [MapEventManager.on(type: 'mapLongClick')](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-mapeventmanager.md) 。
**模型约束：** 此接口仅可在Stage模型下使用。
**元服务API：** 从版本4.1.0(11)开始，该接口支持在元服务中使用。
**系统能力：** SystemCapability.Map.Core
**起始版本：** 4.1.0(11)
...
建议使用 [MapEventManager.off(type: 'mapLongClick')](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-mapeventmanager.md) 。
**模型约束：** 此接口仅可在Stage模型下使用。
**元服务API：** 从版本4.1.0(11)开始，该接口支持在元服务中使用。
**系统能力：** SystemCapability.Map.Core
**起始版本：** 4.1.0(11)
...
建议使用 [MapEventManager.on(type: 'myLocationButtonClick')](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-mapeventmanager.md) 。
**模型约束：** 此接口仅可在Stage模型下使用。
**元服务API：** 从版本4.1.0(11)开始，该接口支持在元服务中使用。
**系统能力：** SystemCapability.Map.Core
**起始版本：** 4.1.0(11)
...
建议使用 [MapEventManager.off(type: 'myLocationButtonClick')](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-mapeventmanager.md) 。
**模型约束：** 此接口仅可在Stage模型下使用。
**元服务API：** 从版本4.1.0(11)开始，该接口支持在元服务中使用。
**系统能力：** SystemCapability.Map.Core
**起始版本：** 4.1.0(11)
...
建议使用 [MapEventManager.on(type: 'myLocationClick')](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-mapeventmanager.md) 。
**模型约束：** 此接口仅可在Stage模型下使用。
**元服务API：** 从版本4.1.0(11)开始，该接口支持在元服务中使用。
**系统能力：** SystemCapability.Map.Core
**起始版本：** 4.1.0(11)
...
建议使用 [MapEventManager.off(type: 'myLocationClick')](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-mapeventmanager.md) 。
**模型约束：** 此接口仅可在Stage模型下使用。
**元服务API：** 从版本4.1.0(11)开始，该接口支持在元服务中使用。
**系统能力：** SystemCapability.Map.Core
**起始版本：** 4.1.0(11)
...
建议使用 [MapEventManager.on(type: 'poiClick')](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-mapeventmanager.md) 。
**模型约束：** 此接口仅可在Stage模型下使用。
**元服务API：** 从版本4.1.0(11)开始，该接口支持在元服务中使用。
**系统能力：** SystemCapability.Map.Core
**起始版本：** 4.1.0(11)
...
| callback | Callback<[mapCommon.Poi](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map-common.md)> | 是 | 回调函数，返回[mapCommon.Poi](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map-common.md)。 |
**示例：**
```typescript
...
建议使用 [MapEventManager.off(type: 'poiClick')](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-mapeventmanager.md) 。
**模型约束：** 此接口仅可在Stage模型下使用。
**元服务API：** 从版本4.1.0(11)开始，该接口支持在元服务中使用。
**系统能力：** SystemCapability.Map.Core
**起始版本：** 4.1.0(11)
...
建议使用 [MapEventManager.on(type: 'markerClick')](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-mapeventmanager.md) 。
**模型约束：** 此接口仅可在Stage模型下使用。
**元服务API：** 从版本4.1.0(11)开始，该接口支持在元服务中使用。
**系统能力：** SystemCapability.Map.Core
**起始版本：** 4.1.0(11)
...
| callback | Callback<[Marker](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-marker.md)> | 是 | 回调函数，返回[Marker](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-marker.md)。 |
**示例：**
```typescript
...
建议使用 [MapEventManager.off(type: 'markerClick')](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-mapeventmanager.md) 。
**模型约束：** 此接口仅可在Stage模型下使用。
**元服务API：** 从版本4.1.0(11)开始，该接口支持在元服务中使用。
**系统能力：** SystemCapability.Map.Core
**起始版本：** 4.1.0(11)
...
建议使用 [MapEventManager.on(type: 'markerDragStart')](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-mapeventmanager.md) 。
**模型约束：** 此接口仅可在Stage模型下使用。
**元服务API：** 从版本4.1.0(11)开始，该接口支持在元服务中使用。
**系统能力：** SystemCapability.Map.Core
**起始版本：** 4.1.0(11)
...
建议使用 [MapEventManager.off(type: 'markerDragStart')](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-mapeventmanager.md) 。
**模型约束：** 此接口仅可在Stage模型下使用。
**元服务API：** 从版本4.1.0(11)开始，该接口支持在元服务中使用。
**系统能力：** SystemCapability.Map.Core
**起始版本：** 4.1.0(11)
...
建议使用 [MapEventManager.on(type: 'markerDrag')](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-mapeventmanager.md) 。
**模型约束：** 此接口仅可在Stage模型下使用。
**元服务API：** 从版本4.1.0(11)开始，该接口支持在元服务中使用。
**系统能力：** SystemCapability.Map.Core
**起始版本：** 4.1.0(11)
...
建议使用 [MapEventManager.off(type: 'markerDrag')](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-mapeventmanager.md) 。
**模型约束：** 此接口仅可在Stage模型下使用。
**元服务API：** 从版本4.1.0(11)开始，该接口支持在元服务中使用。
**系统能力：** SystemCapability.Map.Core
**起始版本：** 4.1.0(11)
...
建议使用 [MapEventManager.on(type: 'markerDragEnd')](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-mapeventmanager.md) 。
**模型约束：** 此接口仅可在Stage模型下使用。
**元服务API：** 从版本4.1.0(11)开始，该接口支持在元服务中使用。
**系统能力：** SystemCapability.Map.Core
**起始版本：** 4.1.0(11)
...
建议使用 [MapEventManager.off(type: 'markerDragEnd')](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-mapeventmanager.md) 。
**模型约束：** 此接口仅可在Stage模型下使用。
**元服务API：** 从版本4.1.0(11)开始，该接口支持在元服务中使用。
**系统能力：** SystemCapability.Map.Core
**起始版本：** 4.1.0(11)
...
建议使用 [MapEventManager.on(type: 'circleClick')](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-mapeventmanager.md) 。
**模型约束：** 此接口仅可在Stage模型下使用。
**元服务API：** 从版本4.1.0(11)开始，该接口支持在元服务中使用。
**系统能力：** SystemCapability.Map.Core
**起始版本：** 4.1.0(11)
...
| callback | Callback<[MapCircle](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-mapcircle.md)> | 是 | 回调函数，返回[MapCircle](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-mapcircle.md)。 |
**示例：**
```typescript
...
建议使用 [MapEventManager.off(type: 'circleClick')](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-mapeventmanager.md) 。
**模型约束：** 此接口仅可在Stage模型下使用。
**元服务API：** 从版本4.1.0(11)开始，该接口支持在元服务中使用。
**系统能力：** SystemCapability.Map.Core
**起始版本：** 4.1.0(11)
...
建议使用 [MapEventManager.on(type: 'polylineClick')](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-mapeventmanager.md) 。
**模型约束：** 此接口仅可在Stage模型下使用。
**元服务API：** 从版本4.1.0(11)开始，该接口支持在元服务中使用。
**系统能力：** SystemCapability.Map.Core
**起始版本：** 4.1.0(11)
...
| callback | Callback<[MapPolyline](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-mappolyline.md)> | 是 | 回调函数，返回[MapPolyline](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-mappolyline.md)。 |
**示例：**
```typescript
...
建议使用 [MapEventManager.off(type: 'polylineClick')](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-mapeventmanager.md) 。
**模型约束：** 此接口仅可在Stage模型下使用。
**元服务API：** 从版本4.1.0(11)开始，该接口支持在元服务中使用。
**系统能力：** SystemCapability.Map.Core
**起始版本：** 4.1.0(11)
...
建议使用 [MapEventManager.on(type: 'polygonClick')](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-mapeventmanager.md) 。
**模型约束：** 此接口仅可在Stage模型下使用。
**元服务API：** 从版本4.1.0(11)开始，该接口支持在元服务中使用。
**系统能力：** SystemCapability.Map.Core
**起始版本：** 4.1.0(11)
...
| callback | Callback<[MapPolygon](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-mappolygon.md)> | 是 | 回调函数，返回[MapPolygon](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-mappolygon.md)。 |
**示例：**
```typescript
...
建议使用 [MapEventManager.off(type: 'polygonClick')](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-mapeventmanager.md) 。
**模型约束：** 此接口仅可在Stage模型下使用。
**元服务API：** 从版本4.1.0(11)开始，该接口支持在元服务中使用。
**系统能力：** SystemCapability.Map.Core
**起始版本：** 4.1.0(11)
...
建议使用 [MapEventManager.on(type: 'infoWindowClick')](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-mapeventmanager.md) 。
**模型约束：** 此接口仅可在Stage模型下使用。
**元服务API：** 从版本4.1.0(11)开始，该接口支持在元服务中使用。
**系统能力：** SystemCapability.Map.Core
**起始版本：** 4.1.0(11)
...
建议使用 [MapEventManager.off(type: 'infoWindowClick')](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-mapeventmanager.md) 。
**模型约束：** 此接口仅可在Stage模型下使用。
**元服务API：** 从版本4.1.0(11)开始，该接口支持在元服务中使用。
**系统能力：** SystemCapability.Map.Core
**起始版本：** 4.1.0(11)
...
建议使用 [MapEventManager.on(type: 'infoWindowClose')](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-mapeventmanager.md) 。
**模型约束：** 此接口仅可在Stage模型下使用。
**元服务API：** 从版本4.1.0(11)开始，该接口支持在元服务中使用。
**系统能力：** SystemCapability.Map.Core
**起始版本：** 4.1.0(11)
...
建议使用 [MapEventManager.off(type: 'infoWindowClose')](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-mapeventmanager.md) 。
**模型约束：** 此接口仅可在Stage模型下使用。
**元服务API：** 从版本4.1.0(11)开始，该接口支持在元服务中使用。
**系统能力：** SystemCapability.Map.Core
**起始版本：** 4.1.0(11)
...
建议使用 [MapEventManager.on(type: 'pointAnnotationClick')](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-mapeventmanager.md) 。
**模型约束：** 此接口仅可在Stage模型下使用。
**元服务API：** 从版本4.1.0(11)开始，该接口支持在元服务中使用。
**系统能力：** SystemCapability.Map.Core
**起始版本：** 4.1.0(11)
...
| callback | Callback<[PointAnnotation](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-pointannotation.md)> | 是 | 回调函数，返回[PointAnnotation](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-pointannotation.md)。 |
**示例：**
```typescript
...
建议使用 [MapEventManager.off(type: 'pointAnnotationClick')](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-mapeventmanager.md) 。
**模型约束：** 此接口仅可在Stage模型下使用。
**元服务API：** 从版本4.1.0(11)开始，该接口支持在元服务中使用。
**系统能力：** SystemCapability.Map.Core
**起始版本：** 4.1.0(11)
...
建议使用 [MapEventManager.on(type: 'bubbleClick')](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-mapeventmanager.md) 。
**模型约束：** 此接口仅可在Stage模型下使用。
**元服务API：** 从版本4.1.0(11)开始，该接口支持在元服务中使用。
**系统能力：** SystemCapability.Map.Core
**起始版本：** 4.1.0(11)
...
| callback | Callback<[Bubble](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-bubble.md)> | 是 | 回调函数，返回[Bubble](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-bubble.md)。 |
**示例：**
```typescript
...
建议使用 [MapEventManager.off(type: 'bubbleClick')](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-mapeventmanager.md) 。
**模型约束：** 此接口仅可在Stage模型下使用。
**元服务API：** 从版本4.1.0(11)开始，该接口支持在元服务中使用。
**系统能力：** SystemCapability.Map.Core
**起始版本：** 4.1.0(11)
...
建议使用 [MapEventManager.on(type: 'imageOverlayClick')](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-mapeventmanager.md) 。
**模型约束：** 此接口仅可在Stage模型下使用。
**元服务API：** 从版本5.0.0(12)开始，该接口支持在元服务中使用。
**系统能力：** SystemCapability.Map.Core
**起始版本：** 5.0.0(12)
...
| callback | Callback<[ImageOverlay](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-imageoverlay.md)> | 是 | 回调函数，返回[ImageOverlay](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-imageoverlay.md)。 |
**示例：**
```typescript
// 监听覆盖物点击事件的回调
...
建议使用 [MapEventManager.off(type: 'imageOverlayClick')](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-mapeventmanager.md) 。
**模型约束：** 此接口仅可在Stage模型下使用。
**元服务API：** 从版本5.0.0(12)开始，该接口支持在元服务中使用。
**系统能力：** SystemCapability.Map.Core
**起始版本：** 5.0.0(12)
...
| --- | --- | --- | --- |
| type | string | 是 | 'imageOverlayClick'：监听覆盖物点击事件。 |
| callback | Callback<[ImageOverlay](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-imageoverlay.md)> | 否 | 回调函数，返回[ImageOverlay](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-imageoverlay.md)，当不填时清除所有监听回调。 |
**示例：**
```typescript
let imageOverlayCallback: Callback<map.ImageOverlay> = (imageOverlay:map.ImageOverlay) => {
  console.info("imageOverlay:" + imageOverlay?.getId());
...
监听发生的异常。
建议使用 [MapEventManager.on(type: 'error')](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-mapeventmanager.md) 。
**模型约束：** 此接口仅可在Stage模型下使用。
**元服务API：** 从版本4.1.0(11)开始，该接口支持在元服务中使用。
**系统能力：** SystemCapability.Map.Core
**起始版本：** 4.1.0(11)
...
| callback | [ErrorCallback](D:/code/APIDevice/output/md_output/harmonyos-references/系统/基础功能/Basic Services Kit（基础服务）/ArkTS API/其他/js-apis-base.md) | 是 | 回调函数，监听异常事件的回调。 |
**示例：**
```typescript
...
建议使用 [MapEventManager.off(type: 'error')](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-mapeventmanager.md) 。
**模型约束：** 此接口仅可在Stage模型下使用。
**元服务API：** 从版本4.1.0(11)开始，该接口支持在元服务中使用。
**系统能力：** SystemCapability.Map.Core
**起始版本：** 4.1.0(11)
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| enabled | boolean | 是 | 是否启用室内图，默认关闭，异常值按照默认值处理。取值范围：true：启用室内图false：关闭室内图 |
**错误码：**
以下错误码的详细介绍请参见 [ArkTS API错误码](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map-errorcode.md) 。
| 错误码ID | 错误信息 |
| --- | --- |
...
| 类型 | 说明 |
| --- | --- |
| boolean | true：室内图为开启状态false：室内图为关闭状态 |
**错误码：**
以下错误码的详细介绍请参见 [ArkTS API错误码](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map-errorcode.md) 。
| 错误码ID | 错误信息 |
| --- | --- |
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| buildingId | string | 是 | 建筑物的ID。从[on('indoorMapEnter')](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-mapeventmanager.md)方法的回调函数中获得。 |
...
设置楼层调节控件的位置。需要先调用 [setIndoorMapEnabled](#section12159164214612) 方法来开启室内图功能，仅17级及以上地图层级可见室内图，仅18级及以上地图层级可见楼层调节控件。
**模型约束：** 此接口仅可在Stage模型下使用。
**元服务API：** 从版本6.0.0(20)开始，该接口支持在元服务中使用。
**系统能力：** SystemCapability.Map.Core
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| point | [mapCommon.MapPoint](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map-common.md) | 是 | 设置楼层调节控件的位置，单位：px。 |
**错误码：**
以下错误码的详细介绍请参见 [ArkTS API错误码](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map-errorcode.md) 。
| 错误码ID | 错误信息 |
| --- | --- |
