...
| --- | --- | --- | --- |
| type | string | 是 | 'cameraChange'：监听地图相机状态变化事件。 |
| callback | Callback<[mapCommon.LatLng](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map-common.md)> | 否 | 回调函数，返回[mapCommon.LatLng](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map-common.md)，取消监听地图相机状态变化事件。callback为空：取消所有callback回调。callback非空：取消指定的callback回调。 |
**示例：**
```typescript
let callback1 = (position: mapCommon.LatLng) => {
...
| callback | Callback<number> | 是 | 回调函数，返回number，监听相机移动开始事件。number表示相机改变的原因：1：地图上的用户手势2：用户交互产生的默认动画3：开发人员启动的动画 |
**示例：**
```typescript
...
| --- | --- | --- | --- |
| type | string | 是 | 'cameraMoveStart'：监听相机移动开始事件。 |
| callback | Callback<number> | 否 | 回调函数，取消监听相机移动开始事件。callback为空：取消所有callback回调。callback非空：取消指定的callback回调。number表示相机改变的原因：1：地图上的用户手势2：用户交互产生的默认动画3：开发人员启动的动画 |
**示例：**
```typescript
let callback1 = (reason: number) => {
...
| callback | Callback<[mapCommon.LatLng](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map-common.md)> | 是 | 回调函数，返回[mapCommon.LatLng](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map-common.md)，监听地图点击事件。 |
**示例：**
```typescript
let callback1 = (position: mapCommon.LatLng) => {
...
```
#### off('mapClick')
off(type: 'mapClick', callback?: Callback< [mapCommon.LatLng](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map-common.md) >): void
...
| --- | --- | --- | --- |
| type | string | 是 | 'mapClick'：监听地图点击事件。 |
| callback | Callback<[mapCommon.LatLng](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map-common.md)> | 否 | 回调函数，返回[mapCommon.LatLng](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map-common.md)，取消监听地图点击事件。callback为空：取消所有callback回调。callback非空：取消指定的callback回调。 |
**示例：**
```typescript
let callback1 = (position: mapCommon.LatLng) => {
...
| callback | Callback<[mapCommon.LatLng](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map-common.md)> | 是 | 回调函数，返回[mapCommon.LatLng](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map-common.md)，监听地图长按事件。 |
**示例：**
```typescript
let callback1 = (position: mapCommon.LatLng) => {
...
| --- | --- | --- | --- |
| type | string | 是 | 'mapLongClick'：监听地图长按事件。 |
| callback | Callback<[mapCommon.LatLng](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map-common.md)> | 否 | 回调函数，返回[mapCommon.LatLng](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map-common.md)，取消监听地图长按事件。callback为空：取消所有callback回调。callback非空：取消指定的callback回调。 |
**示例：**
```typescript
let callback1 = (position: mapCommon.LatLng) => {
...
| callback | Callback<[mapCommon.LatLng](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map-common.md)> | 是 | 回调函数，返回[mapCommon.LatLng](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map-common.md)，监听“我的位置”点击事件。 |
**示例：**
```typescript
let callback1 = (position: mapCommon.LatLng) => {
...
| --- | --- | --- | --- |
| type | string | 是 | 'myLocationClick'：监听“我的位置”点击事件。 |
| callback | Callback<[mapCommon.LatLng](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map-common.md)> | 否 | 回调函数，返回[mapCommon.LatLng](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map-common.md)，取消监听“我的位置”点击事件。callback为空：取消所有callback回调。callback非空：取消指定的callback回调。 |
**示例：**
```typescript
let callback1 = (position: mapCommon.LatLng) => {
...
| callback | Callback<[mapCommon.Poi](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map-common.md)> | 是 | 回调函数，返回[mapCommon.Poi](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map-common.md)，监听POI点击事件。 |
**示例：**
```typescript
...
| --- | --- | --- | --- |
| type | string | 是 | 'poiClick'：监听POI点击事件。 |
| callback | Callback<[mapCommon.Poi](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map-common.md)> | 否 | 回调函数，返回[mapCommon.Poi](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map-common.md)，取消监听POI点击事件。callback为空：取消所有callback回调。callback非空：取消指定的callback回调。 |
**示例：**
```typescript
let callback1 = (poi: mapCommon.Poi) => {
...
| callback | Callback<[Marker](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-marker.md)> | 是 | 回调函数，返回[Marker](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-marker.md)，监听标记点击事件。 |
**示例：**
```typescript
...
| --- | --- | --- | --- |
| type | string | 是 | 'markerClick'：监听标记点击事件。 |
| callback | Callback<[Marker](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-marker.md)> | 否 | 回调函数，返回[Marker](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-marker.md)，取消监听标记点击事件。callback为空：取消所有callback回调。callback非空：取消指定的callback回调。 |
**示例：**
```typescript
let callback1 = (marker: map.Marker) => {
...
| callback | Callback<[Marker](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-marker.md)> | 是 | 回调函数，返回[Marker](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-marker.md)，监听标记开始拖拽事件。 |
**示例：**
```typescript
let callback1 = (marker: map.Marker) => {
...
| --- | --- | --- | --- |
| type | string | 是 | 'markerDragStart'：监听标记开始拖拽事件。 |
| callback | Callback<[Marker](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-marker.md)> | 否 | 回调函数，返回[Marker](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-marker.md)，取消监听标记开始拖拽事件。callback为空：取消所有callback回调。callback非空：取消指定的callback回调。 |
**示例：**
```typescript
let callback1 = (marker: map.Marker) => {
...
| callback | Callback<[Marker](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-marker.md)> | 是 | 回调函数，返回[Marker](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-marker.md)，监听标记拖拽事件。 |
**示例：**
```typescript
let callback1 = (marker: map.Marker) => {
...
| --- | --- | --- | --- |
| type | string | 是 | 'markerDrag'：监听标记拖拽事件。 |
| callback | Callback<[Marker](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-marker.md)> | 否 | 回调函数，返回[Marker](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-marker.md)，取消监听标记拖拽事件。callback为空：取消所有callback回调。callback非空：取消指定的callback回调。 |
**示例：**
```typescript
let callback1 = (marker: map.Marker) => {
...
| callback | Callback<[Marker](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-marker.md)> | 是 | 回调函数，返回[Marker](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-marker.md)，监听标记拖拽结束事件。 |
**示例：**
```typescript
let callback1 = (marker: map.Marker) => {
...
| callback | Callback<[Marker](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-marker.md)> | 否 | 回调函数，返回[Marker](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-marker.md)，取消监听标记拖拽结束事件。callback为空：取消所有callback回调。callback非空：取消指定的callback回调。 |
**示例：**
```typescript
let callback1 = (marker: map.Marker) => {
...
| callback | Callback<[MapCircle](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-mapcircle.md)> | 是 | 回调函数，返回[MapCircle](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-mapcircle.md)，监听圆点击事件。 |
**示例：**
```typescript
...
| --- | --- | --- | --- |
| type | string | 是 | 'circleClick'：监听圆点击事件。 |
| callback | Callback<[MapCircle](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-mapcircle.md)> | 否 | 回调函数，返回[MapCircle](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-mapcircle.md)，取消监听圆点击事件。callback为空：取消所有callback回调。callback非空：取消指定的callback回调。 |
**示例：**
```typescript
let callback1 = (circle: map.MapCircle) => {
...
| callback | Callback<[MapPolyline](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-mappolyline.md)> | 是 | 回调函数，返回[MapPolyline](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-mappolyline.md)，监听折线点击事件。 |
**示例：**
```typescript
...
| --- | --- | --- | --- |
| type | string | 是 | 'polylineClick'：监听折线点击事件。 |
| callback | Callback<[MapPolyline](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-mappolyline.md)> | 否 | 回调函数，返回[MapPolyline](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-mappolyline.md)，取消监听折线点击事件。callback为空：取消所有callback回调。callback非空：取消指定的callback回调。 |
**示例：**
```typescript
let callback1 = (polyline: map.MapPolyline) => {
...
| callback | Callback<[MapPolygon](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-mappolygon.md)> | 是 | 回调函数，返回[MapPolygon](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-mappolygon.md)，监听多边形点击事件。 |
**示例：**
```typescript
...
| --- | --- | --- | --- |
| type | string | 是 | 'polygonClick'：监听多边形点击事件。 |
| callback | Callback<[MapPolygon](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-mappolygon.md)> | 否 | 回调函数，返回[MapPolygon](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-mappolygon.md)，取消监听多边形点击事件。callback为空：取消所有callback回调。callback非空：取消指定的callback回调。 |
**示例：**
```typescript
let callback1 = (polygon: map.MapPolygon) => {
...
| callback | Callback<[Marker](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-marker.md)> | 是 | 回调函数，返回[Marker](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-marker.md)，监听信息窗点击事件。 |
**示例：**
```typescript
...
```
#### off('infoWindowClick')
off(type: 'infoWindowClick', callback?: Callback< [Marker](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-marker.md) >): void
...
| --- | --- | --- | --- |
| type | string | 是 | 'infoWindowClick'：监听信息窗点击事件。 |
| callback | Callback<[Marker](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-marker.md)> | 否 | 回调函数，返回[Marker](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-marker.md)，取消监听信息窗点击事件。callback为空：取消所有callback回调。callback非空：取消指定的callback回调。 |
**示例：**
```typescript
let callback1 = (infoWindow: map.Marker) => {
...
| callback | Callback<[Marker](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-marker.md)> | 是 | 回调函数，返回[Marker](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-marker.md)，监听信息窗关闭事件。 |
**示例：**
```typescript
let callback1 = (infoWindow: map.Marker) => {
...
| --- | --- | --- | --- |
| type | string | 是 | 'infoWindowClose'：监听信息窗关闭事件。 |
| callback | Callback<[Marker](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-marker.md)> | 否 | 回调函数，返回[Marker](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-marker.md)，取消监听信息窗关闭事件。callback为空：取消所有callback回调。callback非空：取消指定的callback回调。 |
**示例：**
```typescript
let callback1 = (infoWindow: map.Marker) => {
...
| --- | --- | --- | --- |
| type | string | 是 | 'pointAnnotationClick'：监听点注释点击事件。 |
| callback | Callback<[PointAnnotation](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-pointannotation.md)> | 否 | 回调函数，返回[PointAnnotation](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-pointannotation.md)，取消监听点注释点击事件。callback为空：取消所有callback回调。callback非空：取消指定的callback回调。 |
**示例：**
```typescript
let callback1 = (pointAnnotation: map.PointAnnotation) => {
...
| callback | Callback<[Bubble](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-bubble.md)> | 是 | 回调函数，返回[Bubble](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-bubble.md)，监听气泡点击事件。 |
**示例：**
```typescript
...
| --- | --- | --- | --- |
| type | string | 是 | 'bubbleClick'：监听气泡点击事件。 |
| callback | Callback<[Bubble](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-bubble.md)> | 否 | 回调函数，返回[Bubble](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-bubble.md)，取消监听气泡点击事件。callback为空：取消所有callback回调。callback非空：取消指定的callback回调。 |
**示例：**
```typescript
let callback1 = (bubble: map.Bubble) => {
...
| callback | Callback<[ImageOverlay](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-imageoverlay.md)> | 是 | 回调函数，返回[ImageOverlay](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-imageoverlay.md)，监听覆盖物点击事件。 |
**示例：**
```typescript
...
| callback | [ErrorCallback](D:/code/APIDevice/output/md_output/harmonyos-references/系统/基础功能/Basic Services Kit（基础服务）/ArkTS API/其他/js-apis-base.md) | 是 | 回调函数，返回[ErrorCallback](D:/code/APIDevice/output/md_output/harmonyos-references/系统/基础功能/Basic Services Kit（基础服务）/ArkTS API/其他/js-apis-base.md)，监听异常事件。 |
**示例：**
```typescript
...
| --- | --- | --- | --- |
| type | string | 是 | 'error'：监听异常事件。 |
| callback | [ErrorCallback](D:/code/APIDevice/output/md_output/harmonyos-references/系统/基础功能/Basic Services Kit（基础服务）/ArkTS API/其他/js-apis-base.md) | 否 | 回调函数，返回[ErrorCallback](D:/code/APIDevice/output/md_output/harmonyos-references/系统/基础功能/Basic Services Kit（基础服务）/ArkTS API/其他/js-apis-base.md)，取消监听异常事件。callback为空：取消所有callback回调。callback非空：取消指定的callback回调。 |
**示例：**
```typescript
import { BusinessError } from '@kit.BasicServicesKit';
let callback1 = (error: BusinessError) => {
...
| callback | Callback<[IndoorMapInfo](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-indoormapinfo.md)> | 是 | 回调函数，返回[IndoorMapInfo](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-indoormapinfo.md)，监听室内图进入事件。 |
**错误码：**
...
| --- | --- | --- | --- |
| type | string | 是 | 'indoorMapEnter'：监听室内图进入事件。 |
| callback | Callback<[IndoorMapInfo](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-indoormapinfo.md)> | 否 | 回调函数，返回[IndoorMapInfo](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-indoormapinfo.md)，取消监听室内图进入事件。 |
**错误码：**
以下错误码的详细介绍请参见 [ArkTS API错误码](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map-errorcode.md) 。
| 错误码ID | 错误信息 |
| --- | --- |
...
| callback | [MassPointOverlayCallback](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-masspointoverlaycallback.md) | 是 | 回调函数，无返回结果的回调函数，监听海量点图层点击事件。 |
**示例：**
```typescript
// 初始化地图组件的监听事件管理接口
...
| callback | [MassPointOverlayCallback](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/map-map-masspointoverlaycallback.md) | 否 | 回调函数，无返回结果的回调函数，取消监听海量点图层点击事件。callback为空：取消所有callback回调。callback非空：取消指定的callback回调。 |
**示例：**
```typescript
// 初始化地图组件的监听事件管理接口
let mapEventManager = this.mapController.getEventManager();
