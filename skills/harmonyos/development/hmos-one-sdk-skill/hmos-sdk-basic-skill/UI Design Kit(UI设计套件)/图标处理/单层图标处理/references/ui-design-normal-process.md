...
适用于图标为单层资源，且图标展示风格要与华为HarmonyOS Design System设计风格一致的应用场景，典型应用场景可参考分层图标 [场景介绍](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/ui-design-layered-process) 。
#### 约束条件
单层图标处理支持Phone、Tablet、PC/2in1设备，并且从5.1.1(19)版本开始，新增支持TV设备。
#### 开发步骤
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/cd/v3/pgOZC0NlR8-o-ZXF1458ZQ/zh-cn_image_0000002659100265.png?HW-CC-KV=V1&HW-CC-Date=20260701T104729Z&HW-CC-Expire=86400&HW-CC-Sign=D7D196459B0B1A2BEDD0CE7BD6C7F15786AB4B2898E6AA340F94BBBBDB2DE1FD)
1.
在entry/src/main/resources/base/media下，配置一张图片资源normal_icon.png。
2.
将图标处理的相关类添加至工程。
```typescript
...
```
3.
简单配置页面的布局，调用 [单层图标接口](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ui-design-hdsdrawable) 获取处理后的图标信息，也可以调用 [异步批量处理接口](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ui-design-hdsdrawable) 。
```typescript
@Entry
@Component
struct Index{
