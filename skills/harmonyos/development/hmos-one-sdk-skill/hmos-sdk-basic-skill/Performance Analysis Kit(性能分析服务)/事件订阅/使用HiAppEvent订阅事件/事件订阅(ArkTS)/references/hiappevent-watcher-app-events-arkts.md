...
#### 接口说明
API接口使用说明，包括参数使用限制和具体取值范围。请参考 [@ohos.hiviewdfx.hiAppEvent](D:/code/APIDevice/output/md_output/harmonyos-references/系统/调测调优/Performance Analysis Kit（性能分析服务）/ArkTS API/js-apis-hiviewdfx-hiappevent.md) 。
**订阅接口功能介绍** ：
| 接口名 | 描述 |
| --- | --- |
| addWatcher(watcher: Watcher): AppEventPackageHolder | 添加应用的事件观察者。 |
| removeWatcher(watcher: Watcher): void | 移除应用的事件观察者。 |
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/6d/v3/tY08Tz3VTj6sM1bk4FhV0g/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260701T104938Z&HW-CC-Expire=86400&HW-CC-Sign=EEA73F7E02B6BCB068CE046D2977E4319429CB2A2AA5F0A70A00A5C8ABCA20AD)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/27/v3/VDumvtkITYuFzSU4agnM_Q/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260701T104938Z&HW-CC-Expire=86400&HW-CC-Sign=722917BF06101B0F7173596E72A27B607984EF902C399DDA1F595551A3D7D655)
