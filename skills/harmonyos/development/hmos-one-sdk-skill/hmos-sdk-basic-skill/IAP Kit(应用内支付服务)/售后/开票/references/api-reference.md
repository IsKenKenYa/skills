...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| context | common.[Context](D:/code/APIDevice/output/md_output/harmonyos-references/应用框架/Ability Kit（程序框架服务）/ArkTS API/接口依赖的元素及定义/application/js-apis-inner-application-context.md) | 是 | 上下文。建议使用[UIAbilityContext](D:/code/APIDevice/output/md_output/harmonyos-references/应用框架/Ability Kit（程序框架服务）/ArkTS API/接口依赖的元素及定义/application/js-apis-inner-application-uiabilitycontext.md)。 |
**返回值：**
| 类型 | 说明 |
| --- | --- |
...
**错误码** ：
以下错误码的详细介绍请参见
[ArkTS API错误码](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/IAP Kit（应用内支付服务）/ArkTS API/iap-error-code.md)
。
| 错误码ID | 错误信息 |
| --- | --- |
| 401 | Parameter error. |
...
**错误码** ：
以下错误码的详细介绍请参见 [ArkTS API错误码](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/IAP Kit（应用内支付服务）/ArkTS API/iap-error-code.md) 。
| 错误码ID | 错误信息 |
| --- | --- |
| 401 | Parameter error. |
| 1001860000 | The operation was canceled by the user. |
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| context | common.[UIAbilityContext](D:/code/APIDevice/output/md_output/harmonyos-references/应用框架/Ability Kit（程序框架服务）/ArkTS API/接口依赖的元素及定义/application/js-apis-inner-application-uiabilitycontext.md) | 是 | [UIAbility](D:/code/APIDevice/output/md_output/harmonyos-references/应用框架/Ability Kit（程序框架服务）/ArkTS API/Stage模型能力的接口/js-apis-app-ability-uiability.md)上下文。 |
| parameter | [QueryProductsParameter](#section1033653365917) | 是 | 包含请求信息的[QueryProductsParameter](#section1033653365917)对象。 |
**返回值：**
| 类型 | 说明 |
| --- | --- |
| Promise<Array<[Product](#section346874219313)>> | Promise对象，返回商品详情信息。 |
**错误码** ：
以下错误码的详细介绍请参见
[ArkTS API错误码](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/IAP Kit（应用内支付服务）/ArkTS API/iap-error-code.md)
。
...
| context | common.[UIAbilityContext](D:/code/APIDevice/output/md_output/harmonyos-references/应用框架/Ability Kit（程序框架服务）/ArkTS API/接口依赖的元素及定义/application/js-apis-inner-application-uiabilitycontext.md) | 是 | [UIAbility](D:/code/APIDevice/output/md_output/harmonyos-references/应用框架/Ability Kit（程序框架服务）/ArkTS API/Stage模型能力的接口/js-apis-app-ability-uiability.md)上下文。 |
| parameter | [QueryProductsParameter](#section1033653365917) | 是 | 包含请求信息的[QueryProductsParameter](#section1033653365917)对象。 |
| callback | AsyncCallback<Array<[Product](#section346874219313)>> | 是 | 回调函数。当查询成功时，err为undefined，data为获取到的Array<[Product](#section346874219313)>；否则为错误对象。 |
**错误码** ：
以下错误码的详细介绍请参见 [ArkTS API错误码](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/IAP Kit（应用内支付服务）/ArkTS API/iap-error-code.md) 。
| 错误码ID | 错误信息 |
| --- | --- |
...
| --- | --- | --- | --- |
| context | common.[UIAbilityContext](D:/code/APIDevice/output/md_output/harmonyos-references/应用框架/Ability Kit（程序框架服务）/ArkTS API/接口依赖的元素及定义/application/js-apis-inner-application-uiabilitycontext.md) | 是 | [UIAbility](D:/code/APIDevice/output/md_output/harmonyos-references/应用框架/Ability Kit（程序框架服务）/ArkTS API/Stage模型能力的接口/js-apis-app-ability-uiability.md)上下文。 |
| productIds | string[] | 是 | 待查询商品ID列表。商品ID必须已经在当前应用中创建且唯一。商品ID来源于开发者在[AppGallery Connect](https://developer.huawei.com/consumer/cn/service/josp/agc/index.html)中配置商品信息时设置的商品ID，请参见[配置商品信息](D:/code/APIDevice/output/md_output/harmonyos-guides/应用服务/IAP Kit（应用内支付服务）/开发准备/配置商品信息/iap-config-product.md)。说明：一次最多可查询200个商品，商品数量较多时建议分批查询。 |
**返回值：**
| 类型 | 说明 |
| --- | --- |
| Promise<Array<[Product](#section346874219313)>> | Promise对象，返回商品详情信息。 |
...
使用Promise异步回调。
**废弃说明：** 从4.1.0(11)开始废弃，建议使用 [createPurchase](#section18798154545516) 替代。
**模型约束：** 此接口仅可在Stage模型下使用。
**系统能力：** SystemCapability.Payment.IAP
...
| --- | --- | --- | --- |
| context | common.[UIAbilityContext](D:/code/APIDevice/output/md_output/harmonyos-references/应用框架/Ability Kit（程序框架服务）/ArkTS API/接口依赖的元素及定义/application/js-apis-inner-application-uiabilitycontext.md) | 是 | [UIAbility](D:/code/APIDevice/output/md_output/harmonyos-references/应用框架/Ability Kit（程序框架服务）/ArkTS API/Stage模型能力的接口/js-apis-app-ability-uiability.md)上下文。 |
| parameter | [PurchaseParameter](#section1340120344598) | 是 | 包含请求信息的[PurchaseParameter](#section1340120344598)对象。 |
**返回值：**
| 类型 | 说明 |
| --- | --- |
| Promise<[PurchaseResult](#section111613541391)> | Promise对象，返回购买结果。 |
**错误码** ：
以下错误码的详细介绍请参见
[ArkTS API错误码](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/IAP Kit（应用内支付服务）/ArkTS API/iap-error-code.md)
。
...
使用callback异步回调。
**废弃说明：** 从4.1.0(11)开始废弃，建议使用 [createPurchase](#section19694203910585) 替代。
**模型约束：** 此接口仅可在Stage模型下使用。
**系统能力：** SystemCapability.Payment.IAP
**设备行为差异：** 该接口在Phone、PC/2in1、Tablet设备中可正常调用，在其他设备中返回1001860001错误码。
**起始版本：** 4.0.0(10)
...
| context | common.[UIAbilityContext](D:/code/APIDevice/output/md_output/harmonyos-references/应用框架/Ability Kit（程序框架服务）/ArkTS API/接口依赖的元素及定义/application/js-apis-inner-application-uiabilitycontext.md) | 是 | [UIAbility](D:/code/APIDevice/output/md_output/harmonyos-references/应用框架/Ability Kit（程序框架服务）/ArkTS API/Stage模型能力的接口/js-apis-app-ability-uiability.md)上下文。 |
| parameter | [PurchaseParameter](#section1340120344598) | 是 | 包含请求信息的[PurchaseParameter](#section1340120344598)对象。 |
| callback | AsyncCallback<[PurchaseResult](#section111613541391)> | 是 | 回调函数。当购买成功时，err为undefined，data为获取到的[PurchaseResult](#section111613541391)对象；否则为错误对象。 |
**错误码** ：
以下错误码的详细介绍请参见
[ArkTS API错误码](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/IAP Kit（应用内支付服务）/ArkTS API/iap-error-code.md)
。
...
| 类型 | 说明 |
| --- | --- |
| Promise<[CreatePurchaseResult](#section193852021105111)> | Promise对象，返回购买结果。 |
**错误码** ：
以下错误码的详细介绍请参见
[ArkTS API错误码](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/IAP Kit（应用内支付服务）/ArkTS API/iap-error-code.md)
。
...
| context | common.[UIAbilityContext](D:/code/APIDevice/output/md_output/harmonyos-references/应用框架/Ability Kit（程序框架服务）/ArkTS API/接口依赖的元素及定义/application/js-apis-inner-application-uiabilitycontext.md) | 是 | [UIAbility](D:/code/APIDevice/output/md_output/harmonyos-references/应用框架/Ability Kit（程序框架服务）/ArkTS API/Stage模型能力的接口/js-apis-app-ability-uiability.md)上下文。 |
| parameter | [PurchaseParameter](#section1340120344598) | 是 | 包含请求信息的[PurchaseParameter](#section1340120344598)对象。 |
| callback | AsyncCallback<[CreatePurchaseResult](#section193852021105111)> | 是 | 回调函数。当购买成功时，err为undefined，data为获取到的[CreatePurchaseResult](#section193852021105111)对象；否则为错误对象。 |
**错误码** ：
以下错误码的详细介绍请参见
[ArkTS API错误码](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/IAP Kit（应用内支付服务）/ArkTS API/iap-error-code.md)
。
...
**废弃说明：** 从4.1.0(11)开始废弃，建议使用 [finishPurchase](#section124751324135814) 替代。
**模型约束：** 此接口仅可在Stage模型下使用。
**系统能力：** SystemCapability.Payment.IAP
**设备行为差异：** 该接口在Phone、PC/2in1、Tablet设备中可正常调用，在其他设备中返回1001860001错误码。
**起始版本：** 4.0.0(10)
...
| --- | --- | --- | --- |
| context | common.[UIAbilityContext](D:/code/APIDevice/output/md_output/harmonyos-references/应用框架/Ability Kit（程序框架服务）/ArkTS API/接口依赖的元素及定义/application/js-apis-inner-application-uiabilitycontext.md) | 是 | [UIAbility](D:/code/APIDevice/output/md_output/harmonyos-references/应用框架/Ability Kit（程序框架服务）/ArkTS API/Stage模型能力的接口/js-apis-app-ability-uiability.md)上下文。 |
| parameter | [ConsumePurchaseParameter](#section659703618597) | 是 | 包含请求信息的[ConsumePurchaseParameter](#section659703618597)对象。 |
**返回值：**
| 类型 | 说明 |
| --- | --- |
| Promise<[ConsumeResult](#section1343816549919)> | Promise对象，返回消耗结果。 |
**错误码** ：
以下错误码的详细介绍请参见
[ArkTS API错误码](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/IAP Kit（应用内支付服务）/ArkTS API/iap-error-code.md)
。
...
**废弃说明：** 从4.1.0(11)开始废弃，建议使用 [finishPurchase](#section2045683917408) 替代。
**模型约束：** 此接口仅可在Stage模型下使用。
**系统能力：** SystemCapability.Payment.IAP
**设备行为差异：** 该接口在Phone、PC/2in1、Tablet设备中可正常调用，在其他设备中返回1001860001错误码。
**起始版本：** 4.0.0(10)
...
| context | common.[UIAbilityContext](D:/code/APIDevice/output/md_output/harmonyos-references/应用框架/Ability Kit（程序框架服务）/ArkTS API/接口依赖的元素及定义/application/js-apis-inner-application-uiabilitycontext.md) | 是 | [UIAbility](D:/code/APIDevice/output/md_output/harmonyos-references/应用框架/Ability Kit（程序框架服务）/ArkTS API/Stage模型能力的接口/js-apis-app-ability-uiability.md)上下文。 |
| parameter | [ConsumePurchaseParameter](#section659703618597) | 是 | 包含请求信息的[ConsumePurchaseParameter](#section659703618597)对象。 |
| callback | AsyncCallback<[ConsumeResult](#section1343816549919)> | 是 | 回调函数。当消耗成功时，err为undefined，data为获取到的[ConsumeResult](#section1343816549919)对象；否则为错误对象。 |
**错误码** ：
以下错误码的详细介绍请参见
[ArkTS API错误码](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/IAP Kit（应用内支付服务）/ArkTS API/iap-error-code.md)
。
...
| --- | --- | --- | --- |
| context | common.[UIAbilityContext](D:/code/APIDevice/output/md_output/harmonyos-references/应用框架/Ability Kit（程序框架服务）/ArkTS API/接口依赖的元素及定义/application/js-apis-inner-application-uiabilitycontext.md) | 是 | [UIAbility](D:/code/APIDevice/output/md_output/harmonyos-references/应用框架/Ability Kit（程序框架服务）/ArkTS API/Stage模型能力的接口/js-apis-app-ability-uiability.md)上下文。 |
| parameter | [FinishPurchaseParameter](#section103714142118) | 是 | 包含请求信息的[FinishPurchaseParameter](#section103714142118)对象。 |
**返回值：**
| 类型 | 说明 |
| --- | --- |
| Promise<void> | Promise对象。无返回结果的Promise对象。 |
...
- 若查询消耗型商品，IAP仅返回用户已购未消耗的购买数据。若有购买数据返回，说明可能存在因某些异常而导致未进行发货的情况，需要应用判断是否已发货，未发货则需要进行补发货处理。开发者应用发货成功后调用[consumePurchase](#section754232910168)接口进行消耗。消耗成功的订单信息将不会在此接口返回，可通过[queryPurchaseRecords](#section69451529105019)接口获取。
- 若查询非消耗型商品，IAP返回用户所有已订购商品的购买数据。
使用Promise异步回调。
**废弃说明：** 从4.1.0(11)开始废弃，建议使用 [queryPurchases](#section1147122418532) 替代。
**模型约束：** 此接口仅可在Stage模型下使用。
**系统能力：** SystemCapability.Payment.IAP
**设备行为差异：** 该接口在Phone、PC/2in1、Tablet设备中可正常调用，在其他设备中返回1001860001错误码。
**起始版本：** 4.0.0(10)
...
| --- | --- | --- | --- |
| context | common.[UIAbilityContext](D:/code/APIDevice/output/md_output/harmonyos-references/应用框架/Ability Kit（程序框架服务）/ArkTS API/接口依赖的元素及定义/application/js-apis-inner-application-uiabilitycontext.md) | 是 | [UIAbility](D:/code/APIDevice/output/md_output/harmonyos-references/应用框架/Ability Kit（程序框架服务）/ArkTS API/Stage模型能力的接口/js-apis-app-ability-uiability.md)上下文。 |
| parameter | [QueryPurchasesParameter](#section555872993213) | 是 | 包含请求信息的[QueryPurchasesParameter](#section555872993213)对象。 |
**返回值：**
| 类型 | 说明 |
| --- | --- |
| Promise<[QueryPurchasesResult](#section7249204210514)> | Promise对象，返回查询的购买数据信息。 |
**错误码** ：
以下错误码的详细介绍请参见
[ArkTS API错误码](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/IAP Kit（应用内支付服务）/ArkTS API/iap-error-code.md)
。
...
查询用户已订购商品的购买数据，包括消耗型商品和非消耗型商品，一次请求只能查询一种类型的商品。
- 若查询消耗型商品，IAP仅返回用户已购未消耗的购买数据。若有购买数据返回，说明可能存在因某些异常而导致未进行发货的情况，需要应用判断是否已发货，未发货则需要进行补发货处理。开发者应用发货成功后调用[consumePurchase](#section754232910168)接口进行消耗。消耗成功的订单信息将不会在此接口返回，可通过[queryPurchaseRecords](#section1495292925012)接口获取。
- 若查询非消耗型商品，IAP返回用户所有已订购商品的购买数据。
使用callback异步回调。
**废弃说明：** 从4.1.0(11)开始废弃，建议使用 [queryPurchases](#section11799839122114) 替代。
**模型约束：** 此接口仅可在Stage模型下使用。
**系统能力：** SystemCapability.Payment.IAP
**设备行为差异：** 该接口在Phone、PC/2in1、Tablet设备中可正常调用，在其他设备中返回1001860001错误码。
**起始版本：** 4.0.0(10)
...
| context | common.[UIAbilityContext](D:/code/APIDevice/output/md_output/harmonyos-references/应用框架/Ability Kit（程序框架服务）/ArkTS API/接口依赖的元素及定义/application/js-apis-inner-application-uiabilitycontext.md) | 是 | [UIAbility](D:/code/APIDevice/output/md_output/harmonyos-references/应用框架/Ability Kit（程序框架服务）/ArkTS API/Stage模型能力的接口/js-apis-app-ability-uiability.md)上下文。 |
| parameter | [QueryPurchasesParameter](#section555872993213) | 是 | 包含请求信息的[QueryPurchasesParameter](#section555872993213)对象。 |
| callback | AsyncCallback<[QueryPurchasesResult](#section7249204210514)> | 是 | 回调函数。当查询成功时，err为undefined，data为获取到[QueryPurchasesResult](#section7249204210514)对象；否则为错误对象。 |
**错误码** ：
以下错误码的详细介绍请参见
[ArkTS API错误码](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/IAP Kit（应用内支付服务）/ArkTS API/iap-error-code.md)
。
...
| 类型 | 说明 |
| --- | --- |
| Promise<[QueryPurchasesResult](#section7249204210514)> | Promise对象，返回已执行过消耗操作的消耗型商品的购买数据。 |
**错误码** ：
以下错误码的详细介绍请参见
[ArkTS API错误码](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/IAP Kit（应用内支付服务）/ArkTS API/iap-error-code.md)
。
...
| 类型 | 说明 |
| --- | --- |
| Promise<[QueryPurchaseResult](#section820381425513)> | Promise对象，返回已购商品的订单信息。在沙盒场景下，已发货状态的非消耗型商品订单信息将不返回。 |
**错误码** ：
以下错误码的详细介绍请参见
[ArkTS API错误码](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/IAP Kit（应用内支付服务）/ArkTS API/iap-error-code.md)
。
...
| context | common.[UIAbilityContext](D:/code/APIDevice/output/md_output/harmonyos-references/应用框架/Ability Kit（程序框架服务）/ArkTS API/接口依赖的元素及定义/application/js-apis-inner-application-uiabilitycontext.md) | 是 | [UIAbility](D:/code/APIDevice/output/md_output/harmonyos-references/应用框架/Ability Kit（程序框架服务）/ArkTS API/Stage模型能力的接口/js-apis-app-ability-uiability.md)上下文。 |
| parameter | [QueryPurchasesParameter](#section555872993213) | 是 | 包含请求信息的[QueryPurchasesParameter](#section555872993213)对象。 |
| callback | AsyncCallback<[QueryPurchaseResult](#section820381425513)> | 是 | 回调函数。当查询成功时，err为undefined，data为获取到[QueryPurchaseResult](#section820381425513)对象；否则为错误对象。同时，在沙盒场景下，已发货状态的非消耗型商品订单信息将不返回。 |
**错误码** ：
以下错误码的详细介绍请参见
[ArkTS API错误码](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/IAP Kit（应用内支付服务）/ArkTS API/iap-error-code.md)
。
...
| --- | --- | --- | --- |
| context | common.[Context](D:/code/APIDevice/output/md_output/harmonyos-references/应用框架/Ability Kit（程序框架服务）/ArkTS API/接口依赖的元素及定义/application/js-apis-inner-application-context.md) | 是 | 上下文。建议使用[UIAbilityContext](D:/code/APIDevice/output/md_output/harmonyos-references/应用框架/Ability Kit（程序框架服务）/ArkTS API/接口依赖的元素及定义/application/js-apis-inner-application-uiabilitycontext.md)。 |
| uiParameter | [UIWindowParameter](#section12131915171317) | 是 | 包含界面窗口模式的[UIWindowParameter](#section12131915171317)对象。 |
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| context | common.[Context](D:/code/APIDevice/output/md_output/harmonyos-references/应用框架/Ability Kit（程序框架服务）/ArkTS API/接口依赖的元素及定义/application/js-apis-inner-application-context.md) | 是 | 上下文。 |
...
[queryProducts](#section55531442102518) 接口的请求参数。
**模型约束：** 此接口仅可在Stage模型下使用。
**元服务API：** 从版本5.0.0(12)开始，该接口支持在元服务中使用。
**系统能力：** SystemCapability.Payment.IAP
**起始版本：** 4.0.0(10)
| **名称** | **类型** | 只读 | 可选 | **说明** |
| --- | --- | --- | --- | --- |
| productType | [ProductType](#section59035422210) | 否 | 否 | 需要查询的商品类型。CONSUMABLE：消耗型商品NONCONSUMABLE：非消耗型商品AUTORENEWABLE：自动续期订阅商品NONRENEWABLE：非续期订阅商品 |
| productIds | string[] | 否 | 否 | 待查询商品ID列表。商品ID必须已经在当前应用中创建且唯一。商品ID来源于开发者在[AppGallery Connect](https://developer.huawei.com/consumer/cn/service/josp/agc/index.html)中配置商品信息时设置的商品ID，请参见[配置商品信息](D:/code/APIDevice/output/md_output/harmonyos-guides/应用服务/IAP Kit（应用内支付服务）/开发准备/配置商品信息/iap-config-product.md)。说明：一次查询最多支持200个商品，商品数量较多时建议分批查询。 |
#### Product
包含单个商品详细信息。
**模型约束：** 此接口仅可在Stage模型下使用。
**系统能力：** SystemCapability.Payment.IAP
...
| type | [ProductType](#section59035422210) | 否 | 否 | 商品类型。CONSUMABLE：消耗型商品NONCONSUMABLE：非消耗型商品AUTORENEWABLE：自动续期订阅商品NONRENEWABLE：非续期订阅商品**元服务API：**从版本5.0.0(12)开始，该接口支持在元服务中使用。 |
...
| localPrice | string | 否 | 是 | 商品的展示价格，包含商品币种和价格，格式为“币种+商品价格”，例如 EUR 0.15。部分国家/地区会返回“货币符号+商品价格”，例如中国境内（香港特别行政区、澳门特别行政区、中国台湾除外）返回“￥0.15”。此价格含税。可选。当商品为消耗型/非消耗型商品/非续期订阅商品，若设置促销价格，该字段为商品的促销价格，未设置则为商品原价。（促销价格能力已调整为[临时价格调整](https://developer.huawei.com/consumer/cn/doc/app/revise-non-subscription-0000001931836328#section1730052050)，临时价格调整场景下该字段为商品原价）当商品为自动续期订阅商品时，该字段为商品的原价。**起始版本：**4.1.0(11)**元服务API：**从版本5.0.0(12)开始，该接口支持在元服务中使用。 |
...
| status | [ProductStatus](#section2762171942710) | 否 | 是 | 商品状态。**起始版本：**5.0.0(12)**元服务API：**从版本5.0.0(12)开始，该接口支持在元服务中使用。 |
| subscriptionInfo | [SubscriptionInfo](#section151973366473) | 否 | 是 | 自动续期订阅商品相关的信息。可选。**起始版本：**4.1.0(11)**元服务API：**从版本5.0.0(12)开始，该接口支持在元服务中使用。 |
| promotionalOffers | [PromotionalOffer](#section446812293465)[] | 否 | 是 | 商品自定义人群优惠促销信息列表。**起始版本：**5.0.0(12)**元服务API：**从版本5.0.0(12)开始，该接口支持在元服务中使用。 |
...
| paymentMode | [OfferPaymentMode](#section23427243315) | 否 | 否 | 促销的付费方式 |
| periodUnit | [PeriodUnit](#section3468210113210) | 否 | 是 | 订阅周期单位。 |
...
| **名称** | **类型** | 只读 | 可选 | **说明** |
| --- | --- | --- | --- | --- |
| periodUnit | [PeriodUnit](#section3468210113210) | 否 | 否 | 订阅周期单位。 |
| periodCount | number | 否 | 否 | 订阅周期数量。 |
| groupId | string | 否 | 否 | 订阅组ID。 |
| groupLevel | number | 否 | 否 | 商品的订阅等级。 |
| hasEligibilityForIntroOffer | boolean | 否 | 是 | 用户是否享受过推介促销。取值如下：true：已享受过false：未享受过其他：未获取到状态 |
| introductoryOffer | [SubscriptionOffer](#section16479185319413) | 否 | 是 | 促销信息。 |
#### SubscriptionOffer
促销信息。
**模型约束：** 此接口仅可在Stage模型下使用。
**元服务API：** 从版本5.0.0(12)开始，该接口支持在元服务中使用。
...
| offerType | [OfferType](#section131398372313) | 否 | 否 | 促销类型。 |
#### PurchaseParameter
[purchase](#section107784425446) 接口和 [createPurchase](#section18798154545516) 接口的请求参数。
**模型约束：** 此接口仅可在Stage模型下使用。
**元服务API：** 从版本5.0.0(12)开始，该接口支持在元服务中使用。
**系统能力：** SystemCapability.Payment.IAP
**起始版本：** 4.0.0(10)
| **名称** | **类型** | 只读 | 可选 | **说明** |
| --- | --- | --- | --- | --- |
| productId | string | 否 | 否 | 待支付的商品ID。商品ID来源于开发者在[AppGallery Connect](https://developer.huawei.com/consumer/cn/service/josp/agc/index.html)中配置商品信息时设置的“商品ID”，具体请参见[配置商品信息](D:/code/APIDevice/output/md_output/harmonyos-guides/应用服务/IAP Kit（应用内支付服务）/开发准备/配置商品信息/iap-config-product.md)。 |
| productType | [ProductType](#section59035422210) | 否 | 否 | 需要查询的商品类型。CONSUMABLE：消耗型商品NONCONSUMABLE：非消耗型商品AUTORENEWABLE：自动续期订阅商品NONRENEWABLE：非续期订阅商品 |
...
| promotionalOfferId | string | 否 | 是 | 优惠ID。优惠ID来源于开发者为商品[配置优惠促销](D:/code/APIDevice/output/md_output/harmonyos-guides/应用服务/IAP Kit（应用内支付服务）/商品购买/自动续期订阅商品购买/自动续期订阅说明/iap-subscription-functions.md)时设置的促销优惠标志符。传递该字段且要生效，需同时在jwsRepresentation字段中传递促销优惠信息。**起始版本：**5.0.0(12) |
| applicationUserName | string | 否 | 是 | 用户账户相关联的混淆字符串，唯一标识用户。传递优惠ID场景，可以传递该字段。**起始版本：**5.0.0(12) |
| jwsRepresentation | string | 否 | 是 | 包含购买参数信息的JWS格式签名数据。购买参数，如优惠促销等。详细说明见[生成优惠签名购买参数](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/IAP Kit（应用内支付服务）/REST API/iap-server-subscribe-offer-sign.md)。**起始版本：**5.0.0(12) |
| quantity | number | 否 | 是 | 购买参数。表示所购买消耗型/非续期订阅商品的数量，需满足以下限制。一次仅针对单商品类型，不支持不同类型混合一次请求数量不超过10个注意：如果开发者使用了quantity参数以支持商品的批量购买，则需要在发货时校验下单的商品数量和最终发货商品数量是否一致，避免造成漏发、多发的情况。**元服务API：**从版本5.0.3(15)开始，该接口支持在元服务中使用。**起始版本：**5.0.3(15) |
#### PurchaseResult(deprecated)
[purchase](#section107784425446) 接口的返回结果。
**废弃说明：** 从4.1.0(11)开始废弃。
**模型约束：** 此接口仅可在Stage模型下使用。
**系统能力：** SystemCapability.Payment.IAP
**起始版本：** 4.0.0(10)
| **名称** | **类型** | 只读 | 可选 | **说明** |
| --- | --- | --- | --- | --- |
| inAppPurchaseData | string | 否 | 否 | 订单数据的JSON字符串，包含的参数请参见[InAppPurchaseData](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/IAP Kit（应用内支付服务）/ArkTS API/iap-data-model.md)。 |
| signature | string | 否 | 否 | 返回使用IAP私钥签署paymentData字符串生成的签名字符串。 |
| signatureAlgorithm | string | 否 | 否 | 签名算法，固定为SHA256WithRSA/PSS。 |
#### CreatePurchaseResult
[createPurchase](#section18798154545516) 接口的返回结果。
**模型约束：** 此接口仅可在Stage模型下使用。
**元服务API：** 从版本5.0.0(12)开始，该接口支持在元服务中使用。
**系统能力：** SystemCapability.Payment.IAP
**起始版本：** 4.1.0(11)
| **名称** | **类型** | 只读 | 可选 | **说明** |
| --- | --- | --- | --- | --- |
| purchaseData | string | 否 | 否 | 包含支付结果的JSON字符串，包含的参数请参见[PurchaseData](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/IAP Kit（应用内支付服务）/ArkTS API/iap-data-model.md)。 |
#### ConsumePurchaseParameter(deprecated)
[consumePurchase](#section754232910168) 接口的请求参数。
**废弃说明：** 从4.1.0(11)开始废弃。
**模型约束：** 此接口仅可在Stage模型下使用。
**系统能力：** SystemCapability.Payment.IAP
**起始版本：** 4.0.0(10)
| **名称** | **类型** | 只读 | 可选 | **说明** |
| --- | --- | --- | --- | --- |
| purchaseToken | string | 否 | 否 | 用户购买商品的标识，在支付完成时由IAP服务器生成。说明：purchaseToken需从购买数据[InAppPurchaseData](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/IAP Kit（应用内支付服务）/ArkTS API/iap-data-model.md)中获取。支付成功或者请求[queryOwnedPurchases](#section78016131463)接口均会返回[InAppPurchaseData](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/IAP Kit（应用内支付服务）/ArkTS API/iap-data-model.md)的JSON字符串。 |
| developerChallenge | string | 否 | 是 | 开发者自定义的挑战字，唯一标识此次消耗请求。消耗成功后此挑战字会记录在购买数据中并返回。说明：该参数长度限制为[0, 64]。 |
#### ConsumeResult(deprecated)
[consumePurchase](#section754232910168) 接口的返回结果。
**废弃说明：** 从4.1.0(11)开始废弃。
**模型约束：** 此接口仅可在Stage模型下使用。
**系统能力：** SystemCapability.Payment.IAP
**起始版本：** 4.0.0(10)
| **名称** | **类型** | 只读 | 可选 | **说明** |
| --- | --- | --- | --- | --- |
| consumedPurchaseData | string | 否 | 否 | 包含消耗结果数据的JSON字符串。字符串中包含参数请参见[InAppPurchaseData](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/IAP Kit（应用内支付服务）/ArkTS API/iap-data-model.md)。 |
| signature | string | 否 | 否 | 使用IAP私钥签署消耗数据consumedPurchaseData生成的签名字符串。签名算法请参考signatureAlgorithm字段。应用在收到此签名字符串后，请参见[对返回结果验签](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/IAP Kit（应用内支付服务）/REST API/iap-verifying-signature.md)对consumedPurchaseData的JSON字符串进行验签。 |
| signatureAlgorithm | string | 否 | 否 | 签名算法，固定为SHA256WithRSA/PSS。 |
#### FinishPurchaseParameter
[finishPurchase](#section124751324135814) 接口请求参数。
**模型约束：** 此接口仅可在Stage模型下使用。
**元服务API：** 从版本5.0.0(12)开始，该接口支持在元服务中使用。
**系统能力：** SystemCapability.Payment.IAP
**起始版本：** 4.1.0(11)
| **名称** | **类型** | 只读 | 可选 | **说明** |
| --- | --- | --- | --- | --- |
| productType | [ProductType](#section59035422210) | 否 | 否 | 商品类型。CONSUMABLE：消耗型商品NONCONSUMABLE：非消耗型商品AUTORENEWABLE：自动续期订阅商品NONRENEWABLE：非续期订阅商品 |
| purchaseToken | string | 否 | 否 | 购买订单中返回的购买token。单次购买中与具体购买订单一一对应；订阅购买中与订阅Id一一对应。说明：purchaseToken需从购买数据[PurchaseOrderPayload](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/IAP Kit（应用内支付服务）/ArkTS API/iap-data-model.md)中获取。请求[createPurchase](#section18798154545516)或[queryPurchases](#section1147122418532)接口均会返回[PurchaseOrderPayload](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/IAP Kit（应用内支付服务）/ArkTS API/iap-data-model.md)。 |
| purchaseOrderId | string | 否 | 否 | 购买订单中返回的购买订单ID。最大长度256。说明：purchaseOrderId需从购买数据[PurchaseOrderPayload](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/IAP Kit（应用内支付服务）/ArkTS API/iap-data-model.md)中获取。请求[createPurchase](#section18798154545516)或[queryPurchases](#section1147122418532)接口均会返回[PurchaseOrderPayload](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/IAP Kit（应用内支付服务）/ArkTS API/iap-data-model.md)。 |
#### QueryPurchasesParameter
[queryOwnedPurchases](#section78016131463) 、 [queryPurchaseRecords](#section69451529105019) 和 [queryPurchases](#section1147122418532) 接口的请求参数。
**模型约束：** 此接口仅可在Stage模型下使用。
**元服务API：** 从版本5.0.0(12)开始，该接口支持在元服务中使用。
**系统能力：** SystemCapability.Payment.IAP
**起始版本：** 4.0.0(10)
...
| queryType | [PurchaseQueryType](#section1389262216514) | 否 | 是 | 查询类型。默认值为UNFINISHED。ALL：消耗型商品、非消耗型商品、自动续期订阅商品和非续期订阅商品的所有购买记录。UNFINISHED：已购买但未交付的消耗型商品、非消耗型商品、自动续期订阅商品和非续期订阅商品。CURRENT_ENTITLEMENT：购买的非消耗型商品或当前有效的自动续期订阅商品。说明：[queryOwnedPurchases](#section78016131463)、[queryPurchaseRecords](#section69451529105019)场景无需关注此字段。**起始版本：**4.1.0(11) |
#### QueryPurchasesResult(deprecated)
[queryOwnedPurchases](#section78016131463) 和 [queryPurchaseRecords](#section69451529105019) 接口的返回结果。
**废弃说明：** 从4.1.0(11)开始废弃。
**模型约束：** 此接口仅可在Stage模型下使用。
**系统能力：** SystemCapability.Payment.IAP
**起始版本：** 4.0.0(10)
...
| inAppPurchaseDataList | string[] | 否 | 否 | 该字段以JSON字符串的形式记录[InAppPurchaseData](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/IAP Kit（应用内支付服务）/ArkTS API/iap-data-model.md)的数据，用于配合inAppSignatureList验签。每个JSON字符串包含的参数请参见[InAppPurchaseData](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/IAP Kit（应用内支付服务）/ArkTS API/iap-data-model.md)。 |
| inAppSignatureList | string[] | 否 | 否 | 对应inAppPurchaseDataList中每一个字符串的签名字符串。过程中使用IAP私钥签署，签名算法请参考signatureAlgorithm字段。应用需要对inAppPurchaseDataList中的每个JSON字符串都进行验签，验签方法请参见[对返回结果验签](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/IAP Kit（应用内支付服务）/REST API/iap-verifying-signature.md)。 |
...
| signatureAlgorithm | string | 否 | 否 | 签名算法，固定为SHA256WithRSA/PSS。 |
#### QueryPurchaseResult
[queryPurchases](#section1147122418532) 接口的返回结果。
**模型约束：** 此接口仅可在Stage模型下使用。
**元服务API：** 从版本5.0.0(12)开始，该接口支持在元服务中使用。
**系统能力：** SystemCapability.Payment.IAP
**起始版本：** 4.1.0(11)
| **名称** | **类型** | 只读 | 可选 | **说明** |
| --- | --- | --- | --- | --- |
| purchaseDataList | string[] | 否 | 否 | [PurchaseData](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/IAP Kit（应用内支付服务）/ArkTS API/iap-data-model.md)字符串的数组。 |
| continuationToken | string | 否 | 是 | 支持分页查询的数据定位标志。如果用户拥有的商品数量非常大，当响应中存在continuationToken时，应用必须对当前方法发起另一个调用，并传入本次接收到的continuationToken。如果商品仍未查完，仍需要继续发起调用，直到不再返回continuationToken，表示已经返回全部商品。 |
#### UIWindowParameter
[iap.showManagedSubscriptions](#section39973360502) 接口界面窗口参数。
**模型约束：** 此接口仅可在Stage模型下使用。
**元服务API：** 从版本5.0.0(12)开始，该接口支持在元服务中使用。
**系统能力：** SystemCapability.Payment.IAP
**起始版本：** 5.0.0(12)
| **名称** | **类型** | 只读 | 可选 | **说明** |
| --- | --- | --- | --- | --- |
| windowScreenMode | [WindowScreenMode](#section15231134814464) | 否 | 否 | 界面窗口模式。DIALOG_BOX：弹窗模式FULLSCREEN：全屏模式 |