...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f2/v3/C8FbERnyTiKsQdaTuUOkGQ/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260401T093302Z&HW-CC-Expire=86400&HW-CC-Sign=D78C87AE19585752F6834029F62270F1F5F3D0ACC6BBE97CB5BC8C8791E1261B)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/66/v3/N09ZhQYmR1KfPlqbaImU2A/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260401T093302Z&HW-CC-Expire=86400&HW-CC-Sign=523584AC4844C89C2D5C1878E73CFE8B7F91BBF5B14A40090B5C950BDE5FC65C)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/4d/v3/JOGmMcnOTAmz1r_t8CtPMA/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260401T093302Z&HW-CC-Expire=86400&HW-CC-Sign=F35248F2D61A097FA421B5D7DF9A1485823ACF2B45255AC5DF102B987D90F82D)
-
...
**错误码：**
以下错误码的详细介绍请参见 [网络连接管理错误码](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Network Kit（网络服务）/错误码/errorcode-net-connection.md) 和 [通用错误码](D:/code/APIDevice/output/md_output/harmonyos-references/API参考概述/errorcode-universal.md) 。
| 错误码ID | 错误信息 |
| --- | --- |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a6/v3/u9Qu8PmoT-KnsEc4pcUpjA/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260401T093302Z&HW-CC-Expire=86400&HW-CC-Sign=3F953AC61AEF05DD22BD2B7CFF2631D4C5E36A8EE2AE48261E915AC9BF28AE15)
-
系统默认使用的网络，该网络的capabilities必须具备 [NET_CAPABILITY_INTERNET](#netcap) 且不是VPN类型的网络。
-
该接口的返回由系统决定，与应用是否指定网络无关。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/7c/v3/zjIri7dsQFeJX_rlqzpFkw/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260401T093302Z&HW-CC-Expire=86400&HW-CC-Sign=1DF722031E491070C3CDDB07362179AAC2C1A7FC087727C1CFA29AF1EFA37798)
-
系统默认使用的网络，该网络的capabilities必须具备 [NET_CAPABILITY_INTERNET](#netcap) 且不是VPN类型的网络。
-
该接口的返回由系统决定，与应用是否指定网络无关。
...
设置应用级Http代理配置信息。
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/85/v3/cn_CdOw8TcGb63YdziNKuA/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260401T093302Z&HW-CC-Expire=86400&HW-CC-Sign=428D9F56274ED7F6953C99552E3C41FAA86456C3C9F265590130819D09BED02D)
若需使用本接口所配置的代理信息，则需在 [HttpRequestOptions](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Network Kit（网络服务）/ArkTS API/js-apis-http.md) 字段中将usingProxy设置为true以启用代理转发。本接口仅负责配置代理规则，不校验代理服务的有效性。
**系统能力** ：SystemCapability.Communication.NetManager.Core
**参数：**
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/3e/v3/oD-LtuUiR6y55233h6BsxQ/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260401T093302Z&HW-CC-Expire=86400&HW-CC-Sign=078A4289FEE0A6BB6DEBE813F8F0A0FB31B84E18D9AA06AA9CA9CE9BA5EE0AE4)
...
**错误码：**
以下错误码的详细介绍请参见 [网络连接管理错误码](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Network Kit（网络服务）/错误码/errorcode-net-connection.md) 。
| 错误码ID | 错误信息 |
| --- | --- |
| 2100002 | Failed to connect to the service. |
| 2100003 | System internal error. |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/6c/v3/qXmERSYxQJWMkWgyRctCQQ/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260401T093302Z&HW-CC-Expire=86400&HW-CC-Sign=16DD61886A43AABC561D3D835962229E6B75894C967D636FCF9A9F1054F3A9D9)
- 如果设置了全局代理，则返回全局代理配置信息。
- 如果进程使用[setAppNet](#connectionsetappnet9)绑定到指定[NetHandle](#nethandle)对应的网络，则返回[NetHandle](#nethandle)对应网络的代理配置信息。在其它情况下，将返回默认网络的代理配置信息。
**系统能力** ：SystemCapability.Communication.NetManager.Core
**返回值：**
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/2a/v3/gcimMugFTGq4vK08K8lt6Q/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260401T093302Z&HW-CC-Expire=86400&HW-CC-Sign=1DE9D9850266FADB66CA723CFE4F1AB1FE3E41E5773B126201971D2099CD85B6)
...
| --- | --- | --- | --- |
| netHandle | [NetHandle](#nethandle) | 是 | 网络句柄。 |
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/57/v3/_MX3HQQJQGK-5AxLSvAf5A/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260401T093302Z&HW-CC-Expire=86400&HW-CC-Sign=F788C711A3AED7948089D179E8C268097A56F36B14D9A9F76E75943625FC2CD2)
如需解除App和指定网络的绑定关系，可以调用 [setAppNet](#connectionsetappnet9) ，并传入一个netId = 0的NetHandle对象，参考以下示例。
```
connection.getDefaultNet().then((netHandle: connection.NetHandle) => {
  netHandle.netId = 0;
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback<Array<[NetHandle](#nethandle)>> | 是 | 回调函数。当成功获取所有处于连接状态的网络列表时，error为undefined，data为处于激活状态的网络列表；否则为错误对象。**说明：**在Wi-Fi和蜂窝数据开关均开启的情况下，若无应用指定使用蜂窝网络，则仅激活Wi-Fi网络，因此仅返回Wi-Fi的NetHandle。除非有特定应用启动蜂窝网络，才能同时获取Wi-Fi和蜂窝数据的NetHandle。 |
**错误码：**
以下错误码的详细介绍请参见 [网络连接管理错误码](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Network Kit（网络服务）/错误码/errorcode-net-connection.md) 和 [通用错误码](D:/code/APIDevice/output/md_output/harmonyos-references/API参考概述/errorcode-universal.md) 。
| 错误码ID | 错误信息 |
| --- | --- |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d2/v3/LHAOHAz2QdaaO81Qa8S6Vw/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260401T093302Z&HW-CC-Expire=86400&HW-CC-Sign=A76B9EEF7CB212DBBAE12A96E090D17033507D36DC50F040B20DBA82A0C74CEA)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/73/v3/s6WhKCvHSCqR4CZuGr4pDw/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260401T093302Z&HW-CC-Expire=86400&HW-CC-Sign=02CA96180B72EE17D81205E160166A0F1BBD2F22DD7FE5259E474BE005029F21)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/9d/v3/FE8tMxteQUS_vMh5I3hCtA/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260401T093302Z&HW-CC-Expire=86400&HW-CC-Sign=C0589D9E12CC1283A4F172E6140CD90876AA57187CE66A5A9975174FA920F858)
不需要时可调用 [removeCustomDnsRule](#connectionremovecustomdnsrule11) 删除某一条自定义规则或调用 [clearCustomDnsRules](#connectionclearcustomdnsrules11) 删除当前应用程序的所有的自定义DNS规则 。
**需要权限** ：ohos.permission.INTERNET
**元服务API：** 从API version 15开始，该接口支持在元服务中使用。
**系统能力** ：SystemCapability.Communication.NetManager.Core
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d4/v3/PtL2kiqRTcmR8nYGiIM5vA/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260401T093302Z&HW-CC-Expire=86400&HW-CC-Sign=6D39D06B20C6079D94C5F296C456A4DFB061E266A9C90CC6BD7EFD135F427952)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b0/v3/576Ba2P0Rv2WLF1y-WGYMw/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260401T093302Z&HW-CC-Expire=86400&HW-CC-Sign=952E31AD8A2A2DD5E368D1FBB1989DA27E0EA72517496D46BE302CB136594B68)
可调用 [addCustomDnsRule](#connectionaddcustomdnsrule11) 添加自定义规则。
**需要权限** ：ohos.permission.INTERNET
**元服务API：** 从API version 15开始，该接口支持在元服务中使用。
**系统能力** ：SystemCapability.Communication.NetManager.Core
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/9d/v3/QP5CgVkRSV6bAZgekAQQcA/caution_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260401T093302Z&HW-CC-Expire=86400&HW-CC-Sign=2C4B43F7AC5A2A665426C750F18F54ACBE6CABCC66194FC0D40F2798770DD6EF)
1、本接口当前只在PC设备上支持解析脚本并启用PAC代理能力，其他设备类型上只保存脚本地址，不会启用PAC代理能力。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/83/v3/2L4naYTdR_i_cBGxS26kww/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260401T093302Z&HW-CC-Expire=86400&HW-CC-Sign=50C6011151997064232A90EC09BB9C29F7E933128F26EA45E1D52FE4D7B68D69)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/aa/v3/lM8DCKzzT8Ood_a0-fC6Lg/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260401T093302Z&HW-CC-Expire=86400&HW-CC-Sign=D2FEA49EE81D51AE3B87397C554401DB64F0D962887B1F781BE432D3973BD37C)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/dc/v3/_VRaROVAQSCLaGebR3iX1A/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260401T093302Z&HW-CC-Expire=86400&HW-CC-Sign=577D8A29DB3A83A9009CB354B21BF9D202E0975CB7E566F66E85F9DBCF67966E)
该接口所需的权限目前仅支持PC设备。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ae/v3/lj2w2U7xRgOF-3gwBw2GvQ/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260401T093302Z&HW-CC-Expire=86400&HW-CC-Sign=387AD190C977A17DA6922CDECEF521372E942B3E46EBC66844FCACE627B8F3BC)
该接口所需的权限目前仅支持PC设备。
**需要权限** ：ohos.permission.SET_NET_EXT_ATTRIBUTE
**系统能力** ：SystemCapability.Communication.NetManager.Core
**参数：**
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/2e/v3/fIedJSgBSWeTMHcdOKhbnQ/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260401T093302Z&HW-CC-Expire=86400&HW-CC-Sign=2249DAF868CF8F34F45A18ADB69C8438CE58A2B3DDE5C3817F62CA0BCD9DC562)
...
#### NetConnection
网络连接对象类型。
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a9/v3/WhswRzbsRuSOOemKVjxCxA/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260401T093302Z&HW-CC-Expire=86400&HW-CC-Sign=65BD0EC1047A4738E4F101CB69AE97BE26F3234689765B239704D88CCFD43C9A)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/12/v3/kkgUGoXOTdy0T9VDJZ6aWg/caution_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260401T093302Z&HW-CC-Expire=86400&HW-CC-Sign=13CE89EA35E285228BB30188D6F9245C13303B723485E340F85BDBDDE30ADEA8)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| socketParam | [TCPSocket](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Network Kit（网络服务）/ArkTS API/js-apis-socket.md)|[UDPSocket](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Network Kit（网络服务）/ArkTS API/js-apis-socket.md) | 是 | 待绑定的TCPSocket或UDPSocket对象。 |
...
| NET_CAPABILITY_VALIDATED | 16 | 表示网络管理通过该网络与华为云地址成功建立连接，此能力由网络管理模块设置。**注意：**网络管理可能会与华为云地址建立连接失败，导致网络能力不具备此标记位，但不完全代表该网络无法访问互联网。另外，对于新完成连接的网络，由于网络正在进行连通性验证，此值可能无法反映真实的验证结果。对此，应用可以通过NET_CAPABILITY_CHECKING_CONNECTIVITY12+检查网络是否正在检测连通性。**元服务API：**从API version 11开始，该接口支持在元服务中使用。 |
| NET_CAPABILITY_PORTAL12+ | 17 | 表示系统发现该网络存在强制网络门户，需要用户登陆认证，该能力由网络管理模块设置。**元服务API：**从API version 12开始，该接口支持在元服务中使用。 |
| NET_CAPABILITY_CHECKING_CONNECTIVITY12+ | 31 | 表示网络管理正在检验当前网络的连通性，此值会在网络连接时设置。当此值存在时，NET_CAPABILITY_VALIDATED的值不准确，连通性检测结束后不再设置，此时可以通过判断NetCap是否包含NET_CAPABILITY_VALIDATED判断连通性。**元服务API：**从API version 12开始，该接口支持在元服务中使用。 |
#### NetBearType
网络类型。
**系统能力** ：SystemCapability.Communication.NetManager.Core
| 名称 | 值 | 说明 |
...
| BEARER_BLUETOOTH12+ | 2 | 蓝牙网络。**元服务API：**从API version 12开始，该接口支持在元服务中使用。 |
...
| networkCap | Array<[NetCap](#netcap)> | 否 | 是 | 网络具体能力。**元服务API：**从API version 11开始，该接口支持在元服务中使用。 |
| bearerTypes | Array<[NetBearType](#netbeartype)> | 否 | 否 | 网络类型。数组里面只包含了一种网络类型。**元服务API：**从API version 11开始，该接口支持在元服务中使用。 |
...
网络连接信息。
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/91/v3/XsdRg5-3RlG6CaZrEVtoHQ/caution_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260401T093302Z&HW-CC-Expire=86400&HW-CC-Sign=254C9DB7A484960FEEDCB03FAF4725EC896C9183536BC4476C2DE5C8DFA6297C)
...
| isExcludedRoute20+ | boolean | 否 | 是 | 是否为排除路由。true表示排除路由，false表示非排除路由，默认值为false。 |
#### LinkAddress
网络链路信息。
**系统能力** ：SystemCapability.Communication.NetManager.Core
| 名称 | 类型 | 只读 | 可选 | 说明 |
...
定义一个HTTP请求，可以通过 [http.createHttp](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Network Kit（网络服务）/ArkTS API/js-apis-http.md) 创建。
**元服务API：** 从API version 11开始，该接口支持在元服务中使用。
...
定义一个TCPSocket对象，可以通过 [socket.constructTCPSocketInstance](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Network Kit（网络服务）/ArkTS API/js-apis-socket.md) 创建。
**系统能力** ：SystemCapability.Communication.NetStack
| 类型 | 说明 |
| --- | --- |
...
定义一个UDPSocket对象，可以通过 [socket.constructUDPSocketInstance](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Network Kit（网络服务）/ArkTS API/js-apis-socket.md) 创建。
**系统能力** ：SystemCapability.Communication.NetStack
| 类型 | 说明 |
| --- | --- |
