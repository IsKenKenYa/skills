...
**起始版本：** 11
**相关模块：**  [NetConnection](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Network Kit（网络服务）/C API/模块/capi-netconnection.md)
#### 汇总
#### 函数
| 名称 | 描述 |
| --- | --- |
...
| 参数项 | 描述 |
| --- | --- |
| [NetConn_NetHandle](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Network Kit（网络服务）/C API/结构体/capi-netconnection-netconn-nethandle.md)*netHandle | 存放网络ID。 |
**返回：**
| 类型 | 说明 |
| --- | --- |
| int32_t | 0 - 成功。 201 - 缺少权限。401 - 参数错误。 2100002 - 无法连接到服务。2100003 - 内部错误。 |
...
| --- | --- |
| [NetConn_NetHandle](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Network Kit（网络服务）/C API/结构体/capi-netconnection-netconn-nethandle.md)*netHandle | 存放网络ID。 |
| [NetConn_ConnectionProperties](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Network Kit（网络服务）/C API/结构体/capi-netconnection-netconn-connectionproperties.md)*prop | 存放链路信息。 |
**返回：**
| 类型 | 说明 |
| --- | --- |
| int32_t | 0 - 成功。 201 - 缺少权限。401 - 参数错误。 2100002 - 无法连接到服务。2100003 - 内部错误。 |
...
| --- | --- |
| [NetConn_NetHandle](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Network Kit（网络服务）/C API/结构体/capi-netconnection-netconn-nethandle.md)*netHandle | 存放网络ID。 |
| [NetConn_NetCapabilities](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Network Kit（网络服务）/C API/结构体/capi-netconnection-netconn-netcapabilities.md)*netCapabilities | 存放能力集。 |
**返回：**
| 类型 | 说明 |
| --- | --- |
| int32_t | 0 - 成功。 201 - 缺少权限。401 - 参数错误. 2100002 - 无法连接到服务。2100003 - 内部错误。 |
...
| 参数项 | 描述 |
| --- | --- |
| [NetConn_HttpProxy](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Network Kit（网络服务）/C API/结构体/capi-netconnection-netconn-httpproxy.md)*httpProxy | 存放代理配置信息。 |
**返回：**
| 类型 | 说明 |
| --- | --- |
| int32_t | 0 - 成功。 201 - 缺少权限。401 - 参数错误. 2100002 - 无法连接到服务。2100003 - 内部错误。 |
...
| 参数项 | 描述 |
| --- | --- |
| [NetConn_NetHandleList](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Network Kit（网络服务）/C API/结构体/capi-netconnection-netconn-nethandlelist.md)*netHandleList | 网络信息列表。 |
**返回：**
| 类型 | 说明 |
| --- | --- |
| int32_t | 0 - 成功。 201 - 缺少权限。401 - 参数错误。 2100002 - 无法连接到服务。2100003 - 内部错误。 |
...
| 参数项 | 描述 |
| --- | --- |
| [OH_NetConn_CustomDnsResolver](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Network Kit（网络服务）/C API/头文件/capi-net-connection-type-h.md)resolver | 指向自定义DNS解析器的指针。 |
**返回：**
| 类型 | 说明 |
| --- | --- |
...
| [NetConn_NetHandle](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Network Kit（网络服务）/C API/结构体/capi-netconnection-netconn-nethandle.md)*netHandle | 指针类型，指向包含网络ID的网络句柄。 |
**返回：**
| 类型 | 说明 |
| --- | --- |
| int32_t | 0 - 成功。401 - 参数错误。2100002 - 无法连接到服务。2100003 - 内部错误。 |
...
| 参数项 | 描述 |
| --- | --- |
| [NetConn_HttpProxy](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Network Kit（网络服务）/C API/结构体/capi-netconnection-netconn-httpproxy.md)*httpProxy | 需要设置的http代理配置信息。 |
**返回：**
| 类型 | 说明 |
| --- | --- |
...
| 参数项 | 描述 |
| --- | --- |
| [OH_NetConn_AppHttpProxyChange](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Network Kit（网络服务）/C API/头文件/capi-net-connection-type-h.md)appHttpProxyChange | 需要注册的监听回调。 |
...
| 类型 | 说明 |
| --- | --- |
| [NetConn_ErrorCode](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Network Kit（网络服务）/C API/头文件/capi-net-connection-type-h.md) | 结果定义在[NetConn_ErrorCode](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Network Kit（网络服务）/C API/头文件/capi-net-connection-type-h.md)。[NETCONN_SUCCESS](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Network Kit（网络服务）/C API/头文件/capi-net-connection-type-h.md)成功。[NETCONN_PERMISSION_DENIED](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Network Kit（网络服务）/C API/头文件/capi-net-connection-type-h.md)缺少权限。[NETCONN_PARAMETER_ERROR](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Network Kit（网络服务）/C API/头文件/capi-net-connection-type-h.md)参数错误。[NETCONN_OPERATION_FAILED](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Network Kit（网络服务）/C API/头文件/capi-net-connection-type-h.md)无法连接到服务。[NETCONN_INTERNAL_ERROR](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Network Kit（网络服务）/C API/头文件/capi-net-connection-type-h.md)内部错误。 |
...
| 类型 | 说明 |
| --- | --- |
| [NetConn_ErrorCode](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Network Kit（网络服务）/C API/头文件/capi-net-connection-type-h.md) | 结果定义在[NetConn_ErrorCode](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Network Kit（网络服务）/C API/头文件/capi-net-connection-type-h.md)。[NETCONN_SUCCESS](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Network Kit（网络服务）/C API/头文件/capi-net-connection-type-h.md)成功。[NETCONN_PARAMETER_ERROR](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Network Kit（网络服务）/C API/头文件/capi-net-connection-type-h.md)参数错误。[NETCONN_OPERATION_FAILED](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Network Kit（网络服务）/C API/头文件/capi-net-connection-type-h.md)无法连接到服务。[NETCONN_INTERNAL_ERROR](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Network Kit（网络服务）/C API/头文件/capi-net-connection-type-h.md)内部错误。 |
...
| [NetConn_ProbeResultInfo](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Network Kit（网络服务）/C API/结构体/capi-netconnection-netconn-proberesultinfo.md)*probeResultInfo | 丢包率和往返时间（RTT）。 |
**返回：**
| 类型 | 说明 |
| --- | --- |
...
**描述**
查询网络跟踪路由。
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ad/v3/Q1vg0QYnRNWcDZzICGOlOg/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260401T093306Z&HW-CC-Expire=86400&HW-CC-Sign=9588DABC2C56F85870BB0C3EAB19413865FF8F1FD1A827BE69C24A29FCACC714)
应用调用该接口需申请精确位置权限。根据 [申请位置权限开发指导](D:/code/APIDevice/output/md_output/harmonyos-guides/应用服务/Location Kit（位置服务）/开发准备/申请位置权限开发指导/location-permission-guidelines.md) ，调用方需同时申请ohos.permission.APPROXIMATELY_LOCATION和ohos.permission.LOCATION。
...
| [NetConn_TraceRouteOption](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Network Kit（网络服务）/C API/结构体/capi-netconnection-netconn-tracerouteoption.md)*option | 路由参数选项。 |
| [NetConn_TraceRouteInfo](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Network Kit（网络服务）/C API/结构体/capi-netconnection-netconn-tracerouteinfo.md)*traceRouteInfo | 路由结果。需传入数组指针，数组大小代表路由跳数，默认30跳。若自定义跳数，则需保证数组大小与option字段中的maxJumpNumber数值保持一致。 |
**返回：**
| 类型 | 说明 |
| --- | --- |
