...
# 使用HTTP访问网络
#### 场景介绍
应用通过HTTP发起一个数据请求，支持常见的GET、POST、OPTIONS、HEAD、PUT、DELETE、TRACE、CONNECT方法。当前提供了2种HTTP请求方式，若请求发送或接收的数据量较少，可使用 [HttpRequest.request](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Network Kit（网络服务）/ArkTS API/js-apis-http.md) ，若是大文件的上传或者下载，且关注数据发送和接收进度，可使用HTTP请求流式传输 [HttpRequest.requestInstream](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Network Kit（网络服务）/ArkTS API/js-apis-http.md) 。从API version 22开始，若是需要在"HTTP请求-响应"生命周期中的关键节点插入自定义逻辑，可以使用 [HTTP拦截器](#http拦截器) 。
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/cd/v3/ZVWFO9ZZT_-B36z0h_6Y2w/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260701T104852Z&HW-CC-Expire=86400&HW-CC-Sign=B11E1350168DEA9BDCE3C86C491AA1C64D3F317F1B7EFABA29D2C69970F83E73)
HTTP模块提供了标准的HTTP网络服务能力，Remote Communication Kit（远场通信服务）提供了场景化的网络服务能力，详见 [Remote Communication Kit简介](D:/code/APIDevice/output/md_output/harmonyos-guides/系统/网络/Remote Communication Kit（远场通信服务）/Remote Communication Kit简介/remote-communication-introduction.md) ，应用可根据自己的需要选择使用。
当前HTTP请求支持的场景如下，以下功能对应的选项可以在HTTP请求的 [HttpRequestOptions](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Network Kit（网络服务）/ArkTS API/js-apis-http.md) 中进行设置：
...
| 代理设置 | 设置SOCKS5代理 | 设置SOCKS5代理，默认不使用SOCKS5代理，若正确配置了[Socks5Proxy](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Network Kit（网络服务）/ArkTS API/js-apis-net-connection.md)自定义SOCKS5代理，则HttpProxy不生效。 | API version 26.0.0 |
#### 发起HTTP数据请求
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/2f/v3/Wg_vEVRCQDu3iLII17aEIQ/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260701T104852Z&HW-CC-Expire=86400&HW-CC-Sign=78152415258ADBD5097D6A25AD311A8DD8B3AA0BF6B99E69E6E3A2EB4233C68F)
...
2.
创建HttpRequest对象
调用 [createHttp()](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Network Kit（网络服务）/ArkTS API/js-apis-http.md) 方法，创建HttpRequest对象。
```
...
3.
订阅HTTP响应头事件
调用该对象的 [on()](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Network Kit（网络服务）/ArkTS API/js-apis-http.md) 方法，订阅HTTP响应头事件，此接口会比request请求先返回。可以根据业务需要订阅此消息。
```
...
4.
发起HTTP请求，解析服务器响应事件
调用该对象的 [request()](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Network Kit（网络服务）/ArkTS API/js-apis-http.md) 方法，传入HTTP请求的url地址和可选参数，发起网络请求，按照实际业务需要，解析返回结果。
```
httpRequest.request(
...
5.
取消订阅HTTP响应头事件
调用该对象的 [off()](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Network Kit（网络服务）/ArkTS API/js-apis-http.md) 方法，取消订阅HTTP响应头事件。
```
...
6.
调用destroy()方法销毁
当该请求使用完毕时，调用 [destroy()](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Network Kit（网络服务）/ArkTS API/js-apis-http.md) 方法销毁。
```
...
```
5.
取消步骤3中订阅HTTP流式响应事件，并调用destroy()方法销毁流式HTTP请求
调用该对象的 [off()](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Network Kit（网络服务）/ArkTS API/js-apis-http.md) 方法，取消订阅步骤3中的事件，并且当该请求使用完毕时，调用 [destroy()](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Network Kit（网络服务）/ArkTS API/js-apis-http.md) 方法销毁，该方法调用的时机，可以参考步骤4中的示例代码。
```
...
2.
- 通过[httprequestoptions](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Network Kit（网络服务）/ArkTS API/js-apis-http.md)的caPath和caData字段配置HTTPS请求CA证书。
- 通过[websocketrequestoptions](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Network Kit（网络服务）/ArkTS API/js-apis-websocket.md)的caPath字段配置WebSocket请求CA证书。
- 通过[tlssecureoptions](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Network Kit（网络服务）/ArkTS API/js-apis-socket.md)的ca字段指定TLS请求CA证书。
3.
- HTTPS：通过[remoteValidation](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Network Kit（网络服务）/ArkTS API/js-apis-http.md)= 'skip' 配置。
- WebSocket：通过[websocketrequestoptions](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Network Kit（网络服务）/ArkTS API/js-apis-websocket.md)的skipServerCertVerification = true 配置。
- TLSSocket：通过[tlsconnectoptions](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Network Kit（网络服务）/ArkTS API/js-apis-socket.md)的skipRemoteValidation = true 配置。
**调试参考**
- 通过API校验指定证书是否可信：可参考[networkSecurity.certVerification](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Network Kit（网络服务）/ArkTS API/js-apis-networksecurity.md)。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/56/v3/jplFZ6HXT1aw_0Em62imig/caution_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260701T104852Z&HW-CC-Expire=86400&HW-CC-Sign=1835FFD6DA6361D5CA21E46CB843E63826AB10D4AA2B5C48819A1FC53C970C67)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/30/v3/6ph8l2PQQ2yUS3rth13I0Q/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260701T104852Z&HW-CC-Expire=86400&HW-CC-Sign=58D52C7144B0F942A63E43AED36212C9DFB67E29ECD2D824ECB7079A4486124B)
...
| Request | boolean | 否 | [Request](D:/code/APIDevice/output/md_output/harmonyos-references/系统/基础功能/Basic Services Kit（基础服务）/ArkTS API/数据文件处理/js-apis-request.md)从API version 18开始默认支持明文HTTP功能，不可配置。从API version 20开始支持配置开启或关闭明文HTTP功能。true表示支持，false表示不支持，默认为true。 |
...
```
3.
调用 [HttpInterceptorChain()](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Network Kit（网络服务）/ArkTS API/js-apis-http.md) 方法，创建拦截器链对象。
```
// 创建拦截器链
...
```
5.
调用 [addChain()](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Network Kit（网络服务）/ArkTS API/js-apis-http.md) 方法，将需要的拦截器实例加入到拦截器链中。
```
...
```
6.
调用 [apply()](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Network Kit（网络服务）/ArkTS API/js-apis-http.md) 方法，将当前配置好的拦截器链附加到httpRequest中。
```
...
```
8.
调用该对象的 [request()](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Network Kit（网络服务）/ArkTS API/js-apis-http.md) 方法，传入HTTP请求的URL地址和可选参数，发起网络请求，按照实际业务需要，解析服务器响应事件。
```
// 发起请求
...
```
9.
调用 [destroy()](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Network Kit（网络服务）/ArkTS API/js-apis-http.md) 方法销毁http请求。
```
// 销毁请求
httpRequest.destroy();
```