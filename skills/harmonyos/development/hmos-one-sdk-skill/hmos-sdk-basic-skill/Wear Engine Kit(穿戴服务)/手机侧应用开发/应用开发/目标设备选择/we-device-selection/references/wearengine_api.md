...
**起始版本** ：5.0.0(12)
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b8/v3/xZzWcKzaSXuUWdYh1q0WoQ/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260401T093447Z&HW-CC-Expire=86400&HW-CC-Sign=30B240936EA5791AE037C730E142E5F91FD133946C3672B6B16E970BCB8AE10D)
针对系统能力SystemCapability.Health.WearEngine，请先使用 [canIUse()](D:/code/APIDevice/output/md_output/harmonyos-references/公共基础能力/ArkTS API/js-apis-syscap.md) 接口判断当前设备是否支持此syscap及对应接口。
#### 导入模块
```typescript
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| context | [common.Context](D:/code/APIDevice/output/md_output/harmonyos-references/应用框架/Ability Kit（程序框架服务）/ArkTS API/接口依赖的元素及定义/application/js-apis-inner-application-context.md) | 是 | Context上下文，仅支持包含connectServiceExtensionAbility方法的Context（例：[UIAbilityContext](D:/code/APIDevice/output/md_output/harmonyos-references/应用框架/Ability Kit（程序框架服务）/ArkTS API/接口依赖的元素及定义/application/js-apis-inner-application-uiabilitycontext.md)）。 |
**返回值：**
| 类型 | 说明 |
| --- | --- |
| [AuthClient](#section876918413377) | 权限管理客户端，存储了权限模块的相关方法。 |
**错误码：**
以下错误码的详细介绍请参见 [Wear Engine ArkTS API错误码](D:/code/APIDevice/output/md_output/harmonyos-references/系统/硬件/Wear Engine Kit（穿戴服务）/wearengine_api_error_code.md) 。
| 错误码ID | 错误信息 |
| --- | --- |
| [401](D:/code/APIDevice/output/md_output/harmonyos-references/系统/硬件/Wear Engine Kit（穿戴服务）/wearengine_api_error_code.md) | Parameter error. Possible causes: 1. Mandatory parameters are left unspecified. 2. Incorrect parameter types. |
| [801](D:/code/APIDevice/output/md_output/harmonyos-references/系统/硬件/Wear Engine Kit（穿戴服务）/wearengine_api_error_code.md) | Capability not supported. |
| [1008509999](D:/code/APIDevice/output/md_output/harmonyos-references/系统/硬件/Wear Engine Kit（穿戴服务）/wearengine_api_error_code.md) | Internal error. |
**示例：**
```
import { wearEngine } from '@kit.WearEngine';
...
```
#### AuthClient
权限管理客户端类，由 [wearEngine.getAuthClient](#section17606835182712) 返回得到。
**模型约束：** 此接口仅可在Stage模型下使用。
**系统能力：** SystemCapability.Health.WearEngine
**起始版本：** 5.0.0(12)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| request | [AuthorizationRequest](#section12513135291215) | 是 | 权限请求类。 |
**返回值：**
| 类型 | 说明 |
| --- | --- |
| Promise<[AuthorizationResponse](#section1536013509131)> | Promise对象，返回权限响应类。 |
**错误码：**
以下错误码的详细介绍请参见 [Wear Engine ArkTS API错误码](D:/code/APIDevice/output/md_output/harmonyos-references/系统/硬件/Wear Engine Kit（穿戴服务）/wearengine_api_error_code.md) 。
| 错误码ID | 错误信息 |
| --- | --- |
| [401](D:/code/APIDevice/output/md_output/harmonyos-references/系统/硬件/Wear Engine Kit（穿戴服务）/wearengine_api_error_code.md) | Parameter error. Possible causes: 1. Mandatory parameters are left unspecified. 2. Incorrect parameter types. 3. Parameter verification failed. |
| [1008500001](D:/code/APIDevice/output/md_output/harmonyos-references/系统/硬件/Wear Engine Kit（穿戴服务）/wearengine_api_error_code.md) | Network error. The network is unavailable. |
| [1008500004](D:/code/APIDevice/output/md_output/harmonyos-references/系统/硬件/Wear Engine Kit（穿戴服务）/wearengine_api_error_code.md) | App has not applied for the Wear Engine service. |
| [1008500006](D:/code/APIDevice/output/md_output/harmonyos-references/系统/硬件/Wear Engine Kit（穿戴服务）/wearengine_api_error_code.md) | User privacy is not agreed. |
| [1008500007](D:/code/APIDevice/output/md_output/harmonyos-references/系统/硬件/Wear Engine Kit（穿戴服务）/wearengine_api_error_code.md) | The device capability is not supported. |
| [1008500008](D:/code/APIDevice/output/md_output/harmonyos-references/系统/硬件/Wear Engine Kit（穿戴服务）/wearengine_api_error_code.md) | Account error. The user has not logged in with HUAWEI ID. |
| [1008500009](D:/code/APIDevice/output/md_output/harmonyos-references/系统/硬件/Wear Engine Kit（穿戴服务）/wearengine_api_error_code.md) | Account error. Failed to obtain account information with HUAWEI ID. |
| [1008509999](D:/code/APIDevice/output/md_output/harmonyos-references/系统/硬件/Wear Engine Kit（穿戴服务）/wearengine_api_error_code.md) | Internal error. |
**示例：**
```typescript
import { wearEngine } from '@kit.WearEngine';
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| permissions | [Permission](#section09971113566)[] | 否 | 否 | 权限枚举类型的数组。 |
#### Permission
权限枚举类型。
**系统能力：** SystemCapability.Health.WearEngine
**模型约束：** 此接口仅可在Stage模型下使用。
...
权限请求类，继承自 [AuthorizationBase](#section3936113217535) 。
**模型约束：** 此接口仅可在Stage模型下使用。
**系统能力：** SystemCapability.Health.WearEngine
**起始版本：** 5.0.0(12)
#### AuthorizationResponse
权限响应类，继承自 [AuthorizationBase](#section3936113217535) 。
**模型约束：** 此接口仅可在Stage模型下使用。
**系统能力：** SystemCapability.Health.WearEngine
**起始版本：** 5.0.0(12)
...
| 类型 | 说明 |
| --- | --- |
| [DeviceClient](#section126321419369) | Device客户端，存储了Device模块的相关方法。 |
**错误码：**
以下错误码的详细介绍请参见 [Wear Engine ArkTS API错误码](D:/code/APIDevice/output/md_output/harmonyos-references/系统/硬件/Wear Engine Kit（穿戴服务）/wearengine_api_error_code.md) 。
| 错误码ID | 错误信息 |
| --- | --- |
...
```
#### DeviceClient
Device客户端类。由接口 [wearEngine.getDeviceClient](#section1892394201117) 返回得到。
**模型约束：** 此接口仅可在Stage模型下使用。
**系统能力：** SystemCapability.Health.WearEngine
**起始版本：** 5.0.0(12)
#### getConnectedDevices
...
| 类型 | 说明 |
| --- | --- |
| Promise<[Device](#section385118379447)[]> | Promise对象，返回设备列表。 |
**错误码：**
以下错误码的详细介绍请参见 [Wear Engine ArkTS API错误码](D:/code/APIDevice/output/md_output/harmonyos-references/系统/硬件/Wear Engine Kit（穿戴服务）/wearengine_api_error_code.md) 。
| 错误码ID | 错误信息 |
| --- | --- |
...
```
#### Device
穿戴设备信息类。由接口 [getConnectedDevices](#section1828213119411) 返回。
**模型约束：** 此接口仅可在Stage模型下使用。
**系统能力：** SystemCapability.Health.WearEngine
**起始版本：** 5.0.0(12)
#### 属性
...
| category | [DeviceCategory](#section145591125155713) | 否 | 是 | 设备类型。 |
...
| osCategory | [OsCategory](#section8322015161010) | 否 | 是 | 设备的操作系统类别。**起始版本：**5.1.0(18) |
#### isWearEngineCapabilitySupported
isWearEngineCapabilitySupported(capability: WearEngineCapability): Promise<boolean>
通过 [getConnectedDevices](#section1828213119411) 接口获取到已连接的穿戴设备后，查询设备是否支持指定的 [WearEngineCapability](#section1639211301479) ，使用Promise异步回调。
**系统能力：** SystemCapability.Health.WearEngine
**设备行为差异：** 该接口在Phone、Tablet中可正常调用，在其他设备类型中返回801错误码。
**模型约束：** 此接口仅可在Stage模型下使用。
**起始版本：** 5.0.0(12)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| capability | [WearEngineCapability](#section1639211301479) | 是 | 指定的WearEngine能力。 |
**返回值：**
| 类型 | 说明 |
| --- | --- |
...
| [801](D:/code/APIDevice/output/md_output/harmonyos-references/系统/硬件/Wear Engine Kit（穿戴服务）/wearengine_api_error_code.md) | Capability not supported. |
| [1008500001](D:/code/APIDevice/output/md_output/harmonyos-references/系统/硬件/Wear Engine Kit（穿戴服务）/wearengine_api_error_code.md) | Network error. The network is unavailable. |
| [1008500002](D:/code/APIDevice/output/md_output/harmonyos-references/系统/硬件/Wear Engine Kit（穿戴服务）/wearengine_api_error_code.md) | No device is bound. |
| [1008500003](D:/code/APIDevice/output/md_output/harmonyos-references/系统/硬件/Wear Engine Kit（穿戴服务）/wearengine_api_error_code.md) | Device disconnected. |
| [1008500004](D:/code/APIDevice/output/md_output/harmonyos-references/系统/硬件/Wear Engine Kit（穿戴服务）/wearengine_api_error_code.md) | App has not applied for the Wear Engine service. |
| [1008500006](D:/code/APIDevice/output/md_output/harmonyos-references/系统/硬件/Wear Engine Kit（穿戴服务）/wearengine_api_error_code.md) | User privacy is not agreed. |
| [1008500008](D:/code/APIDevice/output/md_output/harmonyos-references/系统/硬件/Wear Engine Kit（穿戴服务）/wearengine_api_error_code.md) | Account error. The user has not logged in with HUAWEI ID. |
| [1008500009](D:/code/APIDevice/output/md_output/harmonyos-references/系统/硬件/Wear Engine Kit（穿戴服务）/wearengine_api_error_code.md) | Account error. Failed to obtain account information with HUAWEI ID. |
...
通过 [getConnectedDevices](#section1828213119411) 接口获取到已连接的穿戴设备后，查询设备是否支持指定的 [DeviceCapability](#section0965105510366) ，使用Promise异步回调。
**系统能力：** SystemCapability.Health.WearEngine
**设备行为差异：** 该接口在Phone、Tablet中可正常调用，在其他设备类型中返回801错误码。
**模型约束：** 此接口仅可在Stage模型下使用。
**起始版本：** 5.0.0(12)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| capability | [DeviceCapability](#section0965105510366) | 是 | 指定的Device能力。 |
**返回值：**
| 类型 | 说明 |
| --- | --- |
| Promise<boolean> | Promise对象，返回是否支持指定能力的查询结果。true：支持，false：不支持。 |
...
通过 [getConnectedDevices](#section1828213119411) 接口获取到已连接的穿戴设备后，查询设备的SN，使用Promise异步回调。
**系统能力：** SystemCapability.Health.WearEngine
**设备行为差异：** 该接口在Phone、Tablet中可正常调用，在其他设备类型中返回801错误码。
**模型约束：** 此接口仅可在Stage模型下使用。
**起始版本：** 5.0.0(12)
...
| [1008500003](D:/code/APIDevice/output/md_output/harmonyos-references/系统/硬件/Wear Engine Kit（穿戴服务）/wearengine_api_error_code.md) | Device disconnected. |
| [1008500004](D:/code/APIDevice/output/md_output/harmonyos-references/系统/硬件/Wear Engine Kit（穿戴服务）/wearengine_api_error_code.md) | App has not applied for the Wear Engine service. |
| [1008500005](D:/code/APIDevice/output/md_output/harmonyos-references/系统/硬件/Wear Engine Kit（穿戴服务）/wearengine_api_error_code.md) | The HUAWEI ID is not authorized. |
| [1008500006](D:/code/APIDevice/output/md_output/harmonyos-references/系统/硬件/Wear Engine Kit（穿戴服务）/wearengine_api_error_code.md) | User privacy is not agreed. |
| [1008500008](D:/code/APIDevice/output/md_output/harmonyos-references/系统/硬件/Wear Engine Kit（穿戴服务）/wearengine_api_error_code.md) | Account error. The user has not logged in with HUAWEI ID. |
| [1008500009](D:/code/APIDevice/output/md_output/harmonyos-references/系统/硬件/Wear Engine Kit（穿戴服务）/wearengine_api_error_code.md) | Account error. Failed to obtain account information with HUAWEI ID. |
| [1008509999](D:/code/APIDevice/output/md_output/harmonyos-references/系统/硬件/Wear Engine Kit（穿戴服务）/wearengine_api_error_code.md) | Internal error. |
...
| 类型 | 说明 |
| --- | --- |
| [MonitorClient](#section178254313113) | Monitor客户端，存储了Monitor模块的相关方法。 |
**错误码：**
以下错误码的详细介绍请参见 [Wear Engine ArkTS API错误码](D:/code/APIDevice/output/md_output/harmonyos-references/系统/硬件/Wear Engine Kit（穿戴服务）/wearengine_api_error_code.md) 。
| 错误码ID | 错误信息 |
| --- | --- |
...
```
#### MonitorClient
Monitor客户端类。由接口 [wearEngine.getMonitorClient](#section068883315262) 返回得到。
**模型约束：** 此接口仅可在Stage模型下使用。
**系统能力：** SystemCapability.Health.WearEngine
**起始版本：** 5.0.0(12)
#### queryStatus
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| deviceRandomId | string | 是 | [Device](#section385118379447)的随机标识符，用于指定本次查询的设备。 |
| item | [MonitorItem](#section16422462613) | 是 | 可查询的设备状态枚举，用于指定本次查询的状态。 |
**返回值：**
| 类型 | 说明 |
| --- | --- |
| Promise<[MonitorData](#section12024822410)> | Promise对象，返回查询的结果。不同状态返回值的含义请参考[MonitorItem](#section16422462613)。 |
**错误码：**
以下错误码的详细介绍请参见 [Wear Engine ArkTS API错误码](D:/code/APIDevice/output/md_output/harmonyos-references/系统/硬件/Wear Engine Kit（穿戴服务）/wearengine_api_error_code.md) 。
| 错误码ID | 错误信息 |
| --- | --- |
...
| [1008500008](D:/code/APIDevice/output/md_output/harmonyos-references/系统/硬件/Wear Engine Kit（穿戴服务）/wearengine_api_error_code.md) | Account error. The user has not logged in with HUAWEI ID. |
| [1008500009](D:/code/APIDevice/output/md_output/harmonyos-references/系统/硬件/Wear Engine Kit（穿戴服务）/wearengine_api_error_code.md) | Account error. Failed to obtain account information with HUAWEI ID. |
| [1008500010](D:/code/APIDevice/output/md_output/harmonyos-references/系统/硬件/Wear Engine Kit（穿戴服务）/wearengine_api_error_code.md) | Device ID is invalid. |
| [1008509999](D:/code/APIDevice/output/md_output/harmonyos-references/系统/硬件/Wear Engine Kit（穿戴服务）/wearengine_api_error_code.md) | Internal error. |
**示例：**
```typescript
import { wearEngine } from '@kit.WearEngine';
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| deviceRandomId | string | 是 | [Device](#section385118379447)的随机标识符，用于指定本次订阅的设备。 |
| type | [MonitorEvent](#section0407141762619) | 是 | 可订阅的设备状态枚举，用于指定本次订阅监听的设备状态。 |
| callback | Callback<[MonitorEventData](#section38571246164212)> | 是 | 回调函数，状态发生变化后执行，传入[MonitorEventData](#section38571246164212)类。建议保证回调函数的生命周期延长至取消监听时，详情请见[unsubscribeEvent](#section182736075018)。 |
**返回值：**
| 类型 | 说明 |
| --- | --- |
...
| [1008500009](D:/code/APIDevice/output/md_output/harmonyos-references/系统/硬件/Wear Engine Kit（穿戴服务）/wearengine_api_error_code.md) | Account error. Failed to obtain account information with HUAWEI ID. |
| [1008500010](D:/code/APIDevice/output/md_output/harmonyos-references/系统/硬件/Wear Engine Kit（穿戴服务）/wearengine_api_error_code.md) | Device ID is invalid. |
| [1008500012](D:/code/APIDevice/output/md_output/harmonyos-references/系统/硬件/Wear Engine Kit（穿戴服务）/wearengine_api_error_code.md) | Too many callbacks of the same type. |
| [1008509999](D:/code/APIDevice/output/md_output/harmonyos-references/系统/硬件/Wear Engine Kit（穿戴服务）/wearengine_api_error_code.md) | Internal error. |
**示例：**
```typescript
import { wearEngine } from '@kit.WearEngine';
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| deviceRandomId | string | 是 | [Device](#section385118379447)的随机标识符，用于指定本次取消订阅的设备。 |
| type | [MonitorEvent](#section0407141762619) | 是 | 可订阅的设备状态枚举，用于指定本次取消订阅监听的设备状态。 |
| callback | Callback<[MonitorEventData](#section38571246164212)> | 是 | 回调函数。此处需保证传入的对象与调用[subscribeEvent](#section74368231248)接口时传入的回调函数为同一个对象。 |
**返回值：**
| 类型 | 说明 |
| --- | --- |
| Promise<void> | Promise对象。无结果返回的Promise对象。 |
...
| 名称 | 值 | 说明 |
| --- | --- | --- |
| WEAR_STATUS | wearStatus | 佩戴状态。返回值含义：1：佩戴2：未佩戴 |
| POWER_STATUS | powerStatus | 电量状态。返回值含义：剩余电量百分比（0~100）。 |
| CHARGE_STATUS | chargeStatus | 充电状态。返回值含义：1：正在充电2：未充电3：电量已充满 |
| AVAILABLE_STORAGE_SPACE | availableStorageSpace | 可用存储空间。返回值含义：用户可用空间（KB）。 |
| POWER_MODE | powerMode | 电源模式。返回值含义：-1：设备不区分电源模式0：智能模式1：超长续航模式 |
#### MonitorEvent
设备状态变化事件的枚举类。
**模型约束：** 此接口仅可在Stage模型下使用。
**系统能力：** SystemCapability.Health.WearEngine
...
#### MonitorData
作为 [queryStatus](#section3383841153218) 接口的返回值与 [subscribeEvent](#section74368231248) 接口回调函数的入参，返回设备的状态信息。
**模型约束：** 此接口仅可在Stage模型下使用。
**系统能力：** SystemCapability.Health.WearEngine
**起始版本：** 5.0.0(12)
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| code | number | 否 | 否 | 当使用[queryStatus](#section3383841153218)接口查询设备状态时，返回值含义请见[MonitorItem](#section16422462613)。当使用[subscribeEvent](#section74368231248)接口订阅监听时，返回值含义请见[MonitorEvent](#section0407141762619)。 |
| data | string | 否 | 是 | 扩展字段。 |
#### MonitorEventData
作为 [subscribeEvent](#section74368231248) 接口的返回值，当订阅监听的事件触发时，作为入参将设备对应状态变化后的信息传递给回调函数。
**模型约束：** 此接口仅可在Stage模型下使用。
**系统能力：** SystemCapability.Health.WearEngine
**起始版本：** 5.0.0(12)
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| event | [MonitorEvent](#section0407141762619) | 否 | 否 | 回调函数注册的订阅监听事件枚举值。 |
| data | [MonitorData](#section12024822410) | 否 | 否 | 设备状态发生变化后的状态信息。 |
...
| 类型 | 说明 |
| --- | --- |
| [P2pClient](#section10175450143316) | P2p客户端，存储了P2p模块的相关方法。 |
**错误码：**
以下错误码的详细介绍请参见 [Wear Engine ArkTS API错误码](D:/code/APIDevice/output/md_output/harmonyos-references/系统/硬件/Wear Engine Kit（穿戴服务）/wearengine_api_error_code.md) 。
| 错误码ID | 错误信息 |
| --- | --- |
...
```
#### P2pClient
P2p客户端类。由接口 [wearEngine.getP2pClient](#section15604103515412) 返回得到。
**模型约束：** 此接口仅可在Stage模型下使用。
**系统能力：** SystemCapability.Health.WearEngine
**起始版本：** 5.0.0(12)
...
| transformLocalBundleName | boolean | 否 | 是否需要将本地包名和指纹转换为兼容应用在云端存储的包名和指纹。默认值：false。true：转换，false：不转换。待兼容应用设置请参考[申请接入Wear Engine服务](D:/code/APIDevice/output/md_output/harmonyos-guides/系统/硬件/Wear Engine Kit（穿戴服务）/手机侧应用开发/接入准备/申请接入Wear Engine服务/wearengine_apply.md)。 |
**返回值：**
| 类型 | 说明 |
| --- | --- |
| Promise<[P2pResult](#section75108813115)> | Promise对象。属性中的code字段表示本次拉起应用的结果。 |
**错误码：**
以下错误码的详细介绍请参见 [Wear Engine ArkTS API错误码](D:/code/APIDevice/output/md_output/harmonyos-references/系统/硬件/Wear Engine Kit（穿戴服务）/wearengine_api_error_code.md) 。
| 错误码ID | 错误信息 |
| --- | --- |
...
| --- | --- | --- | --- |
| deviceRandomId | string | 是 | [Device](#section385118379447)的随机标识符，用于指定本次订阅的设备。 |
| appParam | [P2pAppParam](#section7874153142020) | 是 | 指定的设备侧应用参数。 |
| message | [P2pMessage](#section188531948121319) | 是 | 需要传输的消息内容，取值范围：[1，4096)，单位字节。 |
**返回值：**
| 类型 | 说明 |
| --- | --- |
| Promise<[P2pResult](#section75108813115)> | Promise对象。返回[P2pResult](#section75108813115)对象，其属性中的code字段表示本次消息发送的结果。 |
**错误码：**
以下错误码的详细介绍请参见 [Wear Engine ArkTS API错误码](D:/code/APIDevice/output/md_output/harmonyos-references/系统/硬件/Wear Engine Kit（穿戴服务）/wearengine_api_error_code.md) 。
| 错误码ID | 错误信息 |
| --- | --- |
...
| deviceRandomId | string | 是 | [Device](#section385118379447)的随机标识符，用于指定本次订阅的设备。 |
| appParam | [P2pAppParam](#section7874153142020) | 是 | 指定的设备侧应用参数。 |
| file | [P2pFile](#section1223384152) | 是 | 需要传输的文件。 |
| callback | AsyncCallback<[P2pResult](#section75108813115)> | 是 | 通用回调函数，携带错误参数和异步返回值。 |
**错误码：**
以下错误码的详细介绍请参见 [Wear Engine ArkTS API错误码](D:/code/APIDevice/output/md_output/harmonyos-references/系统/硬件/Wear Engine Kit（穿戴服务）/wearengine_api_error_code.md) 。
| 错误码ID | 错误信息 |
| --- | --- |
...
| [1008500009](D:/code/APIDevice/output/md_output/harmonyos-references/系统/硬件/Wear Engine Kit（穿戴服务）/wearengine_api_error_code.md) | Account error. Failed to obtain account information with HUAWEI ID. |
| [1008500010](D:/code/APIDevice/output/md_output/harmonyos-references/系统/硬件/Wear Engine Kit（穿戴服务）/wearengine_api_error_code.md) | Device ID is invalid. |
| [1008500011](D:/code/APIDevice/output/md_output/harmonyos-references/系统/硬件/Wear Engine Kit（穿戴服务）/wearengine_api_error_code.md) | File is invalid. |
| [1008509999](D:/code/APIDevice/output/md_output/harmonyos-references/系统/硬件/Wear Engine Kit（穿戴服务）/wearengine_api_error_code.md) | Internal error. |
**示例：**
```typescript
import { wearEngine } from '@kit.WearEngine';
...
| --- | --- | --- | --- |
| deviceRandomId | string | 是 | [Device](#section385118379447)的随机标识符，用于指定本次订阅的设备。 |
| appParam | [P2pAppParam](#section7874153142020) | 是 | 指定设备侧应用参数。 |
| file | [P2pFile](#section1223384152) | 是 | 需要传输的文件。 |
**返回值：**
| 类型 | 说明 |
| --- | --- |
| Promise<[P2pResult](#section75108813115)> | Promise对象。属性中的code字段表示本次取消文件发送的结果。 |
**错误码：**
以下错误码的详细介绍请参见 [Wear Engine ArkTS API错误码](D:/code/APIDevice/output/md_output/harmonyos-references/系统/硬件/Wear Engine Kit（穿戴服务）/wearengine_api_error_code.md) 。
| 错误码ID | 错误信息 |
| --- | --- |
...
| --- | --- | --- | --- |
| deviceRandomId | string | 是 | [Device](#section385118379447)的随机标识符，用于指定本次订阅的设备。 |
| appParam | [P2pAppParam](#section7874153142020) | 是 | 设备侧应用参数。 |
| callback | Callback<[P2pMessage](#section188531948121319)> | 是 | 接收到设备侧应用发送的消息后执行的回调函数。 |
**返回值：**
| 类型 | 说明 |
| --- | --- |
| Promise<void> | Promise对象。无结果返回的Promise对象。 |
...
| deviceRandomId | string | 是 | [Device](#section385118379447)的随机标识符，用于指定本次订阅的设备。 |
| appParam | [P2pAppParam](#section7874153142020) | 是 | 设备侧应用参数。 |
| callback | Callback<[P2pFile](#section1223384152)> | 是 | 接收到设备侧应用发送的文件后执行的回调函数。 |
**返回值：**
| 类型 | 说明 |
| --- | --- |
| Promise<void> | Promise对象。无结果返回的Promise对象。 |
...
| deviceRandomId | string | 是 | [Device](#section385118379447)的随机标识符，用于指定本次订阅的设备。 |
| appParam | [P2pAppParam](#section7874153142020) | 是 | 设备侧应用参数。 |
| callback | Callback<[P2pMessage](#section188531948121319)> | 是 | 回调函数，需要同订阅监听时的回调函数为同一个对象。 |
**返回值：**
| 类型 | 说明 |
| --- | --- |
| Promise<void> | Promise对象。无结果返回的Promise对象。 |
...
| deviceRandomId | string | 是 | [Device](#section385118379447)的随机标识符，用于指定本次订阅的设备。 |
| appParam | [P2pAppParam](#section7874153142020) | 是 | 设备侧应用参数。 |
| callback | Callback<[P2pFile](#section1223384152)> | 是 | 回调函数，需要同订阅监听时的回调函数为同一个对象。 |
**返回值：**
| 类型 | 说明 |
| --- | --- |
| Promise<void> | Promise对象。无结果返回的Promise对象。 |
...
| fingerprint | string | 否 | 否 | 用于标识应用唯一身份的应用指纹或[APP ID。](D:/code/APIDevice/output/md_output/harmonyos-guides/系统/硬件/Wear Engine Kit（穿戴服务）/Wear Engine常见问题/使用AppInfo时，如何获取应用身份标识/wearengine_faq-9.md)**说明：**HarmonyOS 5.0及其之后版本的wearable设备传APP ID，其它传应用指纹。 |
#### P2pResultCode
存储P2p通信的返回值枚举类。
**模型约束：** 此接口仅可在Stage模型下使用。
**系统能力：** SystemCapability.Health.WearEngine
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| code | number | 否 | 是 | 用于返回除文件传输外的P2p通信结果，返回值含义见[P2pResultCode](#section34326155711)。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| file | [fs.File](D:/code/APIDevice/output/md_output/harmonyos-references/应用框架/Core File Kit（文件基础服务）/ArkTS API/js-apis-file-fs.md) | 否 | 否 | 文件对象。 |
#### P2pAppParam
P2p通信过程中可用的设备侧应用参数类。
**模型约束：** 此接口仅可在Stage模型下使用。
**系统能力：** SystemCapability.Health.WearEngine
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| remoteApp | [AppInfo](#section1357110221710) | 否 | 否 | 设备侧应用信息类。 |
| transformLocalAppInfo | boolean | 否 | 是 | 是否需要将本地包名和指纹转换为兼容应用在云端存储的包名和指纹。默认值：false。true：转换；false：不转换。待兼容应用设置请参考[申请接入Wear Engine服务](D:/code/APIDevice/output/md_output/harmonyos-guides/系统/硬件/Wear Engine Kit（穿戴服务）/手机侧应用开发/接入准备/申请接入Wear Engine服务/wearengine_apply.md)。 |
...
| 类型 | 说明 |
| --- | --- |
| [NotifyClient](#section82221754103913) | 模板化通知客户端，存储了发送模板化通知的相关方法。 |
**错误码：**
以下错误码的详细介绍请参见 [Wear Engine ArkTS API错误码](D:/code/APIDevice/output/md_output/harmonyos-references/系统/硬件/Wear Engine Kit（穿戴服务）/wearengine_api_error_code.md) 。
| 错误码ID | 错误信息 |
| --- | --- |
...
```
#### NotifyClient
Notify客户端类，由 [wearEngine.getNotifyClient](#section552416431386) 返回得到。
**模型约束：** 此接口仅可在Stage模型下使用。
**系统能力：** SystemCapability.Health.WearEngine
**起始版本：** 5.0.0(12)
#### notify
...
| --- | --- | --- | --- |
| deviceRandomId | string | 是 | [Device](#section385118379447)的随机标识符，用于指定本次查询的设备。 |
| options | [NotificationOptions](#section0751457344) | 是 | 模板化通知配置参数类。 |
**返回值：**
| 类型 | 说明 |
| --- | --- |
| Promise<void> | Promise对象。无结果返回的Promise对象。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| notification | [Notification](#section33797461644) | 否 | 否 | 模板化通知的通知体参数类。 |
#### onAction
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| feedback | [NotificationFeedback](#section498821414418) | 是 | 设备侧操作通知的反馈类。 |
#### Notification
模板化通知的通知体参数类。
**模型约束：** 此接口仅可在Stage模型下使用。
**系统能力：** SystemCapability.Health.WearEngine
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| type | [NotificationType](#section45813154136) | 否 | 否 | 通知的模板类型。 |
| bundleName | string | 否 | 否 | 发送通知应用的包名。 |
| title | string | 否 | 否 | 通知的标题，取值范围：[1，28)，单位字节。 |
| text | string | 否 | 否 | 通知的内容，取值范围：[1，400)，单位字节。 |
| buttons | [NotificationButton](#section7336124218819)[] | 否 | 是 | 通知按钮信息类，若未填写，默认为空。 |
#### NotificationType
模板化通知的模板类型枚举类。
**模型约束：** 此接口仅可在Stage模型下使用。
**系统能力：** SystemCapability.Health.WearEngine
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| buttonId | [ButtonId](#section171882571499) | 否 | 否 | 按钮Id枚举类。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| action | [NotificationAction](#section924615208466) | 否 | 是 | 设备侧对通知的操作反馈枚举类。 |
| errorCode | number | 否 | 是 | 错误码，含义请见[NotificationErrorCode](#section9782193965320)。 |
#### NotificationAction
设备侧对通知的操作反馈枚举类。
**模型约束：** 此接口仅可在Stage模型下使用。
**系统能力：** SystemCapability.Health.WearEngine
...
| 类型 | 说明 |
| --- | --- |
| [SensorClient](#section1743102372015) | Sensor客户端，存储了Sensor模块的相关方法。 |
**错误码：**
以下错误码的详细介绍请参见 [Wear Engine ArkTS API错误码](D:/code/APIDevice/output/md_output/harmonyos-references/系统/硬件/Wear Engine Kit（穿戴服务）/wearengine_api_error_code.md) 。
| 错误码ID | 错误信息 |
| --- | --- |
...
```
#### SensorClient
Sensor客户端类。由接口 [wearEngine.getSensorClient](#section1529943512113) 返回得到。
**模型约束：** 此接口仅可在Stage模型下使用。
**系统能力：** SystemCapability.Health.WearEngine
**起始版本：** 5.0.0(12)
#### getSensorList
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| deviceRandomId | string | 是 | [Device](#section385118379447)的随机标识符，用于指定设备。 |
**返回值：**
| 类型 | 说明 |
| --- | --- |
| Promise<[Sensor](#section19142203612579)[]> | Promise对象，返回设备侧可用的传感器列表。 |
**错误码：**
以下错误码的详细介绍请参见 [Wear Engine ArkTS API错误码](D:/code/APIDevice/output/md_output/harmonyos-references/系统/硬件/Wear Engine Kit（穿戴服务）/wearengine_api_error_code.md) 。
| 错误码ID | 错误信息 |
| --- | --- |
...
| --- | --- | --- | --- |
| deviceRandomId | string | 是 | [Device](#section385118379447)的随机标识符，用于指定本次订阅的设备。 |
| type | [SensorType](#section2420171225210) | 是 | 传感器类别，用于指定本次订阅的传感器。 |
| callback | Callback<[SensorResult](#section19118123861519)> | 是 | 回调函数，用于处理传感器上报的数据。 |
**返回值：**
| 类型 | 说明 |
| --- | --- |
| Promise<void> | Promise对象。无结果返回的Promise对象。 |
...
| --- | --- | --- | --- |
| deviceRandomId | string | 是 | [Device](#section385118379447)的随机标识符，用于指定本次取消订阅的设备。 |
| type | [SensorType](#section2420171225210) | 是 | 传感器类别，用于指定本次取消订阅的传感器。 |
| callback | Callback<[SensorResult](#section19118123861519)> | 是 | 回调函数，用于处理传感器上报的数据，需要同订阅监听时的回调函数为同一个对象。 |
**返回值：**
| 类型 | 说明 |
| --- | --- |
| Promise<void> | Promise对象。无结果返回的Promise对象。 |
...
| id | number | 否 | 否 | 传感器ID。 |
| type | [SensorType](#section2420171225210) | 否 | 否 | 传感器类型。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| sensorType | [SensorType](#section2420171225210) | 否 | 否 | 传感器类型。 |
| data | number[] | 否 | 否 | 数据内容，格式及含义请参考[穿戴设备传感器数据格式及样例](D:/code/APIDevice/output/md_output/harmonyos-guides/系统/硬件/Wear Engine Kit（穿戴服务）/手机侧应用开发/应用开发/穿戴设备传感器获取/device_sensor.md)。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| data | [SensorData](#section1896124869)[] | 否 | 是 | 传感器正常上报的数据内容。 |
| errorCode | number | 否 | 是 | 错误码，含义请见[SensorErrorCode](#section173105551894)。 |
#### on/off订阅事件
#### wearEngine.on
on(type: 'serviceDie', callback: Callback<void>): void
订阅服务端消亡事件，调用 [wearEngine.destroy](#section890395942912) 接口主动发起的消亡事件不会触发执行回调函数。
**模型约束：** 此接口仅可在Stage模型下使用。
**系统能力：** SystemCapability.Health.WearEngine
**起始版本：** 5.0.0(12)
**参数：**
