...
接口所需权限用户尚未授权。
**处理步骤**
参考 [请求用户授权](D:/code/APIDevice/output/md_output/harmonyos-guides/系统/硬件/Wear Engine Kit（穿戴服务）/手机侧应用开发/应用开发/请求用户授权/request_user_authorization.md) ，确认用户已授权相关权限。
...
2. 传入了过期的设备ID。
**处理步骤**
调用 [getConnectedDevices](D:/code/APIDevice/output/md_output/harmonyos-references/系统/硬件/Wear Engine Kit（穿戴服务）/ArkTS API/wearengine_api.md) 接口重新获取设备ID。
#### 1008500011 无效文件
**错误信息**
File is invalid.
**错误描述**
...
2. 断开重连设备。
3. 在metadata中[配置clientId](D:/code/APIDevice/output/md_output/harmonyos-guides/系统/硬件/Wear Engine Kit（穿戴服务）/手机侧应用开发/接入准备/配置Client ID/configuration_client_id.md)。
