...
-
本地化接口调用
为了确保接口返回值与用户设置保持一致，通常需要在 [i18n模块](D:/code/APIDevice/output/md_output/harmonyos-references/应用框架/Localization Kit（本地化开发服务）/ArkTS API/js-apis-i18n.md) 和 [intl模块](D:/code/APIDevice/output/md_output/harmonyos-references/应用框架/Localization Kit（本地化开发服务）/ArkTS API/js-apis-intl.md) 接口中传入系统区域ID或系统区域对象。系统区域ID和系统区域对象传入的示例如下：
```
...
对于应用开发者，仅需关注资源配置，资源文件配置完成后，根据业务需求对资源进行访问。资源文件配置和资源匹配规则请参考 [资源分类与访问](D:/code/APIDevice/output/md_output/harmonyos-guides/基础入门/资源分类与访问/resource-categories-and-access.md) 。
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e5/v3/EYU4kjraQV26uBXl8_EFew/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260701T104727Z&HW-CC-Expire=86400&HW-CC-Sign=A7CEFF9AF2281A94C12D2042A0A73759B12A6C2C0F904EDA156034B17F33F4C8)
