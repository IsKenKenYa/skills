...
从API version 20开始，时区模块还可用于获取时区跳变时间点和偏移量等，时区的跳变逻辑参考 [夏令时跳变](D:/code/APIDevice/output/md_output/harmonyos-guides/应用框架/Localization Kit（本地化开发服务）/应用国际化/时区与夏令时国际化/夏令时跳变/i18n-dst-transition.md) 。
#### 接口说明
时区模块关键接口如下表所示，具体API说明详见 [国际化-I18n](D:/code/APIDevice/output/md_output/harmonyos-references/应用框架/Localization Kit（本地化开发服务）/ArkTS API/js-apis-i18n.md) 。
| 接口名 | 描述 |
| --- | --- |
