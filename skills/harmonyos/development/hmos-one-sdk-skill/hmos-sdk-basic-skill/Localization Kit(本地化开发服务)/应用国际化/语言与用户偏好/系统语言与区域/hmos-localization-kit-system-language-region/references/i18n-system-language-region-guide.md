...
接口具体使用方法和说明请参考[System](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-i18n)的API接口文档。
...
- [System API参考说明](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-i18n)
- [扩展参数](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/i18n-locale-culture)
