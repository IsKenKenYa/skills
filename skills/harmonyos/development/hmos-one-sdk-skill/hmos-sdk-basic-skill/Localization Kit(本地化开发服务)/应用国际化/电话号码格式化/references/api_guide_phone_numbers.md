...
电话号码格式化通过 [PhoneNumberFormat](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-i18n) 的 [format](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-i18n) 接口实现。
...
详细API定义和参数说明请参考:
- [PhoneNumberFormat API参考文档](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-i18n)