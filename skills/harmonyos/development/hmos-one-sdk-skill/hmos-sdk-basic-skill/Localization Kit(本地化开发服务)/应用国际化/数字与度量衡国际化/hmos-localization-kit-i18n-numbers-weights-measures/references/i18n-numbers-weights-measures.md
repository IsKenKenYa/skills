...
#### 度量衡转换
度量衡包括长度单位、面积单位、体积单位和容量单位等，通过 [I18NUtil](D:/code/APIDevice/output/md_output/harmonyos-references/应用框架/Localization Kit（本地化开发服务）/ArkTS API/js-apis-i18n.md) 类的 [unitConvert](D:/code/APIDevice/output/md_output/harmonyos-references/应用框架/Localization Kit（本地化开发服务）/ArkTS API/js-apis-i18n.md) 接口实现度量衡转换和格式化。
**格式化风格**
