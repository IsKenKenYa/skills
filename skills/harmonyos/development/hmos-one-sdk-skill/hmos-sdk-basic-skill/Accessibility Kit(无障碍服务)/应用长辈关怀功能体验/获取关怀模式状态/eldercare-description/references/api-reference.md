...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c0/v3/A1c5z_bSTRyiQSL3aQ55pQ/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260401T092737Z&HW-CC-Expire=86400&HW-CC-Sign=C5428C4A44BEC2D47EFEA184F6ADE20CAF6CCCA3CD153BDAEA6EE1CEA743DB2E)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/9c/v3/YlzAep59Tl-SzHdXWb7lDw/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260401T092737Z&HW-CC-Expire=86400&HW-CC-Sign=709F4049E0D7337364DD6DCA3D369E0642D69B10D9C765F38CBB0144CB1D06A2)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c2/v3/ria6aMXkSJqxqYC-fIwG3g/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260401T092737Z&HW-CC-Expire=86400&HW-CC-Sign=7D01634BD0C7748439A4F30B260D30BCF99EF8C50A1818A25A5FB918625664CF)
从API version 8开始支持，从API version 12开始废弃。系统不再开放相关功能。
**系统能力** ：SystemCapability.BarrierFree.Accessibility.Hearing
**参数：**
| 参数名 | 类型 | 必填 | 说明 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/71/v3/5mitufwHRL-de2-qfXgskw/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260401T092737Z&HW-CC-Expire=86400&HW-CC-Sign=03D1736434425A9F158B8C4C11826888E2C8B5855C50552F182D52FD2E0D5DBB)
从API version 8开始支持，从API version 12开始废弃。系统不再开放相关功能。
**系统能力** ：SystemCapability.BarrierFree.Accessibility.Hearing
**参数：**
| 参数名 | 类型 | 必填 | 说明 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/96/v3/bPHSqlLDRjKxYc6m9Rwxmw/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260401T092737Z&HW-CC-Expire=86400&HW-CC-Sign=1E9C561F0967E77BB3CFC90DE01E620619F686C51A7D21D6774F9547C457C050)
从API version 8开始支持，从API version 12开始废弃。系统不再开放相关功能。
**系统能力** ：SystemCapability.BarrierFree.Accessibility.Hearing
**参数：**
| 参数名 | 类型 | 必填 | 说明 |
...
| textAnnouncedForAccessibility12+ | string | 否 | 是 | 主动播报的内容。当应用需要主动播报时，根据实际场景设置播报内容，无特殊限制。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d2/v3/w147urrOQ1KGfWA3EVly9w/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260401T092737Z&HW-CC-Expire=86400&HW-CC-Sign=B4E0975AF2086AAD3A9B4DBA1E27E5FF61E9EBFCC4D03BECB5944F0AEDC91E62)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/dd/v3/1LA-pw9WQdmLWpjZj5IxEA/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260401T092737Z&HW-CC-Expire=86400&HW-CC-Sign=F8E9BFCB36303287789B5B6F0F34831A7D9E0EC50E7FC1646FD94AC109F20CD5)
...
console.info(`accessibilty status = ${status}`);
if (!status) {
  console.info(`screen reader not enable.`); // 屏幕朗读关闭
  return;
}
let abilityType: accessibility.AbilityType = 'all'; // 辅助应用类型为所有类型
let abilityState: accessibility.AbilityState = 'enable'; // 辅助应用状态为已使能
let data: accessibility.AccessibilityAbilityInfo[];
try {
  data = accessibility.getAccessibilityExtensionListSync(abilityType, abilityState);
  if(data.length <= 0) {
  ...
  for (let i = 0; i < data.length; i++) {
    console.info(`Succeeded in get accessibility extension, ${JSON.stringify(data[i])}`);
    if (data[i].bundleName == 'com.huawei.hmos.screenreader') {
      console.info(`screen reader is enabled.`); // 屏幕朗读开启
      return;
    }
  }
} catch (error) {
...
获取无障碍字幕配置管理实例。
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e7/v3/JVbRTYcST8-ULHS7bF7eiA/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260401T092737Z&HW-CC-Expire=86400&HW-CC-Sign=13A55ADE3DE1A292863A71496ED9ACAD89D9C4EEAA0047CAC1E29AA62CCB3E70)
从API version 8开始支持，从API version 12开始废弃。系统不再开放相关功能。
**系统能力** ：SystemCapability.BarrierFree.Accessibility.Hearing
**返回值：**
| 类型 | 说明 |
...
import { accessibility } from '@kit.AccessibilityKit';
import { BusinessError } from '@kit.BasicServicesKit';
let onAccessibilityStateChangeListener = (state: boolean) : void => {
  if (!state) {
    console.info(`screen reader not enable.`); // 屏幕朗读关闭
    return;
  }
...
accessibility.on('accessibilityStateChange', onAccessibilityStateChangeListener);
```
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/61/v3/bNNVyotUQSWWYefapHuBOw/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260401T092737Z&HW-CC-Expire=86400&HW-CC-Sign=03569F9B2083D3763437BA99CCF54093C0E00C01DC08B2CC599DA13962262134)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/82/v3/eUez9tfQQtiS4OOuk9JXjw/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260401T092737Z&HW-CC-Expire=86400&HW-CC-Sign=84DA1A930015C9EFF4ACA58FD4D9D907CE00F51C2D1B1A1ACEE74A3DB5EB8356)
从API version 7开始支持，从API version 10开始废弃，建议使用 [accessibility.isOpenAccessibilitySync](#accessibilityisopenaccessibilitysync10) 替代。
**系统能力** ：SystemCapability.BarrierFree.Accessibility.Core
**参数：**
| 参数名 | 类型 | 必填 | 说明 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/2d/v3/Rw3c5gtxRsSHzBHfBYHiyg/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260401T092737Z&HW-CC-Expire=86400&HW-CC-Sign=B74BEC449E5CDCBCF8982B91704705C3E1591E34784F73AFB1233141EC4AC2F4)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/6c/v3/DEKNfRoJQrS0zVs77kNHlA/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260401T092737Z&HW-CC-Expire=86400&HW-CC-Sign=53DF25768822371211D086E30C24121D7C65CC0CFAB2977F9681079F250A9E32)
从API version 7开始支持，从API version 10开始废弃，建议使用 [accessibility.isOpenTouchGuideSync](#accessibilityisopentouchguidesync10) 替代。
**系统能力** ：SystemCapability.BarrierFree.Accessibility.Vision
**参数：**
| 参数名 | 类型 | 必填 | 说明 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/48/v3/SmQQf7qiR8OXlsNBtJb9SA/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260401T092737Z&HW-CC-Expire=86400&HW-CC-Sign=7EA730A90D4884332CAD2327BDD997B960D4D00FB68467C439B9C3E4A2B75D34)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/92/v3/uhFqk_A8Re-0tHMKxXKvKA/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260401T092737Z&HW-CC-Expire=86400&HW-CC-Sign=A3852F849DE4B925ACCEBDC4E14A66E619A69149A902910D05A6BC4CC1D6BCC4)
