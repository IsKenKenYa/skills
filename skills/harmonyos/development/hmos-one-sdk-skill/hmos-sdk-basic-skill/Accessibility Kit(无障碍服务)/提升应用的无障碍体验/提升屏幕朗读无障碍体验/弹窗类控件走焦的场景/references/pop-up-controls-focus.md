...
支持设置模态类型的弹窗控件包括 [Popup](D:/code/APIDevice/output/md_output/harmonyos-references/应用框架/ArkUI（方舟UI框架）/ArkTS组件/系统预置UI组件库/ohos-arkui-advanced-popup.md) 、 [Menu](D:/code/APIDevice/output/md_output/harmonyos-references/应用框架/ArkUI（方舟UI框架）/ArkTS组件/菜单/ts-basic-components-menu.md) 、 [Diaglog](D:/code/APIDevice/output/md_output/harmonyos-references/应用框架/ArkUI（方舟UI框架）/ArkTS组件/弹窗/ohos-arkui-advanced-dialog.md) 、 [bindSheet](D:/code/APIDevice/output/md_output/harmonyos-references/应用框架/ArkUI（方舟UI框架）/ArkTS组件/通用属性/模态转场设置/ts-universal-attributes-sheet-transition.md) 。
#### 开发实例
