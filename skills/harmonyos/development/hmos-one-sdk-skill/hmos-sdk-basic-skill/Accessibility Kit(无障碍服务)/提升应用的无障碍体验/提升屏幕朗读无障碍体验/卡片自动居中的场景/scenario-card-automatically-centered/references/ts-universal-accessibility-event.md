...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/8/v3/QZZcAeXDTUSuEuK48D5XVQ/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260401T092839Z&HW-CC-Expire=86400&HW-CC-Sign=8E19B0FDEADB8BCA6698B02A34D76D6C166C6C9CBE9B3806D3BD1EA5D0EA7FE5)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [AccessibilityFocusCallback](D:/code/APIDevice/output/md_output/harmonyos-references/应用框架/ArkUI（方舟UI框架）/ArkTS组件/通用事件/无障碍相关/ts-universal-accessibility-event.md) | 是 | 向注册回调函数方通知当前获焦、失焦状态。 |
**返回值：**
| 类型 | 说明 |
| --- | --- |
| T | 返回当前组件。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [AccessibilityActionInterceptCallback](D:/code/APIDevice/output/md_output/harmonyos-references/应用框架/ArkUI（方舟UI框架）/ArkTS组件/通用事件/无障碍相关/ts-universal-accessibility-event.md) | 是 | 在无障碍控制操作触发前，向注册回调函数方通知，由注册方决定是否拦截该次无障碍控制操作。入参设置undefined时取消回调注册。 |
**返回值：**
| 类型 | 说明 |
| --- | --- |
| T | 返回当前组件。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| action | [AccessibilityAction](D:/code/APIDevice/output/md_output/harmonyos-references/应用框架/ArkUI（方舟UI框架）/ArkTS组件/通用事件/无障碍相关/ts-universal-accessibility-event.md) | 是 | 当前触发的无障碍控制操作类型。 |
**返回值：**
| 类型 | 说明 |
| --- | --- |
| [AccessibilityActionInterceptResult](D:/code/APIDevice/output/md_output/harmonyos-references/应用框架/ArkUI（方舟UI框架）/ArkTS组件/通用事件/无障碍相关/ts-universal-accessibility-event.md) | 无障碍控制操作拦截结果。 |
...
从API version 18开始，当获焦、失焦状态发生变化时，触发该回调函数。本示例展示了 [onAccessibilityFocus](D:/code/APIDevice/output/md_output/harmonyos-references/应用框架/ArkUI（方舟UI框架）/ArkTS组件/通用事件/无障碍相关/ts-universal-accessibility-event.md) 的基本用法，聚焦到"onAccessibilityFocus takes effect"时，会打印"[testingTag] isFocus current is true"，聚焦到除了"onAccessibilityFocus takes effect"以外的地方都会打印"[testingTag] isFocus current is false"。
```
// xxx.ets
@Entry
@Component
