...
| **名称** | **类型** | 只读 | **可选** | **说明** |
| --- | --- | --- | --- | --- |
| width | number | 否 | 否 | [XComponent](D:/code/APIDevice/output/md_output/harmonyos-references/应用框架/ArkUI（方舟UI框架）/ArkTS组件/渲染绘制/ts-basic-components-xcomponent.md)组件的宽，默认使用单位为vp，支持px、lpx和vp。 |
| height | number | 否 | 否 | XComponent组件的高，默认使用单位为vp，支持px、lpx和vp。 |
| surfaceId | string | 否 | 否 | XComponent持有surface的ID。 |
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c6/v3/uTNXmxm_Qda2Pfch1BDk8A/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260401T093647Z&HW-CC-Expire=86400&HW-CC-Sign=A0005519075AD7B448E8E74E0DA912B05145AFC6C6D1016DF8DA96FAFB9CC90F)
1. ViewControl的width和height需和XComponent的保持一致，start接口根据设置宽高值会匹配最接近相机分辨率，如果宽高比例与相机的分辨率比例相差过大会影响预览流体验。XComponent组件为预览流提供的Surface，而XComponent的能力由UI提供，相关介绍可参见[XComponent](D:/code/APIDevice/output/md_output/harmonyos-references/应用框架/ArkUI（方舟UI框架）/ArkTS组件/渲染绘制/ts-basic-components-xcomponent.md)。
...
| scanCodeRects | Array<scanBarcode.[ScanCodeRect](D:/code/APIDevice/output/md_output/harmonyos-references/媒体/Scan Kit（统一扫码服务）/ArkTS API/scan-scanbarcode-api.md)> | 否 | 是 | 相机预览流的码图检测位置信息。**设备行为差异：**该属性在带有Kirin NPU（Neural-network Processing Unit，神经网络处理器）的设备可正常返回，在不带有Kirin NPU的设备上返回null。 |
**示例：**
```typescript
import { hilog } from '@kit.PerformanceAnalysisKit';
...
```
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/37/v3/A7kII0gWSHeqKno31Pdywg/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260401T093647Z&HW-CC-Expire=86400&HW-CC-Sign=E302E9C45E958C62497900C60109414DF793E6DF01A81A80D7D106748558F9C3)
...
| **参数名** | **类型** | **必填** | **说明** |
| --- | --- | --- | --- |
| options | scanBarcode.[ScanOptions](D:/code/APIDevice/output/md_output/harmonyos-references/媒体/Scan Kit（统一扫码服务）/ArkTS API/scan-scanbarcode-api.md) | 否 | 自定义界面扫码参数。 |
**错误码：**
以下错误码的详细介绍请参见 [ArkTS API错误码](D:/code/APIDevice/output/md_output/harmonyos-references/媒体/Scan Kit（统一扫码服务）/ArkTS API/scan-error-code.md) 。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a6/v3/IOudye_aQey6BPoJiPgRPg/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260401T093647Z&HW-CC-Expire=86400&HW-CC-Sign=5869FDAEB193EC7A4E988EE27EE1B7381977DB8173A6D7E1F7F5743C86F27850)
此接口需要在init接口调用后才能使用。
**需要权限：** ohos.permission.CAMERA
**系统能力：** SystemCapability.Multimedia.Scan.ScanBarcode
**起始版本：** 4.1.0(11)
...
| **参数名** | **类型** | **必填** | **说明** |
| --- | --- | --- | --- |
| viewControl | [ViewControl](#section8604949165313) | 是 | 相机控制参数。 |
**返回值：**
| **类型** | **说明** |
| --- | --- |
| Promise<Array<scanBarcode.[ScanResult](D:/code/APIDevice/output/md_output/harmonyos-references/媒体/Scan Kit（统一扫码服务）/ArkTS API/scan-scanbarcode-api.md)>> | Promise对象，返回启动相机流扫码结果对象。 |
**错误码：**
以下错误码的详细介绍请参见 [ArkTS API错误码](D:/code/APIDevice/output/md_output/harmonyos-references/媒体/Scan Kit（统一扫码服务）/ArkTS API/scan-error-code.md) 。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/82/v3/IkQb5wL9Tziw8x8tykr4kg/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260401T093647Z&HW-CC-Expire=86400&HW-CC-Sign=B880DEF0A2AC6C92FF2FC3FD731FC376626D8772D8BF8AD4FF32300DE9062E66)
此接口需要在init接口调用后才能使用。
**需要权限：** ohos.permission.CAMERA
**系统能力：** SystemCapability.Multimedia.Scan.ScanBarcode
**起始版本：** 4.1.0(11)
...
| --- | --- | --- | --- |
| viewControl | [ViewControl](#section8604949165313) | 是 | 相机控制参数。 |
| callback | AsyncCallback<Array<scanBarcode.[ScanResult](D:/code/APIDevice/output/md_output/harmonyos-references/媒体/Scan Kit（统一扫码服务）/ArkTS API/scan-scanbarcode-api.md)>> | 是 | 回调函数，当启动相机流扫码成功，err为undefined，data为获取到的Array<scanBarcode.[ScanResult](D:/code/APIDevice/output/md_output/harmonyos-references/媒体/Scan Kit（统一扫码服务）/ArkTS API/scan-scanbarcode-api.md)>；否则为错误对象。 |
| frameCallback | AsyncCallback<[ScanFrame](#section1670633211200)> | 否 | 回调函数，当启动相机流成功，err为undefined，data为获取到的相机预览流（YUV）[ScanFrame](#section1670633211200)；否则为错误对象。**起始版本：**5.0.0(12) |
**错误码：**
以下错误码的详细介绍请参见 [ArkTS API错误码](D:/code/APIDevice/output/md_output/harmonyos-references/媒体/Scan Kit（统一扫码服务）/ArkTS API/scan-error-code.md) 。
从5.0.2(14)开始，customScan模块的start接口新增错误码201。
- 对于5.0.2(14)之前版本，在未申请相机权限时调用customScan模块start接口，返回错误码1000500001。
...
获取当前相机闪光灯状态。
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f1/v3/ysqdyHfCQWCGDYlejjwpzA/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260401T093647Z&HW-CC-Expire=86400&HW-CC-Sign=F7DF2274DC024D5364F05C9A7C2F7CA2F72B4C53F16F8D283D99C5B08D0E5693)
...
openFlashLight(): void
开启相机闪光灯。
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/9b/v3/7lDXEoiUSAGTtanztCl8Zg/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260401T093647Z&HW-CC-Expire=86400&HW-CC-Sign=E65258E8EF164557AC37E881F989CD5D25E5436DAF64842AAEB574DD9CE0211B)
本接口必须在启动相机流start接口后使用，相机流初始化、停止和释放阶段使用都会抛出内部错误的异常。
**系统能力：** SystemCapability.Multimedia.Scan.ScanBarcode
**起始版本：** 4.1.0(11)
**错误码：**
...
关闭相机闪光灯。
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/da/v3/L_kc5ke7SZGD9zoTEHJ3vg/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260401T093647Z&HW-CC-Expire=86400&HW-CC-Sign=EAFF19229DBDCAA9BC2640CD2DE4C3E872225B2ECA4602A351E8C761DA7AE10A)
本接口必须在启动相机流start接口后使用，相机流初始化、停止和释放阶段使用都会抛出内部错误的异常。
**系统能力：** SystemCapability.Multimedia.Scan.ScanBarcode
**起始版本：** 4.1.0(11)
**错误码：**
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/5f/v3/oZ6LfrZgT3OeLdgQZn_E3g/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260401T093647Z&HW-CC-Expire=86400&HW-CC-Sign=5C05F98B269FAB4E93E77AB06A28B160E2E4EC641215658EF23CA5CE7ABB41C1)
...
getZoom(): number
获取当前的变焦比。
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/79/v3/wNRbPlIURTGIKFd0bQCQEg/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260401T093647Z&HW-CC-Expire=86400&HW-CC-Sign=5A1704CF37FE9F9E9857EF04CF871952AFD7A3A042A820403AB161629C673768)
本接口必须在启动相机流start接口后使用。
**系统能力：** SystemCapability.Multimedia.Scan.ScanBarcode
**起始版本：** 5.0.0(12)
**返回值：**
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f0/v3/Dz-PQg4jTXyRk16bShlmQw/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260401T093647Z&HW-CC-Expire=86400&HW-CC-Sign=09ADBA238CFE56E04C6A28D8DE5BAFC8774BA1D2440D71520430B072A90917A4)
本接口必须在启动相机流start接口后使用。
**系统能力：** SystemCapability.Multimedia.Scan.ScanBarcode
**起始版本：** 5.0.0(12)
**参数：**
| **参数名** | **类型** | **必填** | **说明** |
| --- | --- | --- | --- |
| point | scanBarcode.[Point](D:/code/APIDevice/output/md_output/harmonyos-references/媒体/Scan Kit（统一扫码服务）/ArkTS API/scan-scanbarcode-api.md) | 是 | 焦点。x、y设置范围应在[0，1]之内，超过范围，如果小于0设置0，大于1设置1。 |
**错误码：**
以下错误码的详细介绍请参见 [ArkTS API错误码](D:/code/APIDevice/output/md_output/harmonyos-references/媒体/Scan Kit（统一扫码服务）/ArkTS API/scan-error-code.md) 。
| 错误码ID | 错误信息 |
| --- | --- |
...
resetFocus(): void
设置连续自动对焦模式。
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/4d/v3/aDwQ-XjdR1mMmFoAGkAeHA/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260401T093647Z&HW-CC-Expire=86400&HW-CC-Sign=2455D6DAC565954FB2A95A100817BD80DDA604C5DCD2AFF36BE53DC0B5283E92)
本接口必须在启动相机流start接口后使用。
**系统能力：** SystemCapability.Multimedia.Scan.ScanBarcode
**起始版本：** 5.0.0(12)
**错误码：**
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e1/v3/xsIpfjoCTtOEtvMsM9w6cA/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260401T093647Z&HW-CC-Expire=86400&HW-CC-Sign=9A6125A8DA0366BFED009DF35A4F456F6352DA86AF70EB3819CC9DDA716D5F31)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/4/v3/eY4PTZu9RUKG1qigF_M3CQ/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260401T093647Z&HW-CC-Expire=86400&HW-CC-Sign=8290953E272DD0C34DC45F8D2C8B3464C836E706A38DBAFA84A93ABF825CB7E7)
本接口必须在启动相机流start接口后使用，未启动相机流调用会抛出内部错误的异常。
**系统能力：** SystemCapability.Multimedia.Scan.ScanBarcode
**起始版本：** 5.0.0(12)
**参数：**
...
| --- | --- | --- | --- |
| type | string | 是 | 事件回调类型，固定为'lightingFlash'，当环境亮度发生变化时触发，可用于提示用户开启或关闭闪光灯。 |
| callback | AsyncCallback<boolean> | 否 | 需要被注销的回调函数，若callback不填，则注销所有绑定在'lightingFlash'上的回调函数，若填写callback，则必须和customScan.on中监听的事件保持一致。 |
**错误码：**
以下错误码的详细介绍请参见 [ArkTS API错误码](D:/code/APIDevice/output/md_output/harmonyos-references/媒体/Scan Kit（统一扫码服务）/ArkTS API/scan-error-code.md) 。
| 错误码ID | 错误信息 |
| --- | --- |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a5/v3/qO-7U1OHQ3Cz5vOA-0lHZw/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260401T093647Z&HW-CC-Expire=86400&HW-CC-Sign=F053018D9B01EF7D9FC91C0F76E5C7AED8356CA86E4BDFBE5861DB37F5A8DFB3)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/63/v3/sYzgDIfuQ2WCzCniE4AKug/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260401T093647Z&HW-CC-Expire=86400&HW-CC-Sign=B57E2003704CE39E46985E4A3290D91D8491381627ECB6A987BAD86522787587)
本接口必须在启动相机流start接口后使用，未启动相机流调用会抛出内部错误的异常。
**系统能力：** SystemCapability.Multimedia.Scan.ScanBarcode
**起始版本：** 5.1.0(18)
**参数：**
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/32/v3/RRcKTCFyRg2klrV_vSbiJQ/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260401T093647Z&HW-CC-Expire=86400&HW-CC-Sign=F3A10CB4F3EBC8448F508C3191EC6171FB874427CA649CBF17BDD65806CEFFFE)
本接口必须在启动相机流start接口后使用，未启动相机流调用会抛出内部错误的异常。
**系统能力：** SystemCapability.Multimedia.Scan.ScanBarcode
**起始版本：** 4.1.0(11)
**返回值：**
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/8a/v3/HEFHAkLQTXWTqtQoSMsJNw/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260401T093647Z&HW-CC-Expire=86400&HW-CC-Sign=A373DD17CE54D909F94005D753E31CA989DC9D734BAC62DDB2CF543256D2F37B)
本接口必须在启动相机流start接口后使用，未启动相机流调用会抛出内部错误的异常。
**系统能力：** SystemCapability.Multimedia.Scan.ScanBarcode
**起始版本：** 4.1.0(11)
**参数：**
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ef/v3/ik2s6uoMRkmMkiOzmqFrjg/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260401T093647Z&HW-CC-Expire=86400&HW-CC-Sign=F85DA7E5A1466D943BDBB0DBB17CC9CD62D884B60331A81C1D08C8799A655DB0)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/fc/v3/gpJtzzWtSw-04X_srw5pjw/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260401T093647Z&HW-CC-Expire=86400&HW-CC-Sign=E142D2937456A848E973EB882E3D398C0E41ED6F131B328F6AFA841BA2E5B044)
本接口建议在启动相机流start接口且暂停相机流stop接口后使用，未启动相机流调用会抛出内部错误的异常。
**系统能力：** SystemCapability.Multimedia.Scan.ScanBarcode
**起始版本：** 4.1.0(11)
**参数：**
