...
---
# ArkTS API错误码
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/da/v3/U6z4Ihf8RGeQTJoR_bEMnw/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260401T093648Z&HW-CC-Expire=86400&HW-CC-Sign=83046DBCA06188BE47EBC2F8907A974D6AF4910BD04F589F053AD4A2AE94F652)
...
用户点击关闭按钮或侧滑取消默认界面扫码。
**处理步骤**
使用 [scanBarcode.startScanForResult](D:/code/APIDevice/output/md_output/harmonyos-references/媒体/Scan Kit（统一扫码服务）/ArkTS API/scan-scanbarcode-api.md) 会返回此错误码，请根据使用场景处理用户取消默认界面扫码后的业务流程。