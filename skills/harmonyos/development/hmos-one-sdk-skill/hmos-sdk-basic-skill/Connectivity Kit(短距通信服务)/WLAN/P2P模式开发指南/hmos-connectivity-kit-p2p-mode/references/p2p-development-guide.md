...
- 建立P2P连接
#### 接口说明
完整的JS API说明以及示例代码请参考： [P2P接口](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Connectivity Kit（短距通信服务）/ArkTS API/js-apis-wifimanager.md) 。
具体接口说明如下表。
| 接口名 | 功能描述 |
| --- | --- |
| createGroup() | 创建群组。 |
...
```
6.
错误码请参见 [WIFI错误码](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Connectivity Kit（短距通信服务）/错误码/errorcode-wifi.md) 。
#### 建立P2P连接
1.
import需要的Wi-Fi模块。
```
...
4. 通过[wifiP2pLinkedInfo.connectState](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Connectivity Kit（短距通信服务）/ArkTS API/js-apis-wifimanager.md)获取P2P连接状态，确保连接状态为CONNECTED。
5. 通过[wifiP2pGroupInfo.goIpAddress](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Connectivity Kit（短距通信服务）/ArkTS API/js-apis-wifimanager.md)获取群组IP地址，以便Socket通信。
6. Socket通信请参考[使用Socket访问网络](D:/code/APIDevice/output/md_output/harmonyos-guides/系统/网络/Network Kit（网络服务）/访问网络/使用Socket访问网络/socket-connection.md)。