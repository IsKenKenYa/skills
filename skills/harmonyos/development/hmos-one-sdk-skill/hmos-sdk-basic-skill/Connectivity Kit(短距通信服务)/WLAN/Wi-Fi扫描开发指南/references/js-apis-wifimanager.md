...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c8/v3/8CHKRMVXQvCy2mejshYYjw/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260401T093252Z&HW-CC-Expire=86400&HW-CC-Sign=1D474EED3AD7FC057A95EB74168D6164D348E26550CE385CDC2B157F583C80F3)
...
**错误码：**
以下错误码的详细介绍请参见 [WIFI错误码](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Connectivity Kit（短距通信服务）/错误码/errorcode-wifi.md) 。
| 错误码ID | 错误信息 |
| --- | --- |
...
**系统能力：** SystemCapability.Communication.WiFi.STA
**错误码：**
以下错误码的详细介绍请参见 [通用错误码说明文档](D:/code/APIDevice/output/md_output/harmonyos-references/API参考概述/errorcode-universal.md) 和 [WIFI错误码](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Connectivity Kit（短距通信服务）/错误码/errorcode-wifi.md) 。
| 错误码ID | 错误信息 |
| --- | --- |
| 201 | Permission denied. |
| 801 | Capability not supported. |
...
scan(): void
启动WLAN扫描，使用前先使能WLAN。
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a1/v3/jgrEGPoxRWqhcY7CFvE8SQ/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260401T093252Z&HW-CC-Expire=86400&HW-CC-Sign=18D357BFE3D2E5A1F1E164EDE6F9D900F5076C9EAF56EC15F31387D81ED7D7F2)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/19/v3/uMS7ur0_RFymJxFy1-8buw/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260401T093252Z&HW-CC-Expire=86400&HW-CC-Sign=79BFB7C24F23743F514D5D480F5A3F01B16EAB3AD09DB955F8B5577EC6084AD0)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/87/v3/7MEY1fYmRg6WrqBYDnXkvA/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260401T093252Z&HW-CC-Expire=86400&HW-CC-Sign=A139A7F4E512C67197048C53CC9A977EF8921AE092B08790AD2F960E61D59B39)
从 API version 9开始支持，从API version 10开始废弃。建议使用 [wifiManager.getScanInfoList](#wifimanagergetscaninfolist10) 代替。
**需要权限：** ohos.permission.GET_WIFI_INFO 和 (ohos.permission.GET_WIFI_PEERS_MAC 或 (ohos.permission.LOCATION 和 ohos.permission.APPROXIMATELY_LOCATION))
**系统能力：** SystemCapability.Communication.WiFi.STA
**参数：**
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e9/v3/j3lhNTbOSuq2fWbtea7Ctw/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260401T093252Z&HW-CC-Expire=86400&HW-CC-Sign=70E47E278FB1E2A9E4BEA22407CD7C4DBD15988B2909A2E85BC3B5B67AAF24CA)
从 API version 9开始支持，从API version 10开始废弃。建议使用 [wifiManager.getScanInfoList](#wifimanagergetscaninfolist10) 代替。
**需要权限：** ohos.permission.GET_WIFI_INFO 和 (ohos.permission.GET_WIFI_PEERS_MAC 或 (ohos.permission.LOCATION 和 ohos.permission.APPROXIMATELY_LOCATION))
**系统能力：** SystemCapability.Communication.WiFi.STA
**返回值：**
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d8/v3/5utWzdBfSGuEr7Mx2EQF6A/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260401T093252Z&HW-CC-Expire=86400&HW-CC-Sign=B3C1E6DC2D3865F2EAE160887BD19A8A925D5AE73086D90CEFF99528E625070F)
...
**错误码：**
以下错误码的详细介绍请参见 [通用错误码](D:/code/APIDevice/output/md_output/harmonyos-references/API参考概述/errorcode-universal.md) 和 [WIFI错误码](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Connectivity Kit（短距通信服务）/错误码/errorcode-wifi.md) 。
| 错误码ID | 错误信息 |
| --- | --- |
| 201 | Permission denied. |
| 801 | Capability not supported. |
...
**需要权限：** ohos.permission.GET_WIFI_INFO 。
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ff/v3/wjs7NEVVRLej6pAuhBpSPw/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260401T093252Z&HW-CC-Expire=86400&HW-CC-Sign=4079C6CC78586E02D2853505BA99B2C9BD4A11D56D197677C5E2309FE29395E4)
...
**需要权限：** ohos.permission.GET_WIFI_INFO 。
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/6f/v3/gow-BIZKSM6rndMgcKkjUA/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260401T093252Z&HW-CC-Expire=86400&HW-CC-Sign=B4D8E8D36C48BC843F2F4AEB3906706A606A1C6E7A5695AE49767B1642D2ABB6)
- 当macType是1（设备MAC地址），获取macAddress还需申请ohos.permission.GET_WIFI_LOCAL_MAC权限（API8-15仅面向系统应用开放。从API 16开始，在PC/2in1设备上面向普通应用开放，在其余设备上仍仅面向系统应用开放），无该权限时，macAddress返回为空。
- 如果应用申请了ohos.permission.GET_WIFI_PEERS_MAC权限，则返回结果中的bssid为真实BSSID地址，否则为随机设备地址。
**系统能力：** SystemCapability.Communication.WiFi.STA
**返回值：**
...
**需要权限：** ohos.permission.GET_WIFI_INFO
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/4b/v3/72G7euB6R--KslXGRhCIbA/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260401T093252Z&HW-CC-Expire=86400&HW-CC-Sign=362A8205F121249B0A822C72525800E97780A4936B2C93EF1B7B6E6B856177B8)
- 当macType是1（设备MAC地址），获取macAddress还需申请ohos.permission.GET_WIFI_LOCAL_MAC权限（API8-15仅面向系统应用开放。从API 16开始，在PC/2in1设备上面向普通应用开放，在其余设备上仍仅面向系统应用开放），无该权限时，macAddress返回为空。
- 如果应用申请了ohos.permission.GET_WIFI_PEERS_MAC权限，则返回结果中的bssid为真实BSSID地址，否则为随机设备地址。
**系统能力：** SystemCapability.Communication.WiFi.STA
**返回值：**
