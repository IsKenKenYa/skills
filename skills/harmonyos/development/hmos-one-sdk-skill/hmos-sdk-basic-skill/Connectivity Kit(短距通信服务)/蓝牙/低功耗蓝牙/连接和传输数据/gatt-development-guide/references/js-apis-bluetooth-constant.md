...
---
# @ohos.bluetooth.constant (蓝牙constant模块)
本模块提供了蓝牙 [Profile](D:/code/APIDevice/output/md_output/harmonyos-guides/系统/网络/Connectivity Kit（短距通信服务）/Connectivity Kit术语/terminology.md) 、设备类型相关的常量定义。
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/94/v3/5JyXjBojRImbcx3yV_64BA/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260401T093250Z&HW-CC-Expire=86400&HW-CC-Sign=A4C9BB5A96B071863E3DED4F7FA274124151FFD56EAA80B3CC76AB497F505158)
...
```
#### ProfileId
枚举，表示蓝牙 [Profile](D:/code/APIDevice/output/md_output/harmonyos-guides/系统/网络/Connectivity Kit（短距通信服务）/Connectivity Kit术语/terminology.md) 协议的标识。
**系统能力** ：SystemCapability.Communication.Bluetooth.Core
| 名称 | 值 | 说明 |
| --- | --- | --- |
| PROFILE_A2DP_SOURCE | 1 | [A2DP Source](D:/code/APIDevice/output/md_output/harmonyos-guides/系统/网络/Connectivity Kit（短距通信服务）/Connectivity Kit术语/terminology.md)Profile，负责发送音频数据端使用的协议。 |
| PROFILE_HANDSFREE_AUDIO_GATEWAY | 4 | [HFP Ag](D:/code/APIDevice/output/md_output/harmonyos-guides/系统/网络/Connectivity Kit（短距通信服务）/Connectivity Kit术语/terminology.md)Profile，负责通话音频网关使用的协议。 |
| PROFILE_HID_HOST | 6 | [HID Host](D:/code/APIDevice/output/md_output/harmonyos-guides/系统/网络/Connectivity Kit（短距通信服务）/Connectivity Kit术语/terminology.md)Profile，负责与[HID Device](D:/code/APIDevice/output/md_output/harmonyos-guides/系统/网络/Connectivity Kit（短距通信服务）/Connectivity Kit术语/terminology.md)建立通信并处理数据交互的协议。 |
| PROFILE_PAN_NETWORK | 7 | [NAP](D:/code/APIDevice/output/md_output/harmonyos-guides/系统/网络/Connectivity Kit（短距通信服务）/Connectivity Kit术语/terminology.md)Profile，负责提供网络共享端使用的协议。 |
...
| 名称 | 值 | 说明 |
| --- | --- | --- |
| STATE_DISCONNECTED | 0 | 表示Profile已断开连接。 |
...
| 名称 | 值 | 说明 |
| --- | --- | --- |
| MAJOR_MISC | 0x0000 | 表示不属于其他标准类别的杂项设备。 |
| MAJOR_COMPUTER | 0x0100 | 表示计算机设备。 |
| MAJOR_PHONE | 0x0200 | 表示手机设备。 |
| MAJOR_NETWORKING | 0x0300 | 表示局域网/网络接入点设备。 |
| MAJOR_AUDIO_VIDEO | 0x0400 | 表示音频/视频设备。 |
...
| AUDIO_VIDEO_HEADPHONES | 0x0418 | 表示头戴式音频/视频设备。 |
| AUDIO_VIDEO_PORTABLE_AUDIO | 0x041C | 表示便携式音频/视频设备。 |
| AUDIO_VIDEO_CAR_AUDIO | 0x0420 | 表示汽车音频/视频设备。 |
...
| WEARABLE_JACKET | 0x070C | 表示可穿戴夹克设备。 |
...
#### ProfileUuids12+
枚举，由蓝牙技术联盟（ [Bluetooth Special Interest Group](D:/code/APIDevice/output/md_output/harmonyos-guides/系统/网络/Connectivity Kit（短距通信服务）/Connectivity Kit术语/terminology.md) ）定义，使用通用唯一标识（Universally Unique Identifier， [UUID](D:/code/APIDevice/output/md_output/harmonyos-guides/系统/网络/Connectivity Kit（短距通信服务）/Connectivity Kit术语/terminology.md) ）表示不同的蓝牙协议Profile。
**系统能力** ：SystemCapability.Communication.Bluetooth.Core
| 名称 | 值 | 说明 |
| --- | --- | --- |
| PROFILE_UUID_HFP_AG | '0000111F-0000-1000-8000-00805F9B34FB' | 表示Hands-Free Audio Gateway Profile。 |
| PROFILE_UUID_HFP_HF | '0000111E-0000-1000-8000-00805F9B34FB' | 表示Hands-Free Profile。 |
| PROFILE_UUID_HSP_AG | '00001112-0000-1000-8000-00805F9B34FB' | 表示Headset Audio Gateway Profile。 |
| PROFILE_UUID_HSP_HS | '00001108-0000-1000-8000-00805F9B34FB' | 表示Headset Profile。 |
| PROFILE_UUID_A2DP_SRC | '0000110A-0000-1000-8000-00805F9B34FB' | 表示A2DP Source Profile。 |
| PROFILE_UUID_A2DP_SINK | '0000110B-0000-1000-8000-00805F9B34FB' | 表示A2DP Sink Profile。 |
| PROFILE_UUID_AVRCP_CT | '0000110E-0000-1000-8000-00805F9B34FB' | 表示AVRCP Controller Profile。 |
| PROFILE_UUID_AVRCP_TG | '0000110C-0000-1000-8000-00805F9B34FB' | 表示AVRCP Target Profile。 |
| PROFILE_UUID_HID | '00001124-0000-1000-8000-00805F9B34FB' | 表示HID Profile。 |
| PROFILE_UUID_HOGP | '00001812-0000-1000-8000-00805F9B34FB' | 表示HID over GATT Profile。 |