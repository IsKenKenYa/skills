...
GATT是低功耗蓝牙（BLE）的核心协议，定义了基于服务（Service）、特征值（Characteristic）和描述符（Descriptor）进行蓝牙通信和传输数据的机制。相关术语介绍请参考 [Connectivity Kit术语](D:/code/APIDevice/output/md_output/harmonyos-guides/系统/网络/Connectivity Kit（短距通信服务）/Connectivity Kit术语/terminology.md) 。
#### 实现原理
...
客户端的BLE扫描和服务端的BLE广播流程，请参考 [查找设备](D:/code/APIDevice/output/md_output/harmonyos-guides/系统/网络/Connectivity Kit（短距通信服务）/蓝牙/低功耗蓝牙/查找设备/ble-development-guide.md) 。
#### 开发步骤
#### 申请蓝牙权限
需要申请权限ohos.permission.ACCESS_BLUETOOTH。如何配置和申请权限，请参考 [声明权限](D:/code/APIDevice/output/md_output/harmonyos-guides/系统/安全/程序访问控制/应用权限管控/申请应用权限/声明权限/declare-permissions.md) 和 [向用户申请授权](D:/code/APIDevice/output/md_output/harmonyos-guides/系统/安全/程序访问控制/应用权限管控/申请应用权限/向用户申请授权/request-user-authorization.md) 。
#### 导入所需API模块
...
相关API请参考 [readCharacteristicValue](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Connectivity Kit（短距通信服务）/ArkTS API/js-apis-bluetooth-ble.md) 和 [writeCharacteristicValue](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Connectivity Kit（短距通信服务）/ArkTS API/js-apis-bluetooth-ble.md) 。
```
// 此处是伪代码
let device = 'XX:XX:XX:XX:XX:XX';
...
相关API请参考 [readDescriptorValue](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Connectivity Kit（短距通信服务）/ArkTS API/js-apis-bluetooth-ble.md) 和 [writeDescriptorValue](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Connectivity Kit（短距通信服务）/ArkTS API/js-apis-bluetooth-ble.md) 。
```
// 此处是伪代码
let device = 'XX:XX:XX:XX:XX:XX';
let bufferDesc = new ArrayBuffer(2);
...
- 先订阅服务端特征值变化事件，详情请见[on('BLECharacteristicChange')](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Connectivity Kit（短距通信服务）/ArkTS API/js-apis-bluetooth-ble.md)。
- 再使能服务端特征值变化通知或者指示能力，应用根据实际场景选择一种方式即可。相关API请参考[setCharacteristicChangeNotification](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Connectivity Kit（短距通信服务）/ArkTS API/js-apis-bluetooth-ble.md)和[setCharacteristicChangeIndication](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Connectivity Kit（短距通信服务）/ArkTS API/js-apis-bluetooth-ble.md)。
```
// 此处是伪代码
let device = 'XX:XX:XX:XX:XX:XX';
// 定义服务端特征值变化事件
...
```
**3. 订阅连接状态变化事件**
通过订阅连接状态变化事件，可以获取实时的GATT连接状态以及客户端的设备地址。整个连接过程涉及多种状态的跃迁，其中 [STATE_CONNECTED](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Connectivity Kit（短距通信服务）/ArkTS API/js-apis-bluetooth-constant.md) 表示已连接， [STATE_DISCONNECTED](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Connectivity Kit（短距通信服务）/ArkTS API/js-apis-bluetooth-constant.md) 表示已断连。
```
...
**4.1 订阅特征值读取或写入事件**
通过订阅特征值读取或写入事件，获取客户端的操作请求，相关API请参考 [on('characteristicRead')](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Connectivity Kit（短距通信服务）/ArkTS API/js-apis-bluetooth-ble.md) 和 [on('characteristicWrite')](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Connectivity Kit（短距通信服务）/ArkTS API/js-apis-bluetooth-ble.md) 。
- 收到读取特征值请求时，需要调用[sendResponse](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Connectivity Kit（短距通信服务）/ArkTS API/js-apis-bluetooth-ble.md)进行回复对应特征值的数据内容。
- 收到写入特征值请求时，可保存客户端写入的特征值数据内容。根据写入请求[CharacteristicWriteRequest](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Connectivity Kit（短距通信服务）/ArkTS API/js-apis-bluetooth-ble.md)的needRsp判断是否需要调用[sendResponse](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Connectivity Kit（短距通信服务）/ArkTS API/js-apis-bluetooth-ble.md)进行回复。
```
let gattServer: ble.GattServer = ble.createGattServer();
...
```
**4.2 订阅描述符读取或写入事件**
通过订阅描述符读取或写入事件，获取客户端的操作请求，相关API请参考 [on('descriptorRead')](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Connectivity Kit（短距通信服务）/ArkTS API/js-apis-bluetooth-ble.md) 和 [on('descriptorWrite')](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Connectivity Kit（短距通信服务）/ArkTS API/js-apis-bluetooth-ble.md) 。
- 收到读取描述符请求时，需要调用[sendResponse](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Connectivity Kit（短距通信服务）/ArkTS API/js-apis-bluetooth-ble.md)进行回复对应描述符的数据内容。
- 收到写入描述符请求时，可保存客户端写入的描述符数据内容。根据写入请求[DescriptorWriteRequest](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Connectivity Kit（短距通信服务）/ArkTS API/js-apis-bluetooth-ble.md)的needRsp判断是否需要调用[sendResponse](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Connectivity Kit（短距通信服务）/ArkTS API/js-apis-bluetooth-ble.md)进行回复。
```
let gattServer: ble.GattServer = ble.createGattServer();
// 定义描述符读取回调函数
...
```
**4.3 发送特征值变化通知或指示**
当服务端的特征值数据内容发生变化时，可以通过通知或者指示主动知会到客户端，相关API请参考 [notifyCharacteristicChanged](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Connectivity Kit（短距通信服务）/ArkTS API/js-apis-bluetooth-ble.md) 。
发送通知时，不需要客户端回复确认；发送指示时，需要客户端回复确认。应用根据 [NotifyCharacteristic](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Connectivity Kit（短距通信服务）/ArkTS API/js-apis-bluetooth-ble.md) 的confirm参数决定发送哪种类型。
- 该特征值需包含蓝牙标准协议定义的Client Characteristic Configuration描述符UUID（00002902-0000-1000-8000-00805f9b34fb），才支持通知或者指示能力。
- 使用通知或者指示能力需要使能。客户端可以通过[setCharacteristicChangeNotification](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Connectivity Kit（短距通信服务）/ArkTS API/js-apis-bluetooth-ble.md)或[setCharacteristicChangeIndication](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Connectivity Kit（短距通信服务）/ArkTS API/js-apis-bluetooth-ble.md)使能该能力，应用根据实际场景选择一种方式即可。
```
