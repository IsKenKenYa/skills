...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/4b/v3/HsciRY0MRdW7eLR_CJw2sA/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260401T093249Z&HW-CC-Expire=86400&HW-CC-Sign=A386EE4059C3B363FE7C408B26B244BF6D5241FBD23C675650D71A0FF5C81D3F)
...
| 类型 | 说明 |
| --- | --- |
| [constant.ProfileConnectionState](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Connectivity Kit（短距通信服务）/ArkTS API/js-apis-bluetooth-constant.md) | 蓝牙设备的Profile协议连接状态。 |
#### ProfileId
...
| 类型 | 说明 |
| --- | --- |
| [constant.ProfileId](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Connectivity Kit（短距通信服务）/ArkTS API/js-apis-bluetooth-constant.md) | 蓝牙Profile协议的枚举。 |
#### ProfileUuids12+
...
| 类型 | 说明 |
| --- | --- |
| [constant.ProfileUuids](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Connectivity Kit（短距通信服务）/ArkTS API/js-apis-bluetooth-constant.md) | 蓝牙Profile协议的UUID。 |
#### MajorClass
...
| 类型 | 说明 |
| --- | --- |
| [constant.MajorClass](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Connectivity Kit（短距通信服务）/ArkTS API/js-apis-bluetooth-constant.md) | 蓝牙设备的主要类型。 |
#### MajorMinorClass
type MajorMinorClass = constant.MajorMinorClass
蓝牙设备的子类型，在 [MajorClass](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Connectivity Kit（短距通信服务）/ArkTS API/js-apis-bluetooth-constant.md) 基础上进一步细分的类型。蓝牙标准协议字段。
**系统能力** ：SystemCapability.Communication.Bluetooth.Core
| 类型 | 说明 |
| --- | --- |
| [constant.MajorMinorClass](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Connectivity Kit（短距通信服务）/ArkTS API/js-apis-bluetooth-constant.md) | 蓝牙设备的子类型。 |
#### BluetoothAddress21+
...
| 类型 | 说明 |
| --- | --- |
| [common.BluetoothAddress](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Connectivity Kit（短距通信服务）/ArkTS API/js-apis-bluetooth-common.md) | 蓝牙设备的地址信息。 |
#### connection.pairDevice
pairDevice(deviceId: string, callback: AsyncCallback<void>): void
主动发起与对端蓝牙设备的配对流程。使用Callback异步回调。
- 若开发者不知道目标设备的[地址类型](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Connectivity Kit（短距通信服务）/ArkTS API/js-apis-bluetooth-common.md)，建议调用此接口发起配对。
...
**错误码** ：
以下错误码的详细介绍请参见 [蓝牙服务子系统错误码](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Connectivity Kit（短距通信服务）/错误码/errorcode-bluetoothmanager.md) 。
| 错误码ID | 错误信息 |
| --- | --- |
...
主动发起与对端蓝牙设备的配对流程。使用Promise异步回调。
- 若开发者已知目标设备的MAC地址及[地址类型](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Connectivity Kit（短距通信服务）/ArkTS API/js-apis-bluetooth-common.md)，建议调用此接口发起配对。
- 蓝牙配对状态通过[on('bondStateChange')](#connectiononbondstatechange)的回调结果获取。
**需要权限** ：ohos.permission.ACCESS_BLUETOOTH
**系统能力** ：SystemCapability.Communication.Bluetooth.Core
**参数：**
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| deviceId | [BluetoothAddress](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Connectivity Kit（短距通信服务）/ArkTS API/js-apis-bluetooth-common.md) | 是 | 需要配对的对端蓝牙设备地址信息，包括地址与地址类型。 |
**返回值：**
| 类型 | 说明 |
| --- | --- |
...
| callback | AsyncCallback<Array<[ProfileUuids](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Connectivity Kit（短距通信服务）/ArkTS API/js-apis-bluetooth-constant.md)>> | 是 | 回调函数。当获取UUID成功，err为undefined，获取到的是Profile协议能力集合；否则为错误对象。 |
**错误码** ：
以下错误码的详细介绍请参见 [蓝牙服务子系统错误码](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Connectivity Kit（短距通信服务）/错误码/errorcode-bluetoothmanager.md) 。
| 错误码ID | 错误信息 |
| --- | --- |
...
| 类型 | 说明 |
| --- | --- |
| Promise<Array<[ProfileUuids](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Connectivity Kit（短距通信服务）/ArkTS API/js-apis-bluetooth-constant.md)>> | Promise对象，返回支持的Profile协议能力集合。 |
**错误码** ：
以下错误码的详细介绍请参见 [蓝牙服务子系统错误码](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Connectivity Kit（短距通信服务）/错误码/errorcode-bluetoothmanager.md) 。
| 错误码ID | 错误信息 |
| --- | --- |
...
| 类型 | 说明 |
| --- | --- |
| Array<string> | 已配对蓝牙设备的地址集合。基于信息安全考虑，此处获取的设备地址为虚拟MAC地址。- 已配对的地址不会变更。- 若该设备重启蓝牙开关，重新获取到的虚拟地址会立即变更。- 若取消配对，蓝牙子系统会根据该地址的实际使用情况，决策后续变更时机；若其他应用正在使用该地址，则不会立刻变更。- 若要持久化保存该地址，可使用[access.addPersistentDeviceId](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Connectivity Kit（短距通信服务）/ArkTS API/js-apis-bluetooth-access.md)方法。 |
**错误码** ：
以下错误码的详细介绍请参见 [蓝牙服务子系统错误码](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Connectivity Kit（短距通信服务）/错误码/errorcode-bluetoothmanager.md) 。
| 错误码ID | 错误信息 |
| --- | --- |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| profileId | [ProfileId](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Connectivity Kit（短距通信服务）/ArkTS API/js-apis-bluetooth-constant.md) | 否 | 表示Profile协议的枚举值。如果携带ProfileId，则返回指定Profile协议的连接状态。如果未携带ProfileId，则检查所有支持的Profile连接状态，按如下优先级顺序检查并返回：- 存在已连接的Profile协议，则返回[STATE_CONNECTED](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Connectivity Kit（短距通信服务）/ArkTS API/js-apis-bluetooth-constant.md)。- 存在正在连接的Profile协议，则返回[STATE_CONNECTING](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Connectivity Kit（短距通信服务）/ArkTS API/js-apis-bluetooth-constant.md)。- 存在正在断连的Profile协议，则返回[STATE_DISCONNECTING](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Connectivity Kit（短距通信服务）/ArkTS API/js-apis-bluetooth-constant.md)。- 以上条件均不满足，则返回[STATE_DISCONNECTED](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Connectivity Kit（短距通信服务）/ArkTS API/js-apis-bluetooth-constant.md)。 |
**返回值：**
| 类型 | 说明 |
| --- | --- |
| [ProfileConnectionState](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Connectivity Kit（短距通信服务）/ArkTS API/js-apis-bluetooth-constant.md) | Profile协议的连接状态。 |
**错误码** ：
以下错误码的详细介绍请参见 [蓝牙服务子系统错误码](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Connectivity Kit（短距通信服务）/错误码/errorcode-bluetoothmanager.md) 。
| 错误码ID | 错误信息 |
| --- | --- |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ad/v3/JJedonOAThOJ9mdgtevm8g/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260401T093249Z&HW-CC-Expire=86400&HW-CC-Sign=F2ACFEFB0E4A28A16DAD3A915C7E4B26E5CCA866D352897679CB331877FE82A1)
...
| callback | Callback<Array<string>> | 是 | 指定订阅的回调函数，会携带扫描到的设备地址集合。基于信息安全考虑，此处获取的设备地址为虚拟MAC地址。- 已配对的地址不会变更。- 若该设备重启蓝牙开关，重新获取到的虚拟地址会立即变更。- 若取消配对，蓝牙子系统会根据该地址的实际使用情况，决策后续变更时机；若其他应用正在使用该地址，则不会立刻变更。- 若要持久化保存该地址，可使用[access.addPersistentDeviceId](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Connectivity Kit（短距通信服务）/ArkTS API/js-apis-bluetooth-access.md)方法。 |
**错误码** ：
以下错误码的详细介绍请参见 [蓝牙服务子系统错误码](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Connectivity Kit（短距通信服务）/错误码/errorcode-bluetoothmanager.md) 。
| 错误码ID | 错误信息 |
| --- | --- |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| majorClass | [MajorClass](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Connectivity Kit（短距通信服务）/ArkTS API/js-apis-bluetooth-constant.md) | 否 | 否 | 主要类型。是蓝牙标准协议中定义的类型字段。 |
| majorMinorClass | [MajorMinorClass](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Connectivity Kit（短距通信服务）/ArkTS API/js-apis-bluetooth-constant.md) | 否 | 否 | 子类型，是在主要类型上基础上进一步细分的类型。是蓝牙标准协议中定义的类型字段。 |
| classOfDevice | number | 否 | 否 | 设备类型。是蓝牙标准协议中定义的类型字段，包含了[MajorClass](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Connectivity Kit（短距通信服务）/ArkTS API/js-apis-bluetooth-constant.md)、[MajorMinorClass](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Connectivity Kit（短距通信服务）/ArkTS API/js-apis-bluetooth-constant.md)和支持的主要服务这三种设备信息。 |
#### BatteryInfo12+
描述设备的电量信息。
...
| TRANSPORT_DUAL20+ | 2 | 同时支持传统蓝牙（BR/EDR）和低功耗蓝牙（BLE）的双模设备传输方式。设备可以根据需要选择使用传统蓝牙（BR/EDR）或低功耗蓝牙（BLE）进行通信。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| deviceId | string | 否 | 否 | 扫描到的设备地址。基于信息安全考虑，此处获取的设备地址为虚拟MAC地址。- 已配对的地址不会变更。- 若该设备重启蓝牙开关，重新获取到的虚拟地址会立即变更。- 若取消配对，蓝牙子系统会根据该地址的实际使用情况，决策后续变更时机；若其他应用正在使用该地址，则不会立刻变更。- 若要持久化保存该地址，可使用[access.addPersistentDeviceId](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Connectivity Kit（短距通信服务）/ArkTS API/js-apis-bluetooth-access.md)方法。 |
