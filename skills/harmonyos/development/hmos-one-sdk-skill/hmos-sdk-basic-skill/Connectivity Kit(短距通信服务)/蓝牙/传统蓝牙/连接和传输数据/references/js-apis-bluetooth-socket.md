...
支持的套接字链路类型包括 [RFCOMM](D:/code/APIDevice/output/md_output/harmonyos-guides/系统/网络/Connectivity Kit（短距通信服务）/Connectivity Kit术语/terminology.md) 和 [L2CAP](D:/code/APIDevice/output/md_output/harmonyos-guides/系统/网络/Connectivity Kit（短距通信服务）/Connectivity Kit术语/terminology.md) 。
- RFCOMM链路类型也称为串口通信协议（Serial Port Profile,[SPP](D:/code/APIDevice/output/md_output/harmonyos-guides/系统/网络/Connectivity Kit（短距通信服务）/Connectivity Kit术语/terminology.md)），适用于传统蓝牙（[BR](D:/code/APIDevice/output/md_output/harmonyos-guides/系统/网络/Connectivity Kit（短距通信服务）/Connectivity Kit术语/terminology.md)/[EDR](D:/code/APIDevice/output/md_output/harmonyos-guides/系统/网络/Connectivity Kit（短距通信服务）/Connectivity Kit术语/terminology.md)）。
- L2CAP链路类型适用于传统蓝牙（BR/EDR）和低功耗蓝牙（[BLE](D:/code/APIDevice/output/md_output/harmonyos-guides/系统/网络/Connectivity Kit（短距通信服务）/Connectivity Kit术语/terminology.md)）。
通过 [socket.sppConnect](#socketsppconnect) 创建客户端套接字并向服务端发起连接。
通过 [socket.sppListen](#socketspplisten) 创建服务端套接字并监听客户端的连接。
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/5e/v3/fnTcY0fLTvOX1sbG1nEcDA/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260401T093251Z&HW-CC-Expire=86400&HW-CC-Sign=9673721F0D75FA56F4643BE1BDCCE332663C7DCF1374414D600C92A5EB3E9354)
...
获取服务端L2CAP链路类型套接字的协议/服务多路复用器值（Protocol/Service Multiplexer, [PSM](D:/code/APIDevice/output/md_output/harmonyos-guides/系统/网络/Connectivity Kit（短距通信服务）/Connectivity Kit术语/terminology.md) ），该值用于标识特定的服务数据传输通道。
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/de/v3/6b9k-drRRw2hWpN21Evl0w/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260401T093251Z&HW-CC-Expire=86400&HW-CC-Sign=EB3E5A9BF4E49EDF06C4E48F3057A8E948B2442CF6F14B0A5172FCC97F54E56D)
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| uuid | string | 否 | 否 | RFCOMM套接字链路类型的服务UUID，例如"00001101-0000-1000-8000-00805F9B34FB"。- 建议开发者使用自定义的服务UUID（可通过工具函数[util.generateRandomUUID](D:/code/APIDevice/output/md_output/harmonyos-references/应用框架/ArkTS（方舟编程语言）/ArkTS API/js-apis-util.md)生成），也可以使用标准协议定义的Serial Port UUID服务(00001101-0000-1000-8000-00805F9B34FB)。- SppType设置为SPP_RFCOMM时该参数必选。- SppType设置为SPP_L2CAP或SPP_L2CAP_BLE时设置为空字符串。 |
