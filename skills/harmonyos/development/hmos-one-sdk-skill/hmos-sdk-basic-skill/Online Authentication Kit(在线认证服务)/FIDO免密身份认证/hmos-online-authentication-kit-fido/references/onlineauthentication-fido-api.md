...
| plte | Array<[RgbPaletteEntry](#section1237320913497)> | 否 | 是 | 调色板条目。默认值为空。 |
#### Authenticator
...
| supportedUAFVersions | Array<[Version](#section1293122884415)> | 是 | 否 | 认证器支持的UAF协议版本。 |
...
| tcDisplayPNGCharacteristics | Array<[DisplayPNGCharacteristicsDescriptor](#section114741413537)> | 是 | 否 | 交易确认显示支持的PNG集合。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| supportedUAFVersions | Array<[Version](#section1293122884415)> | 否 | 否 | 客户端支持的FIDO UAF协议版本列表。 |
| clientVendor | string | 否 | 否 | UAF客户端的供应商，CFCA长度为4个字符。 |
| clientVersion | [Version](#section1293122884415) | 否 | 否 | FIDO UAF客户端版本。 |
| availableAuthenticators | Array<[Authenticator](#section14811192415918)> | 否 | 否 | 包含描述可使用UAF认证器的认证器结构数。 |
#### discover
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| context | [common.Context](D:/code/APIDevice/output/md_output/harmonyos-references/应用框架/Ability Kit（程序框架服务）/ArkTS API/接口依赖的元素及定义/application/js-apis-inner-application-context.md) | 是 | ability的context。 |
**返回值:**
| 类型 | 说明 |
| --- | --- |
| Promise<[DiscoveryData](#section11682103284015)> | Promise对象。返回包含当前设备软件支持的认证器数据的对象。 |
**错误码:**
以下错误码的详细介绍请参见 [FIDO免密认证错误码](D:/code/APIDevice/output/md_output/harmonyos-references/系统/安全/Online Authentication Kit（在线认证服务）/ArkTS API/ArkTS API错误码/onlineauthentication-error-code-fido.md) 。
| 错误码ID | 错误信息 |
| --- | --- |
| 401 | Parameter error. |
...
| --- | --- | --- | --- |
| context | [common.Context](D:/code/APIDevice/output/md_output/harmonyos-references/应用框架/Ability Kit（程序框架服务）/ArkTS API/接口依赖的元素及定义/application/js-apis-inner-application-context.md) | 是 | ability的context。 |
| uafRequest | [UAFMessage](#section2134351143710) | 是 | 需要检测的策略和操作。 |
**返回值:**
| 类型 | 说明 |
| --- | --- |
...
| --- | --- | --- | --- |
| context | [common.Context](D:/code/APIDevice/output/md_output/harmonyos-references/应用框架/Ability Kit（程序框架服务）/ArkTS API/接口依赖的元素及定义/application/js-apis-inner-application-context.md) | 是 | ability的context。 |
| uafRequest | [UAFMessage](#section2134351143710) | 是 | FIDO客户端软件使用的[UAFMessage](#section2134351143710)。 |
| channelBindings | [ChannelBinding](#section1081123302517) | 否 | 传输通道的绑定参数，用于验证通道安全性，默认为空。 |
**返回值:**
| 类型 | 说明 |
| --- | --- |
| Promise<[UAFMessage](#section2134351143710)> | Promise对象。返回包含签名后响应数据的UAFMessage消息对象。 |
**错误码：**
以下错误码的详细介绍请参见 [FIDO免密认证错误码](D:/code/APIDevice/output/md_output/harmonyos-references/系统/安全/Online Authentication Kit（在线认证服务）/ArkTS API/ArkTS API错误码/onlineauthentication-error-code-fido.md) 。
| 错误码ID | 错误信息 |
| --- | --- |
...
| --- | --- | --- | --- |
| context | [common.Context](D:/code/APIDevice/output/md_output/harmonyos-references/应用框架/Ability Kit（程序框架服务）/ArkTS API/接口依赖的元素及定义/application/js-apis-inner-application-context.md) | 是 | ability的context。 |
| uafResponse | [UAFMessage](#section2134351143710) | 是 | UAF响应消息。 |
**返回值:**
| 类型 | 说明 |
| --- | --- |
| Promise<void> | Promise对象。无返回结果的Promise对象。 |
