...
---
# FIDO
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/45/v3/Z4fRqPaUT4e-KtopnyRXXA/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260401T093230Z&HW-CC-Expire=86400&HW-CC-Sign=7C61017373C329CE252ED15F1ED0C07AC91AA7DFF03B8FB424D97365178A72AD)
以下仅介绍本模块特有错误码，通用错误码请参见 [通用错误码](D:/code/APIDevice/output/md_output/harmonyos-references/API参考概述/errorcode-universal.md) 。
#### 1005900003 用户取消操作
**错误信息**
User cancels.
**错误描述**
...
认证：用户在未开启状态，先开启再做认证，参见： [FIDO免密身份认证](D:/code/APIDevice/output/md_output/harmonyos-guides/系统/安全/Online Authentication Kit（在线认证服务）/FIDO免密身份认证/onlineauthentication-fido.md) 。
#### 1005900006 协议错误
**错误信息**
...
应用签名值通过 [getBundleInfoForSelf](D:/code/APIDevice/output/md_output/harmonyos-references/应用框架/Ability Kit（程序框架服务）/ArkTS API/通用能力的接口(推荐)/js-apis-bundlemanager.md) 接口获取， [BundleFlag](D:/code/APIDevice/output/md_output/harmonyos-references/应用框架/Ability Kit（程序框架服务）/ArkTS API/通用能力的接口(推荐)/js-apis-bundlemanager.md) 设置为GET_BUNDLE_INFO_WITH_SIGNATURE_INFO，获取其中的signatureInfo的appId字段，并且将appId去除前面的包名前缀以及末尾全部“=”。
例：
1. 通过 [getBundleInfoForSelf](D:/code/APIDevice/output/md_output/harmonyos-references/应用框架/Ability Kit（程序框架服务）/ArkTS API/通用能力的接口(推荐)/js-apis-bundlemanager.md) 接口获取的appId：
