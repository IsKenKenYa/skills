...
| 类型 | 说明 |
| --- | --- |
| Promise<string> | Promise对象，返回JSON格式的系统完整性检测结果。JSON内容详见《Device Security Kit开发指南》中的本地系统完整性检测[开发步骤](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/devicesecurity-sysintegrity-check-onlocal)。 |
**错误码：**
以下错误码的详细介绍请参见 [ArkTS API错误码](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/devicesecurity-arktsapi-errcode) **。**
| 错误码ID | 错误信息 |
| --- | --- |
