...
| **名称** | **类型** | 只读 | 可选 | **说明** |
| --- | --- | --- | --- | --- |
| result | string | 否 | 否 | JWS格式的系统完整性检测结果。JWS内容详见《Device Security Kit开发指南》中的系统完整性检测[开发步骤](D:/code/APIDevice/output/md_output/harmonyos-guides/系统/安全/Device Security Kit（设备安全服务）/安全检测/系统完整性检测/devicesecurity-sysintegrity-check.md)。 |
#### UrlCheckRequest
URL检测请求参数。
**元服务API：** 从版本5.0.2(14)开始，该接口支持在元服务中使用。
**系统能力：** SystemCapability.Security.SafetyDetect
...
| **名称** | **类型** | 只读 | 可选 | **说明** |
| --- | --- | --- | --- | --- |
| results | Array<[UrlCheckResult](#section13695147172010)> | 否 | 否 | URL检测返回的检测结果 |
#### UrlCheckResult
URL检测结果详情。
**元服务API：** 从版本5.0.2(14)开始，该接口支持在元服务中使用。
**系统能力：** SystemCapability.Security.SafetyDetect
...
| threat | [UrlThreatType](#section3468103822215) | 否 | 否 | URL的威胁类型 |
#### UrlThreatType
枚举URL威胁类型。
**元服务API：** 从版本5.0.2(14)开始，该接口支持在元服务中使用。
**系统能力：** SystemCapability.Security.SafetyDetect
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/6e/v3/2RWfVvysQvKXSNp-ZyEM3g/caution_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260401T093222Z&HW-CC-Expire=86400&HW-CC-Sign=65EA990395B1A2CDCE23458DE76E9184B518F6AC3B5FB8C7E4E33990AB816240)
...
**错误码：**
以下错误码的详细介绍请参见 [ArkTS API错误码](D:/code/APIDevice/output/md_output/harmonyos-references/devicesecurity-arktsapi-errcode.md) **。**
| 错误码ID | 错误信息 |
| --- | --- |
...
```
#### checkUrlThreat
checkUrlThreat(req: [UrlCheckRequest](#section1991313125213) ): Promise< [UrlCheckResponse](#section7578162151315) >
检测URL是否为恶意网址。使用Promise异步回调。
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/bd/v3/AmFDhMszQ7SHXagadTOTCw/caution_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260401T093222Z&HW-CC-Expire=86400&HW-CC-Sign=46EFEC40D5F468DD4A761D6C7CF191833C1B56A8B4D2D980ACD4D6548F90CC88)
该接口涉及端云协同，需要联网等耗时操作，因此不要在UI线程中执行，避免阻塞UI线程。
**元服务API：** 从版本5.0.2(14)开始，该接口支持在元服务中使用。
**系统能力：** SystemCapability.Security.SafetyDetect
**起始版本：** 5.0.0(12)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| req | [UrlCheckRequest](#section1991313125213) | 是 | 请求参数，包含被检测的URL列表。传入的URL数量最多10个并且每个URL长度不大于4096字节。 |
**返回值：**
| 类型 | 说明 |
| --- | --- |
| Promise<[UrlCheckResponse](#section7578162151315)> | Promise对象，返回URL检测结果。 |
**错误码：**
以下错误码的详细介绍请参见 [ArkTS API错误码](D:/code/APIDevice/output/md_output/harmonyos-references/devicesecurity-arktsapi-errcode.md) **。**
| 错误码ID | 错误信息 |
| --- | --- |
...
| 类型 | 说明 |
| --- | --- |
| Promise<string> | Promise对象，返回JSON格式的系统完整性检测结果。JSON内容详见《Device Security Kit开发指南》中的本地系统完整性检测[开发步骤](D:/code/APIDevice/output/md_output/harmonyos-guides/系统/安全/Device Security Kit（设备安全服务）/安全检测/本地系统完整性检测/devicesecurity-sysintegrity-check-onlocal.md)。 |
**错误码：**
以下错误码的详细介绍请参见 [ArkTS API错误码](D:/code/APIDevice/output/md_output/harmonyos-references/devicesecurity-arktsapi-errcode.md) **。**
| 错误码ID | 错误信息 |
| --- | --- |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f9/v3/hqjlia3NRIC8pnQ_tUkTHA/caution_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260401T093222Z&HW-CC-Expire=86400&HW-CC-Sign=CD04A8C115A0BCFD030609D42EC7845C4A3BE61BFF630929EE16CD45423BA01B)
该接口涉及端云协同，需要联网等耗时操作，因此不要在UI线程中执行，避免阻塞UI线程。
