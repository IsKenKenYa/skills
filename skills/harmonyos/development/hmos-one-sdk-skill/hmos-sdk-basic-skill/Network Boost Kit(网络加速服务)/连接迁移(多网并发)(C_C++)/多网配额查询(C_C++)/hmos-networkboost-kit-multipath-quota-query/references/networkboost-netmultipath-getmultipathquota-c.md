...
```
2.
CMakeLists.txt中添加以下lib，具体请见 [C API开发准备](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/networkboost-preparations) 。
```cpp
libnetwork_boost.so
```
3.
调用GetMultiPathQuotaStats接口，获取多网配额信息。
```cpp
