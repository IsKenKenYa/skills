...
---
# netHandover（连接迁移）
本模块提供网络连接迁移能力，以便在弱网环境下，系统发起多网迁移（WiFi<->蜂窝，主�?->副卡等）的过程中，给应用提供连接迁移开始和完成通知，应用根据连接迁移通知的建议进行重建，快速恢复业务，给用户带来平滑、高速、低时延的上网体验�?
**起始版本�?* 5.0.0(12)
#### 导入模块
```typescript
...
| 参数�?| 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| type | string | �?| 固定填写"handoverChange"字符串，表示连接迁移变化事件�?|
| callback | Callback<[HandoverInfo](#section5777123521219)> | �?| 回调函数，返回连接迁移开始和完成的详细信息�?|
**错误码：**
涉及错误码均为通用错误码， [通用错误码详细描述查看](D:/code/APIDevice/output/md_output/harmonyos-references/API参考概�?errorcode-universal.md) �?
| 错误�?| 说明 |
| --- | --- |
| 201 | 权限校验失败�?|
| 401 | 参数检查失败�?|
...
try {
  netHandover.on('handoverChange', (info: netHandover.HandoverInfo) => {
    if (info.handoverStart) {
      // 连接迁移开始回调，应用按照HandoverStart的建议调整数传策�?
...
| 参数�?| 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| type | string | �?| 固定填写"handoverChange"字符串，表示连接状态变化事件�?|
| callback | Callback<[HandoverInfo](#section5777123521219)> | �?| 需要取消注册的回调函数，需与订阅时传入的回调函数是同一个。若无此参数，则取消注册所有的回调函数�?|
**错误码：**
涉及错误码均为通用错误码， [通用错误码详细描述查看](D:/code/APIDevice/output/md_output/harmonyos-references/API参考概�?errorcode-universal.md) �?
| 错误�?| 说明 |
| --- | --- |
...
| 参数�?| 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| mode | [HandoverMode](#section85513341136) | �?| 表示应用需要通知系统侧的迁移模式�?|
**错误码：**
涉及错误码均为通用错误码， [通用错误码详细描述查看](D:/code/APIDevice/output/md_output/harmonyos-references/API参考概�?errorcode-universal.md) �?
| 错误�?| 说明 |
| --- | --- |
...
| 类型 | 说明 |
| --- | --- |
| [MultiPathQuota](#section168911430203320) | 应用配额信息�?|
**错误码：**
以下错误码的详细介绍请参�?[ArkTS API错误码](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Network Boost Kit（网络加速服务）/ArkTS API/networkboost-arkts-errorcode.md) �?[通用错误码](D:/code/APIDevice/output/md_output/harmonyos-references/API参考概�?errorcode-universal.md) �?
| 错误�?| 说明 |
| --- | --- |
| 201 | 权限校验失败�?|
...
| 参数�?| 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback<[MultiPathRequestResult](#section1578014618195)> | �?| 回调函数，返回发起多网的结果�?|
**错误码：**
以下错误码的详细介绍请参�?[ArkTS API错误码](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Network Boost Kit（网络加速服务）/ArkTS API/networkboost-arkts-errorcode.md) �?[通用错误码](D:/code/APIDevice/output/md_output/harmonyos-references/API参考概�?errorcode-universal.md) �?
| 错误�?| 说明 |
| --- | --- |
...
| 参数�?| 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| type | string | �?| 固定填写"multiPathStateChange"字符串，表示多网状态变化事件�?|
| callback | Callback<[MultiPathStateInfo](#section166554717569)> | �?| 回调函数，返回多网状态变化信息�?|
**错误码：**
以下错误码的详细介绍请参�?[ArkTS API错误码](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Network Boost Kit（网络加速服务）/ArkTS API/networkboost-arkts-errorcode.md) �?[通用错误码](D:/code/APIDevice/output/md_output/harmonyos-references/API参考概�?errorcode-universal.md) �?
| 错误�?| 说明 |
| --- | --- |
...
| --- | --- | --- | --- |
| type | string | �?| 固定填写"multiPathStateChange"字符串，表示多网状态变化事件�?|
| callback | Callback<[MultiPathStateInfo](#section166554717569)> | �?| 需要取消注册的回调函数，需与订阅时传入的回调函数是同一个。若无此参数，则取消注册所有的回调函数�?|
**错误码：**
以下错误码的详细介绍请参�?[ArkTS API错误码](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Network Boost Kit（网络加速服务）/ArkTS API/networkboost-arkts-errorcode.md) �?[通用错误码](D:/code/APIDevice/output/md_output/harmonyos-references/API参考概�?errorcode-universal.md) �?
| 错误�?| 说明 |
| --- | --- |
...
| 参数�?| 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| type | string | �?| 固定填写"multiPathRecommendation"字符串，表示系统多网建议变化事件�?|
| callback | Callback<[MultiPathRecommendationInfo](#section1557733015378)> | �?| 回调函数，返回多网建议变化信息�?|
**错误码：**
以下错误码的详细介绍请参�?[ArkTS API错误码](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Network Boost Kit（网络加速服务）/ArkTS API/networkboost-arkts-errorcode.md) �?[通用错误码](D:/code/APIDevice/output/md_output/harmonyos-references/API参考概�?errorcode-universal.md) �?
| 错误�?| 说明 |
| --- | --- |
...
| --- | --- | --- | --- |
| type | string | �?| 固定填写"multiPathRecommendation"字符串，表示系统多网建议变化事件�?|
| callback | Callback<[MultiPathRecommendationInfo](#section1557733015378)> | �?| 需要取消注册的回调函数，需与订阅时传入的回调函数是同一个。若无此参数，则取消注册所有的回调函数�?|
**错误码：**
以下错误码的详细介绍请参�?[ArkTS API错误码](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Network Boost Kit（网络加速服务）/ArkTS API/networkboost-arkts-errorcode.md) �?[通用错误码](D:/code/APIDevice/output/md_output/harmonyos-references/API参考概�?errorcode-universal.md) �?
| 错误�?| 说明 |
| --- | --- |
...
| 名称 | 类型 | 只读 | 可�?| 说明 |
| --- | --- | --- | --- | --- |
| handoverStart | [HandoverStart](#section1593261915415) | �?| �?| 表示连接迁移开始信息�?|
| handoverComplete | [HandoverComplete](#section16119482176) | �?| �?| 表示连接迁移完成信息�?|
#### HandoverStart
连接迁移开始信息�?
**系统能力�?* SystemCapability.Communication.NetworkBoost.Core
**起始版本�?* 5.0.0(12)
| 名称 | 类型 | 只读 | 可�?| 说明 |
| --- | --- | --- | --- | --- |
| expires | number | �?| �?| 连接迁移全流程的超时时间，单位为秒，取值为任意正整数或�?�?|
| dataSpeedAction | [DataSpeedAction](#section136319552227) | �?| �?| 老链路的发包建议�?|
#### HandoverComplete
连接迁移完成信息�?
**系统能力�?* SystemCapability.Communication.NetworkBoost.Core
**起始版本�?* 5.0.0(12)
| 名称 | 类型 | 只读 | 可�?| 说明 |
| --- | --- | --- | --- | --- |
| result | [ErrorResult](#section1823191782614) | �?| �?| 连接迁移结果�?|
| handoverContinue | boolean | �?| �?| 是否还有HandoverComplete消息。true表示还有新链路待激活，系统还会上报HandoverComplete消息，一般发生在连接迁移到多个网络的场景。false表示当前已经是最后一个HandoverComplete消息，连接迁移流程完成�?|
| oldPathLifetime | number | �?| �?| 老链路的剩余生存时长，单位为秒，取值为任意正整数或0�?|
| oldDataSpeedAction | [DataSpeedAction](#section136319552227) | �?| �?| 老链路发包建议�?|
| pathTypeChanged | boolean | �?| �?| 新老链路类型是否发生变更。true表示发生变化，如WiFi<->蜂窝。false表示没有发生变化�?|
| newNetHandle | [connection.NetHandle](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Network Kit（网络服务）/ArkTS API/js-apis-net-connection.md) | �?| �?| 新链路的NetHandle信息�?|
| reEstAction | [ReEstAction](#section575241112914) | �?| �?| 链路重建类型�?|
| newDataSpeedAction | [DataSpeedAction](#section136319552227) | �?| �?| 新链路发包建议�?|
#### DataSpeedAction
发包速率建议�?
**系统能力�?* SystemCapability.Communication.NetworkBoost.Core
**起始版本�?* 5.0.0(12)
| 名称 | 类型 | 只读 | 可�?| 说明 |
| --- | --- | --- | --- | --- |
| dataSpeedSimpleAction | [netQuality.DataSpeedSimpleAction](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Network Boost Kit（网络加速服务）/ArkTS API/networkboost-netquality.md) | �?| �?| 应用发包策略的简单建议�?|
| linkUpBandwidth | [netQuality.RateBps](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Network Boost Kit（网络加速服务）/ArkTS API/networkboost-netquality.md) | �?| �?| 老链路上行带宽�?|
| linkDownBandwidth | [netQuality.RateBps](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Network Boost Kit（网络加速服务）/ArkTS API/networkboost-netquality.md) | �?| �?| 老链路下行带宽�?|
#### MultiPathStateInfo
多网状态信息�?
**系统能力�?* SystemCapability.Communication.NetworkBoost.Core
**起始版本�?* 6.0.0(20)
| 名称 | 类型 | 只读 | 可�?| 说明 |
| --- | --- | --- | --- | --- |
| multiPathState | [MultiPathState](#section1635319535411) | �?| �?| 多网状态�?|
| cause | [MultiPathChangeCause](#section155215540412) | �?| �?| 多网状态变化原因�?|
| netHandle | [connection.NetHandle](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Network Kit（网络服务）/ArkTS API/js-apis-net-connection.md) | �?| �?| 多网链路的netHandle�?|
| pathState | [PathState](#section6391255134310) | �?| �?| 多网链路状态�?|
| pathType | [netQuality.PathType](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Network Boost Kit（网络加速服务）/ArkTS API/networkboost-netquality.md) | �?| �?| 多网链路类型�?|
...
| 名称 | 类型 | 只读 | 可�?| 说明 |
| --- | --- | --- | --- | --- |
| action | [MultiPathAction](#section186801623193513) | �?| �?| 多网推荐动作�?|
#### MultiPathQuota
应用配额使用信息�?
**系统能力�?* SystemCapability.Communication.NetworkBoost.Core
**起始版本�?* 6.0.0(20)
| 名称 | 类型 | 只读 | 可�?| 说明 |
| --- | --- | --- | --- | --- |
| used | [MultiPathQuotaInfo](#section1338164523216) | �?| �?| 应用已使用配额信息�?|
| remaining | [MultiPathQuotaInfo](#section1338164523216) | �?| �?| 应用剩余使用配额信息�?|
#### MultiPathQuotaInfo
配额信息�?
**系统能力�?* SystemCapability.Communication.NetworkBoost.Core
**起始版本�?* 6.0.0(20)
...
| 名称 | 类型 | 只读 | 可�?| 说明 |
| --- | --- | --- | --- | --- |
| result | [MultiPathErrorResult](#section1689645144117) | �?| �?| 多网请求结果�?|
#### MultiPathAction
多网推荐动作的枚举�?
**系统能力�?* SystemCapability.Communication.NetworkBoost.Core
**起始版本�?* 6.0.0(20)
