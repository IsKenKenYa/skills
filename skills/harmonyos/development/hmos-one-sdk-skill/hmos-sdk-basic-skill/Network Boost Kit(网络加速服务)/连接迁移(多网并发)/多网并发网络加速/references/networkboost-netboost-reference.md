...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| sceneDesc | [SceneDesc](#section5777123521219) | 是 | 要设置的业务场景信息。 |
**错误码：**
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| scene | [netQuality.ServiceType](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Network Boost Kit（网络加速服务）/ArkTS API/networkboost-netquality.md) | 否 | 否 | 表示业务场景类型。 |
| sceneEvent | [SceneEvent](#section1278885681816) | 否 | 否 | 表示业务场景事件。 |
