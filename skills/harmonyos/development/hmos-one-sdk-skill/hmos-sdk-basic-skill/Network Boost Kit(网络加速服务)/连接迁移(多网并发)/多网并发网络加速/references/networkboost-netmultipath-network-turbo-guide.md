...
# 多网并发网络加速
#### 概述
网络数据传输是应用的核心功能场景之一，而传输的性能直接决定着用户体验——例如高清晰度视频/图片的加载、大文件的上传下载、设备间多文件的同步迁移等场景，有限的网络传输性能导致的卡顿、长时间等待往往会导致用户使用感受变差。针对此类性能敏感的场景，Network Boost Kit的 [多网并发](D:/code/APIDevice/output/md_output/harmonyos-guides/系统/网络/Network Boost Kit（网络加速服务）/连接迁移（多网并发）/networkboost-netmultipathguide.md) 能力提供了网络加速的解决方案。
...
1.
开发前准备。
多网并发能力在设备类型、网络状态及开发方案的选择上存在一定限制，具体接入要求可参考 [多网发起和释放](D:/code/APIDevice/output/md_output/harmonyos-guides/系统/网络/Network Boost Kit（网络加速服务）/连接迁移（多网并发）/多网发起和释放/networkboost-netmultipath-request-release.md) ，开发者也可以在调试过程中通过 [多网请求错误码](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Network Boost Kit（网络加速服务）/ArkTS API/networkboost-nethandover.md) 分析。
2.
发起多网并发。
(1) 权限配置：应用使用多网并发等网络加速能力，连接迁移能力部分接口需要ohos.permission.LINKTURBO权限，权限配置方法参见 [申请权限步骤](D:/code/APIDevice/output/md_output/harmonyos-guides/系统/网络/Network Boost Kit（网络加速服务）/开发准备/networkboost-preparations.md) 。同时此权限为受限ACL权限需要特别配置和申请，具体操作步骤参考 [配置签名](D:/code/APIDevice/output/md_output/harmonyos-guides/系统/网络/Network Boost Kit（网络加速服务）/开发准备/networkboost-preparations.md) 和 [受限ACL权限申请](D:/code/APIDevice/output/md_output/harmonyos-guides/系统/网络/Network Boost Kit（网络加速服务）/开发准备/networkboost-preparations.md) 。
(2) 发起流程：多网并发能力发起的核心步骤包括 [netBoost.setSceneDesc()](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Network Boost Kit（网络加速服务）/ArkTS API/networkboost-netboost.md) 设置多网场景、 [netHandover.getMultiPathQuotaStats()](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Network Boost Kit（网络加速服务）/ArkTS API/networkboost-nethandover.md) 查询多网配额、 [netHandover.requestMultiPath()](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Network Boost Kit（网络加速服务）/ArkTS API/networkboost-nethandover.md) 请求发起多网以及 [netHandover.on('multiPathStateChange')](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Network Boost Kit（网络加速服务）/ArkTS API/networkboost-nethandover.md) 多网状态监听，详细实现可参考 [代码实现](#代码实现) 中的多网发起与接入。
3.
获取多网NetHandle并绑定Socket。
(1) 成功发起多网请求后，可以在 [netHandover.on('multiPathStateChange')](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Network Boost Kit（网络加速服务）/ArkTS API/networkboost-nethandover.md) 回调中监听并获取到可用的 [NetHandle](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Network Kit（网络服务）/ArkTS API/js-apis-net-connection.md) 数据网络句柄对象。
(2) 针对需要在多网路径上传输的数据，创建对应的TCP Socket（详见 [TCPSocket](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Network Kit（网络服务）/ArkTS API/js-apis-socket.md) ）/UDP Socket（详见 [UDPSocket](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Network Kit（网络服务）/ArkTS API/js-apis-socket.md) ），通过 [bindSocket()](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Network Kit（网络服务）/ArkTS API/js-apis-net-connection.md) 方法将Socket对象绑定到NetHandle对应的网络上。
4.
Socket发起网络传输任务。
绑定网络后，TCP Socket/UDP Socket进行 [数据传输](D:/code/APIDevice/output/md_output/harmonyos-guides/系统/网络/Network Kit（网络服务）/访问网络/使用Socket访问网络/socket-connection.md) 时将会使用对应的网络通路，多个Socket使用不同的网络通路同时发起网络传输任务就可以起到多网并发的效果。
#### 大文件分片传输
#### 场景描述
当发布视频帖子、下载应用资源包时，应用本质上在进行大文件网络传输，通过将大文件分片可以充分发挥多网并发能力，将不同文件片段分配给不同网络通路同时传输，能极大地加快传输速度。
#### 关键技术
1. [Network Boost Kit](D:/code/APIDevice/output/md_output/harmonyos-guides/系统/网络/Network Boost Kit（网络加速服务）/network-boost-kit-guide.md)：多网能力的发起、监听、状态管理与绑定。
2. [@ohos.net.connection](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Network Kit（网络服务）/ArkTS API/js-apis-net-connection.md)：网络连接管理，网络通路获取。
3. [Socket数据传输](D:/code/APIDevice/output/md_output/harmonyos-guides/系统/网络/Network Kit（网络服务）/访问网络/使用Socket访问网络/socket-connection.md)：创建网络连接，执行网络传输任务。
4. [TaskPool](D:/code/APIDevice/output/md_output/harmonyos-guides/应用框架/ArkTS（方舟编程语言）/ArkTS并发/多线程并发/TaskPool简介/taskpool-introduction.md)：管理多线程网络并发任务。
5. [@ohos.file.fs](D:/code/APIDevice/output/md_output/harmonyos-references/应用框架/Core File Kit（文件基础服务）/ArkTS API/js-apis-file-fs.md)：负责文件管理，包括文件分片、大小查询等。
#### 开发步骤
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/85/v3/CcLh4mhpT9Gyk5Ftniov0g/zh-cn_image_0000002659220355.png?HW-CC-KV=V1&HW-CC-Date=20260701T104857Z&HW-CC-Expire=86400&HW-CC-Sign=FB879F05C95401C28579BD26A6755E0412105E3F4E47D4B59D56585F8268D09D)
#### 代码实现
1.
多网发起与接入。
根据当前网络传输任务通过 [netBoost.setSceneDesc()](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Network Boost Kit（网络加速服务）/ArkTS API/networkboost-netboost.md) 设置多网场景，帮助系统进行多网并发管控和业务时长分析，当前对于文件分片上传任务选择'upload'场景。
```
/**
...
```
通过 [netHandover.getMultiPathQuotaStats()](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Network Boost Kit（网络加速服务）/ArkTS API/networkboost-nethandover.md) 获取当前多网配额，包括次数和时长等，应用可按需添加业务逻辑如提示用户剩余配额等。
```
/**
...
```
通过 [netHandover.requestMultiPath()](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Network Boost Kit（网络加速服务）/ArkTS API/networkboost-nethandover.md) 请求开启多网，支持Wi-Fi和蜂窝并发以及主卡和副卡并发，不支持开发者指定并发组合，并发组合由系统决定。
```
/**
...
```
多网请求成功后还需要使用 [netHandover.on('multiPathStateChange')](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Network Boost Kit（网络加速服务）/ArkTS API/networkboost-nethandover.md) 监听多网状态，确认多网络通路的使能与可用情况，记录可用的NetHandle信息。
```
/**
...
2.
多网通路绑定Socket。
封装网络查询函数，通过 [connection.getAllNetsSync()](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Network Kit（网络服务）/ArkTS API/js-apis-net-connection.md) 获取当前所有网络信息。由于网络传输任务一般放在子线程实现，而当前无法跨线程传递Socket对象和NetHandle对象，为了在子线程实现网络与Socket绑定需要获取所有网络信息，再通过之前请求多网后记录的NetHandle对象的ID找到指定网络在执行绑定操作；如果应用业务不涉及多线程问题可直接绑定上一步多网状态监听中获取到的NetHandle。
```
/**
 * Get all netHandles.
...
```
通过 [fileIo.statSync()](D:/code/APIDevice/output/md_output/harmonyos-references/应用框架/Core File Kit（文件基础服务）/ArkTS API/js-apis-file-fs.md) 获取待上传文件的大小等信息，按照计算出的分片规格对文件进行分片处理。
```
/**
...
```
封装网络上传接口，包括创建TCP Socket实例并绑定到指定网络NetHandle、设置网络请求头等配置、通过 [TCPSocket.send()](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Network Kit（网络服务）/ArkTS API/js-apis-socket.md) 方法发送请求至服务端并通过 [TCPSocket.on('message')](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Network Kit（网络服务）/ArkTS API/js-apis-socket.md) 监听响应。
```
/**
 * Upload file segment.
 * @param host Server host.
...
6.
释放资源。
通过 [netHandover.releaseMultiPath()](D:/code/APIDevice/output/md_output/harmonyos-references/系统/网络/Network Boost Kit（网络加速服务）/ArkTS API/networkboost-nethandover.md) 释放多网，注销相关的监听方法。
```
/**
 * Stop multi net path.
 * */
...
#### 开发步骤
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/46/v3/YtjHS88pQKaO_HH5UTJ2lw/zh-cn_image_0000002628701162.png?HW-CC-KV=V1&HW-CC-Date=20260701T104857Z&HW-CC-Expire=86400&HW-CC-Sign=E354217C4777DCC665F555BFD2A74223B3B6E1D2F6B766B4E31917ADCBAF8F3D)
#### 代码实现
