...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| data | [systemShare.SharedData](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Share Kit（分享服务）/ArkTS API/share-system-share.md) | 是 | 分享数据。 |
**返回值：**
| 类型 | 说明 |
| --- | --- |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| error | [SharableErrorCode](#section98742174617) | 是 | 拒绝本次分享的原因。通过系统弹窗提示用户。 |
**返回值：**
| 类型 | 说明 |
| --- | --- |
| Promise<void> | Promise对象。无返回结果的Promise对象。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| data | [UpdatedData](#section108971112124018) | 是 | 需要更新的数据信息。 |
**返回值：**
| 类型 | 说明 |
| --- | --- |
| Promise<void> | Promise对象。无返回结果的Promise对象。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| info | [SharableErrorInfo](#section10176454018) | 是 | 提示信息，用于告知用户无法分享的原因。 |
**返回值：**
| 类型 | 说明 |
| --- | --- |
| Promise<void> | Promise对象。无返回结果的Promise对象。 |
...
| callback | [ReceiveCallback](#section496835162818) | 是 | 沙箱接收的回调。 |
**返回值：**
| 类型 | 说明 |
| --- | --- |
| Promise<void> | Promise对象。无返回结果的Promise对象。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| error | [ReceivableErrorCode](#section1884011169111) | 是 | 拒绝本次沙箱接收的原因。通过系统弹窗提示用户。 |
**返回值：**
| 类型 | 说明 |
| --- | --- |
| Promise<void> | Promise对象。无返回结果的Promise对象。 |
...
华为分享事件窗口注册配置项。继承 [BaseCapabilityRegistry](#section7252115555417) 。
**模型约束：** 此接口仅可在Stage模型下使用。
**系统能力：** SystemCapability.Collaboration.HarmonyShare
**起始版本：** 6.0.0(20)
| 名称 | 类型 | 只读 | 可选 | 说明 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| utd | string | 否 | 否 | 统一数据类型，参考[@ohos.data.uniformTypeDescriptor (标准化数据定义与描述)](D:/code/APIDevice/output/md_output/harmonyos-references/应用框架/ArkData（方舟数据管理）/ArkTS API/js-apis-data-uniformtypedescriptor.md)。 |
| maxSupportedCount | number | 否 | 否 | 可接收文件的最大数量限制，仅允许设置大于0的整数。 |
#### RecvCapabilityRegistry
沙箱接收事件窗口注册配置项。继承 [BaseCapabilityRegistry](#section7252115555417) 。
**模型约束：** 此接口仅可在Stage模型下使用。
**系统能力：** SystemCapability.Collaboration.HarmonyShare
**起始版本：** 6.0.0(20)
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| capabilities | [RecvCapability](#section5644182344013)[] | 否 | 否 | 沙箱接收能力设置，用于设置可接收的数据类型和数量。 |
#### TransferBaseResults
沙箱接收时，文件数据传输完成的回调函数。
**模型约束：** 此接口仅可在Stage模型下使用。
**系统能力：** SystemCapability.Collaboration.HarmonyShare
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| onResult | Callback<[ShareResultCode](#section943818433405)> | 否 | 是 | 传输完成的回调函数。用于通知传输结果。 |
#### ReceiveCallback
沙箱接收传输完成后回调函数。可用此方法监听完成事件，并处理接收后的数据。继承 [TransferBaseResults](#section54808149718) 。
**模型约束：** 此接口仅可在Stage模型下使用。
**系统能力：** SystemCapability.Collaboration.HarmonyShare
**起始版本：** 6.0.0(20)
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| onDataReceived | Callback<[systemShare.SharedData](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/Share Kit（分享服务）/ArkTS API/share-system-share.md)> | 否 | 否 | 沙箱接收传输完成后回调函数。用于接收已保存至沙箱路径下的文件列表。 |
#### SharableErrorInfo
提示信息，用于告知用户无法分享的原因。
**模型约束：** 此接口仅可在Stage模型下使用。
**系统能力：** SystemCapability.Collaboration.HarmonyShare
...
| callback | Callback<[SharableTarget](#section9147845115614)> | 是 | 事件回调。 |
**错误码：**
以下错误码的详细介绍请参见 [通用错误码](D:/code/APIDevice/output/md_output/harmonyos-references/API参考概述/errorcode-universal.md) 。
| 错误码ID | 错误信息 |
| --- | --- |
...
| callback | Callback<[SharableTarget](#section9147845115614)> | 否 | 回调函数。可以指定传入on中的callback取消对应的监听，也可以不指定callback清空所有监听。 |
**错误码：**
以下错误码的详细介绍请参见 [通用错误码](D:/code/APIDevice/output/md_output/harmonyos-references/API参考概述/errorcode-universal.md) 。
| 错误码ID | 错误信息 |
| --- | --- |
...
| --- | --- | --- | --- |
| event | string | 是 | 事件回调类型，取值为'knockShare'，当设备轻贴时，触发该事件。 |
| capability | [SendCapabilityRegistry](#section7361949172719) | 是 | 事件属性。 |
| callback | Callback<[SharableTarget](#section9147845115614)> | 是 | 事件回调。 |
**示例：**
```typescript
import { uniformTypeDescriptor as utd } from '@kit.ArkData';
...
| capability | [RecvCapabilityRegistry](#section145341487280) | 是 | 事件属性。 |
| callback | Callback<[ReceivableTarget](#section13539165583)> | 是 | 事件回调。 |
**示例：**
```typescript
import { uniformTypeDescriptor as utd } from '@kit.ArkData';
import { systemShare, harmonyShare } from '@kit.ShareKit';
...
| capability | [RecvCapabilityRegistry](#section145341487280) | 是 | 事件属性。 |
| callback | Callback<[ReceivableTarget](#section13539165583)> | 否 | 回调函数。可以指定传入on中的callback取消对应的监听，也可以不指定callback清空所有监听。 |
**示例：**
```typescript
let capabilityRegistry: harmonyShare.RecvCapabilityRegistry = {
  windowId: 999, // 此值仅为示例 实际使用时请替换正确的windowId
