...
```
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/4a/v3/voW8u_fdT-yzNSBuE3Y4Zg/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260701T104716Z&HW-CC-Expire=86400&HW-CC-Sign=155469EDEE978953E70F114E6B01B4A376E677AD0D8FCA6F95B02D3D412FE54F)
通过本地数据库进行卡片信息的持久化时，建议先在 [**onAddForm**](D:/code/APIDevice/output/md_output/harmonyos-references/应用框架/Form Kit（卡片开发服务）/ArkTS API/js-apis-app-form-formextensionability.md) 生命周期进行卡片信息持久化；同时需要在卡片销毁( **[onRemoveForm](D:/code/APIDevice/output/md_output/harmonyos-references/应用框架/Form Kit（卡片开发服务）/ArkTS API/js-apis-app-form-formextensionability.md)** )时删除当前卡片存储的持久化信息，避免反复添加删除卡片导致数据库文件持续变大。