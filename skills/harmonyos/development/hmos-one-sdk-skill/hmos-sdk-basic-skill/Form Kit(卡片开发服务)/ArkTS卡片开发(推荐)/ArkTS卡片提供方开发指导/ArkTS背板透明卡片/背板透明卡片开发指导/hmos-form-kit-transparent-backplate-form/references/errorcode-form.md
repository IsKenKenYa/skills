...
---
# 卡片错误码
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/0a/v3/dmzG14P8Q6-VXXv8kxM4Bg/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260401T093145Z&HW-CC-Expire=86400&HW-CC-Sign=57ACD6C71176AB60F824FAA4AAA3F5385A403B7EB0AC6DEF2CA07A1E562AC0BE)
...
**处理步骤**
检查当前卡片对应 [互动卡片配置项sceneAnimationParams](D:/code/APIDevice/output/md_output/harmonyos-guides/应用框架/Form Kit（卡片开发服务）/ArkTS卡片开发（推荐）/配置ArkTS卡片的配置文件/arkts-ui-widget-configuration.md) 是否正确。
#### 16501012 卡片尺寸错误
**错误信息**
...
指定卡片尺寸未配置，或传入无效卡片尺寸。
**处理步骤**
检查入参卡片尺寸是否在 [FormDimension](D:/code/APIDevice/output/md_output/harmonyos-references/应用框架/Form Kit（卡片开发服务）/ArkTS API/js-apis-app-form-forminfo.md) 和 [supportDimensions](D:/code/APIDevice/output/md_output/harmonyos-guides/应用框架/Form Kit（卡片开发服务）/ArkTS卡片开发（推荐）/配置ArkTS卡片的配置文件/arkts-ui-widget-configuration.md) 配置列表。
#### 2293761 内部服务错误
**错误信息**
...
4. 空参数错误，比如传入空字符串（''）。
5. 参数格式错误。
6. 参数值错误。输入参数需要与[app.json5](D:/code/APIDevice/output/md_output/harmonyos-guides/基础入门/开发基础知识/应用配置文件/app.json5配置文件/app-configuration-file.md)和[配置ArkTS卡片的配置文件](D:/code/APIDevice/output/md_output/harmonyos-guides/应用框架/Form Kit（卡片开发服务）/ArkTS卡片开发（推荐）/配置ArkTS卡片的配置文件/arkts-ui-widget-configuration.md)中对应的配置保持一致。
**处理步骤**
