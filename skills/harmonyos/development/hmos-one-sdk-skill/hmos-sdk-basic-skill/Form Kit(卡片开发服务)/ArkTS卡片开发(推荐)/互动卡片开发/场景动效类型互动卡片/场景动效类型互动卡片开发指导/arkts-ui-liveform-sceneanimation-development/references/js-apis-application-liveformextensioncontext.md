...
---
# LiveFormExtensionContext
LiveFormExtensionContext是 [LiveFormExtensionAbility](D:/code/APIDevice/output/md_output/harmonyos-references/应用框架/Form Kit（卡片开发服务）/ArkTS API/js-apis-app-form-liveformextensionability.md) 的上下文，继承自 [ExtensionContext](D:/code/APIDevice/output/md_output/harmonyos-references/应用框架/Ability Kit（程序框架服务）/ArkTS API/接口依赖的元素及定义/application/js-apis-inner-application-extensioncontext.md) 。
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/16/v3/spGmgH7vSGifjmeMHvXOew/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260401T093143Z&HW-CC-Expire=86400&HW-CC-Sign=705B35BF86912A016EB53AB360A2D1E10C36D5632516DBE30D283F17E6F39728)
...
```
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ee/v3/CIsoF6IkSCa7wSw2C8bZwg/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260401T093143Z&HW-CC-Expire=86400&HW-CC-Sign=08BE6AEB43185BFD2AAD6589D4A8C42FCDADE64A5DCCC82EBB83D823444172EC)
-
...
#### LiveFormExtensionContext
LiveFormExtensionContext提供允许访问特定于LiveFormExtensionAbility资源的能力，继承自 [ExtensionContext](D:/code/APIDevice/output/md_output/harmonyos-references/应用框架/Ability Kit（程序框架服务）/ArkTS API/接口依赖的元素及定义/application/js-apis-inner-application-extensioncontext.md) 。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| want | [Want](D:/code/APIDevice/output/md_output/harmonyos-references/应用框架/Ability Kit（程序框架服务）/ArkTS API/通用能力的接口(推荐)/js-apis-app-ability-want.md) | 是 | 需要被拉起的应用页面信息。[仅支持使用显式want。](D:/code/APIDevice/output/md_output/harmonyos-guides/应用框架/Ability Kit（程序框架服务）/应用模型/应用组件/信息传递载体Want/使用显式Want启动应用组件/ability-startup-with-explicit-want.md) |
**返回值：**
| 类型 | 说明 |
| --- | --- |
| Promise<void> | Promise对象，无返回结果。 |
**错误码：**
以下错误码的详细介绍请参见 [卡片错误码](D:/code/APIDevice/output/md_output/harmonyos-references/应用框架/Form Kit（卡片开发服务）/错误码/errorcode-form.md) 和 [通用错误码](D:/code/APIDevice/output/md_output/harmonyos-references/API参考概述/errorcode-universal.md) 。
| 错误码ID | 错误信息 |
| --- | --- |
