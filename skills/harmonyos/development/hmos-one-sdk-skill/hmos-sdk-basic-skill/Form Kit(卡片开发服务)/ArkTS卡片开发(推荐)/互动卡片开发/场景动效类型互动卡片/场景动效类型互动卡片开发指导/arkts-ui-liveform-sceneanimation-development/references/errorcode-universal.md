...
试图操作已被设备管理应用禁用的系统功能。
**处理步骤**
请使用 [getDisallowedPolicy](D:/code/APIDevice/output/md_output/harmonyos-references/系统/基础功能/MDM Kit（企业设备管理服务）/ArkTS API/js-apis-enterprise-restrictions.md) 接口检查该系统功能是否被禁用，并使用 [setDisallowedPolicy](D:/code/APIDevice/output/md_output/harmonyos-references/系统/基础功能/MDM Kit（企业设备管理服务）/ArkTS API/js-apis-enterprise-restrictions.md) 接口解除禁用状态。
#### 401 参数检查失败
**错误信息**
