...
FormProvider类有如下API接口，具体的API介绍详见 [@ohos.app.form.formProvider (formProvider)](D:/code/APIDevice/output/md_output/harmonyos-references/应用框架/Form Kit（卡片开发服务）/ArkTS API/js-apis-app-form-formprovider.md) 。
| 接口名 | 描述 |
| --- | --- |
...
FormBindingData类有如下API接口，具体的API介绍详见 [@ohos.app.form.formBindingData (卡片数据绑定类)](D:/code/APIDevice/output/md_output/harmonyos-references/应用框架/Form Kit（卡片开发服务）/ArkTS API/js-apis-app-form-formbindingdata.md) 。
| 接口名 | 描述 |
| --- | --- |
...
#### 实现卡片生命周期接口
创建FA模型的卡片，需实现卡片的生命周期接口。先参考 [DevEco Studio开发服务卡片指南](D:/code/APIDevice/output/md_output/harmonyos-guides/开发环境搭建/工程创建/模块管理/创建服务卡片/ide-service-widget.md) 生成服务卡片模板。
1.
在form.ts中，导入相关模块
```
...
export default obj;
```
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d0/v3/ELr-QWAlRbejxK5hVl6gfA/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260701T104720Z&HW-CC-Expire=86400&HW-CC-Sign=57E5AA3F0AAA24AC6C6857BE40F67FCEA83BC7D08164C6777E98B5E868B8D360)
...
// ...
```
具体的持久化方法可以参考 [应用数据持久化概述](D:/code/APIDevice/output/md_output/harmonyos-guides/应用框架/ArkData（方舟数据管理）/应用数据持久化/应用数据持久化概述/app-data-persistence-overview.md) 。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f0/v3/GbPSOWMDSRC_dHqk0lvsVw/zh-cn_image_0000002628860896.png?HW-CC-KV=V1&HW-CC-Date=20260701T104720Z&HW-CC-Expire=86400&HW-CC-Sign=004143C544AD19D396DEBCA1BD6EB68A726DA97F3AA79D7A0EF4131935CFD59B)
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/43/v3/v5fOIU5tSGmCBAJaatRbdQ/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260701T104720Z&HW-CC-Expire=86400&HW-CC-Sign=A19E769C8D8DFA05D974A41E968AB8D3BC7AF071ED65C90E8B0540C2FB5B27DE)
