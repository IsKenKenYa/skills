...
# updateManager（更新功能）
提供检测新版本及升级功能。
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ff/v3/UI-uoiSVRLu--ifWl2nbzg/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260401T093800Z&HW-CC-Expire=86400&HW-CC-Sign=EDF941096BD5E0B7247E661525E67D229E21B6675C42F7F8A3CC3385DFB68EEE)
调用接口需捕获异常。
**起始版本：** 5.0.0(12)
#### 导入模块
```typescript
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| updateAvailable | [UpdateAvailableCode](#section4465197164210) | 是 | 否 | 检查结果。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| code | [RequestErrorCode](#section1713825674019) | 是 | 否 | 检查结果码。 |
| checkUpdateResult | [CheckUpdateResult](#section1535385414136) | 是 | 是 | 检查结果。说明：仅在RequestErrorCode为NEED_UPGRADE或NO_UPGRADE时不为空。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<[CheckUpdateResult](#section1535385414136)> | Promise对象，返回是否有更新检查结果。 |
**错误码：**
...
| 类型 | 说明 |
| --- | --- |
| Promise<[ShowUpdateResultCode](#section194882568246)> | Promise对象，返回显示升级弹框获取结果。 |
**错误码：**
以下错误码的详细介绍请参见 [ArkTS API错误码](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/AppGallery Kit（应用市场服务）/ArkTS API/store-error-code.md) 。
| 错误码ID | 错误信息 |
| --- | --- |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/91/v3/x6RULb7GTS2GIY04ZXgFrw/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260401T093800Z&HW-CC-Expire=86400&HW-CC-Sign=597E6CC3EE835403BDFC94C76291BFB1BBE4792F1339401DFF54B13434219744)
...
| callback | Callback<[UpdateSessionState](#section18222589421)> | 是 | 回调函数，使用Callback方式获取结果。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 固定值"updateChange"。 |
| callback | Callback<[UpdateSessionState](#section18222589421)> | 否 | 回调函数，使用Callback的方式获取结果。不传该参数则会取消当前应用的所有监听。 |
**错误码：**
以下错误码的详细介绍请参见 [ArkTS API错误码](D:/code/APIDevice/output/md_output/harmonyos-references/应用服务/AppGallery Kit（应用市场服务）/ArkTS API/store-error-code.md) 。
| 错误码ID | 错误信息 |
| --- | --- |
