...
description: "使用 Jetpack Media3 在 Android 应用中实现 Google Cast 支持。涵盖添加构建依赖、更新清单、配置 OptionsProvider，以及在 Compose 和基于 View 的 UI 中使用 CastPlayer 或 RemoteCastPlayer 管理播放。适用于添加 Cast 功能，或从旧版 Cast SDK 迁移到 Media3 Cast。"
